...
- `bootstrap/lexer.c+h` generated from `src/self/lexer.til` (includes core.til)
- `bootstrap/ast.c+h` generated from `src/self/ast.til` (includes lexer+core)
- `bootstrap/parser.c+h` generated from `src/self/parser.til`
