...
- `make` — build bin/ctil (also regenerates bootstrap/ from core.til)
...
- `bootstrap/til.c` generated from `src/til.til` (not tracked, in .gitignore)
- All generated by `make` via the `ctil_core` target. NEVER edit manually.
