...
SRCS := $(wildcard src/*.c) $(filter-out src/c/lexer.c src/c/ast.c, $(wildcard src/c/*.c)) bootstrap/lexer.c bootstrap/ast.c
HDRS := $(filter-out src/c/lexer.h src/c/ast.h, $(wildcard src/c/*.h)) bootstrap/lexer.h bootstrap/ast.h
