...
static void _til_lib_init(void) {
        _t4267 = malloc(sizeof(I64));
    *_t4267 = 0;
    (void)_t4267;
    _t4268 = malloc(sizeof(I64));
    *_t4268 = 1;
    (void)_t4268;
    _t4269 = malloc(sizeof(I64)); *_t4269 = I64_sub(DEREF(_t4267), DEREF(_t4268));
    (void)_t4269;
    CAP_LIT = malloc(sizeof(U64)); *CAP_LIT = I64_to_u64(DEREF(_t4269));
    (void)CAP_LIT;
    _t4270 = malloc(sizeof(I64));
    *_t4270 = 0;
    (void)_t4270;
    _t4271 = malloc(sizeof(I64));
    *_t4271 = 2;
    (void)_t4271;
    _t4272 = malloc(sizeof(I64)); *_t4272 = I64_sub(DEREF(_t4270), DEREF(_t4271));
    (void)_t4272;
    CAP_VIEW = malloc(sizeof(U64)); *CAP_VIEW = I64_to_u64(DEREF(_t4272));
    (void)CAP_VIEW;
    _t4273 = Str_lit("Str", 3ULL);
    (void)_t4273;
    _t4274 = Str_size();
    (void)_t4274;
    _t4275 = Str_lit("Mode", 4ULL);
    (void)_t4275;
    _t4276 = Mode_size();
    (void)_t4276;
    core_modes = Map_new(_t4273, _t4274, _t4275, _t4276);
    (void)core_modes;
    ...
    *_t4280 = 0;
    (void)_t4280;
    _t4281 = Str_lit("script", 6ULL);
    (void)_t4281;
    _t4282 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("script", 6ULL)); _t4282->name = *_ca; free(_ca); }
    _t4282->needs_main = DEREF(_t4277);
    _t4282->decls_only = DEREF(_t4278);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t4282->auto_import = *_ca; free(_ca); }
    _t4282->is_pure = DEREF(_t4279);
    _t4282->debug_prints = DEREF(_t4280);
    (void)_t4282;
    Map_set(core_modes, _t4281, _t4282);
    _t4283 = malloc(sizeof(Bool));
    *_t4283 = 1;
    (void)_t4283;
    _t4284 = malloc(sizeof(Bool));
    *_t4284 = 1;
    (void)_t4284;
    ...
    *_t4286 = 0;
    (void)_t4286;
    _t4287 = Str_lit("cli", 3ULL);
    (void)_t4287;
    _t4288 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("cli", 3ULL)); _t4288->name = *_ca; free(_ca); }
    _t4288->needs_main = DEREF(_t4283);
    _t4288->decls_only = DEREF(_t4284);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t4288->auto_import = *_ca; free(_ca); }
    _t4288->is_pure = DEREF(_t4285);
    _t4288->debug_prints = DEREF(_t4286);
    (void)_t4288;
    Map_set(core_modes, _t4287, _t4288);
    _t4289 = malloc(sizeof(Bool));
    *_t4289 = 1;
    (void)_t4289;
    _t4290 = malloc(sizeof(Bool));
    *_t4290 = 1;
    (void)_t4290;
    ...
    *_t4292 = 0;
    (void)_t4292;
    _t4293 = Str_lit("gui", 3ULL);
    (void)_t4293;
    _t4294 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("gui", 3ULL)); _t4294->name = *_ca; free(_ca); }
    _t4294->needs_main = DEREF(_t4289);
    _t4294->decls_only = DEREF(_t4290);
    { Str *_ca = Str_clone(Str_lit("gui", 3ULL)); _t4294->auto_import = *_ca; free(_ca); }
    _t4294->is_pure = DEREF(_t4291);
    _t4294->debug_prints = DEREF(_t4292);
    (void)_t4294;
    Map_set(core_modes, _t4293, _t4294);
    _t4295 = malloc(sizeof(Bool));
    *_t4295 = 0;
    (void)_t4295;
    _t4296 = malloc(sizeof(Bool));
    *_t4296 = 1;
    (void)_t4296;
    ...
    *_t4298 = 0;
    (void)_t4298;
    _t4299 = Str_lit("test", 4ULL);
    (void)_t4299;
    _t4300 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("test", 4ULL)); _t4300->name = *_ca; free(_ca); }
    _t4300->needs_main = DEREF(_t4295);
    _t4300->decls_only = DEREF(_t4296);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t4300->auto_import = *_ca; free(_ca); }
    _t4300->is_pure = DEREF(_t4297);
    _t4300->debug_prints = DEREF(_t4298);
    (void)_t4300;
    Map_set(core_modes, _t4299, _t4300);
    _t4301 = malloc(sizeof(Bool));
    *_t4301 = 0;
    (void)_t4301;
    _t4302 = malloc(sizeof(Bool));
    *_t4302 = 1;
    (void)_t4302;
    ...
    *_t4304 = 0;
    (void)_t4304;
    _t4305 = Str_lit("pure", 4ULL);
    (void)_t4305;
    _t4306 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("pure", 4ULL)); _t4306->name = *_ca; free(_ca); }
    _t4306->needs_main = DEREF(_t4301);
    _t4306->decls_only = DEREF(_t4302);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t4306->auto_import = *_ca; free(_ca); }
    _t4306->is_pure = DEREF(_t4303);
    _t4306->debug_prints = DEREF(_t4304);
    (void)_t4306;
    Map_set(core_modes, _t4305, _t4306);
    _t4307 = malloc(sizeof(Bool));
    *_t4307 = 0;
    (void)_t4307;
    _t4308 = malloc(sizeof(Bool));
    *_t4308 = 1;
    (void)_t4308;
    _t4309 = malloc(sizeof(Bool));
    *_t4309 = 1;
    (void)_t4309;
    _t4310 = malloc(sizeof(Bool));
    *_t4310 = 1;
    (void)_t4310;
    _t4311 = Str_lit("pura", 4ULL);
    (void)_t4311;
    _t4312 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("pura", 4ULL)); _t4312->name = *_ca; free(_ca); }
    _t4312->needs_main = DEREF(_t4307);
    _t4312->decls_only = DEREF(_t4308);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t4312->auto_import = *_ca; free(_ca); }
    _t4312->is_pure = DEREF(_t4309);
    _t4312->debug_prints = DEREF(_t4310);
    (void)_t4312;
    Map_set(core_modes, _t4311, _t4312);
    _t4313 = malloc(sizeof(Bool));
    *_t4313 = 0;
    (void)_t4313;
    _t4314 = malloc(sizeof(Bool));
    *_t4314 = 1;
    (void)_t4314;
    _t4315 = malloc(sizeof(Bool));
    *_t4315 = 0;
    (void)_t4315;
    _t4316 = malloc(sizeof(Bool));
    *_t4316 = 0;
    (void)_t4316;
    _t4317 = Str_lit("lib", 3ULL);
    (void)_t4317;
    _t4318 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("lib", 3ULL)); _t4318->name = *_ca; free(_ca); }
    _t4318->needs_main = DEREF(_t4313);
    _t4318->decls_only = DEREF(_t4314);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t4318->auto_import = *_ca; free(_ca); }
    _t4318->is_pure = DEREF(_t4315);
    _t4318->debug_prints = DEREF(_t4316);
    (void)_t4318;
    Map_set(core_modes, _t4317, _t4318);
    _t4319 = malloc(sizeof(Bool));
    *_t4319 = 0;
    (void)_t4319;
    _t4320 = malloc(sizeof(Bool));
    *_t4320 = 1;
    (void)_t4320;
    _t4321 = malloc(sizeof(Bool));
    *_t4321 = 0;
    (void)_t4321;
    _t4322 = malloc(sizeof(Bool));
    *_t4322 = 1;
    (void)_t4322;
    _t4323 = Str_lit("liba", 4ULL);
    (void)_t4323;
    _t4324 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("liba", 4ULL)); _t4324->name = *_ca; free(_ca); }
    _t4324->needs_main = DEREF(_t4319);
    _t4324->decls_only = DEREF(_t4320);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t4324->auto_import = *_ca; free(_ca); }
    _t4324->is_pure = DEREF(_t4321);
    _t4324->debug_prints = DEREF(_t4322);
    (void)_t4324;
    Map_set(core_modes, _t4323, _t4324);
}
