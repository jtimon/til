...
void Mode_delete(Mode * self, Bool * call_free) {
    ...
    Bool _t3048 = 0;
    (void)_t3048;
    Str_delete(&self->name, &(Bool){_t3048});
    ;
    Bool _t3049 = 0;
    (void)_t3049;
    Bool_delete(&self->needs_main, &(Bool){_t3049});
    ;
    Bool _t3050 = 0;
    (void)_t3050;
    Bool_delete(&self->decls_only, &(Bool){_t3050});
    ;
    Bool _t3051 = 0;
    (void)_t3051;
    Str_delete(&self->auto_import, &(Bool){_t3051});
    ;
    Bool _t3052 = 0;
    (void)_t3052;
    Bool_delete(&self->is_pure, &(Bool){_t3052});
    ;
    Bool _t3053 = 0;
    (void)_t3053;
    Bool_delete(&self->debug_prints, &(Bool){_t3053});
    ;
    if (DEREF(call_free)) {
        free(self);
    }
...
static void _til_lib_init(void) {
    _t3081 = malloc(sizeof(I64));
    *_t3081 = 0;
    (void)_t3081;
    _t3082 = malloc(sizeof(I64));
    *_t3082 = 1;
    (void)_t3082;
    _t3083 = malloc(sizeof(I64)); *_t3083 = I64_sub(DEREF(_t3081), DEREF(_t3082));
    (void)_t3083;
    CAP_LIT = malloc(sizeof(U64)); *CAP_LIT = I64_to_u64(DEREF(_t3083));
    (void)CAP_LIT;
    _t3084 = malloc(sizeof(I64));
    *_t3084 = 0;
    (void)_t3084;
    _t3085 = malloc(sizeof(I64));
    *_t3085 = 2;
    (void)_t3085;
    _t3086 = malloc(sizeof(I64)); *_t3086 = I64_sub(DEREF(_t3084), DEREF(_t3085));
    (void)_t3086;
    CAP_VIEW = malloc(sizeof(U64)); *CAP_VIEW = I64_to_u64(DEREF(_t3086));
    (void)CAP_VIEW;
    _t3087 = Str_lit("Str", 3ULL);
    (void)_t3087;
    _t3088 = Str_size();
    (void)_t3088;
    _t3089 = Str_lit("Mode", 4ULL);
    (void)_t3089;
    _t3090 = Mode_size();
    (void)_t3090;
    core_modes = Map_new(_t3087, _t3088, _t3089, _t3090);
    (void)core_modes;
    _t3091 = malloc(sizeof(Bool));
    *_t3091 = 0;
    (void)_t3091;
    ...
    *_t3094 = 0;
    (void)_t3094;
    _t3095 = Str_lit("script", 6ULL);
    (void)_t3095;
    _t3096 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("script", 6ULL)); _t3096->name = *_ca; free(_ca); }
    _t3096->needs_main = DEREF(_t3091);
    _t3096->decls_only = DEREF(_t3092);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t3096->auto_import = *_ca; free(_ca); }
    _t3096->is_pure = DEREF(_t3093);
    _t3096->debug_prints = DEREF(_t3094);
    (void)_t3096;
    _t3097 = malloc(sizeof(Bool));
    *_t3097 = 1;
    (void)_t3097;
    ...
    *_t3100 = 0;
    (void)_t3100;
    _t3101 = Str_lit("cli", 3ULL);
    (void)_t3101;
    _t3102 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("cli", 3ULL)); _t3102->name = *_ca; free(_ca); }
    _t3102->needs_main = DEREF(_t3097);
    _t3102->decls_only = DEREF(_t3098);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t3102->auto_import = *_ca; free(_ca); }
    _t3102->is_pure = DEREF(_t3099);
    _t3102->debug_prints = DEREF(_t3100);
    (void)_t3102;
    _t3103 = malloc(sizeof(Bool));
    *_t3103 = 1;
    (void)_t3103;
    ...
    *_t3106 = 0;
    (void)_t3106;
    _t3107 = Str_lit("gui", 3ULL);
    (void)_t3107;
    _t3108 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("gui", 3ULL)); _t3108->name = *_ca; free(_ca); }
    _t3108->needs_main = DEREF(_t3103);
    _t3108->decls_only = DEREF(_t3104);
    { Str *_ca = Str_clone(Str_lit("gui", 3ULL)); _t3108->auto_import = *_ca; free(_ca); }
    _t3108->is_pure = DEREF(_t3105);
    _t3108->debug_prints = DEREF(_t3106);
    (void)_t3108;
    _t3109 = malloc(sizeof(Bool));
    *_t3109 = 0;
    (void)_t3109;
    ...
    *_t3112 = 0;
    (void)_t3112;
    _t3113 = Str_lit("test", 4ULL);
    (void)_t3113;
    _t3114 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("test", 4ULL)); _t3114->name = *_ca; free(_ca); }
    _t3114->needs_main = DEREF(_t3109);
    _t3114->decls_only = DEREF(_t3110);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t3114->auto_import = *_ca; free(_ca); }
    _t3114->is_pure = DEREF(_t3111);
    _t3114->debug_prints = DEREF(_t3112);
    (void)_t3114;
    _t3115 = malloc(sizeof(Bool));
    *_t3115 = 0;
    (void)_t3115;
    ...
    *_t3118 = 0;
    (void)_t3118;
    _t3119 = Str_lit("pure", 4ULL);
    (void)_t3119;
    _t3120 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("pure", 4ULL)); _t3120->name = *_ca; free(_ca); }
    _t3120->needs_main = DEREF(_t3115);
    _t3120->decls_only = DEREF(_t3116);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t3120->auto_import = *_ca; free(_ca); }
    _t3120->is_pure = DEREF(_t3117);
    _t3120->debug_prints = DEREF(_t3118);
    (void)_t3120;
    _t3121 = malloc(sizeof(Bool));
    *_t3121 = 0;
    (void)_t3121;
    ...
    *_t3124 = 1;
    (void)_t3124;
    _t3125 = Str_lit("pura", 4ULL);
    (void)_t3125;
    _t3126 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("pura", 4ULL)); _t3126->name = *_ca; free(_ca); }
    _t3126->needs_main = DEREF(_t3121);
    _t3126->decls_only = DEREF(_t3122);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t3126->auto_import = *_ca; free(_ca); }
    _t3126->is_pure = DEREF(_t3123);
    _t3126->debug_prints = DEREF(_t3124);
    (void)_t3126;
    _t3127 = malloc(sizeof(Bool));
    *_t3127 = 0;
    (void)_t3127;
    _t3128 = malloc(sizeof(Bool));
    *_t3128 = 1;
    (void)_t3128;
    _t3129 = malloc(sizeof(Bool));
    *_t3129 = 0;
    (void)_t3129;
    _t3130 = malloc(sizeof(Bool));
    *_t3130 = 0;
    (void)_t3130;
    _t3131 = Str_lit("lib", 3ULL);
    (void)_t3131;
    _t3132 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("lib", 3ULL)); _t3132->name = *_ca; free(_ca); }
    _t3132->needs_main = DEREF(_t3127);
    _t3132->decls_only = DEREF(_t3128);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t3132->auto_import = *_ca; free(_ca); }
    _t3132->is_pure = DEREF(_t3129);
    _t3132->debug_prints = DEREF(_t3130);
    (void)_t3132;
    _t3133 = malloc(sizeof(Bool));
    *_t3133 = 0;
    (void)_t3133;
    _t3134 = malloc(sizeof(Bool));
    *_t3134 = 1;
    (void)_t3134;
    _t3135 = malloc(sizeof(Bool));
    *_t3135 = 0;
    (void)_t3135;
    _t3136 = malloc(sizeof(Bool));
    *_t3136 = 1;
    (void)_t3136;
    _t3137 = Str_lit("liba", 4ULL);
    (void)_t3137;
    _t3138 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("liba", 4ULL)); _t3138->name = *_ca; free(_ca); }
    _t3138->needs_main = DEREF(_t3133);
    _t3138->decls_only = DEREF(_t3134);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t3138->auto_import = *_ca; free(_ca); }
    _t3138->is_pure = DEREF(_t3135);
    _t3138->debug_prints = DEREF(_t3136);
    (void)_t3138;
    _t3139 = Str_lit("script", 6ULL);
    (void)_t3139;
    Mode *MODE_SCRIPT = Map_get(core_modes, _t3139);
    (void)MODE_SCRIPT;
    _t3140 = Str_lit("cli", 3ULL);
    (void)_t3140;
    Mode *MODE_CLI = Map_get(core_modes, _t3140);
    (void)MODE_CLI;
    _t3141 = Str_lit("gui", 3ULL);
    (void)_t3141;
    Mode *MODE_GUI = Map_get(core_modes, _t3141);
    (void)MODE_GUI;
    _t3142 = Str_lit("test", 4ULL);
    (void)_t3142;
    Mode *MODE_TEST = Map_get(core_modes, _t3142);
    (void)MODE_TEST;
    _t3143 = Str_lit("pure", 4ULL);
    (void)_t3143;
    Mode *MODE_PURE = Map_get(core_modes, _t3143);
    (void)MODE_PURE;
    _t3144 = Str_lit("pura", 4ULL);
    (void)_t3144;
    Mode *MODE_PURA = Map_get(core_modes, _t3144);
    (void)MODE_PURA;
    _t3145 = Str_lit("lib", 3ULL);
    (void)_t3145;
    Mode *MODE_LIB = Map_get(core_modes, _t3145);
    (void)MODE_LIB;
    _t3146 = Str_lit("liba", 4ULL);
    (void)_t3146;
    Mode *MODE_LIBA = Map_get(core_modes, _t3146);
    (void)MODE_LIBA;
}
