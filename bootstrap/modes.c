...
static void _til_lib_init(void) {
    _t4249 = malloc(sizeof(I64));
    *_t4249 = 0;
    (void)_t4249;
    _t4250 = malloc(sizeof(I64));
    *_t4250 = 1;
    (void)_t4250;
    _t4251 = malloc(sizeof(I64)); *_t4251 = I64_sub(DEREF(_t4249), DEREF(_t4250));
    (void)_t4251;
    CAP_LIT = malloc(sizeof(U64)); *CAP_LIT = I64_to_u64(DEREF(_t4251));
    (void)CAP_LIT;
    _t4252 = malloc(sizeof(I64));
    *_t4252 = 0;
    (void)_t4252;
    _t4253 = malloc(sizeof(I64));
    *_t4253 = 2;
    (void)_t4253;
    _t4254 = malloc(sizeof(I64)); *_t4254 = I64_sub(DEREF(_t4252), DEREF(_t4253));
    (void)_t4254;
    CAP_VIEW = malloc(sizeof(U64)); *CAP_VIEW = I64_to_u64(DEREF(_t4254));
    (void)CAP_VIEW;
    _t4255 = Str_lit("Str", 3ULL);
    (void)_t4255;
    _t4256 = Str_size();
    (void)_t4256;
    _t4257 = Str_lit("Mode", 4ULL);
    (void)_t4257;
    _t4258 = Mode_size();
    (void)_t4258;
    core_modes = Map_new(_t4255, _t4256, _t4257, _t4258);
    (void)core_modes;
    ...
    *_t4262 = 0;
    (void)_t4262;
    _t4263 = Str_lit("script", 6ULL);
    (void)_t4263;
    _t4264 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("script", 6ULL)); _t4264->name = *_ca; free(_ca); }
    _t4264->needs_main = DEREF(_t4259);
    _t4264->decls_only = DEREF(_t4260);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t4264->auto_import = *_ca; free(_ca); }
    _t4264->is_pure = DEREF(_t4261);
    _t4264->debug_prints = DEREF(_t4262);
    (void)_t4264;
    Map_set(core_modes, _t4263, _t4264);
    ...
    *_t4268 = 0;
    (void)_t4268;
    _t4269 = Str_lit("cli", 3ULL);
    (void)_t4269;
    _t4270 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("cli", 3ULL)); _t4270->name = *_ca; free(_ca); }
    _t4270->needs_main = DEREF(_t4265);
    _t4270->decls_only = DEREF(_t4266);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t4270->auto_import = *_ca; free(_ca); }
    _t4270->is_pure = DEREF(_t4267);
    _t4270->debug_prints = DEREF(_t4268);
    (void)_t4270;
    Map_set(core_modes, _t4269, _t4270);
    ...
    *_t4274 = 0;
    (void)_t4274;
    _t4275 = Str_lit("gui", 3ULL);
    (void)_t4275;
    _t4276 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("gui", 3ULL)); _t4276->name = *_ca; free(_ca); }
    _t4276->needs_main = DEREF(_t4271);
    _t4276->decls_only = DEREF(_t4272);
    { Str *_ca = Str_clone(Str_lit("gui", 3ULL)); _t4276->auto_import = *_ca; free(_ca); }
    _t4276->is_pure = DEREF(_t4273);
    _t4276->debug_prints = DEREF(_t4274);
    (void)_t4276;
    Map_set(core_modes, _t4275, _t4276);
    ...
    *_t4280 = 0;
    (void)_t4280;
    _t4281 = Str_lit("test", 4ULL);
    (void)_t4281;
    _t4282 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("test", 4ULL)); _t4282->name = *_ca; free(_ca); }
    ...
    *_t4286 = 0;
    (void)_t4286;
    _t4287 = Str_lit("pure", 4ULL);
    (void)_t4287;
    _t4288 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("pure", 4ULL)); _t4288->name = *_ca; free(_ca); }
    ...
    *_t4292 = 1;
    (void)_t4292;
    _t4293 = Str_lit("pura", 4ULL);
    (void)_t4293;
    _t4294 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("pura", 4ULL)); _t4294->name = *_ca; free(_ca); }
    _t4294->needs_main = DEREF(_t4289);
    _t4294->decls_only = DEREF(_t4290);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t4294->auto_import = *_ca; free(_ca); }
    ...
    *_t4298 = 0;
    (void)_t4298;
    _t4299 = Str_lit("lib", 3ULL);
    (void)_t4299;
    _t4300 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("lib", 3ULL)); _t4300->name = *_ca; free(_ca); }
    ...
    *_t4304 = 1;
    (void)_t4304;
    _t4305 = Str_lit("liba", 4ULL);
    (void)_t4305;
    _t4306 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("liba", 4ULL)); _t4306->name = *_ca; free(_ca); }
