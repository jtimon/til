...
static void _til_lib_init(void) {
    ...
    *_t3082 = 0;
    (void)_t3082;
    _t3083 = malloc(sizeof(I64));
    *_t3083 = 1;
    (void)_t3083;
    _t3084 = malloc(sizeof(I64)); *_t3084 = I64_sub(DEREF(_t3082), DEREF(_t3083));
    (void)_t3084;
    CAP_LIT = malloc(sizeof(U64)); *CAP_LIT = I64_to_u64(DEREF(_t3084));
    (void)CAP_LIT;
    _t3085 = malloc(sizeof(I64));
    *_t3085 = 0;
    (void)_t3085;
    _t3086 = malloc(sizeof(I64));
    *_t3086 = 2;
    (void)_t3086;
    _t3087 = malloc(sizeof(I64)); *_t3087 = I64_sub(DEREF(_t3085), DEREF(_t3086));
    (void)_t3087;
    CAP_VIEW = malloc(sizeof(U64)); *CAP_VIEW = I64_to_u64(DEREF(_t3087));
    (void)CAP_VIEW;
    _t3088 = Str_lit("Str", 3ULL);
    (void)_t3088;
    _t3089 = Str_size();
    (void)_t3089;
    _t3090 = Str_lit("Mode", 4ULL);
    (void)_t3090;
    _t3091 = Mode_size();
    (void)_t3091;
    core_modes = Map_new(_t3088, _t3089, _t3090, _t3091);
    (void)core_modes;
    ...
    *_t3095 = 0;
    (void)_t3095;
    _t3096 = Str_lit("script", 6ULL);
    (void)_t3096;
    _t3097 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("script", 6ULL)); _t3097->name = *_ca; free(_ca); }
    _t3097->needs_main = DEREF(_t3092);
    _t3097->decls_only = DEREF(_t3093);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t3097->auto_import = *_ca; free(_ca); }
    ...
    *_t3101 = 0;
    (void)_t3101;
    _t3102 = Str_lit("cli", 3ULL);
    (void)_t3102;
    _t3103 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("cli", 3ULL)); _t3103->name = *_ca; free(_ca); }
    ...
    *_t3107 = 0;
    (void)_t3107;
    _t3108 = Str_lit("gui", 3ULL);
    (void)_t3108;
    _t3109 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("gui", 3ULL)); _t3109->name = *_ca; free(_ca); }
    _t3109->needs_main = DEREF(_t3104);
    _t3109->decls_only = DEREF(_t3105);
    { Str *_ca = Str_clone(Str_lit("gui", 3ULL)); _t3109->auto_import = *_ca; free(_ca); }
    ...
    *_t3113 = 0;
    (void)_t3113;
    _t3114 = Str_lit("test", 4ULL);
    (void)_t3114;
    _t3115 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("test", 4ULL)); _t3115->name = *_ca; free(_ca); }
    ...
    *_t3119 = 0;
    (void)_t3119;
    _t3120 = Str_lit("pure", 4ULL);
    (void)_t3120;
    _t3121 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("pure", 4ULL)); _t3121->name = *_ca; free(_ca); }
    ...
    *_t3125 = 1;
    (void)_t3125;
    _t3126 = Str_lit("pura", 4ULL);
    (void)_t3126;
    _t3127 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("pura", 4ULL)); _t3127->name = *_ca; free(_ca); }
    ...
    *_t3130 = 0;
    (void)_t3130;
    _t3131 = malloc(sizeof(Bool));
    *_t3131 = 0;
    (void)_t3131;
    _t3132 = Str_lit("lib", 3ULL);
    (void)_t3132;
    _t3133 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("lib", 3ULL)); _t3133->name = *_ca; free(_ca); }
    _t3133->needs_main = DEREF(_t3128);
    _t3133->decls_only = DEREF(_t3129);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t3133->auto_import = *_ca; free(_ca); }
    _t3133->is_pure = DEREF(_t3130);
    _t3133->debug_prints = DEREF(_t3131);
    (void)_t3133;
    ...
    *_t3136 = 0;
    (void)_t3136;
    _t3137 = malloc(sizeof(Bool));
    *_t3137 = 1;
    (void)_t3137;
    _t3138 = Str_lit("liba", 4ULL);
    (void)_t3138;
    _t3139 = malloc(sizeof(Mode));
    { Str *_ca = Str_clone(Str_lit("liba", 4ULL)); _t3139->name = *_ca; free(_ca); }
    _t3139->needs_main = DEREF(_t3134);
    _t3139->decls_only = DEREF(_t3135);
    { Str *_ca = Str_clone(Str_lit("", 0ULL)); _t3139->auto_import = *_ca; free(_ca); }
    _t3139->is_pure = DEREF(_t3136);
    _t3139->debug_prints = DEREF(_t3137);
    (void)_t3139;
}
