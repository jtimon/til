...
#include "lexer_core.c"
#include "lexer_array.c"
#include "lexer_map.c"
#include "lexer_set.c"
#include "lexer_str.c"
#include "lexer_vec.c"
#include "lexer_tuple.c"
#include "lexer_lexer.c"
...
static void _til_lib_init(void) {
    ...
    *_t2189 = 1;
    ...
    (void)_t2190;
    CAP_LIT = malloc(sizeof(U64)); *CAP_LIT = I64_to_u64(DEREF(_t2190));
    (void)CAP_LIT;
    _t2191 = malloc(sizeof(I64));
    *_t2191 = 0;
    (void)_t2191;
    _t2192 = malloc(sizeof(I64));
    *_t2192 = 2;
    (void)_t2192;
    _t2193 = malloc(sizeof(I64)); *_t2193 = I64_sub(DEREF(_t2191), DEREF(_t2192));
    (void)_t2193;
    CAP_VIEW = malloc(sizeof(U64)); *CAP_VIEW = I64_to_u64(DEREF(_t2193));
    (void)CAP_VIEW;
}
