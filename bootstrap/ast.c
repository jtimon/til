...
static void _til_lib_init(void) {
    ...
    *_t3032 = 0;
    (void)_t3032;
    _t3033 = malloc(sizeof(I64));
    *_t3033 = 1;
    (void)_t3033;
    _t3034 = malloc(sizeof(I64)); *_t3034 = I64_sub(DEREF(_t3032), DEREF(_t3033));
    (void)_t3034;
    CAP_LIT = malloc(sizeof(U64)); *CAP_LIT = I64_to_u64(DEREF(_t3034));
    (void)CAP_LIT;
    _t3035 = malloc(sizeof(I64));
    *_t3035 = 0;
    (void)_t3035;
    _t3036 = malloc(sizeof(I64));
    *_t3036 = 2;
    (void)_t3036;
    _t3037 = malloc(sizeof(I64)); *_t3037 = I64_sub(DEREF(_t3035), DEREF(_t3036));
    (void)_t3037;
    CAP_VIEW = malloc(sizeof(U64)); *CAP_VIEW = I64_to_u64(DEREF(_t3037));
    (void)CAP_VIEW;
}
