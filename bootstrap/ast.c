...
static void _til_lib_init(void) {
    ...
    *_t3034 = 1;
    (void)_t3034;
    _t3035 = malloc(sizeof(I64)); *_t3035 = I64_sub(DEREF(_t3033), DEREF(_t3034));
    (void)_t3035;
    CAP_LIT = malloc(sizeof(U64)); *CAP_LIT = I64_to_u64(DEREF(_t3035));
    (void)CAP_LIT;
    ...
    *_t3037 = 2;
    (void)_t3037;
    _t3038 = malloc(sizeof(I64)); *_t3038 = I64_sub(DEREF(_t3036), DEREF(_t3037));
    (void)_t3038;
    CAP_VIEW = malloc(sizeof(U64)); *CAP_VIEW = I64_to_u64(DEREF(_t3038));
    (void)CAP_VIEW;
}
