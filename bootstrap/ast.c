...
static void _til_lib_init(void) {
    _t3042 = malloc(sizeof(I64));
    *_t3042 = 0;
    (void)_t3042;
    _t3043 = malloc(sizeof(I64));
    *_t3043 = 1;
    (void)_t3043;
    _t3044 = malloc(sizeof(I64)); *_t3044 = I64_sub(DEREF(_t3042), DEREF(_t3043));
    (void)_t3044;
    CAP_LIT = malloc(sizeof(U64)); *CAP_LIT = I64_to_u64(DEREF(_t3044));
    (void)CAP_LIT;
    _t3045 = malloc(sizeof(I64));
    *_t3045 = 0;
    (void)_t3045;
    _t3046 = malloc(sizeof(I64));
    *_t3046 = 2;
    (void)_t3046;
    _t3047 = malloc(sizeof(I64)); *_t3047 = I64_sub(DEREF(_t3045), DEREF(_t3046));
    (void)_t3047;
    CAP_VIEW = malloc(sizeof(U64)); *CAP_VIEW = I64_to_u64(DEREF(_t3047));
    (void)CAP_VIEW;
}
