...
I32 * resolve_imports(Vec * import_paths, Str * base_dir, void * resolved_set, void * stack, void * merged, Str * lib_dir) {
    ...
    (void)lib_dir;
    {
        ...
        while (1) {
            ...
            (void)source;
            Vec *tokens = til_tokenize(source, abs);
            (void)tokens;
...
int main(int argc, char **argv) {
    ...
    *NODE_CASE = 24;
    ...
    if (_t3561) {
        ...
        ;
        Str *_t3179 = Str_lit("src/til.til:231:15", 18ULL);
        (void)_t3179;
        panic(_t3179, _va64);
    ...
    *path_idx = 1;
    ...
    (void)core_source;
    Vec *core_tokens = til_tokenize(core_source, core_path);
    (void)core_tokens;
    ...
    if (_t3583) {
        ...
        if (_t3230) {
            ...
            ;
            Str *_t3226 = Str_lit("src/til.til:317:19", 18ULL);
            (void)_t3226;
            panic(_t3226, _va65);
    ...
    (void)source;
    Vec *tokens = til_tokenize(source, path);
    (void)tokens;
    Str_delete(source, &(Bool){1});
    ...
    if (_t3586) {
        ...
        if (_t3241) {
            ...
            ;
            Str *_t3239 = Str_lit("src/til.til:333:19", 18ULL);
            (void)_t3239;
            panic(_t3239, _va66);
    ...
    if (_t3589) {
        ...
        (void)mode_source;
        Vec *mode_tokens = til_tokenize(mode_source, mode_til_path);
        (void)mode_tokens;
    ...
    if (_t3592) {
        ...
        if (_t3254) {
            ...
            ;
            Str *_t3251 = Str_lit("src/til.til:354:19", 18ULL);
            (void)_t3251;
            panic(_t3251, _va67);
    ...
    *i = _t3598;
    ...
    if (_t3601) {
        ...
        ;
        Str *_t3318 = Str_lit("src/til.til:445:15", 18ULL);
        (void)_t3318;
        panic(_t3318, _va68);
    ...
    if (_t3636) {
        ...
        if (_t3348) {
            ...
            ;
            Str *_t3345 = Str_lit("src/til.til:499:19", 18ULL);
            (void)_t3345;
            panic(_t3345, _va69);
        ...
        if (_t3558) {
            ...
            if (_t3477) {
                ...
                ;
                Str *_t3355 = Str_lit("src/til.til:505:19", 18ULL);
                (void)_t3355;
                panic(_t3355, _va70);
