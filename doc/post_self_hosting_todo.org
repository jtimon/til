...
** TODO Support Struct Instantiation with Arguments                    :LOW:
:PROPERTIES:
:FILE: src/rs/interpreter.rs:464
:END:
...
- [ ] Type check argument types match field types
- [ ] Handle default values for missing arguments

*** Why It's Post-Self-Hosting
Current workaround (initialize then assign fields) works fine.
