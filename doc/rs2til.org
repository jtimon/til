...
Note: Functions returning Vec with heap data must use ~proc~ instead of ~func~ due to Bug #133.
Add a TODO comment referencing Bug #133 to track this workaround.
