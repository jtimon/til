...
In TIL, ~?~ is NOT propagation. It simply marks that a call may throw.
Whether the error is caught or propagated is determined by catch blocks,
not by ~?~ itself. The ~?~ is just a required annotation.
