...
*** Status: FUNCTIONAL PARITY ✅ - HOMOLOGIZATION IN PROGRESS ⚠️
...
*Phase 2: Critical Bugs (MUST FIX)*
- [ ] Fix line numbering (0-based vs 1-based) - Rust line 258, TIL line 191
- [ ] Fix column calculation +1 inconsistencies - Multiple locations
- [ ] Fix number token column (use start not pos) - TIL line 229
- [ ] Fix TIL comment scanning bug (2 chars vs 1) - TIL line 336
- [ ] Fix string token column (use start not pos) - TIL line 427
- [ ] Fix identifier token column calculation - TIL line 450
...
- [ ] Add print_lex_errors helper to Rust - TIL lines 677-685
- [ ] Add enum_to_str helper to Rust
- [ ] Fix grammar: "have" → "has" in ext_func comment
...
- [ ] Standardize whitespace handling structure
