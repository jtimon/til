...
- Added ~snapshot_symbols~ / ~restore_removed_symbols~ helpers for control-flow
  aware own-consumption tracking
- ~check_if_statement~: snapshot before branches, restore between branches.
