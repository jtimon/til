...
|------|--------|---------------|--------|
| rust interpreted | 169.7s | 210.5s | +24% |
| rust compiled | 4.4s | 4.1s | -7% |
| til interpreted | 380.7s | 540.1s | +42% |
| til compiled | 15.4s | 24.7s | +60% |
| Total | 570.3s | 779.5s | +37% |
...
|----------|-------|-------|---------|-----|
| Rust     | 7     | +1018 | -1280   | -262 |
| TIL      | 7     | +1645 | -1380   | +265 |
| C        | 1     | +42682 | -37392 | +5290 |

Note: C changes are in bootstrap/til.c (generated from TIL self-hosted compiler).
Net effect: Rust has 262 fewer lines, TIL has 265 more lines (+3 source lines).
