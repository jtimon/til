...
:STATUS: Open - implementation plan ready (2026-02-18)
:RELATED: Bug #90 (semicolon/body syntax), Bug #159 (needs func ptrs for deep clone/delete), src/test/function_pointers.til, doc/lamda.org
:END:
...
**** Future syntax direction (documented, not implemented now)
Move the full signature into the type position of the declaration:
#+BEGIN_SRC til
my_double : func(a: I64) returns I64 = {
    return a.mul(2)
}
my_func_ptr : func(a: I64) returns I64   // no initializer = type only
my_caller : func(a: I64, f: func(I64) returns I64) returns I64 = {
    return f(a)
}
#+END_SRC
This is more disruptive (changes all function declarations) and deferred.
When done, parameter names in function types become optional:
~func(I64) returns I64~ and ~func(a: I64) returns I64~ are both valid types.
See also Bug #90.

*** Existing Infrastructure (as of 2026-02-18)
