...
:STATUS: In progress - syntax complete (2026-02-21), leverages #105/#106 patterns
...
Next: bodyless declarations (~BinaryOp := func(I64, I64) returns I64~ with no
~= { }~) for function type definitions (FuncSig). See also Bug #90.
