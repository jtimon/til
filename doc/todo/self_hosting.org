...
| parser      |     1,479 |      1,408 | 100%       | ✅ TRANSLATION COMPLETE     |
...
|-------------+-----------+------------+------------+------------------------------|
| *TOTAL*     |     4,404 |      7,456 | *59%*      | Lexer & Parser Complete ✅  |
...
** External Function Architecture (ext.rs → ext.c)
...
*** Status: ✅ TRANSLATION COMPLETE (2025-01-10)
*** Runtime Status: ⏳ TESTING IN PROGRESS (2025-01-10)

*Translation Completed:* 100% of parser.rs (1,408 lines) translated to parser.til (1,527 lines)

*TIL Implementation (1,527 lines):*
- ✅ All data structures (ValueType, Declaration, NodeType, Expr, etc.)
- ✅ All parse functions (parse_primary, parse_statement, parse_body, etc.)
- ✅ Mode system (ModeDef, parse_mode, can_be_imported)
- ✅ Function/proc/macro parsing with full type annotations
- ✅ Enum and struct definition parsing
- ✅ Control flow parsing (if/while/for/switch/catch)
- ✅ Pattern matching and case expressions
- ✅ Full expression parsing with method chaining
- ✅ Public API: parse_tokens() entry point
- ✅ All TODOs resolved
- ✅ All type errors fixed (194 type errors → 0)
- ✅ Helper functions added (empty_expr_array, token_type_eq)
- ✅ Fixed Array/Map/struct constructors to use proper dynamic initialization
...
- ✅ 11 parser tests passing (10 lower-level + test_declarations)
- ❌ test_simple_expressions: memcpy error on 2nd test
- ❌ test_functions: Parse error "Expected statement, found returns"
- ❌ test_control_flow: memcpy error
- ❌ test_enums: Parse error "Expected statement, found }"
- ❌ test_structs: Parse error "Expected statement, found :"
- ❌ test_switch: Type error "Could not find function definition"
- ❌ test_parse_file: Hangs (infinite loop)
...
- [X] Removed tests_self_hosted.til, replaced with "src/til.til help" in rs_interpreted
  - til.til type-checked by running with "help" argument
...
- [ ] "src/til.til help" passes in interpreted mode
