...
| - | - | FuncNameResult | TIL only (helper result type) |
| - | - | TypeArgResult | TIL only (helper result type) |
| - | - | ReceiverTypeResult | TIL only (helper result type) |
| - | - | FuncLookupResult | TIL only (helper result type) |
...
| has_str | - | Y | TIL only |
| add_var_declared | - | Y | TIL only |
| lookup_receiver_type | - | Y | TIL only |
