...
*** Solution
Remove the throw_types check (lines 265-269 in Rust, 365-369 in TIL).
The existing exception handling in ~eval_comptime~ will catch throws and
report them as compile-time errors.
