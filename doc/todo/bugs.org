...
2. Function names emitted as variables - ~til_Str x = til_panic;~ treats function as value
3. Extra Array operations - til generates extra ~Array_new~ and ~Array_set~ calls
4. Compound literals vs intermediate variables - til uses ~&(til_I64){expr}~ inline,
