...
- Investigated Dynamic parameter casting in ccodegen - found cosmetic issue but
  NOT the root cause (both cast and non-cast versions produce same pointer value)
