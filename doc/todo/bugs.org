...
These flags are currently suppressed to allow -Werror. Each needs to be fixed and re-enabled:
...
*** Progress
- [X] Step 1: Suppress warnings (add -Wno-incompatible-pointer-types, -Wno-discarded-qualifiers, -Wno-int-conversion)
- [X] Step 2: Add -Werror to build (2026-01-13)
- [ ] Step 3a: Fix and re-enable -Wincompatible-pointer-types
- [ ] Step 3b: Fix and re-enable -Wdiscarded-qualifiers
- [ ] Step 3c: Fix and re-enable -Wint-conversion
