...
| get_func_name_string | Y | Y | MATCH | vec+join vs string concat is implementation detail, same result (2026-01-05) |
| get_til_func_name_string | Y | Y | MATCH | vec+join vs string concat is implementation detail, same result (2026-01-05) |
| get_type_arg_name | Y | Y | MATCH | Option->throws is correct rs2til.org translation |
| get_fcall_func_def | Y | Y | MATCH | Option->throws KeyNotFoundError per rs2til.org (2026-01-05) |
...
| get_type_dependencies | Y | Y | MATCH | Same structure, empty Vec return matches Rust (2026-01-05) |
