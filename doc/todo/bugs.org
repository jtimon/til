...
Build passes. 107/107 tests pass. Test breakdown:
- 36 tests in all_common (pass all 4 modes)
- 29 tests in til_interpreted (pass til interpret, fail til compile)
- 34 tests in rs_common (pass rstil, fail til compile)
...
The 29 tests in til_interpreted have these failure modes when run with ~./bin/til run~:

| Error Type | Count | Example |
|------------|-------|---------|
| segfault | 27 | Crash during C execution |
| gcc error undeclared | 2 | c_mem.til, lists.til - variable not declared |
