...
*** Root Cause
Unknown. Likely a counter used for generating unique variable names is not
being reset consistently between compilation runs, or iteration order over
some data structure (Map?) is non-deterministic.
...
| -Wunused-parameter           |     0 | Low      | FIXED 2026-01-25                           |
