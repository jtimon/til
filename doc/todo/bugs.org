...
*** Fix Strategy
1. High priority first - these may cause actual bugs
2. Medium - add casts or specialize Vec_push per type
3. Low - either fix in ccodegen or suppress with pragmas
