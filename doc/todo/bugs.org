...
- ~Set~ (set.til:6-7): ~elem_type_name: Str~, ~elem_type_size: I64~
- ~Map~ (map.til:39-40): ~key_type_name: Str~, ~key_type_size: I64~
- ~HashMap~ (hashmap.til:27-28): ~key_type_name: Str~, ~key_type_size: I64~
