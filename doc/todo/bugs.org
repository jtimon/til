...
| Function | Rust | TIL | Status | Notes |
|----------|------|-----|--------|-------|
| topological_sort_types | Y | Y | DIVERGE | Uses Map<I64,Vec> but should use Vec<Vec> like Rust - needs fix |
...
| Function | Rust | TIL | Status | Notes |
|----------|------|-----|--------|-------|
| emit | Y (pub) | Y | DIVERGE | "" vs None verified per rs2til.org, needs full comparison |
