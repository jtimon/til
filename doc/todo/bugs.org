...
:STATUS: In Progress - mut declarations done, user directing remaining work
:END:
...
**** Step 4: TODO - Remaining copy_fields locations (progress tracking)
| Location              | Purpose                                             | Status                        |
|-----------------------+-----------------------------------------------------+-------------------------------|
| mut declarations      | =mut x := y=                                        | DONE (garbager inserts clone) |
| Function copy params  | interpreter.rs:2098,2128,2153 / .til:2261,2308,2340 | TODO                          |
| Struct literal fields | interpreter.rs:603, .til:563                        | TODO                          |
| Assignment statements | interpreter.rs:1139, .til:1202                      | TODO                          |
| Nested member assign  | interpreter.rs:968, .til:1090                       | TODO                          |
