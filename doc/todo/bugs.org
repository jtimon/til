...
| -Wunused-parameter           |     7 | Low      | ext.c has unused _err params               |
| -Wmissing-braces             |     4 | Low      | Nested struct initializers                 |
| -Wmissing-field-initializers |     1 | Low      | Struct initializer missing field           |
...
- [ ] Step 5a: Remove -Wno-dangling-pointer (971 occurrences, high priority)
...
- [ ] Step 5e: Remove -Wno-unused-parameter (7 occurrences)
- [X] Step 5f: Remove -Wno-missing-braces (2026-01-25) - use Ptr() instead of NULL for Declaration.default_value
- [X] Step 5g: Remove -Wno-missing-field-initializers (2026-01-25) - add cap=0 to Str literals for Type params
