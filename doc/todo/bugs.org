...
| get_type_name | Y | Y | MATCH | "" sentinel for Option per rs2til.org (2026-01-05) |
...
| get_struct_construction_type | Y | Y | MATCH | "" sentinel per rs2til.org, method chaining fixed (2026-01-05) |
| get_enum_construction_type | Y | Y | MATCH | "" sentinel per rs2til.org, switch/case idiom (2026-01-05) |
| get_case_variant_info | Y | Y | MATCH | switch/case and mut result are acceptable TIL idioms (2026-01-05) |
| parse_pattern_variant_name | Y | Y | MATCH | catch blocks are acceptable TIL idiom for error handling (2026-01-05) |
