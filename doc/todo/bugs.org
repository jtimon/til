...
*** Progress (2026-01-25)
Commit 129ba21a fixed -Wreturn-type by adding implicit ~return 0;~ at end of ALL
throwing functions (not just void ones). All throwing functions return int
(0=success, 1+=error), so return 0 is always valid as an unreachable fallback.
