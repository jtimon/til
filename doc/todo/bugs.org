...
:STATUS: Part 1 done, Part 2a+2b+2c done (Vec+Array fully cleaned), List remaining
...
Affected containers:
- ~Vec~ (vec.til:11-12): ~type_name: Str~, ~type_size: I64~ -- type_size DONE
...
**** Part 2 remaining:
- Vec type_name -- cannot remove yet, Set reads it at runtime for Str dispatch
