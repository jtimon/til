...
| is_enum_declaration | Y | Y | MATCH | Removed unused vars, uses method chaining (2026-01-05) |
| is_enum_with_payloads | Y | Y | MATCH | Removed unused vars, uses method chaining (2026-01-05) |
| is_constant_declaration | Y | Y | MATCH | Removed unused vars, uses method chaining (2026-01-05) |
| is_global_declaration | Y | Y | MATCH | Removed unused vars, uses method chaining (2026-01-05) |
| is_throwing_fcall | Y | Y | DIVERGE | No longer uses FuncLookupResult, but may have other differences |
| is_func_declaration | Y | Y | MATCH | Removed unused vars, uses method chaining (2026-01-05) |
