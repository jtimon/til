...
|------|------|-----|-------|
| CodegenContext | Y | Y | |
| VariadicParamInfo | Y | Y | |
| CatchLabelInfo | Y | Y | |
| CatchLabelInfoEntry | Y | Y | |
| ParamTypeInfo | Y | Y | |
| ThrowingDefault | Y | Y | |
| CollectedDeclaration | Y | Y | |
| SwitchCaseInfo | Y | Y | |
| HoistedArg | Y | Y | |
| VariantInfo | Y | Y | |
| ThrowingFCallInfo | Y | Y | |
| VariadicFCallInfo | Y | Y | |
| - | - | FuncNameResult | TIL only (helper result type) - caused segfault when removed |
| - | - | FuncLookupResult | TIL only (helper result type) - caused segfault when removed |
...
| emit_struct_literal_assign | Y | Y | DIVERGE | TIL uses mut result variable, Rust mutates output directly |
| emit_struct_literal_start | Y | Y | DIVERGE | TIL uses mut result variable, Rust mutates output directly |
...
| til_type_to_c | Y | Y | DIVERGE | TIL has extra default case that Rust doesn't have |
| value_type_to_c_name | Y | Y | DIVERGE | Comments differ, error message format differs |
