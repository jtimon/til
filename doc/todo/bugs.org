...
- 38 tests in all_common (pass all 4 modes)
- 27 tests in til_interpreted (pass til interpret, fail til compile)
...
The 27 tests in til_interpreted have these failure modes when run with ~./bin/til run~:

| Error Type | Count | Example |
|------------|-------|---------|
| segfault | 27 | Crash during C execution |
