...
:STATUS: In Progress - Steps 3-6 done (mut decl, copy params, struct fields, assignments)
:END:
...
| Nested member assign  | struct member defaults   | TODO           |
| Own params (ident)    | =func(own p: T)= ident  | TODO           |
| Own params (expr)     | =func(own p: T)= expr   | TODO           |
