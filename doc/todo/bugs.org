...
**** Recommendation
Solution A (unique ID on Expr) is simpler and would fix the immediate bug.
Solution C requires more careful architectural work and should be planned separately.
