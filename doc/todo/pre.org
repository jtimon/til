...
- [ ] Improve test error handling with ERROR: prefix (IN PROGRESS - dynamic_arrays.til, mut_test.til, pointers.til, enums.til, arrays.til, and args.til completed, larger test files remain)
