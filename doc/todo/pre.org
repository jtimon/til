...
**** Step 5: Typer own-consumption analysis (Bug #162)
...
**** Step 6: Ccodegen - remove ~const~ for struct/enum locals
...
File: ccodegen.rs, ccodegen.til (7 locations, from latest117):
...
**** Step 7: Container ~own~ params + zeroing + clone fixes
...
**** Step 8: Change container ~get~ to return borrowed Ptr
...
**** Step 9: Garbager - auto-insert Type.delete() calls
