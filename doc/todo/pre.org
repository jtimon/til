...
- [ ] Implement pass-by-reference semantics with three argument modes
  ...
  - [ ] Phase 3: Use references for ALL non-copy parameters
    - Both const (default) and mut parameters use references
    - Includes primitives (I64, Bool, U8, Str) for semantic consistency
    - Only 'copy' keyword creates actual copies
    - Change interpreter to share arena offsets for non-copy params
    - Remove deep copying from const parameter passing
