...
- Step 1: Add =build_dest_ptr_expr= helper
- Step 2: Modify =emit_throwing_call_propagate= -- skip temp, use dest ptr, skip copy
- Step 3: Modify =emit_throwing_call_with_goto= -- same changes
...
- Step 5: Add =needs_out_pointer= helper
- Step 6: Modify =emit_func_signature= -- void + =_ret= param for structs
- Step 7: Modify =emit_return= -- =*_ret = value; return;=
- Step 8: Modify implicit return fallbacks (3 locations)
- Step 9: Modify =emit_fcall_arg_string= -- hoist nested struct calls
- Step 10: Modify =emit_declaration= for direct out-pointer
- Step 11: Modify =emit_assignment= for direct out-pointer
- Step 12: Update ext.c (=til_i64_to_str=, =til_fs_parent_dir=)
