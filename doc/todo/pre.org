...
- [ ] Improve test error handling with ERROR: prefix (IN PROGRESS - dynamic_arrays.til, mut_test.til, pointers.til, enums.til, and arrays.til completed, other test files remain)
