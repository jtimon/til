...
*** Completed
- [X] Validate default values don't call procs (FIXED in src/rs/typer.rs:997-1000, 1153-1161)
- [X] Ensure function arguments don't call procs (FIXED in src/rs/typer.rs:1177-1198, test in src/test/func_purity.til)
- [X] Test struct member type checking (FIXED in src/rs/typer.rs:1001-1026, test in src/test/structs.til)
