...
fn emit_expr(expr: &Expr, output: &mut String, indent: usize, ctx: &mut CodegenContext, context: &mut Context) -> Result<(), String> {
    ...
    match &expr.node_type {
        ...
        // Switch should have been desugared in desugarer phase
        NodeType::Switch => panic!("Switch should have been desugared in desugarer phase"),
        NodeType::DefaultCase => panic!("DefaultCase should have been desugared in desugarer phase"),
        NodeType::Range => Err("ccodegen: Range not yet supported".to_string()),
        NodeType::Pattern(_) => panic!("Pattern should have been desugared in desugarer phase"),
