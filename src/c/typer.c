    ...
    case NODE_FCALL: {
        ...
        if (expr_child(e, 0)->type == NODE_FIELD_ACCESS) {
            ...
            for (I32 i = 1; i < e->children.count && i - 1 < ns_func->data.func_def.nparam; i++) {
                ...
                if (arg->type == NODE_LITERAL_NUM && (ptype == TIL_TYPE_I64 || ptype == TIL_TYPE_U8 || ptype == TIL_TYPE_U32))
                    continue;
            ...
            if (stmt->data.decl.explicit_type) {
                ...
                if (declared == TIL_TYPE_UNKNOWN) {
                    ...
                    type_error(stmt, buf);
                           ...
                           (declared == TIL_TYPE_I64 || declared == TIL_TYPE_U8 || declared == TIL_TYPE_U32 || declared == TIL_TYPE_DYNAMIC)) {
