...
void til_panic(const til_Str* til_loc_str, const til_Str* til_msg, til_Array* til_extra_msgs) {
    ...
    while (til_I64_lt(&_for_i_0, &(til_I64){til_Array_len(til_extra_msgs)}).data) {
        ...
        int _status__tmp_panic_1 = til_Array_get(&_err0__tmp_panic_1, til_extra_msgs, &_for_i_0, (til_Dynamic*)&til_extra_msg);
...
void til_println(til_Array* til_args) {
    ...
    while (til_I64_lt(&_for_i_0, &(til_I64){til_Array_len(til_args)}).data) {
        ...
        int _status__tmp_println_1 = til_Array_get(&_err0__tmp_println_1, til_args, &_for_i_0, (til_Dynamic*)&til_print_arg);
...
til_Str til_format(const til_Str* til_prefix, til_Array* til_args) {
    ...
    while (til_I64_lt(&_for_i_0, &(til_I64){til_Array_len(til_args)}).data) {
        ...
        int _status__tmp_format_19 = til_Array_get(&_err0__tmp_format_19, til_args, &_for_i_0, (til_Dynamic*)&til_s);
