...
void til_assertm(const til_Str* til_Str_loc_str, const til_Bool* til_Bool_cond, const til_Str* til_Str_msg) {
    ...
    if (_tmp_assertm_0.data) {
        ...
        til_Array_new(&_tmp_assertm_2, _tmp_assertm_4, &_tmp_assertm_5);
        int __attribute__((unused)) _arr_status__tmp_assertm_3;
        til_I64 _tmp_assertm_6 = 0;
        _arr_status__tmp_assertm_3 = til_Array_set(&_err_idx__tmp_assertm_3, &_tmp_assertm_2, &_tmp_assertm_6, (til_Dynamic*)&(*til_Str_msg));
        ...
        til_panic(til_Str_loc_str, &_tmp_assertm_1, &_tmp_assertm_7);
...
int til_get_substr(til_Str* _ret, til_IndexOutOfBoundsError* _err1, const til_Str* til_Str_s, const til_I64* til_I64_start, const til_I64* til_I64_end) {
    ...
    if (_tmp_get_substr_1.data) {
        ...
        til_Type _tmp_get_substr_6 = "Str";
        til_I64 _tmp_get_substr_7 = 3;
        til_Array_new(&_tmp_get_substr_4, _tmp_get_substr_6, &_tmp_get_substr_7);
        int __attribute__((unused)) _arr_status__tmp_get_substr_5;
        til_I64 _tmp_get_substr_8 = 0;
        _arr_status__tmp_get_substr_5 = til_Array_set(&_err_idx__tmp_get_substr_5, &_tmp_get_substr_4, &_tmp_get_substr_8, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"get_substr: start index ", 1, 0, 0, 0}), 24, 0}));
        til_I64 _tmp_get_substr_9 = 1;
        _arr_status__tmp_get_substr_5 = til_Array_set(&_err_idx__tmp_get_substr_5, &_tmp_get_substr_4, &_tmp_get_substr_9, (til_Dynamic*)&_tmp_get_substr_2);
        til_I64 _tmp_get_substr_10 = 2;
        _arr_status__tmp_get_substr_5 = til_Array_set(&_err_idx__tmp_get_substr_5, &_tmp_get_substr_4, &_tmp_get_substr_10, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" cannot be negative", 1, 0, 0, 0}), 19, 0}));
    ...
    til_Bool _tmp_get_substr_12;
    til_I64_lt(&_tmp_get_substr_12, til_I64_end, &_tmp_get_substr_11);
    if (_tmp_get_substr_12.data) {
        til_Str _tmp_get_substr_13;
        til_I64_to_str(&_tmp_get_substr_13, til_I64_end);
        til_Str _tmp_get_substr_14;
        til_Array _tmp_get_substr_15;
        til_IndexOutOfBoundsError __attribute__((unused)) _err_idx__tmp_get_substr_16;
        til_Type _tmp_get_substr_17 = "Str";
        til_I64 _tmp_get_substr_18 = 3;
        til_Array_new(&_tmp_get_substr_15, _tmp_get_substr_17, &_tmp_get_substr_18);
        int __attribute__((unused)) _arr_status__tmp_get_substr_16;
        til_I64 _tmp_get_substr_19 = 0;
        _arr_status__tmp_get_substr_16 = til_Array_set(&_err_idx__tmp_get_substr_16, &_tmp_get_substr_15, &_tmp_get_substr_19, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"get_substr: end index ", 1, 0, 0, 0}), 22, 0}));
        til_I64 _tmp_get_substr_20 = 1;
        _arr_status__tmp_get_substr_16 = til_Array_set(&_err_idx__tmp_get_substr_16, &_tmp_get_substr_15, &_tmp_get_substr_20, (til_Dynamic*)&_tmp_get_substr_13);
        til_I64 _tmp_get_substr_21 = 2;
        _arr_status__tmp_get_substr_16 = til_Array_set(&_err_idx__tmp_get_substr_16, &_tmp_get_substr_15, &_tmp_get_substr_21, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" cannot be negative", 1, 0, 0, 0}), 19, 0}));
        til_format(&_tmp_get_substr_14, &((til_Str){((til_Ptr){(til_I64)"src/core/str.til:562:48:", 1, 0, 0, 0}), 24, 0}), &_tmp_get_substr_15);
        til_Array_delete(&_tmp_get_substr_15);
        *_err1 = (til_IndexOutOfBoundsError){.msg = _tmp_get_substr_14};
        return 1;
    }
    til_Bool _tmp_get_substr_22;
    til_I64_gt(&_tmp_get_substr_22, til_I64_start, til_I64_end);
    if (_tmp_get_substr_22.data) {
        til_Str _tmp_get_substr_23;
        til_I64_to_str(&_tmp_get_substr_23, til_I64_start);
        til_Str _tmp_get_substr_24;
        til_I64_to_str(&_tmp_get_substr_24, til_I64_end);
        til_Str _tmp_get_substr_25;
        til_Array _tmp_get_substr_26;
        til_IndexOutOfBoundsError __attribute__((unused)) _err_idx__tmp_get_substr_27;
        til_Type _tmp_get_substr_28 = "Str";
        til_I64 _tmp_get_substr_29 = 4;
        til_Array_new(&_tmp_get_substr_26, _tmp_get_substr_28, &_tmp_get_substr_29);
        int __attribute__((unused)) _arr_status__tmp_get_substr_27;
        til_I64 _tmp_get_substr_30 = 0;
        _arr_status__tmp_get_substr_27 = til_Array_set(&_err_idx__tmp_get_substr_27, &_tmp_get_substr_26, &_tmp_get_substr_30, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"get_substr: start index ", 1, 0, 0, 0}), 24, 0}));
        til_I64 _tmp_get_substr_31 = 1;
        _arr_status__tmp_get_substr_27 = til_Array_set(&_err_idx__tmp_get_substr_27, &_tmp_get_substr_26, &_tmp_get_substr_31, (til_Dynamic*)&_tmp_get_substr_23);
        til_I64 _tmp_get_substr_32 = 2;
        _arr_status__tmp_get_substr_27 = til_Array_set(&_err_idx__tmp_get_substr_27, &_tmp_get_substr_26, &_tmp_get_substr_32, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" is greater than end index ", 1, 0, 0, 0}), 27, 0}));
        til_I64 _tmp_get_substr_33 = 3;
        _arr_status__tmp_get_substr_27 = til_Array_set(&_err_idx__tmp_get_substr_27, &_tmp_get_substr_26, &_tmp_get_substr_33, (til_Dynamic*)&_tmp_get_substr_24);
        til_format(&_tmp_get_substr_25, &((til_Str){((til_Ptr){(til_I64)"src/core/str.til:565:48:", 1, 0, 0, 0}), 24, 0}), &_tmp_get_substr_26);
        til_Array_delete(&_tmp_get_substr_26);
        *_err1 = (til_IndexOutOfBoundsError){.msg = _tmp_get_substr_25};
        return 1;
    }
    til_I64 _tmp_get_substr_34 = til_Str_len(til_Str_s);
    til_Bool _tmp_get_substr_35;
    til_I64_gt(&_tmp_get_substr_35, til_I64_end, &_tmp_get_substr_34);
    if (_tmp_get_substr_35.data) {
        til_Str _tmp_get_substr_36;
        til_I64_to_str(&_tmp_get_substr_36, til_I64_end);
        til_I64 _tmp_get_substr_37 = til_Str_len(til_Str_s);
        til_Str _tmp_get_substr_38;
        til_I64_to_str(&_tmp_get_substr_38, &_tmp_get_substr_37);
        ...
        til_Type _tmp_get_substr_42 = "Str";
        til_I64 _tmp_get_substr_43 = 4;
        til_Array_new(&_tmp_get_substr_40, _tmp_get_substr_42, &_tmp_get_substr_43);
        int __attribute__((unused)) _arr_status__tmp_get_substr_41;
        til_I64 _tmp_get_substr_44 = 0;
        _arr_status__tmp_get_substr_41 = til_Array_set(&_err_idx__tmp_get_substr_41, &_tmp_get_substr_40, &_tmp_get_substr_44, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"get_substr: end index ", 1, 0, 0, 0}), 22, 0}));
        til_I64 _tmp_get_substr_45 = 1;
        _arr_status__tmp_get_substr_41 = til_Array_set(&_err_idx__tmp_get_substr_41, &_tmp_get_substr_40, &_tmp_get_substr_45, (til_Dynamic*)&_tmp_get_substr_36);
        til_I64 _tmp_get_substr_46 = 2;
        _arr_status__tmp_get_substr_41 = til_Array_set(&_err_idx__tmp_get_substr_41, &_tmp_get_substr_40, &_tmp_get_substr_46, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" is greater than string length ", 1, 0, 0, 0}), 31, 0}));
        til_I64 _tmp_get_substr_47 = 3;
        _arr_status__tmp_get_substr_41 = til_Array_set(&_err_idx__tmp_get_substr_41, &_tmp_get_substr_40, &_tmp_get_substr_47, (til_Dynamic*)&_tmp_get_substr_38);
        til_format(&_tmp_get_substr_39, &((til_Str){((til_Ptr){(til_I64)"src/core/str.til:568:48:", 1, 0, 0, 0}), 24, 0}), &_tmp_get_substr_40);
        til_Array_delete(&_tmp_get_substr_40);
        *_err1 = (til_IndexOutOfBoundsError){.msg = _tmp_get_substr_39};
        return 1;
    }
    til_Bool _tmp_get_substr_48;
    til_I64_eq(&_tmp_get_substr_48, til_I64_start, til_I64_end);
    if (_tmp_get_substr_48.data) {
        *_ret = ((til_Str){((til_Ptr){(til_I64)"", 1, 0, 0, 0}), 0, 0});
        return 0;
    }
    til_Ptr _tmp_get_substr_49 = (til_Ptr){.data = til_I64_NULL, .is_borrowed = 0, .alloc_size = 0, .elem_type = til_I64_NULL, .elem_size = 0};
    til_Str til_Str_substr = {.c_string = _tmp_get_substr_49, ._len = 0, .cap = 0};
    til_Str_substr._len = til_I64_sub(til_I64_end, til_I64_start);
    til_I64 _tmp_get_substr_50 = 1;
    til_Str_substr.cap = til_I64_add(&til_Str_substr._len, &_tmp_get_substr_50);
    til_Ptr _tmp_get_substr_51;
    til_Ptr_new_by_size(&_tmp_get_substr_51, &til_Str_substr.cap);
    til_Str_substr.c_string = _tmp_get_substr_51;
    til_Str_substr.c_string.is_borrowed = 0;
    til_Ptr _tmp_get_substr_52;
    til_Ptr_offset(&_tmp_get_substr_52, &til_Str_s->c_string, til_I64_start);
    til_memcpy(&til_Str_substr.c_string.data, &_tmp_get_substr_52.data, &til_Str_substr._len);
    til_U8 til_U8_zero = 0;
    til_Ptr _tmp_get_substr_53;
    til_Ptr_offset(&_tmp_get_substr_53, &til_Str_substr.c_string, &til_Str_substr._len);
    til_I64 _tmp_get_substr_54 = 1;
    til_memset(&_tmp_get_substr_53.data, &til_U8_zero, &_tmp_get_substr_54);
    *_ret = til_Str_substr;
    return 0;
    return 0;
}
...
void til_assert_eq(const til_Str* til_Str_loc_str, const til_I64* til_I64_a, const til_I64* til_I64_b) {
    ...
    if (_tmp_assert_eq_1.data) {
        ...
        til_Type _tmp_assert_eq_6 = "Str";
        til_I64 _tmp_assert_eq_7 = 6;
        til_Array_new(&_tmp_assert_eq_4, _tmp_assert_eq_6, &_tmp_assert_eq_7);
        int __attribute__((unused)) _arr_status__tmp_assert_eq_5;
        til_I64 _tmp_assert_eq_8 = 0;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_8, (til_Dynamic*)&(*til_Str_loc_str));
        til_I64 _tmp_assert_eq_9 = 1;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_9, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"assert_eq failed: expected '", 1, 0, 0, 0}), 28, 0}));
        til_I64 _tmp_assert_eq_10 = 2;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_10, (til_Dynamic*)&_tmp_assert_eq_2);
        til_I64 _tmp_assert_eq_11 = 3;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_11, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"', found '", 1, 0, 0, 0}), 10, 0}));
        til_I64 _tmp_assert_eq_12 = 4;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_12, (til_Dynamic*)&_tmp_assert_eq_3);
        til_I64 _tmp_assert_eq_13 = 5;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_13, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"'", 1, 0, 0, 0}), 1, 0}));
        til_println(&_tmp_assert_eq_4);
        til_Array_delete(&_tmp_assert_eq_4);
        til_I64 _tmp_assert_eq_14 = 1;
        til_exit(&_tmp_assert_eq_14);
    }
}
...
void til_Ptr_is_null(til_Bool* _ret, const til_Ptr* til_Ptr_self) {
    (void)_ret;
    til_I64_eq(_ret, &til_I64_NULL, &til_Ptr_self->data);
    return;
}
...
int til_Array_get(til_Ptr* _ret, til_IndexOutOfBoundsError* _err1, const til_Array* til_Array_self, const til_I64* til_I64_index) {
    ...
    if (_tmp_til_Array_get_0.data) {
        ...
        til_Array_new(&_tmp_til_Array_get_2, _tmp_til_Array_get_4, &_tmp_til_Array_get_5);
        int __attribute__((unused)) _arr_status__tmp_til_Array_get_3;
        til_I64 _tmp_til_Array_get_6 = 0;
        _arr_status__tmp_til_Array_get_3 = til_Array_set(&_err_idx__tmp_til_Array_get_3, &_tmp_til_Array_get_2, &_tmp_til_Array_get_6, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"Array.get: index out of bounds", 1, 0, 0, 0}), 30, 0}));
    ...
    til_Ptr_offset(_ret, &til_Array_self->ptr, &_tmp_til_Array_get_7);
    return 0;
    return 0;
}
...
int til_Array_set(til_IndexOutOfBoundsError* _err1, til_Array* til_Array_self, const til_I64* til_I64_index, til_Dynamic* til_Dynamic_value) {
    ...
    if (_tmp_til_Array_set_0.data) {
        ...
        til_Array_new(&_tmp_til_Array_set_2, _tmp_til_Array_set_4, &_tmp_til_Array_set_5);
        int __attribute__((unused)) _arr_status__tmp_til_Array_set_3;
        til_I64 _tmp_til_Array_set_6 = 0;
        _arr_status__tmp_til_Array_set_3 = til_Array_set(&_err_idx__tmp_til_Array_set_3, &_tmp_til_Array_set_2, &_tmp_til_Array_set_6, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"Array.set: index out of bounds", 1, 0, 0, 0}), 30, 0}));
    ...
    til_Ptr_offset(&til_Ptr_dest, &til_Array_self->ptr, &_tmp_til_Array_set_7);
...
void til_Bool_eq(til_Bool* _ret, const til_Bool* til_Bool_a, const til_Bool* til_Bool_b) {
    ...
    til_Bool_or(_ret, &_tmp_til_Bool_eq_0, &_tmp_til_Bool_eq_3);
    return;
}
...
int til_I64_safe_add(til_I64* _ret, til_I64_Overflow* _err1, const til_I64* til_I64_a, const til_I64* til_I64_b) {
    ...
    if (_tmp_til_I64_safe_add_1.data) {
        ...
        if (_tmp_til_I64_safe_add_2.data) {
            ...
            til_Array_new(&_tmp_til_I64_safe_add_6, _tmp_til_I64_safe_add_8, &_tmp_til_I64_safe_add_9);
            int __attribute__((unused)) _arr_status__tmp_til_I64_safe_add_7;
            til_I64 _tmp_til_I64_safe_add_10 = 0;
            _arr_status__tmp_til_I64_safe_add_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_7, &_tmp_til_I64_safe_add_6, &_tmp_til_I64_safe_add_10, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"I64 overflow: ", 1, 0, 0, 0}), 14, 0}));
            til_I64 _tmp_til_I64_safe_add_11 = 1;
            _arr_status__tmp_til_I64_safe_add_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_7, &_tmp_til_I64_safe_add_6, &_tmp_til_I64_safe_add_11, (til_Dynamic*)&_tmp_til_I64_safe_add_3);
            til_I64 _tmp_til_I64_safe_add_12 = 2;
            _arr_status__tmp_til_I64_safe_add_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_7, &_tmp_til_I64_safe_add_6, &_tmp_til_I64_safe_add_12, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" + ", 1, 0, 0, 0}), 3, 0}));
            til_I64 _tmp_til_I64_safe_add_13 = 3;
            _arr_status__tmp_til_I64_safe_add_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_7, &_tmp_til_I64_safe_add_6, &_tmp_til_I64_safe_add_13, (til_Dynamic*)&_tmp_til_I64_safe_add_4);
    ...
    til_Bool _tmp_til_I64_safe_add_15;
    til_I64_lt(&_tmp_til_I64_safe_add_15, til_I64_b, &_tmp_til_I64_safe_add_14);
    if (_tmp_til_I64_safe_add_15.data) {
        til_Bool _tmp_til_I64_safe_add_16;
        til_I64_gt(&_tmp_til_I64_safe_add_16, &til_I64_result, til_I64_a);
        if (_tmp_til_I64_safe_add_16.data) {
            ...
            til_Array_new(&_tmp_til_I64_safe_add_20, _tmp_til_I64_safe_add_22, &_tmp_til_I64_safe_add_23);
            int __attribute__((unused)) _arr_status__tmp_til_I64_safe_add_21;
            til_I64 _tmp_til_I64_safe_add_24 = 0;
            _arr_status__tmp_til_I64_safe_add_21 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_21, &_tmp_til_I64_safe_add_20, &_tmp_til_I64_safe_add_24, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"I64 overflow: ", 1, 0, 0, 0}), 14, 0}));
            til_I64 _tmp_til_I64_safe_add_25 = 1;
            _arr_status__tmp_til_I64_safe_add_21 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_21, &_tmp_til_I64_safe_add_20, &_tmp_til_I64_safe_add_25, (til_Dynamic*)&_tmp_til_I64_safe_add_17);
            til_I64 _tmp_til_I64_safe_add_26 = 2;
            _arr_status__tmp_til_I64_safe_add_21 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_21, &_tmp_til_I64_safe_add_20, &_tmp_til_I64_safe_add_26, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" + ", 1, 0, 0, 0}), 3, 0}));
            til_I64 _tmp_til_I64_safe_add_27 = 3;
            _arr_status__tmp_til_I64_safe_add_21 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_21, &_tmp_til_I64_safe_add_20, &_tmp_til_I64_safe_add_27, (til_Dynamic*)&_tmp_til_I64_safe_add_18);
            til_format(&_tmp_til_I64_safe_add_19, &((til_Str){((til_Ptr){(til_I64)"src/core/i64.til:41:47:", 1, 0, 0, 0}), 23, 0}), &_tmp_til_I64_safe_add_20);
...
int til_I64_safe_sub(til_I64* _ret, til_I64_Overflow* _err1, const til_I64* til_I64_a, const til_I64* til_I64_b) {
    ...
    if (_tmp_til_I64_safe_sub_1.data) {
        ...
        if (_tmp_til_I64_safe_sub_2.data) {
            ...
            til_Array_new(&_tmp_til_I64_safe_sub_6, _tmp_til_I64_safe_sub_8, &_tmp_til_I64_safe_sub_9);
            int __attribute__((unused)) _arr_status__tmp_til_I64_safe_sub_7;
            til_I64 _tmp_til_I64_safe_sub_10 = 0;
            _arr_status__tmp_til_I64_safe_sub_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_7, &_tmp_til_I64_safe_sub_6, &_tmp_til_I64_safe_sub_10, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"I64 underflow: ", 1, 0, 0, 0}), 15, 0}));
            til_I64 _tmp_til_I64_safe_sub_11 = 1;
            _arr_status__tmp_til_I64_safe_sub_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_7, &_tmp_til_I64_safe_sub_6, &_tmp_til_I64_safe_sub_11, (til_Dynamic*)&_tmp_til_I64_safe_sub_3);
            til_I64 _tmp_til_I64_safe_sub_12 = 2;
            _arr_status__tmp_til_I64_safe_sub_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_7, &_tmp_til_I64_safe_sub_6, &_tmp_til_I64_safe_sub_12, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" - ", 1, 0, 0, 0}), 3, 0}));
            til_I64 _tmp_til_I64_safe_sub_13 = 3;
            _arr_status__tmp_til_I64_safe_sub_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_7, &_tmp_til_I64_safe_sub_6, &_tmp_til_I64_safe_sub_13, (til_Dynamic*)&_tmp_til_I64_safe_sub_4);
    ...
    til_Bool _tmp_til_I64_safe_sub_15;
    til_I64_lt(&_tmp_til_I64_safe_sub_15, til_I64_b, &_tmp_til_I64_safe_sub_14);
    if (_tmp_til_I64_safe_sub_15.data) {
        til_Bool _tmp_til_I64_safe_sub_16;
        til_I64_lt(&_tmp_til_I64_safe_sub_16, &til_I64_result, til_I64_a);
        if (_tmp_til_I64_safe_sub_16.data) {
            ...
            til_Array_new(&_tmp_til_I64_safe_sub_20, _tmp_til_I64_safe_sub_22, &_tmp_til_I64_safe_sub_23);
            int __attribute__((unused)) _arr_status__tmp_til_I64_safe_sub_21;
            til_I64 _tmp_til_I64_safe_sub_24 = 0;
            _arr_status__tmp_til_I64_safe_sub_21 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_21, &_tmp_til_I64_safe_sub_20, &_tmp_til_I64_safe_sub_24, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"I64 underflow: ", 1, 0, 0, 0}), 15, 0}));
            til_I64 _tmp_til_I64_safe_sub_25 = 1;
            _arr_status__tmp_til_I64_safe_sub_21 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_21, &_tmp_til_I64_safe_sub_20, &_tmp_til_I64_safe_sub_25, (til_Dynamic*)&_tmp_til_I64_safe_sub_17);
            til_I64 _tmp_til_I64_safe_sub_26 = 2;
            _arr_status__tmp_til_I64_safe_sub_21 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_21, &_tmp_til_I64_safe_sub_20, &_tmp_til_I64_safe_sub_26, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" - ", 1, 0, 0, 0}), 3, 0}));
            til_I64 _tmp_til_I64_safe_sub_27 = 3;
            _arr_status__tmp_til_I64_safe_sub_21 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_21, &_tmp_til_I64_safe_sub_20, &_tmp_til_I64_safe_sub_27, (til_Dynamic*)&_tmp_til_I64_safe_sub_18);
            til_format(&_tmp_til_I64_safe_sub_19, &((til_Str){((til_Ptr){(til_I64)"src/core/i64.til:59:47:", 1, 0, 0, 0}), 23, 0}), &_tmp_til_I64_safe_sub_20);
...
int til_I64_safe_mul(til_I64* _ret, til_I64_Overflow* _err1, const til_I64* til_I64_a, const til_I64* til_I64_b) {
    ...
    if (_tmp_til_I64_safe_mul_2.data) {
        ...
        if (_tmp_til_I64_safe_mul_5.data) {
            ...
            til_Array_new(&_tmp_til_I64_safe_mul_9, _tmp_til_I64_safe_mul_11, &_tmp_til_I64_safe_mul_12);
            int __attribute__((unused)) _arr_status__tmp_til_I64_safe_mul_10;
            til_I64 _tmp_til_I64_safe_mul_13 = 0;
            _arr_status__tmp_til_I64_safe_mul_10 = til_Array_set(&_err_idx__tmp_til_I64_safe_mul_10, &_tmp_til_I64_safe_mul_9, &_tmp_til_I64_safe_mul_13, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"I64 overflow: ", 1, 0, 0, 0}), 14, 0}));
            til_I64 _tmp_til_I64_safe_mul_14 = 1;
            _arr_status__tmp_til_I64_safe_mul_10 = til_Array_set(&_err_idx__tmp_til_I64_safe_mul_10, &_tmp_til_I64_safe_mul_9, &_tmp_til_I64_safe_mul_14, (til_Dynamic*)&_tmp_til_I64_safe_mul_6);
            til_I64 _tmp_til_I64_safe_mul_15 = 2;
            _arr_status__tmp_til_I64_safe_mul_10 = til_Array_set(&_err_idx__tmp_til_I64_safe_mul_10, &_tmp_til_I64_safe_mul_9, &_tmp_til_I64_safe_mul_15, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" * ", 1, 0, 0, 0}), 3, 0}));
            til_I64 _tmp_til_I64_safe_mul_16 = 3;
            _arr_status__tmp_til_I64_safe_mul_10 = til_Array_set(&_err_idx__tmp_til_I64_safe_mul_10, &_tmp_til_I64_safe_mul_9, &_tmp_til_I64_safe_mul_16, (til_Dynamic*)&_tmp_til_I64_safe_mul_7);
...
void til_Vec__is_str_type(til_Bool* _ret, const til_Vec* til_Vec_self) {
    ...
    til_I64_eq(_ret, &_tmp_til_Vec__is_str_type_2, &_tmp_til_Vec__is_str_type_3);
    return;
}
...
void til_Vec_with_capacity(til_Vec* _ret, til_Type til_Type_T, const til_I64* til_I64_capacity) {
    ...
    if (_tmp_til_Vec_with_capacity_2.data) {
        ...
        til_Vec__alloc_ptr(&_tmp_til_Vec_with_capacity_9, &til_Vec_vec, til_I64_capacity);
        til_Vec_vec.ptr = _tmp_til_Vec_with_capacity_9;
    }
    *_ret = til_Vec_vec;
    return;
}
...
int til_Vec_get(til_Ptr* _ret, til_IndexOutOfBoundsError* _err1, const til_Vec* til_Vec_self, const til_I64* til_I64_index) {
    ...
    if (_tmp_til_Vec_get_0.data) {
        ...
        til_Array_new(&_tmp_til_Vec_get_2, _tmp_til_Vec_get_4, &_tmp_til_Vec_get_5);
        int __attribute__((unused)) _arr_status__tmp_til_Vec_get_3;
        til_I64 _tmp_til_Vec_get_6 = 0;
        _arr_status__tmp_til_Vec_get_3 = til_Array_set(&_err_idx__tmp_til_Vec_get_3, &_tmp_til_Vec_get_2, &_tmp_til_Vec_get_6, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"Vec.get: index out of bounds", 1, 0, 0, 0}), 28, 0}));
    ...
    til_Ptr_offset(_ret, &til_Vec_self->ptr, &_tmp_til_Vec_get_7);
    return 0;
    return 0;
}
...
int til_Vec_set(til_IndexOutOfBoundsError* _err1, til_Vec* til_Vec_self, const til_I64* til_I64_index, til_Dynamic* til_Dynamic_value) {
    ...
    if (_tmp_til_Vec_set_0.data) {
        ...
        til_Array_new(&_tmp_til_Vec_set_2, _tmp_til_Vec_set_4, &_tmp_til_Vec_set_5);
        int __attribute__((unused)) _arr_status__tmp_til_Vec_set_3;
        til_I64 _tmp_til_Vec_set_6 = 0;
        _arr_status__tmp_til_Vec_set_3 = til_Array_set(&_err_idx__tmp_til_Vec_set_3, &_tmp_til_Vec_set_2, &_tmp_til_Vec_set_6, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"Vec.set: index out of bounds", 1, 0, 0, 0}), 28, 0}));
    ...
    til_Ptr til_Ptr_dest;
    til_Ptr_offset(&til_Ptr_dest, &til_Vec_self->ptr, &_tmp_til_Vec_set_7);
    til_Ptr_copy_from_dynamic(&til_Ptr_dest, (til_Dynamic*)til_Dynamic_value, &til_Vec_self->ptr.elem_size);
    return 0;
}
...
int til_Vec_pop(til_IndexOutOfBoundsError* _err1, til_Vec* til_Vec_self, til_Dynamic* til_Dynamic_dest) {
    ...
    if (_tmp_til_Vec_pop_1.data) {
        ...
        til_Array_new(&_tmp_til_Vec_pop_3, _tmp_til_Vec_pop_5, &_tmp_til_Vec_pop_6);
        int __attribute__((unused)) _arr_status__tmp_til_Vec_pop_4;
        til_I64 _tmp_til_Vec_pop_7 = 0;
        _arr_status__tmp_til_Vec_pop_4 = til_Array_set(&_err_idx__tmp_til_Vec_pop_4, &_tmp_til_Vec_pop_3, &_tmp_til_Vec_pop_7, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"Vec.pop: cannot pop from empty Vec", 1, 0, 0, 0}), 34, 0}));
    ...
    til_Ptr til_Ptr_src;
    til_Ptr_offset(&til_Ptr_src, &til_Vec_self->ptr, &_tmp_til_Vec_pop_9);
...
int til_Vec_remove(til_IndexOutOfBoundsError* _err1, til_Vec* til_Vec_self, const til_I64* til_I64_index) {
    ...
    if (_tmp_til_Vec_remove_0.data) {
        ...
        til_Array_new(&_tmp_til_Vec_remove_2, _tmp_til_Vec_remove_4, &_tmp_til_Vec_remove_5);
        int __attribute__((unused)) _arr_status__tmp_til_Vec_remove_3;
        til_I64 _tmp_til_Vec_remove_6 = 0;
        _arr_status__tmp_til_Vec_remove_3 = til_Array_set(&_err_idx__tmp_til_Vec_remove_3, &_tmp_til_Vec_remove_2, &_tmp_til_Vec_remove_6, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"Vec.remove: index out of bounds", 1, 0, 0, 0}), 31, 0}));
    ...
    while (1) {
        ...
        til_Bool _tmp_til_Vec_remove_9;
        til_I64_lt(&_tmp_til_Vec_remove_9, &til_I64_i, &_tmp_til_Vec_remove_8);
        if (!(_tmp_til_Vec_remove_9.data)) break;
        til_I64 _tmp_til_Vec_remove_10 = 1;
        til_I64 _tmp_til_Vec_remove_11 = til_I64_add(&til_I64_i, &_tmp_til_Vec_remove_10);
        til_I64 _tmp_til_Vec_remove_12 = til_I64_mul(&_tmp_til_Vec_remove_11, &til_Vec_self->ptr.elem_size);
        til_Ptr_offset(&til_Ptr_src, &til_Vec_self->ptr, &_tmp_til_Vec_remove_12);
        til_I64 _tmp_til_Vec_remove_13 = til_I64_mul(&til_I64_i, &til_Vec_self->ptr.elem_size);
        til_Ptr_offset(&til_Ptr_dest, &til_Vec_self->ptr, &_tmp_til_Vec_remove_13);
        til_Ptr_copy_from(&til_Ptr_dest, &til_Ptr_src, &til_Vec_self->ptr.elem_size);
        til_I64 _tmp_til_Vec_remove_14 = 1;
        til_I64_i = til_I64_add(&til_I64_i, &_tmp_til_Vec_remove_14);
    }
    til_I64 _tmp_til_Vec_remove_15 = 1;
    til_Vec_self->_len = til_I64_sub(&til_Vec_self->_len, &_tmp_til_Vec_remove_15);
    return 0;
}
...
int til_Vec_insert_at(til_IndexOutOfBoundsError* _err1, til_Vec* til_Vec_self, const til_I64* til_I64_index, til_Dynamic* til_Dynamic_value) {
    ...
    if (_tmp_til_Vec_insert_at_0.data) {
        ...
        til_Array_new(&_tmp_til_Vec_insert_at_2, _tmp_til_Vec_insert_at_4, &_tmp_til_Vec_insert_at_5);
        int __attribute__((unused)) _arr_status__tmp_til_Vec_insert_at_3;
        til_I64 _tmp_til_Vec_insert_at_6 = 0;
        _arr_status__tmp_til_Vec_insert_at_3 = til_Array_set(&_err_idx__tmp_til_Vec_insert_at_3, &_tmp_til_Vec_insert_at_2, &_tmp_til_Vec_insert_at_6, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"Vec.insert_at: index out of bounds", 1, 0, 0, 0}), 34, 0}));
    ...
    til_I64 til_I64_new_cap;
    til_Ptr til_Ptr_new_ptr;
    til_Bool _tmp_til_Vec_insert_at_7;
    til_I64_eq(&_tmp_til_Vec_insert_at_7, &til_Vec_self->_len, &til_Vec_self->cap);
    if (_tmp_til_Vec_insert_at_7.data) {
        til_I64 _tmp_til_Vec_insert_at_8 = 2;
        til_I64_new_cap = til_I64_mul(&til_Vec_self->cap, &_tmp_til_Vec_insert_at_8);
        til_I64 _tmp_til_Vec_insert_at_9 = 1;
        til_Bool _tmp_til_Vec_insert_at_10;
        til_I64_lt(&_tmp_til_Vec_insert_at_10, &til_I64_new_cap, &_tmp_til_Vec_insert_at_9);
        if (_tmp_til_Vec_insert_at_10.data) {
            til_I64_new_cap = 1;
        }
        til_I64 _tmp_til_Vec_insert_at_11 = til_Vec_MAX_CAP;
        til_Bool _tmp_til_Vec_insert_at_12;
        til_I64_gt(&_tmp_til_Vec_insert_at_12, &til_I64_new_cap, &_tmp_til_Vec_insert_at_11);
        if (_tmp_til_Vec_insert_at_12.data) {
            til_Array _tmp_til_Vec_insert_at_13;
            til_IndexOutOfBoundsError __attribute__((unused)) _err_idx__tmp_til_Vec_insert_at_14;
            til_Type _tmp_til_Vec_insert_at_15 = "Str";
            til_I64 _tmp_til_Vec_insert_at_16 = 0;
            til_Array_new(&_tmp_til_Vec_insert_at_13, _tmp_til_Vec_insert_at_15, &_tmp_til_Vec_insert_at_16);
            int __attribute__((unused)) _arr_status__tmp_til_Vec_insert_at_14;
            til_panic(&((til_Str){((til_Ptr){(til_I64)"src/core/vec.til:312:23:", 1, 0, 0, 0}), 24, 0}), &((til_Str){((til_Ptr){(til_I64)"Vec.insert_at: capacity exceeded Vec.MAX_CAP", 1, 0, 0, 0}), 44, 0}), &_tmp_til_Vec_insert_at_13);
            til_Array_delete(&_tmp_til_Vec_insert_at_13);
        }
        til_Vec__alloc_ptr(&til_Ptr_new_ptr, til_Vec_self, &til_I64_new_cap);
        til_I64 _tmp_til_Vec_insert_at_17 = 0;
        til_Bool _tmp_til_Vec_insert_at_18;
        til_I64_gt(&_tmp_til_Vec_insert_at_18, &til_Vec_self->_len, &_tmp_til_Vec_insert_at_17);
        if (_tmp_til_Vec_insert_at_18.data) {
            til_I64 _tmp_til_Vec_insert_at_19 = til_I64_mul(&til_Vec_self->_len, &til_Vec_self->ptr.elem_size);
            til_Ptr_copy_from(&til_Ptr_new_ptr, &til_Vec_self->ptr, &_tmp_til_Vec_insert_at_19);
        }
        til_Bool _tmp_til_Vec_insert_at_20;
        til_Ptr_is_null(&_tmp_til_Vec_insert_at_20, &til_Vec_self->ptr);
        til_Bool _tmp_til_Vec_insert_at_21;
        til_not(&_tmp_til_Vec_insert_at_21, &_tmp_til_Vec_insert_at_20);
    ...
    while (1) {
        ...
        til_I64_gt(&_tmp_til_Vec_insert_at_22, &til_I64_i, til_I64_index);
        if (!(_tmp_til_Vec_insert_at_22.data)) break;
        til_I64 _tmp_til_Vec_insert_at_23 = 1;
        til_I64 _tmp_til_Vec_insert_at_24 = til_I64_sub(&til_I64_i, &_tmp_til_Vec_insert_at_23);
        til_I64 _tmp_til_Vec_insert_at_25 = til_I64_mul(&_tmp_til_Vec_insert_at_24, &til_Vec_self->ptr.elem_size);
        til_Ptr_offset(&til_Ptr_shift_src, &til_Vec_self->ptr, &_tmp_til_Vec_insert_at_25);
        til_I64 _tmp_til_Vec_insert_at_26 = til_I64_mul(&til_I64_i, &til_Vec_self->ptr.elem_size);
        til_Ptr_offset(&til_Ptr_shift_dest, &til_Vec_self->ptr, &_tmp_til_Vec_insert_at_26);
        til_Ptr_copy_from(&til_Ptr_shift_dest, &til_Ptr_shift_src, &til_Vec_self->ptr.elem_size);
        til_I64 _tmp_til_Vec_insert_at_27 = 1;
        til_I64_i = til_I64_sub(&til_I64_i, &_tmp_til_Vec_insert_at_27);
    }
    til_I64 _tmp_til_Vec_insert_at_28 = til_I64_mul(til_I64_index, &til_Vec_self->ptr.elem_size);
    til_Ptr til_Ptr_insert_dest;
    til_Ptr_offset(&til_Ptr_insert_dest, &til_Vec_self->ptr, &_tmp_til_Vec_insert_at_28);
    til_Ptr_copy_from_dynamic(&til_Ptr_insert_dest, (til_Dynamic*)til_Dynamic_value, &til_Vec_self->ptr.elem_size);
    til_I64 _tmp_til_Vec_insert_at_29 = 1;
    til_Vec_self->_len = til_I64_add(&til_Vec_self->_len, &_tmp_til_Vec_insert_at_29);
    return 0;
}
...
void til_Vec_is_empty(til_Bool* _ret, const til_Vec* til_Vec_self) {
    ...
    til_I64_eq(_ret, &til_Vec_self->_len, &_tmp_til_Vec_is_empty_0);
    return;
}
...
int til_Vec_split_off(til_Vec* _ret, til_IndexOutOfBoundsError* _err1, til_Vec* til_Vec_self, const til_I64* til_I64_at) {
    ...
    if (_tmp_til_Vec_split_off_0.data) {
        ...
        til_Array_new(&_tmp_til_Vec_split_off_2, _tmp_til_Vec_split_off_4, &_tmp_til_Vec_split_off_5);
        int __attribute__((unused)) _arr_status__tmp_til_Vec_split_off_3;
        til_I64 _tmp_til_Vec_split_off_6 = 0;
        _arr_status__tmp_til_Vec_split_off_3 = til_Array_set(&_err_idx__tmp_til_Vec_split_off_3, &_tmp_til_Vec_split_off_2, &_tmp_til_Vec_split_off_6, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"Vec.split_off: index out of bounds", 1, 0, 0, 0}), 34, 0}));
    ...
    til_Bool _tmp_til_Vec_split_off_9;
    til_I64_gt(&_tmp_til_Vec_split_off_9, &til_I64_tail_len, &_tmp_til_Vec_split_off_8);
    if (_tmp_til_Vec_split_off_9.data) {
        til_Vec_result.cap = til_I64_tail_len;
        til_Ptr _tmp_til_Vec_split_off_10;
        til_Vec__alloc_ptr(&_tmp_til_Vec_split_off_10, &til_Vec_result, &til_I64_tail_len);
        til_Vec_result.ptr = _tmp_til_Vec_split_off_10;
        til_I64 _tmp_til_Vec_split_off_11 = til_I64_mul(til_I64_at, &til_Vec_self->ptr.elem_size);
        til_Ptr_offset(&til_Ptr_src, &til_Vec_self->ptr, &_tmp_til_Vec_split_off_11);
        til_I64 _tmp_til_Vec_split_off_12 = til_I64_mul(&til_I64_tail_len, &til_Vec_self->ptr.elem_size);
        til_Ptr_copy_from(&til_Vec_result.ptr, &til_Ptr_src, &_tmp_til_Vec_split_off_12);
    }
...
void til_Str_is_empty(til_Bool* _ret, const til_Str* til_Str_self) {
    ...
    til_I64_eq(_ret, &til_Str_self->_len, &_tmp_til_Str_is_empty_0);
    return;
}
...
void til_Str_from_byte(til_Str* _ret, const til_U8* til_U8_byte) {
    ...
    til_Str_s.c_string = _tmp_til_Str_from_byte_2;
    til_Str_s.c_string.is_borrowed = 0;
    til_Str_s._len = 1;
    til_Str_s.cap = 2;
    til_I64 _tmp_til_Str_from_byte_3 = (til_I64)&(*til_U8_byte);
    til_I64 _tmp_til_Str_from_byte_4 = 1;
    til_memcpy(&til_Str_s.c_string.data, &_tmp_til_Str_from_byte_3, &_tmp_til_Str_from_byte_4);
    til_U8 til_U8_zero = 0;
    til_I64 _tmp_til_Str_from_byte_5 = 1;
    til_Ptr _tmp_til_Str_from_byte_6;
    til_Ptr_offset(&_tmp_til_Str_from_byte_6, &til_Str_s.c_string, &_tmp_til_Str_from_byte_5);
...
void til_Str_replace(til_Str* _ret, const til_Str* til_Str_self, const til_Str* til_Str_from, const til_Str* til_Str_to) {
    ...
    if (_tmp_til_Str_replace_2.data) {
        til_Str_clone(_ret, til_Str_self);
        return;
    }
    ...
    while (1) {
        ...
        til_Bool _tmp_til_Str_replace_6;
        til_I64_lteq(&_tmp_til_Str_replace_6, &til_I64_search_start, &_tmp_til_Str_replace_5);
        if (!(_tmp_til_Str_replace_6.data)) break;
        til_Bool_clone(&til_Bool_matches, &true);
        til_I64_i = 0;
        til_I64 _tmp_til_Str_replace_7 = 0;
        til_I64 _tmp_til_Str_replace_8 = til_Str_len(til_Str_from);
        til_Bool _tmp_til_Str_replace_9;
        til_I64_lt(&_tmp_til_Str_replace_9, &_tmp_til_Str_replace_7, &_tmp_til_Str_replace_8);
        if (_tmp_til_Str_replace_9.data) {
            while (1) {
                til_I64 _tmp_til_Str_replace_10 = til_Str_len(til_Str_from);
                til_Bool _tmp_til_Str_replace_11;
                til_I64_lt(&_tmp_til_Str_replace_11, &til_I64_i, &_tmp_til_Str_replace_10);
                if (!(_tmp_til_Str_replace_11.data)) break;
                til_U8_self_byte = 0;
                til_U8_from_byte = 0;
                til_I64 _tmp_til_Str_replace_12 = (til_I64)&til_U8_self_byte;
                til_I64 _tmp_til_Str_replace_13 = til_I64_add(&til_I64_search_start, &til_I64_i);
                til_Ptr _tmp_til_Str_replace_14;
                til_Ptr_offset(&_tmp_til_Str_replace_14, &til_Str_self->c_string, &_tmp_til_Str_replace_13);
                til_I64 _tmp_til_Str_replace_15 = 1;
                til_memcpy(&_tmp_til_Str_replace_12, &_tmp_til_Str_replace_14.data, &_tmp_til_Str_replace_15);
                til_I64 _tmp_til_Str_replace_16 = (til_I64)&til_U8_from_byte;
                til_Ptr _tmp_til_Str_replace_17;
                til_Ptr_offset(&_tmp_til_Str_replace_17, &til_Str_from->c_string, &til_I64_i);
                til_I64 _tmp_til_Str_replace_18 = 1;
                til_memcpy(&_tmp_til_Str_replace_16, &_tmp_til_Str_replace_17.data, &_tmp_til_Str_replace_18);
                til_Bool _tmp_til_Str_replace_19;
                til_U8_eq(&_tmp_til_Str_replace_19, &til_U8_self_byte, &til_U8_from_byte);
                til_Bool _tmp_til_Str_replace_20;
                til_not(&_tmp_til_Str_replace_20, &_tmp_til_Str_replace_19);
                if (_tmp_til_Str_replace_20.data) {
                    til_Bool_clone(&til_Bool_matches, &false);
                }
                til_I64_inc(&til_I64_i);
            }
            ...
            while (1) {
                til_I64 _tmp_til_Str_replace_21 = til_Str_len(til_Str_from);
                til_Bool _tmp_til_Str_replace_22;
                til_I64_gt(&_tmp_til_Str_replace_22, &til_I64_i, &_tmp_til_Str_replace_21);
                if (!(_tmp_til_Str_replace_22.data)) break;
                til_U8_self_byte = 0;
                til_U8_from_byte = 0;
                til_I64 _tmp_til_Str_replace_23 = (til_I64)&til_U8_self_byte;
                til_I64 _tmp_til_Str_replace_24 = til_I64_add(&til_I64_search_start, &til_I64_i);
                til_Ptr _tmp_til_Str_replace_25;
                til_Ptr_offset(&_tmp_til_Str_replace_25, &til_Str_self->c_string, &_tmp_til_Str_replace_24);
                til_I64 _tmp_til_Str_replace_26 = 1;
                til_memcpy(&_tmp_til_Str_replace_23, &_tmp_til_Str_replace_25.data, &_tmp_til_Str_replace_26);
                til_I64 _tmp_til_Str_replace_27 = (til_I64)&til_U8_from_byte;
                til_Ptr _tmp_til_Str_replace_28;
                til_Ptr_offset(&_tmp_til_Str_replace_28, &til_Str_from->c_string, &til_I64_i);
                til_I64 _tmp_til_Str_replace_29 = 1;
                til_memcpy(&_tmp_til_Str_replace_27, &_tmp_til_Str_replace_28.data, &_tmp_til_Str_replace_29);
                ...
                til_not(&_tmp_til_Str_replace_31, &_tmp_til_Str_replace_30);
                if (_tmp_til_Str_replace_31.data) {
                    til_Bool_clone(&til_Bool_matches, &false);
                }
                til_I64_dec(&til_I64_i);
            }
        ...
        if (til_Bool_matches.data) {
            ...
            til_I64 _tmp_til_Str_replace_32 = til_Str_len(til_Str_from);
            til_I64_search_start = til_I64_add(&til_I64_search_start, &_tmp_til_Str_replace_32);
        } else {
            til_I64_inc(&til_I64_search_start);
        }
    }
    til_I64 _tmp_til_Str_replace_33 = 0;
    til_Bool _tmp_til_Str_replace_34;
    til_I64_eq(&_tmp_til_Str_replace_34, &til_I64_count, &_tmp_til_Str_replace_33);
    ...
    til_I64 _tmp_til_Str_replace_37 = til_I64_mul(&til_I64_count, &_tmp_til_Str_replace_36);
    til_I64 _tmp_til_Str_replace_38 = til_I64_sub(&_tmp_til_Str_replace_35, &_tmp_til_Str_replace_37);
    til_I64 _tmp_til_Str_replace_39 = til_Str_len(til_Str_to);
    til_I64 _tmp_til_Str_replace_40 = til_I64_mul(&til_I64_count, &_tmp_til_Str_replace_39);
    til_I64 til_I64_new_len = til_I64_add(&_tmp_til_Str_replace_38, &_tmp_til_Str_replace_40);
    til_Ptr _tmp_til_Str_replace_41 = (til_Ptr){.data = til_I64_NULL, .is_borrowed = 0, .alloc_size = 0, .elem_type = til_I64_NULL, .elem_size = 0};
    til_Str til_Str_result = {.c_string = _tmp_til_Str_replace_41, ._len = 0, .cap = 0};
    til_Str_result._len = til_I64_new_len;
    til_I64 _tmp_til_Str_replace_42 = 1;
    til_Str_result.cap = til_I64_add(&til_I64_new_len, &_tmp_til_Str_replace_42);
    til_Ptr _tmp_til_Str_replace_43;
    til_Ptr_new_by_size(&_tmp_til_Str_replace_43, &til_Str_result.cap);
    til_Str_result.c_string = _tmp_til_Str_replace_43;
    til_Str_result.c_string.is_borrowed = 0;
    ...
    while (1) {
        til_I64 _tmp_til_Str_replace_44 = til_Str_len(til_Str_self);
        til_Bool _tmp_til_Str_replace_45;
        til_I64_lt(&_tmp_til_Str_replace_45, &til_I64_src_idx, &_tmp_til_Str_replace_44);
        if (!(_tmp_til_Str_replace_45.data)) break;
        ...
        til_I64 _tmp_til_Str_replace_48 = til_I64_sub(&_tmp_til_Str_replace_46, &_tmp_til_Str_replace_47);
        til_Bool _tmp_til_Str_replace_49;
        til_I64_lteq(&_tmp_til_Str_replace_49, &til_I64_src_idx, &_tmp_til_Str_replace_48);
        if (_tmp_til_Str_replace_49.data) {
            til_I64_j = 0;
            til_I64 _tmp_til_Str_replace_50 = 0;
            til_I64 _tmp_til_Str_replace_51 = til_Str_len(til_Str_from);
            til_Bool _tmp_til_Str_replace_52;
            til_I64_lt(&_tmp_til_Str_replace_52, &_tmp_til_Str_replace_50, &_tmp_til_Str_replace_51);
            if (_tmp_til_Str_replace_52.data) {
                while (1) {
                    til_I64 _tmp_til_Str_replace_53 = til_Str_len(til_Str_from);
                    til_Bool _tmp_til_Str_replace_54;
                    til_I64_lt(&_tmp_til_Str_replace_54, &til_I64_j, &_tmp_til_Str_replace_53);
                    if (!(_tmp_til_Str_replace_54.data)) break;
                    til_U8_src_byte = 0;
                    til_U8_pattern_byte = 0;
                    til_I64 _tmp_til_Str_replace_55 = (til_I64)&til_U8_src_byte;
                    til_I64 _tmp_til_Str_replace_56 = til_I64_add(&til_I64_src_idx, &til_I64_j);
                    til_Ptr _tmp_til_Str_replace_57;
                    til_Ptr_offset(&_tmp_til_Str_replace_57, &til_Str_self->c_string, &_tmp_til_Str_replace_56);
                    til_I64 _tmp_til_Str_replace_58 = 1;
                    til_memcpy(&_tmp_til_Str_replace_55, &_tmp_til_Str_replace_57.data, &_tmp_til_Str_replace_58);
                    til_I64 _tmp_til_Str_replace_59 = (til_I64)&til_U8_pattern_byte;
                    til_Ptr _tmp_til_Str_replace_60;
                    til_Ptr_offset(&_tmp_til_Str_replace_60, &til_Str_from->c_string, &til_I64_j);
                    til_I64 _tmp_til_Str_replace_61 = 1;
                    til_memcpy(&_tmp_til_Str_replace_59, &_tmp_til_Str_replace_60.data, &_tmp_til_Str_replace_61);
                    til_Bool _tmp_til_Str_replace_62;
                    til_U8_eq(&_tmp_til_Str_replace_62, &til_U8_src_byte, &til_U8_pattern_byte);
                    til_Bool _tmp_til_Str_replace_63;
                    til_not(&_tmp_til_Str_replace_63, &_tmp_til_Str_replace_62);
                    if (_tmp_til_Str_replace_63.data) {
                ...
                while (1) {
                    ...
                    til_I64_gt(&_tmp_til_Str_replace_65, &til_I64_j, &_tmp_til_Str_replace_64);
                    if (!(_tmp_til_Str_replace_65.data)) break;
                    til_U8_src_byte = 0;
                    til_U8_pattern_byte = 0;
                    til_I64 _tmp_til_Str_replace_66 = (til_I64)&til_U8_src_byte;
                    til_I64 _tmp_til_Str_replace_67 = til_I64_add(&til_I64_src_idx, &til_I64_j);
                    til_Ptr _tmp_til_Str_replace_68;
                    til_Ptr_offset(&_tmp_til_Str_replace_68, &til_Str_self->c_string, &_tmp_til_Str_replace_67);
                    til_I64 _tmp_til_Str_replace_69 = 1;
                    til_memcpy(&_tmp_til_Str_replace_66, &_tmp_til_Str_replace_68.data, &_tmp_til_Str_replace_69);
                    til_I64 _tmp_til_Str_replace_70 = (til_I64)&til_U8_pattern_byte;
                    til_Ptr _tmp_til_Str_replace_71;
                    til_Ptr_offset(&_tmp_til_Str_replace_71, &til_Str_from->c_string, &til_I64_j);
                    til_I64 _tmp_til_Str_replace_72 = 1;
                    til_memcpy(&_tmp_til_Str_replace_70, &_tmp_til_Str_replace_71.data, &_tmp_til_Str_replace_72);
                    til_Bool _tmp_til_Str_replace_73;
                    til_U8_eq(&_tmp_til_Str_replace_73, &til_U8_src_byte, &til_U8_pattern_byte);
                    til_Bool _tmp_til_Str_replace_74;
                    til_not(&_tmp_til_Str_replace_74, &_tmp_til_Str_replace_73);
                    if (_tmp_til_Str_replace_74.data) {
                        til_Bool_clone(&til_Bool_found_match, &false);
                    }
        ...
        if (til_Bool_found_match.data) {
            ...
            til_Ptr_offset(&_tmp_til_Str_replace_75, &til_Str_result.c_string, &til_I64_dst_idx);
            til_I64 _tmp_til_Str_replace_76 = til_Str_len(til_Str_to);
            til_memcpy(&_tmp_til_Str_replace_75.data, &til_Str_to->c_string.data, &_tmp_til_Str_replace_76);
            til_I64 _tmp_til_Str_replace_77 = til_Str_len(til_Str_to);
            til_I64_dst_idx = til_I64_add(&til_I64_dst_idx, &_tmp_til_Str_replace_77);
            til_I64 _tmp_til_Str_replace_78 = til_Str_len(til_Str_from);
            til_I64_src_idx = til_I64_add(&til_I64_src_idx, &_tmp_til_Str_replace_78);
        } else {
            til_Ptr _tmp_til_Str_replace_79;
            til_Ptr_offset(&_tmp_til_Str_replace_79, &til_Str_result.c_string, &til_I64_dst_idx);
            til_Ptr _tmp_til_Str_replace_80;
            til_Ptr_offset(&_tmp_til_Str_replace_80, &til_Str_self->c_string, &til_I64_src_idx);
            til_I64 _tmp_til_Str_replace_81 = 1;
            til_memcpy(&_tmp_til_Str_replace_79.data, &_tmp_til_Str_replace_80.data, &_tmp_til_Str_replace_81);
    ...
    til_Ptr_offset(&_tmp_til_Str_replace_82, &til_Str_result.c_string, &til_Str_result._len);
    til_I64 _tmp_til_Str_replace_83 = 1;
    til_memset(&_tmp_til_Str_replace_82.data, &til_U8_zero, &_tmp_til_Str_replace_83);
    *_ret = til_Str_result;
    return;
}
...
void til_Str_lt(til_Bool* _ret, const til_Str* til_Str_self, const til_Str* til_Str_other) {
    ...
    til_I64_lt(_ret, &_tmp_til_Str_lt_0, &_tmp_til_Str_lt_1);
    return;
}
...
void til_Str_gt(til_Bool* _ret, const til_Str* til_Str_self, const til_Str* til_Str_other) {
    ...
    til_I64_gt(_ret, &_tmp_til_Str_gt_0, &_tmp_til_Str_gt_1);
    return;
}
...
void til_Str_lteq(til_Bool* _ret, const til_Str* til_Str_self, const til_Str* til_Str_other) {
    ...
    til_I64_lteq(_ret, &_tmp_til_Str_lteq_0, &_tmp_til_Str_lteq_1);
    return;
}
...
void til_Str_gteq(til_Bool* _ret, const til_Str* til_Str_self, const til_Str* til_Str_other) {
    ...
    til_I64_gteq(_ret, &_tmp_til_Str_gteq_0, &_tmp_til_Str_gteq_1);
    return;
}
...
void til_Str_replacen(til_Str* _ret, const til_Str* til_Str_self, const til_Str* til_Str_from, const til_Str* til_Str_to, const til_I64* til_I64_n) {
    ...
    til_Bool _tmp_til_Str_replacen_5;
    til_I64_eq(&_tmp_til_Str_replacen_5, til_I64_n, &_tmp_til_Str_replacen_4);
    if (_tmp_til_Str_replacen_5.data) {
        til_Str_clone(_ret, til_Str_self);
        return;
    }
    ...
    til_I64_lt(&_tmp_til_Str_replacen_7, &til_I64_idx, &_tmp_til_Str_replacen_6);
    ...
    til_concat(&til_Str_result, &_tmp_til_Str_replacen_14, &til_Str_suffix);
    til_Str til_Str_rest;
    til_I64 _tmp_til_Str_replacen_15 = 1;
    til_Bool _tmp_til_Str_replacen_16;
    til_I64_gt(&_tmp_til_Str_replacen_16, til_I64_n, &_tmp_til_Str_replacen_15);
    if (_tmp_til_Str_replacen_16.data) {
        til_I64 _tmp_til_Str_replacen_17 = 1;
        til_I64 _tmp_til_Str_replacen_18 = til_I64_sub(til_I64_n, &_tmp_til_Str_replacen_17);
        til_Str_replacen(&til_Str_rest, &til_Str_suffix, til_Str_from, til_Str_to, &_tmp_til_Str_replacen_18);
        til_Str _tmp_til_Str_replacen_19;
        til_concat(&_tmp_til_Str_replacen_19, &til_Str_prefix, til_Str_to);
        til_concat(&til_Str_result, &_tmp_til_Str_replacen_19, &til_Str_rest);
    }
...
int til_Str_split(til_Vec* _ret, til_IndexOutOfBoundsError* _err1, const til_Str* til_Str_self, const til_Str* til_Str_delimiter) {
    (void)_ret;
    til_Vec til_Vec_parts;
    til_Vec_new(&til_Vec_parts, "Str");
    ...
    if (_tmp_til_Str_split_2.data) {
        ...
        til_Vec_push(&til_Vec_parts, (til_Dynamic*)&_tmp_til_Str_split_3);
        *_ret = til_Vec_parts;
        return 0;
    }
...
void til_Str_repeat(til_Str* _ret, const til_Str* til_Str_self, const til_I64* til_I64_n) {
    ...
    til_Ptr _tmp_til_Str_repeat_4 = (til_Ptr){.data = til_I64_NULL, .is_borrowed = 0, .alloc_size = 0, .elem_type = til_I64_NULL, .elem_size = 0};
    til_Str til_Str_result = {.c_string = _tmp_til_Str_repeat_4, ._len = 0, .cap = 0};
    til_Str_result._len = til_I64_mul(&til_Str_self->_len, til_I64_n);
    til_I64 _tmp_til_Str_repeat_5 = 1;
    til_Str_result.cap = til_I64_add(&til_Str_result._len, &_tmp_til_Str_repeat_5);
    til_Ptr _tmp_til_Str_repeat_6;
    til_Ptr_new_by_size(&_tmp_til_Str_repeat_6, &til_Str_result.cap);
    til_Str_result.c_string = _tmp_til_Str_repeat_6;
    til_Str_result.c_string.is_borrowed = 0;
    til_I64 til_I64_offset = 0;
    til_I64 til_I64_i = 0;
    til_I64 _tmp_til_Str_repeat_7 = 0;
    til_Bool _tmp_til_Str_repeat_8;
    til_I64_lt(&_tmp_til_Str_repeat_8, &_tmp_til_Str_repeat_7, til_I64_n);
    if (_tmp_til_Str_repeat_8.data) {
        while (1) {
            til_Bool _tmp_til_Str_repeat_9;
            til_I64_lt(&_tmp_til_Str_repeat_9, &til_I64_i, til_I64_n);
            if (!(_tmp_til_Str_repeat_9.data)) break;
            til_Ptr _tmp_til_Str_repeat_10;
            til_Ptr_offset(&_tmp_til_Str_repeat_10, &til_Str_result.c_string, &til_I64_offset);
            til_memcpy(&_tmp_til_Str_repeat_10.data, &til_Str_self->c_string.data, &til_Str_self->_len);
        ...
        while (1) {
            ...
            til_I64_gt(&_tmp_til_Str_repeat_11, &til_I64_i, til_I64_n);
            if (!(_tmp_til_Str_repeat_11.data)) break;
            til_Ptr _tmp_til_Str_repeat_12;
            til_Ptr_offset(&_tmp_til_Str_repeat_12, &til_Str_result.c_string, &til_I64_offset);
            til_memcpy(&_tmp_til_Str_repeat_12.data, &til_Str_self->c_string.data, &til_Str_self->_len);
            til_I64_offset = til_I64_add(&til_I64_offset, &til_Str_self->_len);
            til_I64_dec(&til_I64_i);
        }
    }
    til_Ptr _tmp_til_Str_repeat_13;
    til_Ptr_offset(&_tmp_til_Str_repeat_13, &til_Str_result.c_string, &til_Str_result._len);
    til_I64 _tmp_til_Str_repeat_14 = 1;
    til_memset(&_tmp_til_Str_repeat_13.data, &til_U8_ZERO_U8, &_tmp_til_Str_repeat_14);
    *_ret = til_Str_result;
    return;
}
...
int til_U8_safe_add(til_U8* _ret, til_U8_Overflow* _err1, const til_U8* til_U8_a, const til_U8* til_U8_b) {
    ...
    if (_tmp_til_U8_safe_add_2.data) {
        ...
        til_Type _tmp_til_U8_safe_add_9 = "Str";
        til_I64 _tmp_til_U8_safe_add_10 = 6;
        til_Array_new(&_tmp_til_U8_safe_add_7, _tmp_til_U8_safe_add_9, &_tmp_til_U8_safe_add_10);
        int __attribute__((unused)) _arr_status__tmp_til_U8_safe_add_8;
        til_I64 _tmp_til_U8_safe_add_11 = 0;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_11, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"U8 overflow: ", 1, 0, 0, 0}), 13, 0}));
        til_I64 _tmp_til_U8_safe_add_12 = 1;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_12, (til_Dynamic*)&_tmp_til_U8_safe_add_3);
        til_I64 _tmp_til_U8_safe_add_13 = 2;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_13, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" + ", 1, 0, 0, 0}), 3, 0}));
        til_I64 _tmp_til_U8_safe_add_14 = 3;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_14, (til_Dynamic*)&_tmp_til_U8_safe_add_4);
        til_I64 _tmp_til_U8_safe_add_15 = 4;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_15, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" = ", 1, 0, 0, 0}), 3, 0}));
        til_I64 _tmp_til_U8_safe_add_16 = 5;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_16, (til_Dynamic*)&_tmp_til_U8_safe_add_5);
...
int til_U8_safe_sub(til_U8* _ret, til_U8_Overflow* _err1, const til_U8* til_U8_a, const til_U8* til_U8_b) {
    ...
    if (_tmp_til_U8_safe_sub_3.data) {
        ...
        til_Type _tmp_til_U8_safe_sub_10 = "Str";
        til_I64 _tmp_til_U8_safe_sub_11 = 6;
        til_Array_new(&_tmp_til_U8_safe_sub_8, _tmp_til_U8_safe_sub_10, &_tmp_til_U8_safe_sub_11);
        int __attribute__((unused)) _arr_status__tmp_til_U8_safe_sub_9;
        til_I64 _tmp_til_U8_safe_sub_12 = 0;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_12, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"U8 underflow: ", 1, 0, 0, 0}), 14, 0}));
        til_I64 _tmp_til_U8_safe_sub_13 = 1;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_13, (til_Dynamic*)&_tmp_til_U8_safe_sub_4);
        til_I64 _tmp_til_U8_safe_sub_14 = 2;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_14, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" - ", 1, 0, 0, 0}), 3, 0}));
        til_I64 _tmp_til_U8_safe_sub_15 = 3;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_15, (til_Dynamic*)&_tmp_til_U8_safe_sub_5);
        til_I64 _tmp_til_U8_safe_sub_16 = 4;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_16, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" = ", 1, 0, 0, 0}), 3, 0}));
        til_I64 _tmp_til_U8_safe_sub_17 = 5;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_17, (til_Dynamic*)&_tmp_til_U8_safe_sub_6);
...
int til_U8_safe_mul(til_U8* _ret, til_U8_Overflow* _err1, const til_U8* til_U8_a, const til_U8* til_U8_b) {
    ...
    if (_tmp_til_U8_safe_mul_2.data) {
        ...
        til_Type _tmp_til_U8_safe_mul_9 = "Str";
        til_I64 _tmp_til_U8_safe_mul_10 = 6;
        til_Array_new(&_tmp_til_U8_safe_mul_7, _tmp_til_U8_safe_mul_9, &_tmp_til_U8_safe_mul_10);
        int __attribute__((unused)) _arr_status__tmp_til_U8_safe_mul_8;
        til_I64 _tmp_til_U8_safe_mul_11 = 0;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_11, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"U8 overflow: ", 1, 0, 0, 0}), 13, 0}));
        til_I64 _tmp_til_U8_safe_mul_12 = 1;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_12, (til_Dynamic*)&_tmp_til_U8_safe_mul_3);
        til_I64 _tmp_til_U8_safe_mul_13 = 2;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_13, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" * ", 1, 0, 0, 0}), 3, 0}));
        til_I64 _tmp_til_U8_safe_mul_14 = 3;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_14, (til_Dynamic*)&_tmp_til_U8_safe_mul_4);
        til_I64 _tmp_til_U8_safe_mul_15 = 4;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_15, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" = ", 1, 0, 0, 0}), 3, 0}));
        til_I64 _tmp_til_U8_safe_mul_16 = 5;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_16, (til_Dynamic*)&_tmp_til_U8_safe_mul_5);
...
void til_U8_to_str(til_Str* _ret, const til_U8* til_U8_self) {
    ...
    til_I64_to_str(_ret, &_tmp_til_U8_to_str_0);
    return;
}
...
void til_HeapState_remove(const til_I64* til_I64_ptr) {
    ...
    til_I64 _tmp_til_HeapState_remove_25 = 2;
    til_Array_new(&_tmp_til_HeapState_remove_22, _tmp_til_HeapState_remove_24, &_tmp_til_HeapState_remove_25);
    int __attribute__((unused)) _arr_status__tmp_til_HeapState_remove_23;
    til_I64 _tmp_til_HeapState_remove_26 = 0;
    _arr_status__tmp_til_HeapState_remove_23 = til_Array_set(&_err_idx__tmp_til_HeapState_remove_23, &_tmp_til_HeapState_remove_22, &_tmp_til_HeapState_remove_26, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"HEAP_STATE PANIC: double-free for pointer", 1, 0, 0, 0}), 41, 0}));
    til_I64 _tmp_til_HeapState_remove_27 = 1;
    _arr_status__tmp_til_HeapState_remove_23 = til_Array_set(&_err_idx__tmp_til_HeapState_remove_23, &_tmp_til_HeapState_remove_22, &_tmp_til_HeapState_remove_27, (til_Dynamic*)&_tmp_til_HeapState_remove_21);
    ...
    til_exit(&_tmp_til_HeapState_remove_28);
    if (0) { _catch_IndexOutOfBoundsError__tmp_til_HeapState_remove_0:;
        ...
        til_Array _tmp_til_HeapState_remove_29;
        til_IndexOutOfBoundsError __attribute__((unused)) _err_idx__tmp_til_HeapState_remove_30;
        til_Type _tmp_til_HeapState_remove_31 = "Str";
        til_I64 _tmp_til_HeapState_remove_32 = 1;
        til_Array_new(&_tmp_til_HeapState_remove_29, _tmp_til_HeapState_remove_31, &_tmp_til_HeapState_remove_32);
        int __attribute__((unused)) _arr_status__tmp_til_HeapState_remove_30;
        til_I64 _tmp_til_HeapState_remove_33 = 0;
        _arr_status__tmp_til_HeapState_remove_30 = til_Array_set(&_err_idx__tmp_til_HeapState_remove_30, &_tmp_til_HeapState_remove_29, &_tmp_til_HeapState_remove_33, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)"HEAP_STATE: unexpected index error in remove", 1, 0, 0, 0}), 44, 0}));
        til_println(&_tmp_til_HeapState_remove_29);
        til_Array_delete(&_tmp_til_HeapState_remove_29);
        til_I64 _tmp_til_HeapState_remove_34 = 1;
        til_exit(&_tmp_til_HeapState_remove_34);
    }
}
...
void til_HeapState_report(void) {
    ...
    til_Type _tmp_til_HeapState_report_19 = "Str";
    til_I64 _tmp_til_HeapState_report_20 = 4;
    til_Array_new(&_tmp_til_HeapState_report_17, _tmp_til_HeapState_report_19, &_tmp_til_HeapState_report_20);
    int __attribute__((unused)) _arr_status__tmp_til_HeapState_report_18;
    til_I64 _tmp_til_HeapState_report_21 = 0;
    _arr_status__tmp_til_HeapState_report_18 = til_Array_set(&_err_idx__tmp_til_HeapState_report_18, &_tmp_til_HeapState_report_17, &_tmp_til_HeapState_report_21, (til_Dynamic*)&_tmp_til_HeapState_report_14);
    til_I64 _tmp_til_HeapState_report_22 = 1;
    _arr_status__tmp_til_HeapState_report_18 = til_Array_set(&_err_idx__tmp_til_HeapState_report_18, &_tmp_til_HeapState_report_17, &_tmp_til_HeapState_report_22, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" allocations, ", 1, 0, 0, 0}), 14, 0}));
    til_I64 _tmp_til_HeapState_report_23 = 2;
    _arr_status__tmp_til_HeapState_report_18 = til_Array_set(&_err_idx__tmp_til_HeapState_report_18, &_tmp_til_HeapState_report_17, &_tmp_til_HeapState_report_23, (til_Dynamic*)&_tmp_til_HeapState_report_15);
    til_I64 _tmp_til_HeapState_report_24 = 3;
    _arr_status__tmp_til_HeapState_report_18 = til_Array_set(&_err_idx__tmp_til_HeapState_report_18, &_tmp_til_HeapState_report_17, &_tmp_til_HeapState_report_24, (til_Dynamic*)&((til_Str){((til_Ptr){(til_I64)" bytes", 1, 0, 0, 0}), 6, 0}));
    ...
    til_Array _tmp_til_HeapState_report_25;
    til_IndexOutOfBoundsError __attribute__((unused)) _err_idx__tmp_til_HeapState_report_26;
    til_Type _tmp_til_HeapState_report_27 = "Str";
    til_I64 _tmp_til_HeapState_report_28 = 1;
    til_Array_new(&_tmp_til_HeapState_report_25, _tmp_til_HeapState_report_27, &_tmp_til_HeapState_report_28);
    int __attribute__((unused)) _arr_status__tmp_til_HeapState_report_26;
    til_I64 _tmp_til_HeapState_report_29 = 0;
    _arr_status__tmp_til_HeapState_report_26 = til_Array_set(&_err_idx__tmp_til_HeapState_report_26, &_tmp_til_HeapState_report_25, &_tmp_til_HeapState_report_29, (til_Dynamic*)&_tmp_til_HeapState_report_16);
    til_println(&_tmp_til_HeapState_report_25);
    til_Array_delete(&_tmp_til_HeapState_report_25);
}
