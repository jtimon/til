...
void test_simple_add(void) {
    ...
    ;
    ;
    Str *_t_Str_2993 = Str_lit("src/test/constfold.til:15:15", 28ULL);
    (void)_t_Str_2993;
    I64 _t_I64_2994 = 3;
    (void)_t_I64_2994;
...
void test_nested_arithmetic(void) {
    ...
    ;
    ;
    Str *_t_Str_3001 = Str_lit("src/test/constfold.til:21:15", 28ULL);
    (void)_t_Str_3001;
    I64 _t_I64_3002 = 15;
    (void)_t_I64_3002;
    assert_eq(_t_Str_3001, &result, &_t_I64_3002);
    ;
...
void test_deeply_nested(void) {
    ...
    ;
    ;
    Str *_t_Str_3009 = Str_lit("src/test/constfold.til:27:15", 28ULL);
    (void)_t_Str_3009;
    I64 _t_I64_3010 = 26;
    (void)_t_I64_3010;
    assert_eq(_t_Str_3009, &result, &_t_I64_3010);
    ;
...
Str * poem(I64 * depth, Str * current, Str * s1, Str * s2) {
    ...
    I64 _t_I64_3018 = 4;
    (void)_t_I64_3018;
    Bool _t_Bool_3019 = I64_eq(DEREF(depth), _t_I64_3018);
    (void)_t_Bool_3019;
    ;
    if (_t_Bool_3019) {
        Str *_t_Str_3011 = Str_lit("\n", 2ULL);
        (void)_t_Str_3011;
        Str *_t_Str_3012 = Str_concat(current, _t_Str_3011);
        (void)_t_Str_3012;
    ...
    (void)_t_I64_3021;
    ;
    Str *_t_Str_3022 = Str_concat(current, s1);
    (void)_t_Str_3022;
    ...
    I64 _t_I64_3024 = 1;
    (void)_t_I64_3024;
    I64 _t_I64_3025 = I64_add(DEREF(depth), _t_I64_3024);
    (void)_t_I64_3025;
    ;
    Str *_t_Str_3026 = Str_concat(current, s2);
    (void)_t_Str_3026;
    Str *_t_Str_3027 = poem(&_t_I64_3025, _t_Str_3026, s1, s2);
    (void)_t_Str_3027;
    ;
    Str_delete(_t_Str_3026, &(Bool){1});
    { Str *_old = result; result = Str_concat(result, _t_Str_3027); Str_delete(_old, &(Bool){1}); }
    Str_delete(_t_Str_3027, &(Bool){1});
    I64 _t_I64_3028 = 2;
    (void)_t_I64_3028;
    Bool _t_Bool_3029 = I64_eq(DEREF(depth), _t_I64_3028);
    (void)_t_Bool_3029;
    ;
    if (_t_Bool_3029) {
        I64 _t_I64_3013 = 1;
        (void)_t_I64_3013;
        Str *_t_Str_3014 = Str_lit("lei", 3ULL);
        (void)_t_Str_3014;
        I64 _t_I64_3015 = I64_add(DEREF(depth), _t_I64_3013);
        (void)_t_I64_3015;
        ;
        Str *_t_Str_3016 = Str_concat(current, _t_Str_3014);
        (void)_t_Str_3016;
        Str_delete(_t_Str_3014, &(Bool){1});
        Str *_t_Str_3017 = poem(&_t_I64_3015, _t_Str_3016, s1, s2);
        (void)_t_Str_3017;
        ;
        Str_delete(_t_Str_3016, &(Bool){1});
        { Str *_old = result; result = Str_concat(result, _t_Str_3017); Str_delete(_old, &(Bool){1}); }
...
Str * make_poem(Str * s1, Str * s2) {
    ...
    I64 _t_I64_3030 = 0;
    (void)_t_I64_3030;
    Str *_t_Str_3031 = Str_lit("", 0ULL);
    (void)_t_Str_3031;
    Str *_t_Str_3032 = poem(&_t_I64_3030, _t_Str_3031, s1, s2);
    (void)_t_Str_3032;
    ;
...
void test_lolalalo(void) {
    Str *_t_Str_3033 = Str_lit("lo", 2ULL);
    (void)_t_Str_3033;
    Str *_t_Str_3034 = Str_lit("la", 2ULL);
    (void)_t_Str_3034;
    Str *lo_la = make_poem(_t_Str_3033, _t_Str_3034);
    (void)lo_la;
    Str_delete(_t_Str_3033, &(Bool){1});
    Str_delete(_t_Str_3034, &(Bool){1});
    Str *_t_Str_3035 = Str_lit("la", 2ULL);
    (void)_t_Str_3035;
    Str *_t_Str_3036 = Str_lit("lo", 2ULL);
    (void)_t_Str_3036;
    Str *la_lo = make_poem(_t_Str_3035, _t_Str_3036);
    (void)la_lo;
    Str_delete(_t_Str_3035, &(Bool){1});
    Str_delete(_t_Str_3036, &(Bool){1});
    Str *_t_Str_3037 = Str_lit("lolalolo", 8ULL);
    (void)_t_Str_3037;
    Str *_t_Str_3038 = Str_lit("src/test/constfold.til:56:12", 28ULL);
    (void)_t_Str_3038;
    Bool _t_Bool_3039 = Str_contains(lo_la, _t_Str_3037);
    (void)_t_Bool_3039;
    ...
    Str *_t_Str_3041 = Str_lit("lalalala", 8ULL);
    (void)_t_Str_3041;
    Str *_t_Str_3042 = Str_lit("src/test/constfold.til:57:12", 28ULL);
    (void)_t_Str_3042;
    Bool _t_Bool_3043 = Str_contains(la_lo, _t_Str_3041);
    (void)_t_Bool_3043;
    ...
    Str *_t_Str_3045 = Str_lit("lolei", 5ULL);
    (void)_t_Str_3045;
    Str *_t_Str_3046 = Str_lit("src/test/constfold.til:59:12", 28ULL);
    (void)_t_Str_3046;
    Bool _t_Bool_3047 = Str_contains(lo_la, _t_Str_3045);
    (void)_t_Bool_3047;
    ...
    Str *_t_Str_3049 = Str_lit("lalei", 5ULL);
    (void)_t_Str_3049;
    Str *_t_Str_3050 = Str_lit("src/test/constfold.til:60:12", 28ULL);
    (void)_t_Str_3050;
    Bool _t_Bool_3051 = Str_contains(la_lo, _t_Str_3049);
    (void)_t_Bool_3051;
    Str_delete(_t_Str_3049, &(Bool){1});
    Str_delete(la_lo, &(Bool){1});
    Bool _t_Bool_3052; { Bool *_hp = (Bool *)assert(_t_Str_3050, &_t_Bool_3051); _t_Bool_3052 = *_hp; free(_hp); }
    (void)_t_Bool_3052;
    ;
    ;
