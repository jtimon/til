...
int til_get_substr(til_Str* _ret, til_IndexOutOfBoundsError* _err1, til_AllocError* _err2, const til_Str til_s, const til_I64 til_start, const til_I64 til_end) {
    ...
    if (til_lt(til_end, 0).data) {
        ...
        int _status__tmp77 = til_format(&_tmp76, &_err0__tmp77, &_err1__tmp77, &_err2__tmp77, ((til_Str){(til_I64)"src/test/constfold.til:360:48:", 30}), &_tmp78);
        if (_status__tmp77 != 0) {
    ...
    if (til_gt(til_start, til_end).data) {
        ...
        int _status__tmp85 = til_format(&_tmp84, &_err0__tmp85, &_err1__tmp85, &_err2__tmp85, ((til_Str){(til_I64)"src/test/constfold.til:363:48:", 30}), &_tmp86);
        if (_status__tmp85 != 0) {
    ...
    if (til_gt(til_end, til_Str_len(til_s)).data) {
        ...
        int _status__tmp94 = til_format(&_tmp93, &_err0__tmp94, &_err1__tmp94, &_err2__tmp94, ((til_Str){(til_I64)"src/test/constfold.til:366:48:", 30}), &_tmp95);
        if (_status__tmp94 != 0) {
    ...
    if (til_I64_eq(til_start, til_end).data) {
        ...
        int _status__tmp103 = til_format(&_tmp102, &_err0__tmp103, &_err1__tmp103, &_err2__tmp103, ((til_Str){(til_I64)"src/test/constfold.til:369:48:", 30}), &_tmp104);
    ...
    if (til_I64_eq(til_NULL, til_substr.c_string).data) {
        ...
        int _status__tmp112 = til_format(&_tmp111, &_err0__tmp112, &_err1__tmp112, &_err2__tmp112, ((til_Str){(til_I64)"src/test/constfold.til:376:37:", 30}), &_tmp113);
...
til_Str til_concat(const til_Str til_a, const til_Str til_b) {
    ...
    if (til_lt(til_result.cap, til_a.cap).data) {
        ...
        til_panic(((til_Str){(til_I64)"src/test/constfold.til:416:15:", 30}), &_tmp126);
    ...
    if (_status__tmp129 == 0) {
        ...
        til_panic(((til_Str){(til_I64)"src/test/constfold.til:428:15:", 30}), &_tmp131);
    ...
    if (til_I64_eq(til_NULL, til_result.c_string).data) {
        ...
        til_panic(((til_Str){(til_I64)"src/test/constfold.til:421:15:", 30}), &_tmp135);
...
_catch_AllocError__tmp124: {
    ...
    til_panic(((til_Str){(til_I64)"src/test/constfold.til:428:15:", 30}), &_tmp139);
...
int til_format(til_Str* _ret, til_I64_OverflowError* _err1, til_IndexOutOfBoundsError* _err2, til_AllocError* _err3, const til_Str til_prefix, til_Array* til_args) {
    ...
    while (til_lt(til_i, til_Array_len((*til_args))).data) {
        ...
        if (til_lt(til_result.cap, til_arg.cap).data) {
            ...
            int _status__tmp148 = til_format(&_tmp147, &_err0__tmp148, &_err1__tmp148, &_err2__tmp148, ((til_Str){(til_I64)"src/test/constfold.til:444:48:", 30}), &_tmp149);
    ...
    if (til_I64_eq(til_NULL, til_result.c_string).data) {
        ...
        int _status__tmp156 = til_format(&_tmp155, &_err0__tmp156, &_err1__tmp156, &_err2__tmp156, ((til_Str){(til_I64)"src/test/constfold.til:450:37:", 30}), &_tmp157);
...
void til_assert_eq_str(const til_Str til_loc_str, const til_Str til_a, const til_Str til_b) {
    if (til_not(til_Str_eq(til_a, til_b)).data) {
        ...
        til_Str _tmp170 = ((til_Str){(til_I64)"assert_eq_str failed: expected '", 32});
        til_Str _tmp171 = til_a;
        til_Str _tmp172 = ((til_Str){(til_I64)"', found '", 10});
        til_Str _tmp173 = til_b;
        til_Str _tmp174 = ((til_Str){(til_I64)"'", 1});
...
void til_assert_eq(const til_Str til_loc_str, const til_I64 til_a, const til_I64 til_b) {
    if (til_not(til_I64_eq(til_a, til_b)).data) {
        ...
        til_Str _tmp180 = ((til_Str){(til_I64)"assert_eq failed: expected '", 28});
        til_Str _tmp181 = til_I64_to_str(til_a);
        til_Str _tmp182 = ((til_Str){(til_I64)"', found '", 10});
        til_Str _tmp183 = til_I64_to_str(til_b);
        til_Str _tmp184 = ((til_Str){(til_I64)"'", 1});
...
int til_Array_get(til_IndexOutOfBoundsError* _err1, const til_Array til_self, const til_I64 til_index, til_Dynamic* til_T) {
    if (til_gteq(til_index, til_self._len).data) {
        ...
        int _status__tmp202 = til_format(&_tmp201, &_err0__tmp202, &_err1__tmp202, &_err2__tmp202, ((til_Str){(til_I64)"src/test/constfold.til:41:52:", 29}), &_tmp203);
...
int til_Array_set(til_IndexOutOfBoundsError* _err1, til_Array* til_self, const til_I64 til_index, const til_Dynamic til_value) {
    if (til_gteq(til_index, til_self->_len).data) {
        ...
        int _status__tmp209 = til_format(&_tmp208, &_err0__tmp209, &_err1__tmp209, &_err2__tmp209, ((til_Str){(til_I64)"src/test/constfold.til:56:52:", 29}), &_tmp210);
...
int til_Array_clone(til_Array* _ret, til_AllocError* _err1, const til_Array til_self) {
    ...
    if (til_I64_eq(til_NULL, til_cloned.ptr).data) {
        ...
        til_Str _tmp221 = ((til_Str){(til_I64)"Array.clone: malloc failed for ", 31});
        til_Str _tmp222 = til_I64_to_str(til_total_bytes);
        til_Str _tmp223 = ((til_Str){(til_I64)" bytes", 6});
        ...
        int _status__tmp218 = til_format(&_tmp217, &_err0__tmp218, &_err1__tmp218, &_err2__tmp218, ((til_Str){(til_I64)"src/test/constfold.til:83:41:", 29}), &_tmp219);
...
int til_Vec_push(til_AllocError* _err1, til_Vec* til_self, const til_Dynamic til_value) {
    if (til_I64_eq(til_self->_len, til_self->cap).data) {
        ...
        if (til_gt(til_new_cap, til_Vec_MAX_CAP).data) {
            ...
            til_Str _tmp275 = ((til_Str){(til_I64)"Vec.push: capacity exceeded Vec.MAX_CAP", 39});
            ...
            til_panic(((til_Str){(til_I64)"src/test/constfold.til:63:23:", 29}), &_tmp273);
...
int til_Vec_get(til_IndexOutOfBoundsError* _err1, const til_Vec til_self, const til_I64 til_index, til_Dynamic* til_T) {
    if (til_gteq(til_index, til_self._len).data) {
        ...
        til_Str _tmp283 = ((til_Str){(til_I64)"Vec.get: index out of bounds", 28});
        ...
        int _status__tmp280 = til_format(&_tmp279, &_err0__tmp280, &_err1__tmp280, &_err2__tmp280, ((til_Str){(til_I64)"src/test/constfold.til:81:52:", 29}), &_tmp281);
...
int til_Vec_set(til_IndexOutOfBoundsError* _err1, til_Vec* til_self, const til_I64 til_index, const til_Dynamic til_value) {
    if (til_gteq(til_index, til_self->_len).data) {
        ...
        til_Str _tmp290 = ((til_Str){(til_I64)"Vec.set: index out of bounds", 28});
        ...
        int _status__tmp287 = til_format(&_tmp286, &_err0__tmp287, &_err1__tmp287, &_err2__tmp287, ((til_Str){(til_I64)"src/test/constfold.til:96:52:", 29}), &_tmp288);
...
int til_Vec_pop(til_IndexOutOfBoundsError* _err1, til_Vec* til_self, til_Dynamic* til_dest) {
    if (til_I64_eq(til_self->_len, 0).data) {
        ...
        til_Str _tmp297 = ((til_Str){(til_I64)"Vec.pop: cannot pop from empty Vec", 34});
        ...
        int _status__tmp294 = til_format(&_tmp293, &_err0__tmp294, &_err1__tmp294, &_err2__tmp294, ((til_Str){(til_I64)"src/test/constfold.til:110:52:", 30}), &_tmp295);
...
int til_Vec_clone(til_Vec* _ret, til_AllocError* _err1, const til_Vec til_self) {
    ...
    if (til_I64_eq(til_NULL, til_cloned.ptr).data) {
        ...
        til_Str _tmp307 = ((til_Str){(til_I64)"Vec.clone: malloc failed for ", 29});
        til_Str _tmp308 = til_I64_to_str(til_total_bytes);
        til_Str _tmp309 = ((til_Str){(til_I64)" bytes", 6});
        ...
        int _status__tmp304 = til_format(&_tmp303, &_err0__tmp304, &_err1__tmp304, &_err2__tmp304, ((til_Str){(til_I64)"src/test/constfold.til:139:41:", 30}), &_tmp305);
    ...
    while (til_lt(til_i, til_other._len).data) {
        ...
        if (til_I64_eq(til_self->_len, til_self->cap).data) {
            ...
            if (til_gt(til_new_cap, til_Vec_MAX_CAP).data) {
                ...
                til_Str _tmp316 = ((til_Str){(til_I64)"Vec.extend: capacity exceeded Vec.MAX_CAP", 41});
                ...
                til_panic(((til_Str){(til_I64)"src/test/constfold.til:158:27:", 30}), &_tmp314);
...
int til_Vec_remove(til_IndexOutOfBoundsError* _err1, til_Vec* til_self, const til_I64 til_index) {
    if (til_gteq(til_index, til_self->_len).data) {
        ...
        til_Str _tmp330 = ((til_Str){(til_I64)"Vec.remove: index out of bounds", 31});
        ...
        int _status__tmp327 = til_format(&_tmp326, &_err0__tmp327, &_err1__tmp327, &_err2__tmp327, ((til_Str){(til_I64)"src/test/constfold.til:202:52:", 30}), &_tmp328);
...
int til_Str_clone(til_Str* _ret, til_AllocError* _err1, const til_Str til_self) {
    ...
    if (til_I64_eq(til_NULL, til_cloned.c_string).data) {
        ...
        til_Str _tmp346 = ((til_Str){(til_I64)"Str.clone: malloc failed for ", 29});
        til_Str _tmp347 = til_I64_to_str(til_cloned.cap);
        til_Str _tmp348 = ((til_Str){(til_I64)" bytes", 6});
        ...
        int _status__tmp343 = til_format(&_tmp342, &_err0__tmp343, &_err1__tmp343, &_err2__tmp343, ((til_Str){(til_I64)"src/test/constfold.til:46:41:", 29}), &_tmp344);
...
int til_Str_replace(til_Str* _ret, til_AllocError* _err1, const til_Str til_self, const til_Str til_from, const til_Str til_to) {
    ...
    if (til_I64_eq(til_NULL, til_result.c_string).data) {
        ...
        til_Str _tmp400 = ((til_Str){(til_I64)"Str.replace: malloc failed for ", 31});
        til_Str _tmp401 = til_I64_to_str(til_new_len);
        til_Str _tmp402 = ((til_Str){(til_I64)" bytes", 6});
        ...
        int _status__tmp397 = til_format(&_tmp396, &_err0__tmp397, &_err1__tmp397, &_err2__tmp397, ((til_Str){(til_I64)"src/test/constfold.til:213:41:", 30}), &_tmp398);
...
int til_Str_split(til_Vec* _ret, til_AllocError* _err1, til_IndexOutOfBoundsError* _err2, const til_Str til_self, const til_Str til_delimiter) {
    ...
    while (til_lteq(til_pos, til_sub(til_Str_len(til_self), til_Str_len(til_delimiter))).data) {
        ...
        if (til_matches.data) {
            if (til_gt(til_pos, til_start).data) {
                ...
                til_Str _tmp443 = ((til_Str){(til_I64)"", 0});
    ...
    if (til_lt(til_start, til_Str_len(til_self)).data) {
        ...
        if (til_I64_eq(til_start, til_Str_len(til_self)).data) {
            til_Str _tmp451 = ((til_Str){(til_I64)"", 0});
...
int til_U8_from_i64(til_U8* _ret, til_U8_OverflowError* _err1, const til_I64 til_self) {
    if (til_lt(til_self, 0).data) {
        ...
        til_Str _tmp466 = ((til_Str){(til_I64)"Negative values cannot be cast into 'U8'", 40});
        ...
        int _status__tmp463 = til_format(&_tmp462, &_err0__tmp463, &_err1__tmp463, &_err2__tmp463, ((til_Str){(til_I64)"src/test/constfold.til:56:47:", 29}), &_tmp464);
    ...
    if (til_gt(til_self, til_MAX_U8).data) {
        ...
        til_Str _tmp472 = ((til_Str){(til_I64)"U8: cannot be casted from an I64 greater than: ", 47});
        ...
        int _status__tmp469 = til_format(&_tmp468, &_err0__tmp469, &_err1__tmp469, &_err2__tmp469, ((til_Str){(til_I64)"src/test/constfold.til:59:47:", 29}), &_tmp470);
