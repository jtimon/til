...
void Vec_append(Vec * self, Vec * other) {
    ...
    if (_t_Bool_186) {
        ...
        ;
        Str *_t_Str_175 = Str_lit("./src/core/vec.til:55:19", 24ULL);
        (void)_t_Str_175;
...
void Vec_move_from(Vec * self, Vec * other) {
    ...
    if (_t_Bool_222) {
        ...
        ;
        Str *_t_Str_200 = Str_lit("./src/core/vec.til:82:19", 24ULL);
        (void)_t_Str_200;
...
void * Vec_get(Vec * self, U32 * i) {
    ...
    if (_t_Bool_248) {
        ...
        ;
        Str *_t_Str_247 = Str_lit("./src/core/vec.til:109:19", 25ULL);
        (void)_t_Str_247;
...
void * Vec_pop(Vec * self) {
    ...
    if (_t_Bool_258) {
        ...
        ;
        Str *_t_Str_256 = Str_lit("./src/core/vec.til:118:19", 25ULL);
        (void)_t_Str_256;
...
Vec * Vec_take_prefix(Vec * self, U32 * n) {
    ...
    if (_t_Bool_282) {
        ...
        ;
        Str *_t_Str_276 = Str_lit("./src/core/vec.til:131:19", 25ULL);
        (void)_t_Str_276;
...
void Vec_set(Vec * self, U32 * i, void * val) {
    ...
    if (_t_Bool_306) {
        ...
        ;
        Str *_t_Str_305 = Str_lit("./src/core/vec.til:155:19", 25ULL);
        (void)_t_Str_305;
...
void Vec_push_take(Vec * self, Vec * src, U32 i) {
    ...
    if (_t_Bool_333) {
        ...
        ;
        Str *_t_Str_322 = Str_lit("./src/core/vec.til:166:19", 25ULL);
        (void)_t_Str_322;
    ...
    if (_t_Bool_338) {
        ...
        ;
        Str *_t_Str_328 = Str_lit("./src/core/vec.til:169:19", 25ULL);
        (void)_t_Str_328;
...
U8 * Str_get(Str * self, U32 * i) {
    ...
    if (_t_Bool_408) {
        ...
        ;
        Str *_t_Str_407 = Str_lit("./src/core/str.til:39:19", 24ULL);
        (void)_t_Str_407;
...
void Str_push_str(Str * self, Str * s) {
    ...
    if (_t_Bool_440) {
        ...
        ;
        Str *_t_Str_433 = Str_lit("./src/core/str.til:82:19", 24ULL);
        (void)_t_Str_433;
    ...
    if (_t_Bool_441) {
        ...
        ;
        Str *_t_Str_439 = Str_lit("./src/core/str.til:86:19", 24ULL);
        (void)_t_Str_439;
...
I64 Str_to_i64(Str * self) {
    ...
    if (_t_Bool_714) {
        ...
        ;
        Str *_t_Str_658 = Str_lit("./src/core/str.til:266:37", 25ULL);
        (void)_t_Str_658;
    ...
    if (_t_Bool_718) {
        ...
        ;
        Str *_t_Str_666 = Str_lit("./src/core/str.til:275:41", 25ULL);
        (void)_t_Str_666;
        ...
        if (_t_Bool_710) {
            while (1) {
                ...
                if (_t_Bool_685) {
                    ...
                    ;
                    Str *_t_Str_678 = Str_lit("./src/core/str.til:280:23", 25ULL);
                    (void)_t_Str_678;
            ...
            while (1) {
                ...
                if (_t_Bool_706) {
                    ...
                    ;
                    Str *_t_Str_699 = Str_lit("./src/core/str.til:280:23", 25ULL);
                    (void)_t_Str_699;
...
Array * Array_new(Str * elem_type, U32 * elem_size, U32 * cap) {
    ...
    if (_t_Bool_1008) {
        ...
        ;
        Str *_t_Str_1007 = Str_lit("./src/core/array.til:22:41", 26ULL);
        (void)_t_Str_1007;
...
void * Array_get(Array * self, U32 * i) {
    ...
    if (_t_Bool_1027) {
        ...
        ;
        Str *_t_Str_1026 = Str_lit("./src/core/array.til:34:19", 26ULL);
        (void)_t_Str_1026;
...
void Array_set(Array * self, U32 * i, void * val) {
    ...
    if (_t_Bool_1044) {
        ...
        ;
        Str *_t_Str_1043 = Str_lit("./src/core/array.til:43:19", 26ULL);
        (void)_t_Str_1043;
...
void panic(Str * loc_str, Array * parts) {
    ...
    U32 _t_U32_2716 = 3;
    (void)_t_U32_2716;
    Array *_va_Array_92 = Array_new(_t_Str_2714, &_t_U32_2715, &_t_U32_2716);
    (void)_va_Array_92;
...
Bool * assert(Str * loc_str, Bool * cond) {
    ...
    if (_t_Bool_2743) {
        ...
        U32 _t_U32_2740 = 1;
        (void)_t_U32_2740;
        Array *_va_Array_95 = Array_new(_t_Str_2738, &_t_U32_2739, &_t_U32_2740);
        (void)_va_Array_95;
...
void assert_eq(Str * loc_str, I64 * a, I64 * b) {
    ...
    if (_t_Bool_2767) {
        ...
        U32 _t_U32_2756 = 5;
        (void)_t_U32_2756;
        Array *_va_Array_97 = Array_new(_t_Str_2754, &_t_U32_2755, &_t_U32_2756);
        (void)_va_Array_97;
...
void test_simple_add(void) {
    ...
    ;
    ;
    Str *_t_Str_2958 = Str_lit("src/test/constfold.til:15:15", 28ULL);
    (void)_t_Str_2958;
    I64 _t_I64_2959 = 3;
    (void)_t_I64_2959;
    assert_eq(_t_Str_2958, &result, &_t_I64_2959);
    ;
    Str_delete(_t_Str_2958, &(Bool){1});
    ;
}
...
void test_nested_arithmetic(void) {
    ...
    ;
    ;
    Str *_t_Str_2966 = Str_lit("src/test/constfold.til:21:15", 28ULL);
    (void)_t_Str_2966;
    I64 _t_I64_2967 = 15;
    (void)_t_I64_2967;
    assert_eq(_t_Str_2966, &result, &_t_I64_2967);
    ;
    Str_delete(_t_Str_2966, &(Bool){1});
    ;
}
...
void test_deeply_nested(void) {
    ...
    ;
    ;
    Str *_t_Str_2974 = Str_lit("src/test/constfold.til:27:15", 28ULL);
    (void)_t_Str_2974;
    I64 _t_I64_2975 = 26;
    (void)_t_I64_2975;
    assert_eq(_t_Str_2974, &result, &_t_I64_2975);
    ;
...
Str * poem(I64 * depth, Str * current, Str * s1, Str * s2) {
    ...
    I64 _t_I64_2983 = 4;
    (void)_t_I64_2983;
    Bool _t_Bool_2984 = I64_eq(DEREF(depth), _t_I64_2983);
    (void)_t_Bool_2984;
    ;
    if (_t_Bool_2984) {
        Str *_t_Str_2976 = Str_lit("\n", 2ULL);
        (void)_t_Str_2976;
        Str *_t_Str_2977 = Str_concat(current, _t_Str_2976);
        (void)_t_Str_2977;
        Str_delete(_t_Str_2976, &(Bool){1});
        ;
        return _t_Str_2977;
    }
    ;
    ...
    I64 _t_I64_2985 = 1;
    (void)_t_I64_2985;
    I64 _t_I64_2986 = I64_add(DEREF(depth), _t_I64_2985);
    (void)_t_I64_2986;
    ;
    Str *_t_Str_2987 = Str_concat(current, s1);
    (void)_t_Str_2987;
    Str *_t_Str_2988 = poem(&_t_I64_2986, _t_Str_2987, s1, s2);
    (void)_t_Str_2988;
    ;
    Str_delete(_t_Str_2987, &(Bool){1});
    { Str *_old = result; result = Str_concat(result, _t_Str_2988); Str_delete(_old, &(Bool){1}); }
    Str_delete(_t_Str_2988, &(Bool){1});
    I64 _t_I64_2989 = 1;
    (void)_t_I64_2989;
    I64 _t_I64_2990 = I64_add(DEREF(depth), _t_I64_2989);
    (void)_t_I64_2990;
    ;
    Str *_t_Str_2991 = Str_concat(current, s2);
    (void)_t_Str_2991;
    Str *_t_Str_2992 = poem(&_t_I64_2990, _t_Str_2991, s1, s2);
    (void)_t_Str_2992;
    ;
    Str_delete(_t_Str_2991, &(Bool){1});
    { Str *_old = result; result = Str_concat(result, _t_Str_2992); Str_delete(_old, &(Bool){1}); }
    Str_delete(_t_Str_2992, &(Bool){1});
    I64 _t_I64_2993 = 2;
    (void)_t_I64_2993;
    Bool _t_Bool_2994 = I64_eq(DEREF(depth), _t_I64_2993);
    (void)_t_Bool_2994;
    ;
    if (_t_Bool_2994) {
        I64 _t_I64_2978 = 1;
        (void)_t_I64_2978;
        Str *_t_Str_2979 = Str_lit("lei", 3ULL);
        (void)_t_Str_2979;
        I64 _t_I64_2980 = I64_add(DEREF(depth), _t_I64_2978);
        (void)_t_I64_2980;
        ;
        Str *_t_Str_2981 = Str_concat(current, _t_Str_2979);
        (void)_t_Str_2981;
        Str_delete(_t_Str_2979, &(Bool){1});
        Str *_t_Str_2982 = poem(&_t_I64_2980, _t_Str_2981, s1, s2);
        (void)_t_Str_2982;
        ;
        Str_delete(_t_Str_2981, &(Bool){1});
        { Str *_old = result; result = Str_concat(result, _t_Str_2982); Str_delete(_old, &(Bool){1}); }
...
Str * make_poem(Str * s1, Str * s2) {
    ...
    I64 _t_I64_2995 = 0;
    (void)_t_I64_2995;
    Str *_t_Str_2996 = Str_lit("", 0ULL);
    (void)_t_Str_2996;
    Str *_t_Str_2997 = poem(&_t_I64_2995, _t_Str_2996, s1, s2);
    (void)_t_Str_2997;
    ;
...
void test_lolalalo(void) {
    Str *_t_Str_2998 = Str_lit("lo", 2ULL);
    (void)_t_Str_2998;
    Str *_t_Str_2999 = Str_lit("la", 2ULL);
    (void)_t_Str_2999;
    Str *lo_la = make_poem(_t_Str_2998, _t_Str_2999);
    (void)lo_la;
    Str_delete(_t_Str_2998, &(Bool){1});
    Str_delete(_t_Str_2999, &(Bool){1});
    Str *_t_Str_3000 = Str_lit("la", 2ULL);
    (void)_t_Str_3000;
    Str *_t_Str_3001 = Str_lit("lo", 2ULL);
    (void)_t_Str_3001;
    Str *la_lo = make_poem(_t_Str_3000, _t_Str_3001);
    (void)la_lo;
    Str_delete(_t_Str_3000, &(Bool){1});
    Str_delete(_t_Str_3001, &(Bool){1});
    Str *_t_Str_3002 = Str_lit("lolalolo", 8ULL);
    (void)_t_Str_3002;
    Str *_t_Str_3003 = Str_lit("src/test/constfold.til:56:12", 28ULL);
    (void)_t_Str_3003;
    Bool _t_Bool_3004 = Str_contains(lo_la, _t_Str_3002);
    (void)_t_Bool_3004;
    Str_delete(_t_Str_3002, &(Bool){1});
    Bool _t_Bool_3005; { Bool *_hp = (Bool *)assert(_t_Str_3003, &_t_Bool_3004); _t_Bool_3005 = *_hp; free(_hp); }
    (void)_t_Bool_3005;
    ;
    ;
    Str_delete(_t_Str_3003, &(Bool){1});
    Str *_t_Str_3006 = Str_lit("lalalala", 8ULL);
    (void)_t_Str_3006;
    Str *_t_Str_3007 = Str_lit("src/test/constfold.til:57:12", 28ULL);
    (void)_t_Str_3007;
    Bool _t_Bool_3008 = Str_contains(la_lo, _t_Str_3006);
    (void)_t_Bool_3008;
    Str_delete(_t_Str_3006, &(Bool){1});
    Bool _t_Bool_3009; { Bool *_hp = (Bool *)assert(_t_Str_3007, &_t_Bool_3008); _t_Bool_3009 = *_hp; free(_hp); }
    (void)_t_Bool_3009;
    ;
    ;
    Str_delete(_t_Str_3007, &(Bool){1});
    Str *_t_Str_3010 = Str_lit("lolei", 5ULL);
    (void)_t_Str_3010;
    Str *_t_Str_3011 = Str_lit("src/test/constfold.til:59:12", 28ULL);
    (void)_t_Str_3011;
    Bool _t_Bool_3012 = Str_contains(lo_la, _t_Str_3010);
    (void)_t_Bool_3012;
    Str_delete(_t_Str_3010, &(Bool){1});
    Str_delete(lo_la, &(Bool){1});
    Bool _t_Bool_3013; { Bool *_hp = (Bool *)assert(_t_Str_3011, &_t_Bool_3012); _t_Bool_3013 = *_hp; free(_hp); }
    (void)_t_Bool_3013;
    ;
    ;
    Str_delete(_t_Str_3011, &(Bool){1});
    Str *_t_Str_3014 = Str_lit("lalei", 5ULL);
    (void)_t_Str_3014;
    Str *_t_Str_3015 = Str_lit("src/test/constfold.til:60:12", 28ULL);
    (void)_t_Str_3015;
    Bool _t_Bool_3016 = Str_contains(la_lo, _t_Str_3014);
    (void)_t_Bool_3016;
    Str_delete(_t_Str_3014, &(Bool){1});
    Str_delete(la_lo, &(Bool){1});
    Bool _t_Bool_3017; { Bool *_hp = (Bool *)assert(_t_Str_3015, &_t_Bool_3016); _t_Bool_3017 = *_hp; free(_hp); }
    (void)_t_Bool_3017;
    ;
    ;
