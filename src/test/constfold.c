...
Vec * Vec_new_type_name(Str * elem_type) {
    ...
    if (_t_Bool_154) {
        ...
        (void)_t_Str_142;
        TilType *_t_TilType_143 = TilType_Struct(_t_Str_142);
        (void)_t_TilType_143;
...
void Vec_append(Vec * self, Vec * other) {
    ...
    if (_t_Bool_189) {
        ...
        (void)_t_Str_173;
        TilType *_t_TilType_174 = TilType_Struct(_t_Str_173);
        (void)_t_TilType_174;
...
void Vec_move_from(Vec * self, Vec * other) {
    ...
    if (_t_Bool_225) {
        ...
        (void)_t_Str_198;
        TilType *_t_TilType_199 = TilType_Struct(_t_Str_198);
        (void)_t_TilType_199;
...
void * Vec_get(Vec * self, U32 * i) {
    ...
    if (_t_Bool_251) {
        ...
        (void)_t_Str_237;
        TilType *_t_TilType_238 = TilType_Struct(_t_Str_237);
        (void)_t_TilType_238;
...
void * Vec_pop(Vec * self) {
    ...
    if (_t_Bool_261) {
        ...
        (void)_t_Str_254;
        TilType *_t_TilType_255 = TilType_Struct(_t_Str_254);
        (void)_t_TilType_255;
...
Vec * Vec_take_prefix(Vec * self, U32 * n) {
    ...
    if (_t_Bool_285) {
        ...
        (void)_t_Str_266;
        TilType *_t_TilType_267 = TilType_Struct(_t_Str_266);
        (void)_t_TilType_267;
...
void Vec_set(Vec * self, U32 * i, void * val) {
    ...
    if (_t_Bool_309) {
        ...
        (void)_t_Str_295;
        TilType *_t_TilType_296 = TilType_Struct(_t_Str_295);
        (void)_t_TilType_296;
...
void Vec_push_take(Vec * self, Vec * src, U32 i) {
    ...
    if (_t_Bool_336) {
        ...
        (void)_t_Str_312;
        TilType *_t_TilType_313 = TilType_Struct(_t_Str_312);
        (void)_t_TilType_313;
    ...
    if (_t_Bool_341) {
        ...
        (void)_t_Str_326;
        TilType *_t_TilType_327 = TilType_Struct(_t_Str_326);
        (void)_t_TilType_327;
...
U8 * Str_get(Str * self, U32 * i) {
    ...
    if (_t_Bool_411) {
        ...
        (void)_t_Str_405;
        TilType *_t_TilType_406 = TilType_Struct(_t_Str_405);
        (void)_t_TilType_406;
...
void Str_push_str(Str * self, Str * s) {
    ...
    if (_t_Bool_443) {
        ...
        (void)_t_Str_431;
        TilType *_t_TilType_432 = TilType_Struct(_t_Str_431);
        (void)_t_TilType_432;
    ...
    if (_t_Bool_444) {
        ...
        (void)_t_Str_437;
        TilType *_t_TilType_438 = TilType_Struct(_t_Str_437);
        (void)_t_TilType_438;
...
I64 Str_to_i64(Str * self) {
    ...
    if (_t_Bool_717) {
        ...
        (void)_t_Str_656;
        TilType *_t_TilType_657 = TilType_Struct(_t_Str_656);
        (void)_t_TilType_657;
    ...
    if (_t_Bool_721) {
        ...
        (void)_t_Str_664;
        TilType *_t_TilType_665 = TilType_Struct(_t_Str_664);
        (void)_t_TilType_665;
        ...
        if (_t_Bool_713) {
            while (1) {
                ...
                if (_t_Bool_688) {
                    ...
                    (void)_t_Str_672;
                    TilType *_t_TilType_673 = TilType_Struct(_t_Str_672);
                    (void)_t_TilType_673;
            ...
            while (1) {
                ...
                if (_t_Bool_709) {
                    ...
                    (void)_t_Str_693;
                    TilType *_t_TilType_694 = TilType_Struct(_t_Str_693);
                    (void)_t_TilType_694;
...
Vec * Str_split(Str * self, Str * delim) {
    ...
    (void)_t_Str_799;
    TilType *_t_TilType_800 = TilType_Struct(_t_Str_799);
    (void)_t_TilType_800;
    Str_delete(_t_Str_799, &(Bool){1});
    Vec *parts = Vec_new(_t_TilType_800);
    (void)parts;
    TilType_delete(_t_TilType_800, &(Bool){1});
...
void I64_inc(I64 * self) {
    ...
    I64 _t_I64_950 = 1;
    (void)_t_I64_950;
    I64 _t_I64_951 = I64_add(DEREF(self), _t_I64_950);
    (void)_t_I64_951;
    ;
    *self = _t_I64_951;
    ;
...
void I64_dec(I64 * self) {
    ...
    I64 _t_I64_952 = 1;
    (void)_t_I64_952;
    I64 _t_I64_953 = I64_sub(DEREF(self), _t_I64_952);
    (void)_t_I64_953;
    ;
    *self = _t_I64_953;
    ;
...
I64 * I64_abs(I64 * a) {
    ...
    I64 _t_I64_959 = 0;
    (void)_t_I64_959;
    Bool _t_Bool_960 = I64_lt(a, &_t_I64_959);
    (void)_t_Bool_960;
    ;
    if (_t_Bool_960) {
        I64 _t_I64_957 = 0;
        (void)_t_I64_957;
        I64 _t_I64_958 = I64_sub(_t_I64_957, DEREF(a));
        (void)_t_I64_958;
        ;
        ;
...
U64 I64_distance(void * a, void * b) {
    ...
    I64 *bu = b;
    (void)bu;
    Bool _t_Bool_964 = I64_lte(au, bu);
    (void)_t_Bool_964;
    if (_t_Bool_964) {
        I64 _t_I64_962 = I64_sub(DEREF(bu), DEREF(au));
        (void)_t_I64_962;
    ...
    ;
    I64 _t_I64_965 = I64_sub(DEREF(au), DEREF(bu));
    (void)_t_I64_965;
    U64 _t_U64_966 = I64_to_u64(_t_I64_965);
    (void)_t_U64_966;
    ;
    return _t_U64_966;
}
...
U32 * I64_size(void) {
    I64 _t_I64_967 = 8;
    (void)_t_I64_967;
    { U32 *_r = malloc(sizeof(U32)); *_r = _t_I64_967; return _r; }
}
...
Bool I64_lt(I64 * a, I64 * b) {
    ...
    (void)_t_I64_970;
    I64 _t_I64_971 = I64_sub(_t_I64_968, _t_I64_969);
    (void)_t_I64_971;
    ;
    ;
...
Bool I64_gt(I64 * a, I64 * b) {
    (void)a;
    (void)b;
    I64 _t_I64_973 = I64_cmp(DEREF(a), DEREF(b));
    (void)_t_I64_973;
    I64 _t_I64_974 = 1;
    (void)_t_I64_974;
    Bool _t_Bool_975 = I64_eq(_t_I64_973, _t_I64_974);
    (void)_t_Bool_975;
    ;
    ;
    return _t_Bool_975;
...
Bool I64_neq(I64 * a, I64 * b) {
    (void)a;
    (void)b;
    Bool _t_Bool_976 = I64_eq(DEREF(a), DEREF(b));
    (void)_t_Bool_976;
...
Bool I64_gte(I64 * a, I64 * b) {
    (void)a;
    (void)b;
    Bool _t_Bool_980 = I64_lt(a, b);
    (void)_t_Bool_980;
    Bool _t_Bool_981 = not(_t_Bool_980);
    (void)_t_Bool_981;
    ;
    return _t_Bool_981;
}
...
Str * Bool_to_str(Bool * b) {
    (void)b;
    if (DEREF(b)) {
        Str *_t_Str_982 = Str_lit("true", 4ULL);
        (void)_t_Str_982;
        return _t_Str_982;
    } else {
        Str *_t_Str_983 = Str_lit("false", 5ULL);
        (void)_t_Str_983;
        return _t_Str_983;
    }
}
...
I64 * Bool_cmp(Bool * a, Bool * b) {
    (void)a;
    (void)b;
    Bool _t_Bool_988 = Bool_eq(DEREF(a), DEREF(b));
    (void)_t_Bool_988;
    if (_t_Bool_988) {
        I64 _t_I64_984 = 0;
        (void)_t_I64_984;
    ...
    if (DEREF(b)) {
        ...
        I64 _t_I64_986 = 1;
        (void)_t_I64_986;
        I64 _t_I64_987 = I64_sub(_t_I64_985, _t_I64_986);
        (void)_t_I64_987;
        ;
        ;
...
U32 * Bool_size(void) {
    I64 _t_I64_990 = 1;
    (void)_t_I64_990;
    { U32 *_r = malloc(sizeof(U32)); *_r = _t_I64_990; return _r; }
}
...
Bool Bool_lt(Bool * a, Bool * b) {
    ...
    (void)_t_I64_993;
    I64 _t_I64_994 = I64_sub(_t_I64_991, _t_I64_992);
    (void)_t_I64_994;
    ;
    ;
...
Bool Bool_gt(Bool * a, Bool * b) {
    (void)a;
    (void)b;
    I64 _t_I64_996; { I64 *_hp = (I64 *)Bool_cmp(a, b); _t_I64_996 = *_hp; free(_hp); }
    (void)_t_I64_996;
    I64 _t_I64_997 = 1;
    (void)_t_I64_997;
    Bool _t_Bool_998 = I64_eq(_t_I64_996, _t_I64_997);
    (void)_t_Bool_998;
    ;
    ;
    return _t_Bool_998;
...
Bool Bool_neq(Bool * a, Bool * b) {
    (void)a;
    (void)b;
    Bool _t_Bool_999 = Bool_eq(DEREF(a), DEREF(b));
    (void)_t_Bool_999;
...
Bool Bool_gte(Bool * a, Bool * b) {
    (void)a;
    (void)b;
    Bool _t_Bool_1003 = Bool_lt(a, b);
    (void)_t_Bool_1003;
    Bool _t_Bool_1004 = not(_t_Bool_1003);
    (void)_t_Bool_1004;
    ;
    return _t_Bool_1004;
}
...
Bool TilType_eq(TilType * a, TilType * b) {
    (void)a;
    (void)b;
    Bool _t_Bool_1164 = TilType_is(a, &(TilType){.tag = TilType_TAG_Custom});
    (void)_t_Bool_1164;
    Bool _t_Bool_1165 = TilType_is(a, &(TilType){.tag = TilType_TAG_Struct});
    (void)_t_Bool_1165;
    Bool _t_Bool_1166 = or(_t_Bool_1164, _t_Bool_1165);
    (void)_t_Bool_1166;
    ;
    ;
    Bool _t_Bool_1167 = TilType_is(a, &(TilType){.tag = TilType_TAG_Enum});
    (void)_t_Bool_1167;
    Bool a_named = or(_t_Bool_1166, _t_Bool_1167);
    (void)a_named;
    ;
    ;
    Bool _t_Bool_1168 = TilType_is(b, &(TilType){.tag = TilType_TAG_Custom});
    (void)_t_Bool_1168;
    Bool _t_Bool_1169 = TilType_is(b, &(TilType){.tag = TilType_TAG_Struct});
    (void)_t_Bool_1169;
    Bool _t_Bool_1170 = or(_t_Bool_1168, _t_Bool_1169);
    (void)_t_Bool_1170;
    ;
    ;
    Bool _t_Bool_1171 = TilType_is(b, &(TilType){.tag = TilType_TAG_Enum});
    (void)_t_Bool_1171;
    Bool b_named = or(_t_Bool_1170, _t_Bool_1171);
    (void)b_named;
    ;
    ;
    Bool _t_Bool_1172 = and(a_named, b_named);
    (void)_t_Bool_1172;
    if (_t_Bool_1172) {
        ...
        (void)bn;
        Bool _t_Bool_1147 = Str_eq(an, bn);
        (void)_t_Bool_1147;
        ;
        ;
        ;
    ...
    ;
    Bool _t_Bool_1173 = or(a_named, b_named);
    (void)_t_Bool_1173;
    ;
    ;
    if (_t_Bool_1173) {
    ...
    ;
    Bool _t_Bool_1174 = TilType_is(a, &(TilType){.tag = TilType_TAG_Unknown});
    (void)_t_Bool_1174;
    if (_t_Bool_1174) {
        Bool _t_Bool_1149 = TilType_is(b, &(TilType){.tag = TilType_TAG_Unknown});
        (void)_t_Bool_1149;
        ;
        return _t_Bool_1149;
    }
    ;
    Bool _t_Bool_1175 = TilType_is(a, &(TilType){.tag = TilType_TAG_None});
    (void)_t_Bool_1175;
    if (_t_Bool_1175) {
        Bool _t_Bool_1150 = TilType_is(b, &(TilType){.tag = TilType_TAG_None});
        (void)_t_Bool_1150;
        ;
        return _t_Bool_1150;
    }
    ;
    Bool _t_Bool_1176 = TilType_is(a, &(TilType){.tag = TilType_TAG_I64});
    (void)_t_Bool_1176;
    if (_t_Bool_1176) {
        Bool _t_Bool_1151 = TilType_is(b, &(TilType){.tag = TilType_TAG_I64});
        (void)_t_Bool_1151;
        ;
        return _t_Bool_1151;
    }
    ;
    Bool _t_Bool_1177 = TilType_is(a, &(TilType){.tag = TilType_TAG_U8});
    (void)_t_Bool_1177;
    if (_t_Bool_1177) {
        Bool _t_Bool_1152 = TilType_is(b, &(TilType){.tag = TilType_TAG_U8});
        (void)_t_Bool_1152;
        ;
        return _t_Bool_1152;
    }
    ;
    Bool _t_Bool_1178 = TilType_is(a, &(TilType){.tag = TilType_TAG_I16});
    (void)_t_Bool_1178;
    if (_t_Bool_1178) {
        Bool _t_Bool_1153 = TilType_is(b, &(TilType){.tag = TilType_TAG_I16});
        (void)_t_Bool_1153;
        ;
        return _t_Bool_1153;
    }
    ;
    Bool _t_Bool_1179 = TilType_is(a, &(TilType){.tag = TilType_TAG_I32});
    (void)_t_Bool_1179;
    if (_t_Bool_1179) {
        Bool _t_Bool_1154 = TilType_is(b, &(TilType){.tag = TilType_TAG_I32});
        (void)_t_Bool_1154;
        ;
        return _t_Bool_1154;
    }
    ;
    Bool _t_Bool_1180 = TilType_is(a, &(TilType){.tag = TilType_TAG_U32});
    (void)_t_Bool_1180;
    if (_t_Bool_1180) {
        Bool _t_Bool_1155 = TilType_is(b, &(TilType){.tag = TilType_TAG_U32});
        (void)_t_Bool_1155;
        ;
        return _t_Bool_1155;
    }
    ;
    Bool _t_Bool_1181 = TilType_is(a, &(TilType){.tag = TilType_TAG_U64});
    (void)_t_Bool_1181;
    if (_t_Bool_1181) {
        Bool _t_Bool_1156 = TilType_is(b, &(TilType){.tag = TilType_TAG_U64});
        (void)_t_Bool_1156;
        ;
        return _t_Bool_1156;
    }
    ;
    Bool _t_Bool_1182 = TilType_is(a, &(TilType){.tag = TilType_TAG_F32});
    (void)_t_Bool_1182;
    if (_t_Bool_1182) {
        Bool _t_Bool_1157 = TilType_is(b, &(TilType){.tag = TilType_TAG_F32});
        (void)_t_Bool_1157;
        ;
        return _t_Bool_1157;
    }
    ;
    Bool _t_Bool_1183 = TilType_is(a, &(TilType){.tag = TilType_TAG_Bool});
    (void)_t_Bool_1183;
    if (_t_Bool_1183) {
        Bool _t_Bool_1158 = TilType_is(b, &(TilType){.tag = TilType_TAG_Bool});
        (void)_t_Bool_1158;
        ;
        return _t_Bool_1158;
    }
    ;
    Bool _t_Bool_1184 = TilType_is(a, &(TilType){.tag = TilType_TAG_StructDef});
    (void)_t_Bool_1184;
    if (_t_Bool_1184) {
        Bool _t_Bool_1159 = TilType_is(b, &(TilType){.tag = TilType_TAG_StructDef});
        (void)_t_Bool_1159;
        ;
        return _t_Bool_1159;
    }
    ;
    Bool _t_Bool_1185 = TilType_is(a, &(TilType){.tag = TilType_TAG_EnumDef});
    (void)_t_Bool_1185;
    if (_t_Bool_1185) {
        Bool _t_Bool_1160 = TilType_is(b, &(TilType){.tag = TilType_TAG_EnumDef});
        (void)_t_Bool_1160;
        ;
        return _t_Bool_1160;
    }
    ;
    Bool _t_Bool_1186 = TilType_is(a, &(TilType){.tag = TilType_TAG_FuncDef});
    (void)_t_Bool_1186;
    if (_t_Bool_1186) {
        Bool _t_Bool_1161 = TilType_is(b, &(TilType){.tag = TilType_TAG_FuncDef});
        (void)_t_Bool_1161;
        ;
        return _t_Bool_1161;
    }
    ;
    Bool _t_Bool_1187 = TilType_is(a, &(TilType){.tag = TilType_TAG_FuncPtr});
    (void)_t_Bool_1187;
    if (_t_Bool_1187) {
        Bool _t_Bool_1162 = TilType_is(b, &(TilType){.tag = TilType_TAG_FuncPtr});
        (void)_t_Bool_1162;
        ;
        return _t_Bool_1162;
    }
    ;
    Bool _t_Bool_1188 = TilType_is(a, &(TilType){.tag = TilType_TAG_Dynamic});
    (void)_t_Bool_1188;
    if (_t_Bool_1188) {
        Bool _t_Bool_1163 = TilType_is(b, &(TilType){.tag = TilType_TAG_Dynamic});
        (void)_t_Bool_1163;
        ;
        return _t_Bool_1163;
    }
...
Bool TilType_is(TilType * self, TilType * other) {
    (void)self;
    (void)other;
    Bool _t_Bool_1190 = is(self, other);
    (void)_t_Bool_1190;
    return _t_Bool_1190;
}
...
void TilType_delete(TilType * self, Bool * call_free) {
    (void)self;
    (void)call_free;
    Bool _t_Bool_1197 = is(self, &(TilType){.tag = TilType_TAG_Struct});
    (void)_t_Bool_1197;
    if (_t_Bool_1197) {
        Str *_t_Str_1191 = get_payload(self);
        (void)_t_Str_1191;
        Bool _t_Bool_1192 = 0;
        (void)_t_Bool_1192;
        Str_delete(_t_Str_1191, &_t_Bool_1192);
        ;
    }
    ;
    Bool _t_Bool_1198 = is(self, &(TilType){.tag = TilType_TAG_Enum});
    (void)_t_Bool_1198;
    if (_t_Bool_1198) {
        Str *_t_Str_1193 = get_payload(self);
        (void)_t_Str_1193;
        Bool _t_Bool_1194 = 0;
        (void)_t_Bool_1194;
        Str_delete(_t_Str_1193, &_t_Bool_1194);
        ;
    }
    ;
    Bool _t_Bool_1199 = is(self, &(TilType){.tag = TilType_TAG_Custom});
    (void)_t_Bool_1199;
    if (_t_Bool_1199) {
        Str *_t_Str_1195 = get_payload(self);
        (void)_t_Str_1195;
        Bool _t_Bool_1196 = 0;
        (void)_t_Bool_1196;
        Str_delete(_t_Str_1195, &_t_Bool_1196);
        ;
    }
    ;
    if (DEREF(call_free)) {
...
Str * TilType_to_str(TilType * self) {
    (void)self;
    Bool _t_Bool_1245 = is(self, &(TilType){.tag = TilType_TAG_Unknown});
    (void)_t_Bool_1245;
    if (_t_Bool_1245) {
        Str *_t_Str_1200 = Str_lit("Unknown", 7ULL);
        (void)_t_Str_1200;
        ;
        return _t_Str_1200;
    }
    ;
    Bool _t_Bool_1246 = is(self, &(TilType){.tag = TilType_TAG_None});
    (void)_t_Bool_1246;
    if (_t_Bool_1246) {
        Str *_t_Str_1201 = Str_lit("None", 4ULL);
        (void)_t_Str_1201;
        ;
        return _t_Str_1201;
    }
    ;
    Bool _t_Bool_1247 = is(self, &(TilType){.tag = TilType_TAG_I64});
    (void)_t_Bool_1247;
    if (_t_Bool_1247) {
        Str *_t_Str_1202 = Str_lit("I64", 3ULL);
        (void)_t_Str_1202;
        ;
        return _t_Str_1202;
    }
    ;
    Bool _t_Bool_1248 = is(self, &(TilType){.tag = TilType_TAG_U8});
    (void)_t_Bool_1248;
    if (_t_Bool_1248) {
        Str *_t_Str_1203 = Str_lit("U8", 2ULL);
        (void)_t_Str_1203;
        ;
        return _t_Str_1203;
    }
    ;
    Bool _t_Bool_1249 = is(self, &(TilType){.tag = TilType_TAG_I16});
    (void)_t_Bool_1249;
    if (_t_Bool_1249) {
        Str *_t_Str_1204 = Str_lit("I16", 3ULL);
        (void)_t_Str_1204;
        ;
        return _t_Str_1204;
    }
    ;
    Bool _t_Bool_1250 = is(self, &(TilType){.tag = TilType_TAG_I32});
    (void)_t_Bool_1250;
    if (_t_Bool_1250) {
        Str *_t_Str_1205 = Str_lit("I32", 3ULL);
        (void)_t_Str_1205;
        ;
        return _t_Str_1205;
    }
    ;
    Bool _t_Bool_1251 = is(self, &(TilType){.tag = TilType_TAG_U32});
    (void)_t_Bool_1251;
    if (_t_Bool_1251) {
        Str *_t_Str_1206 = Str_lit("U32", 3ULL);
        (void)_t_Str_1206;
        ;
        return _t_Str_1206;
    }
    ;
    Bool _t_Bool_1252 = is(self, &(TilType){.tag = TilType_TAG_U64});
    (void)_t_Bool_1252;
    if (_t_Bool_1252) {
        Str *_t_Str_1207 = Str_lit("U64", 3ULL);
        (void)_t_Str_1207;
        ;
        return _t_Str_1207;
    }
    ;
    Bool _t_Bool_1253 = is(self, &(TilType){.tag = TilType_TAG_F32});
    (void)_t_Bool_1253;
    if (_t_Bool_1253) {
        Str *_t_Str_1208 = Str_lit("F32", 3ULL);
        (void)_t_Str_1208;
        ;
        return _t_Str_1208;
    }
    ;
    Bool _t_Bool_1254 = is(self, &(TilType){.tag = TilType_TAG_Bool});
    (void)_t_Bool_1254;
    if (_t_Bool_1254) {
        Str *_t_Str_1209 = Str_lit("Bool", 4ULL);
        (void)_t_Str_1209;
        ;
        return _t_Str_1209;
    }
    ;
    Bool _t_Bool_1255 = is(self, &(TilType){.tag = TilType_TAG_Struct});
    (void)_t_Bool_1255;
    if (_t_Bool_1255) {
        Str *_p_Str_10 = get_payload(self);
        (void)_p_Str_10;
        Str *_t_Str_1210 = Str_lit("Str", 3ULL);
        (void)_t_Str_1210;
        TilType *_t_TilType_1211 = TilType_Struct(_t_Str_1210);
        (void)_t_TilType_1211;
        ...
        U32 _t_U32_1213 = 0;
        (void)_t_U32_1213;
        Str *_t_Str_1214 = Str_lit("Struct(", 7ULL);
        (void)_t_Str_1214;
        Array_set(_va_Array_20, &_t_U32_1213, _t_Str_1214);
        ;
        U32 _t_U32_1215 = 1;
        (void)_t_U32_1215;
        Str *_t_Str_1216 = Str_to_str(_p_Str_10);
        (void)_t_Str_1216;
        Array_set(_va_Array_20, &_t_U32_1215, _t_Str_1216);
        ;
        U32 _t_U32_1217 = 2;
        (void)_t_U32_1217;
        Str *_t_Str_1218 = Str_lit(")", 1ULL);
        (void)_t_Str_1218;
        Array_set(_va_Array_20, &_t_U32_1217, _t_Str_1218);
        ;
        Str *_t_Str_1219 = format(_va_Array_20);
        (void)_t_Str_1219;
        ;
        return _t_Str_1219;
    }
    ;
    Bool _t_Bool_1256 = is(self, &(TilType){.tag = TilType_TAG_StructDef});
    (void)_t_Bool_1256;
    if (_t_Bool_1256) {
        Str *_t_Str_1220 = Str_lit("StructDef", 9ULL);
        (void)_t_Str_1220;
        ;
        return _t_Str_1220;
    }
    ;
    Bool _t_Bool_1257 = is(self, &(TilType){.tag = TilType_TAG_Enum});
    (void)_t_Bool_1257;
    if (_t_Bool_1257) {
        Str *_p_Str_12 = get_payload(self);
        (void)_p_Str_12;
        Str *_t_Str_1221 = Str_lit("Str", 3ULL);
        (void)_t_Str_1221;
        TilType *_t_TilType_1222 = TilType_Struct(_t_Str_1221);
        (void)_t_TilType_1222;
        ...
        U32 _t_U32_1224 = 0;
        (void)_t_U32_1224;
        Str *_t_Str_1225 = Str_lit("Enum(", 5ULL);
        (void)_t_Str_1225;
        Array_set(_va_Array_21, &_t_U32_1224, _t_Str_1225);
        ;
        U32 _t_U32_1226 = 1;
        (void)_t_U32_1226;
        Str *_t_Str_1227 = Str_to_str(_p_Str_12);
        (void)_t_Str_1227;
        Array_set(_va_Array_21, &_t_U32_1226, _t_Str_1227);
        ;
        U32 _t_U32_1228 = 2;
        (void)_t_U32_1228;
        Str *_t_Str_1229 = Str_lit(")", 1ULL);
        (void)_t_Str_1229;
        Array_set(_va_Array_21, &_t_U32_1228, _t_Str_1229);
        ;
        Str *_t_Str_1230 = format(_va_Array_21);
        (void)_t_Str_1230;
        ;
        return _t_Str_1230;
    }
    ;
    Bool _t_Bool_1258 = is(self, &(TilType){.tag = TilType_TAG_EnumDef});
    (void)_t_Bool_1258;
    if (_t_Bool_1258) {
        Str *_t_Str_1231 = Str_lit("EnumDef", 7ULL);
        (void)_t_Str_1231;
        ;
        return _t_Str_1231;
    }
    ;
    Bool _t_Bool_1259 = is(self, &(TilType){.tag = TilType_TAG_FuncDef});
    (void)_t_Bool_1259;
    if (_t_Bool_1259) {
        Str *_t_Str_1232 = Str_lit("FuncDef", 7ULL);
        (void)_t_Str_1232;
        ;
        return _t_Str_1232;
    }
    ;
    Bool _t_Bool_1260 = is(self, &(TilType){.tag = TilType_TAG_FuncPtr});
    (void)_t_Bool_1260;
    if (_t_Bool_1260) {
        Str *_t_Str_1233 = Str_lit("FuncPtr", 7ULL);
        (void)_t_Str_1233;
        ;
        return _t_Str_1233;
    }
    ;
    Bool _t_Bool_1261 = is(self, &(TilType){.tag = TilType_TAG_Dynamic});
    (void)_t_Bool_1261;
    if (_t_Bool_1261) {
        Str *_t_Str_1234 = Str_lit("Dynamic", 7ULL);
        (void)_t_Str_1234;
        ;
        return _t_Str_1234;
    }
    ;
    Bool _t_Bool_1262 = is(self, &(TilType){.tag = TilType_TAG_Custom});
    (void)_t_Bool_1262;
    if (_t_Bool_1262) {
        Str *_p_Str_17 = get_payload(self);
        (void)_p_Str_17;
        Str *_t_Str_1235 = Str_lit("Str", 3ULL);
        (void)_t_Str_1235;
        TilType *_t_TilType_1236 = TilType_Struct(_t_Str_1235);
        (void)_t_TilType_1236;
        ...
        U32 _t_U32_1238 = 0;
        (void)_t_U32_1238;
        Str *_t_Str_1239 = Str_lit("Custom(", 7ULL);
        (void)_t_Str_1239;
        Array_set(_va_Array_22, &_t_U32_1238, _t_Str_1239);
        ;
        U32 _t_U32_1240 = 1;
        (void)_t_U32_1240;
        Str *_t_Str_1241 = Str_to_str(_p_Str_17);
        (void)_t_Str_1241;
        Array_set(_va_Array_22, &_t_U32_1240, _t_Str_1241);
        ;
        U32 _t_U32_1242 = 2;
        (void)_t_U32_1242;
        Str *_t_Str_1243 = Str_lit(")", 1ULL);
        (void)_t_Str_1243;
        Array_set(_va_Array_22, &_t_U32_1242, _t_Str_1243);
        ;
        Str *_t_Str_1244 = format(_va_Array_22);
        (void)_t_Str_1244;
        ;
        return _t_Str_1244;
    }
    ;
    Str *_t_Str_1263 = Str_lit("unknown", 7ULL);
    (void)_t_Str_1263;
    return _t_Str_1263;
}
...
TilType * TilType_clone(TilType * self) {
    (void)self;
    Bool _t_Bool_1266 = is(self, &(TilType){.tag = TilType_TAG_Unknown});
    (void)_t_Bool_1266;
    if (_t_Bool_1266) {
        ;
    ...
    ;
    Bool _t_Bool_1267 = is(self, &(TilType){.tag = TilType_TAG_None});
    (void)_t_Bool_1267;
    if (_t_Bool_1267) {
        ;
    ...
    ;
    Bool _t_Bool_1268 = is(self, &(TilType){.tag = TilType_TAG_I64});
    (void)_t_Bool_1268;
    if (_t_Bool_1268) {
        ;
    ...
    ;
    Bool _t_Bool_1269 = is(self, &(TilType){.tag = TilType_TAG_U8});
    (void)_t_Bool_1269;
    if (_t_Bool_1269) {
        ;
    ...
    ;
    Bool _t_Bool_1270 = is(self, &(TilType){.tag = TilType_TAG_I16});
    (void)_t_Bool_1270;
    if (_t_Bool_1270) {
        ;
    ...
    ;
    Bool _t_Bool_1271 = is(self, &(TilType){.tag = TilType_TAG_I32});
    (void)_t_Bool_1271;
    if (_t_Bool_1271) {
        ;
    ...
    ;
    Bool _t_Bool_1272 = is(self, &(TilType){.tag = TilType_TAG_U32});
    (void)_t_Bool_1272;
    if (_t_Bool_1272) {
        ;
    ...
    ;
    Bool _t_Bool_1273 = is(self, &(TilType){.tag = TilType_TAG_U64});
    (void)_t_Bool_1273;
    if (_t_Bool_1273) {
        ;
    ...
    ;
    Bool _t_Bool_1274 = is(self, &(TilType){.tag = TilType_TAG_F32});
    (void)_t_Bool_1274;
    if (_t_Bool_1274) {
        ;
    ...
    ;
    Bool _t_Bool_1275 = is(self, &(TilType){.tag = TilType_TAG_Bool});
    (void)_t_Bool_1275;
    if (_t_Bool_1275) {
        ;
    ...
    ;
    Bool _t_Bool_1276 = is(self, &(TilType){.tag = TilType_TAG_Struct});
    (void)_t_Bool_1276;
    if (_t_Bool_1276) {
        Str *_clone_payload_Struct_10 = get_payload(self);
        (void)_clone_payload_Struct_10;
        TilType *_t_TilType_1264 = TilType_Struct(_clone_payload_Struct_10);
        (void)_t_TilType_1264;
        ;
        return _t_TilType_1264;
    }
    ;
    Bool _t_Bool_1277 = is(self, &(TilType){.tag = TilType_TAG_StructDef});
    (void)_t_Bool_1277;
    if (_t_Bool_1277) {
        ;
    ...
    ;
    Bool _t_Bool_1278 = is(self, &(TilType){.tag = TilType_TAG_Enum});
    (void)_t_Bool_1278;
    if (_t_Bool_1278) {
        Str *_clone_payload_Enum_12 = get_payload(self);
        (void)_clone_payload_Enum_12;
        TilType *_t_TilType_1265 = TilType_Enum(_clone_payload_Enum_12);
        (void)_t_TilType_1265;
        ;
        return _t_TilType_1265;
    }
    ;
    Bool _t_Bool_1279 = is(self, &(TilType){.tag = TilType_TAG_EnumDef});
    (void)_t_Bool_1279;
    if (_t_Bool_1279) {
        ;
    ...
    ;
    Bool _t_Bool_1280 = is(self, &(TilType){.tag = TilType_TAG_FuncDef});
    (void)_t_Bool_1280;
    if (_t_Bool_1280) {
        ;
    ...
    ;
    Bool _t_Bool_1281 = is(self, &(TilType){.tag = TilType_TAG_FuncPtr});
    (void)_t_Bool_1281;
    if (_t_Bool_1281) {
        ;
    ...
    ;
    Bool _t_Bool_1282 = is(self, &(TilType){.tag = TilType_TAG_Dynamic});
    (void)_t_Bool_1282;
    if (_t_Bool_1282) {
        ;
    ...
    TilType *_t_TilType_1283 = TilType_Custom(_clone_payload_Custom_17);
    (void)_t_TilType_1283;
    return _t_TilType_1283;
}
...
Array * Array_new(Str * elem_type, U32 * cap) {
    ...
    (void)_t_Bool_2407;
    if (_t_Bool_2407) {
        Str *_t_Str_2401 = Str_lit("Str", 3ULL);
        (void)_t_Str_2401;
        TilType *_t_TilType_2402 = TilType_Struct(_t_Str_2401);
        (void)_t_TilType_2402;
        ...
        U32 _t_U32_2404 = 0;
        (void)_t_U32_2404;
        Str *_t_Str_2405 = Str_lit("Array.new: elem_type required", 29ULL);
        (void)_t_Str_2405;
        Array_set(_va_Array_73, &_t_U32_2404, _t_Str_2405);
        ;
        Str *_t_Str_2406 = Str_lit("./src/core/array.til:23:41", 26ULL);
        (void)_t_Str_2406;
        panic(_t_Str_2406, _va_Array_73);
        Str_delete(_t_Str_2406, &(Bool){1});
    }
    ;
    U32 elem_size = dyn_size_of(elem_type);
    (void)elem_size;
    void * _t_v_2408 = calloc(DEREF(cap), elem_size);
    (void)_t_v_2408;
    void * _t_v_2409 = dyn_fn(elem_type, &(Str){.c_str=(U8*)"clone", .count=5ULL, .cap=TIL_CAP_LIT});
    (void)_t_v_2409;
    void * _t_v_2410 = dyn_fn(elem_type, &(Str){.c_str=(U8*)"delete", .count=6ULL, .cap=TIL_CAP_LIT});
    (void)_t_v_2410;
    Array *_t_Array_2411 = malloc(sizeof(Array));
    _t_Array_2411->data = _t_v_2408;
    _t_Array_2411->cap = DEREF(cap);
    _t_Array_2411->elem_size = elem_size;
    { Str *_ca = Str_clone(elem_type); _t_Array_2411->elem_type = *_ca; free(_ca); }
    _t_Array_2411->elem_clone = _t_v_2409;
    _t_Array_2411->elem_delete = _t_v_2410;
    (void)_t_Array_2411;
    ;
...
void * Array_get(Array * self, U32 * i) {
    (void)self;
    (void)i;
    Bool _t_Bool_2427 = U32_gte(i, &self->cap);
    (void)_t_Bool_2427;
    if (_t_Bool_2427) {
        Str *_t_Str_2413 = Str_lit("Str", 3ULL);
        (void)_t_Str_2413;
        TilType *_t_TilType_2414 = TilType_Struct(_t_Str_2413);
        (void)_t_TilType_2414;
        Str_delete(_t_Str_2413, &(Bool){1});
        U32 _t_U32_2415 = 5;
        (void)_t_U32_2415;
        Array *_va_Array_74 = Array_new_newi(_t_TilType_2414, &_t_U32_2415);
        (void)_va_Array_74;
        TilType_delete(_t_TilType_2414, &(Bool){1});
        ;
        U32 _t_U32_2416 = 0;
        (void)_t_U32_2416;
        Str *_t_Str_2417 = Str_lit("Array.get: index ", 17ULL);
        (void)_t_Str_2417;
        Array_set(_va_Array_74, &_t_U32_2416, _t_Str_2417);
        ;
        U32 _t_U32_2418 = 1;
        (void)_t_U32_2418;
        Str *_t_Str_2419 = U32_to_str(i);
        (void)_t_Str_2419;
        Array_set(_va_Array_74, &_t_U32_2418, _t_Str_2419);
        ;
        U32 _t_U32_2420 = 2;
        (void)_t_U32_2420;
        Str *_t_Str_2421 = Str_lit(" out of bounds (len ", 20ULL);
        (void)_t_Str_2421;
        Array_set(_va_Array_74, &_t_U32_2420, _t_Str_2421);
        ;
        U32 _t_U32_2422 = 3;
        (void)_t_U32_2422;
        Str *_t_Str_2423 = U32_to_str(&self->cap);
        (void)_t_Str_2423;
        Array_set(_va_Array_74, &_t_U32_2422, _t_Str_2423);
        ;
        U32 _t_U32_2424 = 4;
        (void)_t_U32_2424;
        Str *_t_Str_2425 = Str_lit(")", 1ULL);
        (void)_t_Str_2425;
        Array_set(_va_Array_74, &_t_U32_2424, _t_Str_2425);
        ;
        Str *_t_Str_2426 = Str_lit("./src/core/array.til:41:19", 26ULL);
        (void)_t_Str_2426;
        panic(_t_Str_2426, _va_Array_74);
        Str_delete(_t_Str_2426, &(Bool){1});
    }
    ;
    U32 _t_U64_2428 = U32_mul(DEREF(i), self->elem_size);
    (void)_t_U64_2428;
    void *_t_v_2429 = ptr_add(self->data, _t_U64_2428);
    (void)_t_v_2429;
    ;
    return _t_v_2429;
}
...
void Array_set(Array * self, U32 * i, void * val) {
    ...
    if (_t_Bool_2444) {
        ...
        (void)_t_Str_2430;
        TilType *_t_TilType_2431 = TilType_Struct(_t_Str_2430);
        (void)_t_TilType_2431;
        Str_delete(_t_Str_2430, &(Bool){1});
        U32 _t_U32_2432 = 5;
        (void)_t_U32_2432;
        Array *_va_Array_75 = Array_new_newi(_t_TilType_2431, &_t_U32_2432);
        (void)_va_Array_75;
        TilType_delete(_t_TilType_2431, &(Bool){1});
        ;
        U32 _t_U32_2433 = 0;
        (void)_t_U32_2433;
        Str *_t_Str_2434 = Str_lit("Array.set: index ", 17ULL);
        (void)_t_Str_2434;
        Array_set(_va_Array_75, &_t_U32_2433, _t_Str_2434);
        ;
        U32 _t_U32_2435 = 1;
        (void)_t_U32_2435;
        Str *_t_Str_2436 = U32_to_str(i);
        (void)_t_Str_2436;
        Array_set(_va_Array_75, &_t_U32_2435, _t_Str_2436);
        ;
        U32 _t_U32_2437 = 2;
        (void)_t_U32_2437;
        Str *_t_Str_2438 = Str_lit(" out of bounds (len ", 20ULL);
        (void)_t_Str_2438;
        Array_set(_va_Array_75, &_t_U32_2437, _t_Str_2438);
        ;
        U32 _t_U32_2439 = 3;
        (void)_t_U32_2439;
        Str *_t_Str_2440 = U32_to_str(&self->cap);
        (void)_t_Str_2440;
        Array_set(_va_Array_75, &_t_U32_2439, _t_Str_2440);
        ;
        U32 _t_U32_2441 = 4;
        (void)_t_U32_2441;
        Str *_t_Str_2442 = Str_lit(")", 1ULL);
        (void)_t_Str_2442;
        Array_set(_va_Array_75, &_t_U32_2441, _t_Str_2442);
        ;
        Str *_t_Str_2443 = Str_lit("./src/core/array.til:50:19", 26ULL);
        (void)_t_Str_2443;
        panic(_t_Str_2443, _va_Array_75);
    ...
    Bool _t_Bool_2447 = 0;
    (void)_t_Bool_2447;
    ((void (*)(void *, Bool *))(void *)(self->elem_delete))(_t_v_2446, &_t_Bool_2447);
    ;
    ;
    U32 _t_U64_2448 = U32_mul(DEREF(i), self->elem_size);
    (void)_t_U64_2448;
    void *_t_v_2449 = ptr_add(self->data, _t_U64_2448);
    (void)_t_v_2449;
    memcpy(_t_v_2449, val, self->elem_size);
    ;
    free(val);
}
...
void Array_delete(Array * self, Bool * call_free) {
    ...
    (void)call_free;
    {
        U32 _re_U32_2450 = self->cap;
        (void)_re_U32_2450;
        U32 _rc_U32_2450 = 0;
        (void)_rc_U32_2450;
        Bool _t_Bool_2459 = U32_lte(&_rc_U32_2450, &_re_U32_2450);
        (void)_t_Bool_2459;
        if (_t_Bool_2459) {
            while (1) {
                Bool _wcond_Bool_2451 = U32_lt(&_rc_U32_2450, &_re_U32_2450);
                (void)_wcond_Bool_2451;
                if (_wcond_Bool_2451) {
                } else {
                    ;
                    break;
                ...
                ;
                U32 i = U32_clone(&_rc_U32_2450);
                (void)i;
                U32_inc(&_rc_U32_2450);
                U32 _t_U64_2452 = U32_mul(i, self->elem_size);
                (void)_t_U64_2452;
                ;
                void *_t_v_2453 = ptr_add(self->data, _t_U64_2452);
                (void)_t_v_2453;
                Bool _t_Bool_2454 = 0;
                (void)_t_Bool_2454;
                ((void (*)(void *, Bool *))(void *)(self->elem_delete))(_t_v_2453, &_t_Bool_2454);
                ;
                ;
            }
        } else {
            while (1) {
                Bool _wcond_Bool_2455 = U32_gt(&_rc_U32_2450, &_re_U32_2450);
                (void)_wcond_Bool_2455;
                if (_wcond_Bool_2455) {
                } else {
                    ;
                    break;
                ...
                U32 i = U32_clone(&_rc_U32_2450);
                (void)i;
                U32_dec(&_rc_U32_2450);
                U32 _t_U64_2456 = U32_mul(i, self->elem_size);
                (void)_t_U64_2456;
                ;
                void *_t_v_2457 = ptr_add(self->data, _t_U64_2456);
                (void)_t_v_2457;
                Bool _t_Bool_2458 = 0;
                (void)_t_Bool_2458;
                ((void (*)(void *, Bool *))(void *)(self->elem_delete))(_t_v_2457, &_t_Bool_2458);
                ;
                ;
            }
        }
    ...
    Bool _t_Bool_2460 = 0;
    (void)_t_Bool_2460;
    Str_delete(&self->elem_type, &_t_Bool_2460);
    ;
    if (DEREF(call_free)) {
        free(self);
    }
...
Array * Array_clone(Array * self) {
    (void)self;
    U32 _t_U64_2473 = U32_mul(self->cap, self->elem_size);
    (void)_t_U64_2473;
    void * new_data = malloc(_t_U64_2473);
    (void)new_data;
    ;
    {
        U32 _re_U32_2461 = self->cap;
        (void)_re_U32_2461;
        U32 _rc_U32_2461 = 0;
        (void)_rc_U32_2461;
        Bool _t_Bool_2472 = U32_lte(&_rc_U32_2461, &_re_U32_2461);
        (void)_t_Bool_2472;
        if (_t_Bool_2472) {
            while (1) {
                ...
                ;
                U32 i = U32_clone(&_rc_U32_2461);
                (void)i;
                U32_inc(&_rc_U32_2461);
                U32 _t_U64_2463 = U32_mul(i, self->elem_size);
                (void)_t_U64_2463;
                void *_t_v_2464 = ptr_add(self->data, _t_U64_2463);
                (void)_t_v_2464;
                void * cloned = ((void * (*)(void *))(void *)(self->elem_clone))(_t_v_2464);
                (void)cloned;
                ;
                U32 _t_U64_2465 = U32_mul(i, self->elem_size);
                (void)_t_U64_2465;
                ;
                void *_t_v_2466 = ptr_add(new_data, _t_U64_2465);
                (void)_t_v_2466;
                memcpy(_t_v_2466, cloned, self->elem_size);
                ;
                free(cloned);
            }
        } else {
            while (1) {
                Bool _wcond_Bool_2467 = U32_gt(&_rc_U32_2461, &_re_U32_2461);
                (void)_wcond_Bool_2467;
                if (_wcond_Bool_2467) {
                } else {
                    ;
                    break;
                ...
                U32 _t_U64_2468 = U32_mul(i, self->elem_size);
                (void)_t_U64_2468;
                void *_t_v_2469 = ptr_add(self->data, _t_U64_2468);
                (void)_t_v_2469;
                void * cloned = ((void * (*)(void *))(void *)(self->elem_clone))(_t_v_2469);
                (void)cloned;
                ;
                U32 _t_U64_2470 = U32_mul(i, self->elem_size);
                (void)_t_U64_2470;
                ;
                void *_t_v_2471 = ptr_add(new_data, _t_U64_2470);
                (void)_t_v_2471;
                memcpy(_t_v_2471, cloned, self->elem_size);
                ;
                free(cloned);
            }
        }
    ...
    Array *_t_Array_2474 = malloc(sizeof(Array));
    _t_Array_2474->data = new_data;
    _t_Array_2474->cap = self->cap;
    _t_Array_2474->elem_size = self->elem_size;
    { Str *_ca = Str_clone(&self->elem_type); _t_Array_2474->elem_type = *_ca; free(_ca); }
    _t_Array_2474->elem_clone = (void *)self->elem_clone;
    _t_Array_2474->elem_delete = (void *)self->elem_delete;
    (void)_t_Array_2474;
    return _t_Array_2474;
}
...
void panic(Str * loc_str, Array * parts) {
    (void)loc_str;
    (void)parts;
    Str *_t_Str_2714 = Str_lit("Str", 3ULL);
    (void)_t_Str_2714;
    TilType *_t_TilType_2715 = TilType_Struct(_t_Str_2714);
    (void)_t_TilType_2715;
    Str_delete(_t_Str_2714, &(Bool){1});
    U32 _t_U32_2716 = 3;
    (void)_t_U32_2716;
    Array *_va_Array_92 = Array_new_newi(_t_TilType_2715, &_t_U32_2716);
    (void)_va_Array_92;
    TilType_delete(_t_TilType_2715, &(Bool){1});
    ;
    U32 _t_U32_2717 = 0;
    (void)_t_U32_2717;
    Str *_t_Str_2718 = Str_clone(loc_str);
    (void)_t_Str_2718;
    Array_set(_va_Array_92, &_t_U32_2717, _t_Str_2718);
    ;
    U32 _t_U32_2719 = 1;
    (void)_t_U32_2719;
    Str *_t_Str_2720 = Str_lit(": panic: ", 9ULL);
    (void)_t_Str_2720;
    Array_set(_va_Array_92, &_t_U32_2719, _t_Str_2720);
    ;
    Array *_t_Array_2721 = Array_clone(parts);
    (void)_t_Array_2721;
    Array_delete(parts, &(Bool){0});
    U32 _t_U32_2722 = 2;
    (void)_t_U32_2722;
    Str *_t_Str_2723 = format(_t_Array_2721);
    (void)_t_Str_2723;
    Array_set(_va_Array_92, &_t_U32_2722, _t_Str_2723);
    ;
...
Bool * assert(Str * loc_str, Bool * cond) {
    (void)loc_str;
    (void)cond;
    Bool _t_Bool_2743 = not(DEREF(cond));
    (void)_t_Bool_2743;
    if (_t_Bool_2743) {
        Str *_t_Str_2738 = Str_lit("Str", 3ULL);
        (void)_t_Str_2738;
        TilType *_t_TilType_2739 = TilType_Struct(_t_Str_2738);
        (void)_t_TilType_2739;
        Str_delete(_t_Str_2738, &(Bool){1});
        U32 _t_U32_2740 = 1;
        (void)_t_U32_2740;
        Array *_va_Array_95 = Array_new_newi(_t_TilType_2739, &_t_U32_2740);
        (void)_va_Array_95;
        TilType_delete(_t_TilType_2739, &(Bool){1});
        ;
        U32 _t_U32_2741 = 0;
        (void)_t_U32_2741;
        Str *_t_Str_2742 = Str_lit("assert failed", 13ULL);
        (void)_t_Str_2742;
        Array_set(_va_Array_95, &_t_U32_2741, _t_Str_2742);
        ;
    ...
    Bool _t_Bool_2744 = 1;
    (void)_t_Bool_2744;
    { Bool *_r = malloc(sizeof(Bool)); *_r = _t_Bool_2744; return _r; }
}
...
void assert_eq(Str * loc_str, I64 * a, I64 * b) {
    ...
    (void)a;
    (void)b;
    Bool _t_Bool_2767 = I64_neq(a, b);
    (void)_t_Bool_2767;
    if (_t_Bool_2767) {
        Str *_t_Str_2754 = Str_lit("Str", 3ULL);
        (void)_t_Str_2754;
        TilType *_t_TilType_2755 = TilType_Struct(_t_Str_2754);
        (void)_t_TilType_2755;
        Str_delete(_t_Str_2754, &(Bool){1});
        U32 _t_U32_2756 = 5;
        (void)_t_U32_2756;
        Array *_va_Array_97 = Array_new_newi(_t_TilType_2755, &_t_U32_2756);
        (void)_va_Array_97;
        TilType_delete(_t_TilType_2755, &(Bool){1});
        ;
        U32 _t_U32_2757 = 0;
        (void)_t_U32_2757;
        Str *_t_Str_2758 = Str_lit("assert_eq failed: expected '", 28ULL);
        (void)_t_Str_2758;
        Array_set(_va_Array_97, &_t_U32_2757, _t_Str_2758);
        ;
        U32 _t_U32_2759 = 1;
        (void)_t_U32_2759;
        Str *_t_Str_2760 = I64_to_str(a);
        (void)_t_Str_2760;
        Array_set(_va_Array_97, &_t_U32_2759, _t_Str_2760);
        ;
        U32 _t_U32_2761 = 2;
        (void)_t_U32_2761;
        Str *_t_Str_2762 = Str_lit("', found '", 10ULL);
        (void)_t_Str_2762;
        Array_set(_va_Array_97, &_t_U32_2761, _t_Str_2762);
        ;
        U32 _t_U32_2763 = 3;
        (void)_t_U32_2763;
        Str *_t_Str_2764 = I64_to_str(b);
        (void)_t_Str_2764;
        Array_set(_va_Array_97, &_t_U32_2763, _t_Str_2764);
        ;
        U32 _t_U32_2765 = 4;
        (void)_t_U32_2765;
        Str *_t_Str_2766 = Str_lit("'", 1ULL);
        (void)_t_Str_2766;
...
void println(Array * parts) {
    (void)parts;
    {
        Array *_fc_Array_2783 = parts;
        (void)_fc_Array_2783;
        U32 _fi_USize_2783 = 0;
        (void)_fi_USize_2783;
        while (1) {
            U32 _t_U32_2785; { U32 *_hp = (U32 *)Array_len(_fc_Array_2783); _t_U32_2785 = *_hp; free(_hp); }
            (void)_t_U32_2785;
            Bool _wcond_Bool_2784 = U32_lt(&_fi_USize_2783, &_t_U32_2785);
            (void)_wcond_Bool_2784;
            ;
            if (_wcond_Bool_2784) {
            } else {
                ;
            ...
            ;
            Str *s = Array_get(_fc_Array_2783, &_fi_USize_2783);
            (void)s;
            U32 _t_U32_2786 = 1;
            (void)_t_U32_2786;
            U32 _t_U32_2787 = U32_add(_fi_USize_2783, _t_U32_2786);
            (void)_t_U32_2787;
            ;
            _fi_USize_2783 = _t_U32_2787;
            ;
            print_single(s);
        }
        ;
...
void test_simple_add(void) {
    ...
    ;
    ;
    Str *_t_Str_2981 = Str_lit("src/test/constfold.til:15:15", 28ULL);
    (void)_t_Str_2981;
    I64 _t_I64_2982 = 3;
    (void)_t_I64_2982;
    assert_eq(_t_Str_2981, &result, &_t_I64_2982);
    ;
    Str_delete(_t_Str_2981, &(Bool){1});
    ;
}
...
void test_nested_arithmetic(void) {
    ...
    ;
    ;
    Str *_t_Str_2989 = Str_lit("src/test/constfold.til:21:15", 28ULL);
    (void)_t_Str_2989;
    I64 _t_I64_2990 = 15;
    (void)_t_I64_2990;
...
void test_deeply_nested(void) {
    ...
    ;
    ;
    Str *_t_Str_2997 = Str_lit("src/test/constfold.til:27:15", 28ULL);
    (void)_t_Str_2997;
    I64 _t_I64_2998 = 26;
    (void)_t_I64_2998;
...
Str * poem(I64 * depth, Str * current, Str * s1, Str * s2) {
    ...
    I64 _t_I64_3006 = 4;
    (void)_t_I64_3006;
    Bool _t_Bool_3007 = I64_eq(DEREF(depth), _t_I64_3006);
    (void)_t_Bool_3007;
    ;
    if (_t_Bool_3007) {
        Str *_t_Str_2999 = Str_lit("\n", 2ULL);
        (void)_t_Str_2999;
        Str *_t_Str_3000 = Str_concat(current, _t_Str_2999);
        (void)_t_Str_3000;
        Str_delete(_t_Str_2999, &(Bool){1});
        ;
        return _t_Str_3000;
    }
    ;
    ...
    (void)_t_I64_3009;
    ;
    Str *_t_Str_3010 = Str_concat(current, s1);
    (void)_t_Str_3010;
    ...
    I64 _t_I64_3012 = 1;
    (void)_t_I64_3012;
    I64 _t_I64_3013 = I64_add(DEREF(depth), _t_I64_3012);
    (void)_t_I64_3013;
    ;
    Str *_t_Str_3014 = Str_concat(current, s2);
    (void)_t_Str_3014;
    Str *_t_Str_3015 = poem(&_t_I64_3013, _t_Str_3014, s1, s2);
    (void)_t_Str_3015;
    ;
    Str_delete(_t_Str_3014, &(Bool){1});
    { Str *_old = result; result = Str_concat(result, _t_Str_3015); Str_delete(_old, &(Bool){1}); }
    Str_delete(_t_Str_3015, &(Bool){1});
    I64 _t_I64_3016 = 2;
    (void)_t_I64_3016;
    Bool _t_Bool_3017 = I64_eq(DEREF(depth), _t_I64_3016);
    (void)_t_Bool_3017;
    ;
    if (_t_Bool_3017) {
        I64 _t_I64_3001 = 1;
        (void)_t_I64_3001;
        Str *_t_Str_3002 = Str_lit("lei", 3ULL);
        (void)_t_Str_3002;
        I64 _t_I64_3003 = I64_add(DEREF(depth), _t_I64_3001);
        (void)_t_I64_3003;
        ;
        Str *_t_Str_3004 = Str_concat(current, _t_Str_3002);
        (void)_t_Str_3004;
        Str_delete(_t_Str_3002, &(Bool){1});
        Str *_t_Str_3005 = poem(&_t_I64_3003, _t_Str_3004, s1, s2);
        (void)_t_Str_3005;
        ;
        Str_delete(_t_Str_3004, &(Bool){1});
        { Str *_old = result; result = Str_concat(result, _t_Str_3005); Str_delete(_old, &(Bool){1}); }
...
Str * make_poem(Str * s1, Str * s2) {
    ...
    I64 _t_I64_3018 = 0;
    (void)_t_I64_3018;
    Str *_t_Str_3019 = Str_lit("", 0ULL);
    (void)_t_Str_3019;
    Str *_t_Str_3020 = poem(&_t_I64_3018, _t_Str_3019, s1, s2);
    (void)_t_Str_3020;
    ;
...
void test_lolalalo(void) {
    Str *_t_Str_3021 = Str_lit("lo", 2ULL);
    (void)_t_Str_3021;
    Str *_t_Str_3022 = Str_lit("la", 2ULL);
    (void)_t_Str_3022;
    Str *lo_la = make_poem(_t_Str_3021, _t_Str_3022);
    (void)lo_la;
    Str_delete(_t_Str_3021, &(Bool){1});
    Str_delete(_t_Str_3022, &(Bool){1});
    Str *_t_Str_3023 = Str_lit("la", 2ULL);
    (void)_t_Str_3023;
    Str *_t_Str_3024 = Str_lit("lo", 2ULL);
    (void)_t_Str_3024;
    Str *la_lo = make_poem(_t_Str_3023, _t_Str_3024);
    (void)la_lo;
    Str_delete(_t_Str_3023, &(Bool){1});
    Str_delete(_t_Str_3024, &(Bool){1});
    Str *_t_Str_3025 = Str_lit("lolalolo", 8ULL);
    (void)_t_Str_3025;
    Str *_t_Str_3026 = Str_lit("src/test/constfold.til:56:12", 28ULL);
    (void)_t_Str_3026;
    Bool _t_Bool_3027 = Str_contains(lo_la, _t_Str_3025);
    (void)_t_Bool_3027;
    ...
    Str *_t_Str_3029 = Str_lit("lalalala", 8ULL);
    (void)_t_Str_3029;
    Str *_t_Str_3030 = Str_lit("src/test/constfold.til:57:12", 28ULL);
    (void)_t_Str_3030;
    Bool _t_Bool_3031 = Str_contains(la_lo, _t_Str_3029);
    (void)_t_Bool_3031;
    ...
    Str *_t_Str_3033 = Str_lit("lolei", 5ULL);
    (void)_t_Str_3033;
    Str *_t_Str_3034 = Str_lit("src/test/constfold.til:59:12", 28ULL);
    (void)_t_Str_3034;
    ...
    Str *_t_Str_3037 = Str_lit("lalei", 5ULL);
    (void)_t_Str_3037;
    Str *_t_Str_3038 = Str_lit("src/test/constfold.til:60:12", 28ULL);
    (void)_t_Str_3038;
