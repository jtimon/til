...
int til_get_substr(til_Str* _ret, til_IndexOutOfBoundsError* _err1, const til_Str* til_Str_s, const til_I64* til_I64_start, const til_I64* til_I64_end) {
    ...
    if (_tmp_get_substr_1.data) {
        ...
        til_Array_new(&_tmp_get_substr_4, _tmp_get_substr_8, &_tmp_get_substr_9);
        int __attribute__((unused)) _arr_status__tmp_get_substr_5;
        til_I64 _tmp_get_substr_10 = 0;
        _arr_status__tmp_get_substr_5 = til_Array_set(&_err_idx__tmp_get_substr_5, &_tmp_get_substr_4, &_tmp_get_substr_10, (til_Dynamic*)&_tmp_get_substr_6);
        til_I64 _tmp_get_substr_11 = 1;
        _arr_status__tmp_get_substr_5 = til_Array_set(&_err_idx__tmp_get_substr_5, &_tmp_get_substr_4, &_tmp_get_substr_11, (til_Dynamic*)&_tmp_get_substr_2);
    ...
    til_Bool _tmp_get_substr_14;
    til_I64_lt(&_tmp_get_substr_14, til_I64_end, &_tmp_get_substr_13);
    if (_tmp_get_substr_14.data) {
        til_Str _tmp_get_substr_15;
        til_I64_to_str(&_tmp_get_substr_15, til_I64_end);
        til_Str _tmp_get_substr_16;
        til_Array _tmp_get_substr_17;
        til_IndexOutOfBoundsError __attribute__((unused)) _err_idx__tmp_get_substr_18;
        til_Str _tmp_get_substr_19 = ((til_Str){((til_Ptr){(til_I64)"get_substr: end index ", 1, 0, 0, 0}), 22, 0});
        ...
        til_Array_new(&_tmp_get_substr_17, _tmp_get_substr_21, &_tmp_get_substr_22);
        int __attribute__((unused)) _arr_status__tmp_get_substr_18;
        til_I64 _tmp_get_substr_23 = 0;
        _arr_status__tmp_get_substr_18 = til_Array_set(&_err_idx__tmp_get_substr_18, &_tmp_get_substr_17, &_tmp_get_substr_23, (til_Dynamic*)&_tmp_get_substr_19);
        til_I64 _tmp_get_substr_24 = 1;
        _arr_status__tmp_get_substr_18 = til_Array_set(&_err_idx__tmp_get_substr_18, &_tmp_get_substr_17, &_tmp_get_substr_24, (til_Dynamic*)&_tmp_get_substr_15);
        til_I64 _tmp_get_substr_25 = 2;
        _arr_status__tmp_get_substr_18 = til_Array_set(&_err_idx__tmp_get_substr_18, &_tmp_get_substr_17, &_tmp_get_substr_25, (til_Dynamic*)&_tmp_get_substr_20);
        til_format(&_tmp_get_substr_16, &((til_Str){((til_Ptr){(til_I64)"src/core/str.til:562:48:", 1, 0, 0, 0}), 24, 0}), &_tmp_get_substr_17);
        til_Array_delete(&_tmp_get_substr_17);
        *_err1 = (til_IndexOutOfBoundsError){.msg = _tmp_get_substr_16};
        return 1;
    }
    til_Bool _tmp_get_substr_26;
    til_I64_gt(&_tmp_get_substr_26, til_I64_start, til_I64_end);
    if (_tmp_get_substr_26.data) {
        til_Str _tmp_get_substr_27;
        til_I64_to_str(&_tmp_get_substr_27, til_I64_start);
        til_Str _tmp_get_substr_28;
        til_I64_to_str(&_tmp_get_substr_28, til_I64_end);
        til_Str _tmp_get_substr_29;
        til_Array _tmp_get_substr_30;
        til_IndexOutOfBoundsError __attribute__((unused)) _err_idx__tmp_get_substr_31;
        til_Str _tmp_get_substr_32 = ((til_Str){((til_Ptr){(til_I64)"get_substr: start index ", 1, 0, 0, 0}), 24, 0});
        til_Str _tmp_get_substr_33 = ((til_Str){((til_Ptr){(til_I64)" is greater than end index ", 1, 0, 0, 0}), 27, 0});
        til_Type _tmp_get_substr_34 = "Str";
        til_I64 _tmp_get_substr_35 = 4;
        til_Array_new(&_tmp_get_substr_30, _tmp_get_substr_34, &_tmp_get_substr_35);
        int __attribute__((unused)) _arr_status__tmp_get_substr_31;
        til_I64 _tmp_get_substr_36 = 0;
        _arr_status__tmp_get_substr_31 = til_Array_set(&_err_idx__tmp_get_substr_31, &_tmp_get_substr_30, &_tmp_get_substr_36, (til_Dynamic*)&_tmp_get_substr_32);
        til_I64 _tmp_get_substr_37 = 1;
        _arr_status__tmp_get_substr_31 = til_Array_set(&_err_idx__tmp_get_substr_31, &_tmp_get_substr_30, &_tmp_get_substr_37, (til_Dynamic*)&_tmp_get_substr_27);
        til_I64 _tmp_get_substr_38 = 2;
        _arr_status__tmp_get_substr_31 = til_Array_set(&_err_idx__tmp_get_substr_31, &_tmp_get_substr_30, &_tmp_get_substr_38, (til_Dynamic*)&_tmp_get_substr_33);
        til_I64 _tmp_get_substr_39 = 3;
        _arr_status__tmp_get_substr_31 = til_Array_set(&_err_idx__tmp_get_substr_31, &_tmp_get_substr_30, &_tmp_get_substr_39, (til_Dynamic*)&_tmp_get_substr_28);
        til_format(&_tmp_get_substr_29, &((til_Str){((til_Ptr){(til_I64)"src/core/str.til:565:48:", 1, 0, 0, 0}), 24, 0}), &_tmp_get_substr_30);
        til_Array_delete(&_tmp_get_substr_30);
        *_err1 = (til_IndexOutOfBoundsError){.msg = _tmp_get_substr_29};
        return 1;
    }
    til_I64 _tmp_get_substr_40 = til_Str_len(til_Str_s);
    til_Bool _tmp_get_substr_41;
    til_I64_gt(&_tmp_get_substr_41, til_I64_end, &_tmp_get_substr_40);
    if (_tmp_get_substr_41.data) {
        ...
        til_Str _tmp_get_substr_49 = ((til_Str){((til_Ptr){(til_I64)" is greater than string length ", 1, 0, 0, 0}), 31, 0});
        til_Type _tmp_get_substr_50 = "Str";
        til_I64 _tmp_get_substr_51 = 4;
        til_Array_new(&_tmp_get_substr_46, _tmp_get_substr_50, &_tmp_get_substr_51);
        int __attribute__((unused)) _arr_status__tmp_get_substr_47;
        til_I64 _tmp_get_substr_52 = 0;
        _arr_status__tmp_get_substr_47 = til_Array_set(&_err_idx__tmp_get_substr_47, &_tmp_get_substr_46, &_tmp_get_substr_52, (til_Dynamic*)&_tmp_get_substr_48);
        til_I64 _tmp_get_substr_53 = 1;
        _arr_status__tmp_get_substr_47 = til_Array_set(&_err_idx__tmp_get_substr_47, &_tmp_get_substr_46, &_tmp_get_substr_53, (til_Dynamic*)&_tmp_get_substr_42);
        til_I64 _tmp_get_substr_54 = 2;
        _arr_status__tmp_get_substr_47 = til_Array_set(&_err_idx__tmp_get_substr_47, &_tmp_get_substr_46, &_tmp_get_substr_54, (til_Dynamic*)&_tmp_get_substr_49);
        til_I64 _tmp_get_substr_55 = 3;
        _arr_status__tmp_get_substr_47 = til_Array_set(&_err_idx__tmp_get_substr_47, &_tmp_get_substr_46, &_tmp_get_substr_55, (til_Dynamic*)&_tmp_get_substr_44);
        til_format(&_tmp_get_substr_45, &((til_Str){((til_Ptr){(til_I64)"src/core/str.til:568:48:", 1, 0, 0, 0}), 24, 0}), &_tmp_get_substr_46);
        til_Array_delete(&_tmp_get_substr_46);
        *_err1 = (til_IndexOutOfBoundsError){.msg = _tmp_get_substr_45};
        return 1;
    }
    til_Bool _tmp_get_substr_56;
    til_I64_eq(&_tmp_get_substr_56, til_I64_start, til_I64_end);
    if (_tmp_get_substr_56.data) {
        *_ret = ((til_Str){((til_Ptr){(til_I64)"", 1, 0, 0, 0}), 0, 0});
        return 0;
    }
    til_Ptr _tmp_get_substr_57 = (til_Ptr){.data = til_I64_NULL, .is_borrowed = 0, .alloc_size = 0, .elem_type = til_I64_NULL, .elem_size = 0};
    til_Str til_Str_substr = {.c_string = _tmp_get_substr_57, ._len = 0, .cap = 0};
    til_Str_substr._len = til_I64_sub(til_I64_end, til_I64_start);
    til_I64 _tmp_get_substr_58 = 1;
    til_Str_substr.cap = til_I64_add(&til_Str_substr._len, &_tmp_get_substr_58);
    til_Ptr _tmp_get_substr_59;
    til_Ptr_new_by_size(&_tmp_get_substr_59, &til_Str_substr.cap);
    til_Str_substr.c_string = _tmp_get_substr_59;
    til_Str_substr.c_string.is_borrowed = 0;
    til_Ptr _tmp_get_substr_60;
    til_Ptr_offset(&_tmp_get_substr_60, &til_Str_s->c_string, til_I64_start);
    til_memcpy(&til_Str_substr.c_string.data, &_tmp_get_substr_60.data, &til_Str_substr._len);
    til_U8 til_U8_zero = 0;
    til_Ptr _tmp_get_substr_61;
    til_Ptr_offset(&_tmp_get_substr_61, &til_Str_substr.c_string, &til_Str_substr._len);
    til_I64 _tmp_get_substr_62 = 1;
    til_memset(&_tmp_get_substr_61.data, &til_U8_zero, &_tmp_get_substr_62);
    *_ret = til_Str_substr;
    return 0;
    return 0;
}
...
void til_assert_eq(const til_Str* til_Str_loc_str, const til_I64* til_I64_a, const til_I64* til_I64_b) {
    ...
    if (_tmp_assert_eq_1.data) {
        ...
        til_Str _tmp_assert_eq_9 = ((til_Str){((til_Ptr){(til_I64)"'", 1, 0, 0, 0}), 1, 0});
        til_Type _tmp_assert_eq_10 = "Str";
        til_I64 _tmp_assert_eq_11 = 6;
        til_Array_new(&_tmp_assert_eq_4, _tmp_assert_eq_10, &_tmp_assert_eq_11);
        int __attribute__((unused)) _arr_status__tmp_assert_eq_5;
        til_I64 _tmp_assert_eq_12 = 0;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_12, (til_Dynamic*)&_tmp_assert_eq_6);
        til_I64 _tmp_assert_eq_13 = 1;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_13, (til_Dynamic*)&_tmp_assert_eq_7);
        til_I64 _tmp_assert_eq_14 = 2;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_14, (til_Dynamic*)&_tmp_assert_eq_2);
        til_I64 _tmp_assert_eq_15 = 3;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_15, (til_Dynamic*)&_tmp_assert_eq_8);
        til_I64 _tmp_assert_eq_16 = 4;
        _arr_status__tmp_assert_eq_5 = til_Array_set(&_err_idx__tmp_assert_eq_5, &_tmp_assert_eq_4, &_tmp_assert_eq_16, (til_Dynamic*)&_tmp_assert_eq_3);
        til_I64 _tmp_assert_eq_17 = 5;
        ...
        til_I64 _tmp_assert_eq_18 = 1;
        til_exit(&_tmp_assert_eq_18);
    }
}
...
int til_Array_get(til_Ptr* _ret, til_IndexOutOfBoundsError* _err1, const til_Array* til_Array_self, const til_I64* til_I64_index) {
    ...
    til_Ptr_offset(_ret, &til_Array_self->ptr, &_tmp_til_Array_get_8);
    return 0;
    return 0;
}
...
int til_I64_safe_add(til_I64* _ret, til_I64_Overflow* _err1, const til_I64* til_I64_a, const til_I64* til_I64_b) {
    ...
    if (_tmp_til_I64_safe_add_1.data) {
        ...
        if (_tmp_til_I64_safe_add_2.data) {
            ...
            til_Str _tmp_til_I64_safe_add_9 = ((til_Str){((til_Ptr){(til_I64)" + ", 1, 0, 0, 0}), 3, 0});
            til_Type _tmp_til_I64_safe_add_10 = "Str";
            til_I64 _tmp_til_I64_safe_add_11 = 4;
            til_Array_new(&_tmp_til_I64_safe_add_6, _tmp_til_I64_safe_add_10, &_tmp_til_I64_safe_add_11);
            int __attribute__((unused)) _arr_status__tmp_til_I64_safe_add_7;
            til_I64 _tmp_til_I64_safe_add_12 = 0;
            _arr_status__tmp_til_I64_safe_add_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_7, &_tmp_til_I64_safe_add_6, &_tmp_til_I64_safe_add_12, (til_Dynamic*)&_tmp_til_I64_safe_add_8);
            til_I64 _tmp_til_I64_safe_add_13 = 1;
            _arr_status__tmp_til_I64_safe_add_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_7, &_tmp_til_I64_safe_add_6, &_tmp_til_I64_safe_add_13, (til_Dynamic*)&_tmp_til_I64_safe_add_3);
            til_I64 _tmp_til_I64_safe_add_14 = 2;
            _arr_status__tmp_til_I64_safe_add_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_7, &_tmp_til_I64_safe_add_6, &_tmp_til_I64_safe_add_14, (til_Dynamic*)&_tmp_til_I64_safe_add_9);
            til_I64 _tmp_til_I64_safe_add_15 = 3;
            _arr_status__tmp_til_I64_safe_add_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_7, &_tmp_til_I64_safe_add_6, &_tmp_til_I64_safe_add_15, (til_Dynamic*)&_tmp_til_I64_safe_add_4);
    ...
    til_Bool _tmp_til_I64_safe_add_17;
    til_I64_lt(&_tmp_til_I64_safe_add_17, til_I64_b, &_tmp_til_I64_safe_add_16);
    if (_tmp_til_I64_safe_add_17.data) {
        til_Bool _tmp_til_I64_safe_add_18;
        til_I64_gt(&_tmp_til_I64_safe_add_18, &til_I64_result, til_I64_a);
        if (_tmp_til_I64_safe_add_18.data) {
            til_Str _tmp_til_I64_safe_add_19;
            til_I64_to_str(&_tmp_til_I64_safe_add_19, til_I64_a);
            til_Str _tmp_til_I64_safe_add_20;
            til_I64_to_str(&_tmp_til_I64_safe_add_20, til_I64_b);
            til_Str _tmp_til_I64_safe_add_21;
            til_Array _tmp_til_I64_safe_add_22;
            til_IndexOutOfBoundsError __attribute__((unused)) _err_idx__tmp_til_I64_safe_add_23;
            til_Str _tmp_til_I64_safe_add_24 = ((til_Str){((til_Ptr){(til_I64)"I64 overflow: ", 1, 0, 0, 0}), 14, 0});
            til_Str _tmp_til_I64_safe_add_25 = ((til_Str){((til_Ptr){(til_I64)" + ", 1, 0, 0, 0}), 3, 0});
            til_Type _tmp_til_I64_safe_add_26 = "Str";
            til_I64 _tmp_til_I64_safe_add_27 = 4;
            til_Array_new(&_tmp_til_I64_safe_add_22, _tmp_til_I64_safe_add_26, &_tmp_til_I64_safe_add_27);
            int __attribute__((unused)) _arr_status__tmp_til_I64_safe_add_23;
            til_I64 _tmp_til_I64_safe_add_28 = 0;
            _arr_status__tmp_til_I64_safe_add_23 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_23, &_tmp_til_I64_safe_add_22, &_tmp_til_I64_safe_add_28, (til_Dynamic*)&_tmp_til_I64_safe_add_24);
            til_I64 _tmp_til_I64_safe_add_29 = 1;
            _arr_status__tmp_til_I64_safe_add_23 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_23, &_tmp_til_I64_safe_add_22, &_tmp_til_I64_safe_add_29, (til_Dynamic*)&_tmp_til_I64_safe_add_19);
            til_I64 _tmp_til_I64_safe_add_30 = 2;
            _arr_status__tmp_til_I64_safe_add_23 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_23, &_tmp_til_I64_safe_add_22, &_tmp_til_I64_safe_add_30, (til_Dynamic*)&_tmp_til_I64_safe_add_25);
            til_I64 _tmp_til_I64_safe_add_31 = 3;
            _arr_status__tmp_til_I64_safe_add_23 = til_Array_set(&_err_idx__tmp_til_I64_safe_add_23, &_tmp_til_I64_safe_add_22, &_tmp_til_I64_safe_add_31, (til_Dynamic*)&_tmp_til_I64_safe_add_20);
            til_format(&_tmp_til_I64_safe_add_21, &((til_Str){((til_Ptr){(til_I64)"src/core/i64.til:41:47:", 1, 0, 0, 0}), 23, 0}), &_tmp_til_I64_safe_add_22);
            til_Array_delete(&_tmp_til_I64_safe_add_22);
            *_err1 = (til_I64_Overflow){.msg = _tmp_til_I64_safe_add_21};
            return 1;
        }
    }
    *_ret = til_I64_result;
...
int til_I64_safe_sub(til_I64* _ret, til_I64_Overflow* _err1, const til_I64* til_I64_a, const til_I64* til_I64_b) {
    ...
    if (_tmp_til_I64_safe_sub_1.data) {
        ...
        if (_tmp_til_I64_safe_sub_2.data) {
            ...
            til_Str _tmp_til_I64_safe_sub_9 = ((til_Str){((til_Ptr){(til_I64)" - ", 1, 0, 0, 0}), 3, 0});
            til_Type _tmp_til_I64_safe_sub_10 = "Str";
            til_I64 _tmp_til_I64_safe_sub_11 = 4;
            til_Array_new(&_tmp_til_I64_safe_sub_6, _tmp_til_I64_safe_sub_10, &_tmp_til_I64_safe_sub_11);
            int __attribute__((unused)) _arr_status__tmp_til_I64_safe_sub_7;
            til_I64 _tmp_til_I64_safe_sub_12 = 0;
            _arr_status__tmp_til_I64_safe_sub_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_7, &_tmp_til_I64_safe_sub_6, &_tmp_til_I64_safe_sub_12, (til_Dynamic*)&_tmp_til_I64_safe_sub_8);
            til_I64 _tmp_til_I64_safe_sub_13 = 1;
            _arr_status__tmp_til_I64_safe_sub_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_7, &_tmp_til_I64_safe_sub_6, &_tmp_til_I64_safe_sub_13, (til_Dynamic*)&_tmp_til_I64_safe_sub_3);
            til_I64 _tmp_til_I64_safe_sub_14 = 2;
            _arr_status__tmp_til_I64_safe_sub_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_7, &_tmp_til_I64_safe_sub_6, &_tmp_til_I64_safe_sub_14, (til_Dynamic*)&_tmp_til_I64_safe_sub_9);
            til_I64 _tmp_til_I64_safe_sub_15 = 3;
            _arr_status__tmp_til_I64_safe_sub_7 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_7, &_tmp_til_I64_safe_sub_6, &_tmp_til_I64_safe_sub_15, (til_Dynamic*)&_tmp_til_I64_safe_sub_4);
    ...
    til_Bool _tmp_til_I64_safe_sub_17;
    til_I64_lt(&_tmp_til_I64_safe_sub_17, til_I64_b, &_tmp_til_I64_safe_sub_16);
    if (_tmp_til_I64_safe_sub_17.data) {
        til_Bool _tmp_til_I64_safe_sub_18;
        til_I64_lt(&_tmp_til_I64_safe_sub_18, &til_I64_result, til_I64_a);
        if (_tmp_til_I64_safe_sub_18.data) {
            til_Str _tmp_til_I64_safe_sub_19;
            til_I64_to_str(&_tmp_til_I64_safe_sub_19, til_I64_a);
            til_Str _tmp_til_I64_safe_sub_20;
            til_I64_to_str(&_tmp_til_I64_safe_sub_20, til_I64_b);
            til_Str _tmp_til_I64_safe_sub_21;
            til_Array _tmp_til_I64_safe_sub_22;
            til_IndexOutOfBoundsError __attribute__((unused)) _err_idx__tmp_til_I64_safe_sub_23;
            til_Str _tmp_til_I64_safe_sub_24 = ((til_Str){((til_Ptr){(til_I64)"I64 underflow: ", 1, 0, 0, 0}), 15, 0});
            til_Str _tmp_til_I64_safe_sub_25 = ((til_Str){((til_Ptr){(til_I64)" - ", 1, 0, 0, 0}), 3, 0});
            til_Type _tmp_til_I64_safe_sub_26 = "Str";
            til_I64 _tmp_til_I64_safe_sub_27 = 4;
            til_Array_new(&_tmp_til_I64_safe_sub_22, _tmp_til_I64_safe_sub_26, &_tmp_til_I64_safe_sub_27);
            int __attribute__((unused)) _arr_status__tmp_til_I64_safe_sub_23;
            til_I64 _tmp_til_I64_safe_sub_28 = 0;
            _arr_status__tmp_til_I64_safe_sub_23 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_23, &_tmp_til_I64_safe_sub_22, &_tmp_til_I64_safe_sub_28, (til_Dynamic*)&_tmp_til_I64_safe_sub_24);
            til_I64 _tmp_til_I64_safe_sub_29 = 1;
            _arr_status__tmp_til_I64_safe_sub_23 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_23, &_tmp_til_I64_safe_sub_22, &_tmp_til_I64_safe_sub_29, (til_Dynamic*)&_tmp_til_I64_safe_sub_19);
            til_I64 _tmp_til_I64_safe_sub_30 = 2;
            _arr_status__tmp_til_I64_safe_sub_23 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_23, &_tmp_til_I64_safe_sub_22, &_tmp_til_I64_safe_sub_30, (til_Dynamic*)&_tmp_til_I64_safe_sub_25);
            til_I64 _tmp_til_I64_safe_sub_31 = 3;
            _arr_status__tmp_til_I64_safe_sub_23 = til_Array_set(&_err_idx__tmp_til_I64_safe_sub_23, &_tmp_til_I64_safe_sub_22, &_tmp_til_I64_safe_sub_31, (til_Dynamic*)&_tmp_til_I64_safe_sub_20);
            til_format(&_tmp_til_I64_safe_sub_21, &((til_Str){((til_Ptr){(til_I64)"src/core/i64.til:59:47:", 1, 0, 0, 0}), 23, 0}), &_tmp_til_I64_safe_sub_22);
            til_Array_delete(&_tmp_til_I64_safe_sub_22);
            *_err1 = (til_I64_Overflow){.msg = _tmp_til_I64_safe_sub_21};
            return 1;
        }
    }
    *_ret = til_I64_result;
...
int til_I64_safe_mul(til_I64* _ret, til_I64_Overflow* _err1, const til_I64* til_I64_a, const til_I64* til_I64_b) {
    ...
    if (_tmp_til_I64_safe_mul_2.data) {
        ...
        if (_tmp_til_I64_safe_mul_5.data) {
            ...
            til_Str _tmp_til_I64_safe_mul_12 = ((til_Str){((til_Ptr){(til_I64)" * ", 1, 0, 0, 0}), 3, 0});
            til_Type _tmp_til_I64_safe_mul_13 = "Str";
            til_I64 _tmp_til_I64_safe_mul_14 = 4;
            til_Array_new(&_tmp_til_I64_safe_mul_9, _tmp_til_I64_safe_mul_13, &_tmp_til_I64_safe_mul_14);
            int __attribute__((unused)) _arr_status__tmp_til_I64_safe_mul_10;
            til_I64 _tmp_til_I64_safe_mul_15 = 0;
            _arr_status__tmp_til_I64_safe_mul_10 = til_Array_set(&_err_idx__tmp_til_I64_safe_mul_10, &_tmp_til_I64_safe_mul_9, &_tmp_til_I64_safe_mul_15, (til_Dynamic*)&_tmp_til_I64_safe_mul_11);
            til_I64 _tmp_til_I64_safe_mul_16 = 1;
            _arr_status__tmp_til_I64_safe_mul_10 = til_Array_set(&_err_idx__tmp_til_I64_safe_mul_10, &_tmp_til_I64_safe_mul_9, &_tmp_til_I64_safe_mul_16, (til_Dynamic*)&_tmp_til_I64_safe_mul_6);
            til_I64 _tmp_til_I64_safe_mul_17 = 2;
            _arr_status__tmp_til_I64_safe_mul_10 = til_Array_set(&_err_idx__tmp_til_I64_safe_mul_10, &_tmp_til_I64_safe_mul_9, &_tmp_til_I64_safe_mul_17, (til_Dynamic*)&_tmp_til_I64_safe_mul_12);
            til_I64 _tmp_til_I64_safe_mul_18 = 3;
            _arr_status__tmp_til_I64_safe_mul_10 = til_Array_set(&_err_idx__tmp_til_I64_safe_mul_10, &_tmp_til_I64_safe_mul_9, &_tmp_til_I64_safe_mul_18, (til_Dynamic*)&_tmp_til_I64_safe_mul_7);
...
int til_Vec_get(til_Ptr* _ret, til_IndexOutOfBoundsError* _err1, const til_Vec* til_Vec_self, const til_I64* til_I64_index) {
    ...
    til_Ptr_offset(_ret, &til_Vec_self->ptr, &_tmp_til_Vec_get_8);
    return 0;
    return 0;
}
...
int til_U8_safe_add(til_U8* _ret, til_U8_Overflow* _err1, const til_U8* til_U8_a, const til_U8* til_U8_b) {
    ...
    if (_tmp_til_U8_safe_add_2.data) {
        ...
        til_Type _tmp_til_U8_safe_add_12 = "Str";
        til_I64 _tmp_til_U8_safe_add_13 = 6;
        til_Array_new(&_tmp_til_U8_safe_add_7, _tmp_til_U8_safe_add_12, &_tmp_til_U8_safe_add_13);
        int __attribute__((unused)) _arr_status__tmp_til_U8_safe_add_8;
        til_I64 _tmp_til_U8_safe_add_14 = 0;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_14, (til_Dynamic*)&_tmp_til_U8_safe_add_9);
        til_I64 _tmp_til_U8_safe_add_15 = 1;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_15, (til_Dynamic*)&_tmp_til_U8_safe_add_3);
        til_I64 _tmp_til_U8_safe_add_16 = 2;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_16, (til_Dynamic*)&_tmp_til_U8_safe_add_10);
        til_I64 _tmp_til_U8_safe_add_17 = 3;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_17, (til_Dynamic*)&_tmp_til_U8_safe_add_4);
        til_I64 _tmp_til_U8_safe_add_18 = 4;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_18, (til_Dynamic*)&_tmp_til_U8_safe_add_11);
        til_I64 _tmp_til_U8_safe_add_19 = 5;
        _arr_status__tmp_til_U8_safe_add_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_add_8, &_tmp_til_U8_safe_add_7, &_tmp_til_U8_safe_add_19, (til_Dynamic*)&_tmp_til_U8_safe_add_5);
...
int til_U8_safe_sub(til_U8* _ret, til_U8_Overflow* _err1, const til_U8* til_U8_a, const til_U8* til_U8_b) {
    ...
    if (_tmp_til_U8_safe_sub_3.data) {
        ...
        til_Type _tmp_til_U8_safe_sub_13 = "Str";
        til_I64 _tmp_til_U8_safe_sub_14 = 6;
        til_Array_new(&_tmp_til_U8_safe_sub_8, _tmp_til_U8_safe_sub_13, &_tmp_til_U8_safe_sub_14);
        int __attribute__((unused)) _arr_status__tmp_til_U8_safe_sub_9;
        til_I64 _tmp_til_U8_safe_sub_15 = 0;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_15, (til_Dynamic*)&_tmp_til_U8_safe_sub_10);
        til_I64 _tmp_til_U8_safe_sub_16 = 1;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_16, (til_Dynamic*)&_tmp_til_U8_safe_sub_4);
        til_I64 _tmp_til_U8_safe_sub_17 = 2;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_17, (til_Dynamic*)&_tmp_til_U8_safe_sub_11);
        til_I64 _tmp_til_U8_safe_sub_18 = 3;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_18, (til_Dynamic*)&_tmp_til_U8_safe_sub_5);
        til_I64 _tmp_til_U8_safe_sub_19 = 4;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_19, (til_Dynamic*)&_tmp_til_U8_safe_sub_12);
        til_I64 _tmp_til_U8_safe_sub_20 = 5;
        _arr_status__tmp_til_U8_safe_sub_9 = til_Array_set(&_err_idx__tmp_til_U8_safe_sub_9, &_tmp_til_U8_safe_sub_8, &_tmp_til_U8_safe_sub_20, (til_Dynamic*)&_tmp_til_U8_safe_sub_6);
...
int til_U8_safe_mul(til_U8* _ret, til_U8_Overflow* _err1, const til_U8* til_U8_a, const til_U8* til_U8_b) {
    ...
    if (_tmp_til_U8_safe_mul_2.data) {
        ...
        til_Type _tmp_til_U8_safe_mul_12 = "Str";
        til_I64 _tmp_til_U8_safe_mul_13 = 6;
        til_Array_new(&_tmp_til_U8_safe_mul_7, _tmp_til_U8_safe_mul_12, &_tmp_til_U8_safe_mul_13);
        int __attribute__((unused)) _arr_status__tmp_til_U8_safe_mul_8;
        til_I64 _tmp_til_U8_safe_mul_14 = 0;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_14, (til_Dynamic*)&_tmp_til_U8_safe_mul_9);
        til_I64 _tmp_til_U8_safe_mul_15 = 1;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_15, (til_Dynamic*)&_tmp_til_U8_safe_mul_3);
        til_I64 _tmp_til_U8_safe_mul_16 = 2;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_16, (til_Dynamic*)&_tmp_til_U8_safe_mul_10);
        til_I64 _tmp_til_U8_safe_mul_17 = 3;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_17, (til_Dynamic*)&_tmp_til_U8_safe_mul_4);
        til_I64 _tmp_til_U8_safe_mul_18 = 4;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_18, (til_Dynamic*)&_tmp_til_U8_safe_mul_11);
        til_I64 _tmp_til_U8_safe_mul_19 = 5;
        _arr_status__tmp_til_U8_safe_mul_8 = til_Array_set(&_err_idx__tmp_til_U8_safe_mul_8, &_tmp_til_U8_safe_mul_7, &_tmp_til_U8_safe_mul_19, (til_Dynamic*)&_tmp_til_U8_safe_mul_5);
...
void til_HeapState_remove(const til_I64* til_I64_ptr) {
    ...
    til_Array_new(&_tmp_til_HeapState_remove_22, _tmp_til_HeapState_remove_25, &_tmp_til_HeapState_remove_26);
    int __attribute__((unused)) _arr_status__tmp_til_HeapState_remove_23;
    til_I64 _tmp_til_HeapState_remove_27 = 0;
    _arr_status__tmp_til_HeapState_remove_23 = til_Array_set(&_err_idx__tmp_til_HeapState_remove_23, &_tmp_til_HeapState_remove_22, &_tmp_til_HeapState_remove_27, (til_Dynamic*)&_tmp_til_HeapState_remove_24);
    til_I64 _tmp_til_HeapState_remove_28 = 1;
    _arr_status__tmp_til_HeapState_remove_23 = til_Array_set(&_err_idx__tmp_til_HeapState_remove_23, &_tmp_til_HeapState_remove_22, &_tmp_til_HeapState_remove_28, (til_Dynamic*)&_tmp_til_HeapState_remove_21);
...
void til_HeapState_report(void) {
    ...
    til_Str _tmp_til_HeapState_report_19 = ((til_Str){((til_Ptr){(til_I64)" allocations, ", 1, 0, 0, 0}), 14, 0});
    til_Str _tmp_til_HeapState_report_20 = ((til_Str){((til_Ptr){(til_I64)" bytes", 1, 0, 0, 0}), 6, 0});
    til_Type _tmp_til_HeapState_report_21 = "Str";
    til_I64 _tmp_til_HeapState_report_22 = 4;
    til_Array_new(&_tmp_til_HeapState_report_17, _tmp_til_HeapState_report_21, &_tmp_til_HeapState_report_22);
    int __attribute__((unused)) _arr_status__tmp_til_HeapState_report_18;
    til_I64 _tmp_til_HeapState_report_23 = 0;
    _arr_status__tmp_til_HeapState_report_18 = til_Array_set(&_err_idx__tmp_til_HeapState_report_18, &_tmp_til_HeapState_report_17, &_tmp_til_HeapState_report_23, (til_Dynamic*)&_tmp_til_HeapState_report_14);
    til_I64 _tmp_til_HeapState_report_24 = 1;
    _arr_status__tmp_til_HeapState_report_18 = til_Array_set(&_err_idx__tmp_til_HeapState_report_18, &_tmp_til_HeapState_report_17, &_tmp_til_HeapState_report_24, (til_Dynamic*)&_tmp_til_HeapState_report_19);
    til_I64 _tmp_til_HeapState_report_25 = 2;
    _arr_status__tmp_til_HeapState_report_18 = til_Array_set(&_err_idx__tmp_til_HeapState_report_18, &_tmp_til_HeapState_report_17, &_tmp_til_HeapState_report_25, (til_Dynamic*)&_tmp_til_HeapState_report_15);
    til_I64 _tmp_til_HeapState_report_26 = 3;
    ...
    til_Array _tmp_til_HeapState_report_27;
    til_IndexOutOfBoundsError __attribute__((unused)) _err_idx__tmp_til_HeapState_report_28;
    til_Type _tmp_til_HeapState_report_29 = "Str";
    til_I64 _tmp_til_HeapState_report_30 = 1;
    til_Array_new(&_tmp_til_HeapState_report_27, _tmp_til_HeapState_report_29, &_tmp_til_HeapState_report_30);
    int __attribute__((unused)) _arr_status__tmp_til_HeapState_report_28;
    til_I64 _tmp_til_HeapState_report_31 = 0;
    _arr_status__tmp_til_HeapState_report_28 = til_Array_set(&_err_idx__tmp_til_HeapState_report_28, &_tmp_til_HeapState_report_27, &_tmp_til_HeapState_report_31, (til_Dynamic*)&_tmp_til_HeapState_report_16);
    til_println(&_tmp_til_HeapState_report_27);
    til_Array_delete(&_tmp_til_HeapState_report_27);
}
