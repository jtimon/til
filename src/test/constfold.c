...
int til_get_substr(til_Str* _ret, til_IndexOutOfBoundsError* _err1, til_AllocError* _err2, const til_Str* til_s, const til_I64* til_start, const til_I64* til_end) {
    if (til_lt(til_start, &(til_I64){0}).data) {
        ...
        int _status__tmp_get_substr_1 = til_format(&_tmp_get_substr_0, &_err0__tmp_get_substr_1, &_err1__tmp_get_substr_1, &_err2__tmp_get_substr_1, &((til_Str){(til_I64)"src/core/str.til:405:48:", 24}), &_tmp_get_substr_2);
        ...
        int _status__tmp_get_substr_13 = til_format(&_tmp_get_substr_12, &_err0__tmp_get_substr_13, &_err1__tmp_get_substr_13, &_err2__tmp_get_substr_13, &((til_Str){(til_I64)"src/core/str.til:405:48:", 24}), &_tmp_get_substr_14);
    ...
    if (til_lt(til_end, &(til_I64){0}).data) {
        ...
        int _status__tmp_get_substr_25 = til_format(&_tmp_get_substr_24, &_err0__tmp_get_substr_25, &_err1__tmp_get_substr_25, &_err2__tmp_get_substr_25, &((til_Str){(til_I64)"src/core/str.til:408:48:", 24}), &_tmp_get_substr_26);
        ...
        int _status__tmp_get_substr_37 = til_format(&_tmp_get_substr_36, &_err0__tmp_get_substr_37, &_err1__tmp_get_substr_37, &_err2__tmp_get_substr_37, &((til_Str){(til_I64)"src/core/str.til:408:48:", 24}), &_tmp_get_substr_38);
    ...
    if (til_gt(til_start, til_end).data) {
        ...
        int _status__tmp_get_substr_49 = til_format(&_tmp_get_substr_48, &_err0__tmp_get_substr_49, &_err1__tmp_get_substr_49, &_err2__tmp_get_substr_49, &((til_Str){(til_I64)"src/core/str.til:411:48:", 24}), &_tmp_get_substr_50);
        ...
        int _status__tmp_get_substr_63 = til_format(&_tmp_get_substr_62, &_err0__tmp_get_substr_63, &_err1__tmp_get_substr_63, &_err2__tmp_get_substr_63, &((til_Str){(til_I64)"src/core/str.til:411:48:", 24}), &_tmp_get_substr_64);
    ...
    if (til_gt(til_end, &(til_I64){til_Str_len(til_s)}).data) {
        ...
        int _status__tmp_get_substr_77 = til_format(&_tmp_get_substr_76, &_err0__tmp_get_substr_77, &_err1__tmp_get_substr_77, &_err2__tmp_get_substr_77, &((til_Str){(til_I64)"src/core/str.til:414:48:", 24}), &_tmp_get_substr_78);
        ...
        int _status__tmp_get_substr_91 = til_format(&_tmp_get_substr_90, &_err0__tmp_get_substr_91, &_err1__tmp_get_substr_91, &_err2__tmp_get_substr_91, &((til_Str){(til_I64)"src/core/str.til:414:48:", 24}), &_tmp_get_substr_92);
    ...
    if (til_I64_eq(til_start, til_end).data) {
        *_ret = ((til_Str){(til_I64)"", 0});
        return 0;
    }
    til_Str til_substr = {.c_string = 0, .cap = 0};
    til_substr.cap = til_sub(til_end, til_start);
    til_I64 _tmp_get_substr_105 = til_add(&til_substr.cap, &(til_I64){1});
    til_I64 _ret__tmp_get_substr_104;
    til_AllocError _err0__tmp_get_substr_104 = {};
    int _status__tmp_get_substr_104 = til_malloc(&_ret__tmp_get_substr_104, &_err0__tmp_get_substr_104, &_tmp_get_substr_105);
    if (_status__tmp_get_substr_104 == 1) { *_err2 = _err0__tmp_get_substr_104; return 2; }
    til_substr.c_string = _ret__tmp_get_substr_104;
    if (til_I64_eq(&til_NULL, &til_substr.c_string).data) {
        til_Str _tmp_get_substr_106;
        til_I64_OverflowError _err0__tmp_get_substr_107;
        til_IndexOutOfBoundsError _err1__tmp_get_substr_107;
        til_AllocError _err2__tmp_get_substr_107;
        til_Array _tmp_get_substr_108;
        til_AllocError _err_alloc__tmp_get_substr_109;
        til_IndexOutOfBoundsError _err_idx__tmp_get_substr_109;
        til_Str _tmp_get_substr_110 = ((til_Str){(til_I64)"Str.get_substr: failed to allocate ", 35});
        til_Str _tmp_get_substr_111 = til_I64_to_str(&(til_I64){til_add(&til_substr.cap, &(til_I64){1})});
        til_Str _tmp_get_substr_112 = ((til_Str){(til_I64)" bytes", 6});
        til_Type _tmp_get_substr_113 = "Str";
        til_I64 _tmp_get_substr_114 = 3;
        int _arr_status__tmp_get_substr_109 = til_Array_new(&_tmp_get_substr_108, &_err_alloc__tmp_get_substr_109, _tmp_get_substr_113, &_tmp_get_substr_114);
        if (_arr_status__tmp_get_substr_109 != 0) {
            *_err2 = _err_alloc__tmp_get_substr_109; return 2;
        }
        til_I64 _tmp_get_substr_115 = 0;
        _arr_status__tmp_get_substr_109 = til_Array_set(&_err_idx__tmp_get_substr_109, &_tmp_get_substr_108, &_tmp_get_substr_115, (til_Dynamic*)&_tmp_get_substr_110);
        if (_arr_status__tmp_get_substr_109 != 0) {
            *_err1 = _err_idx__tmp_get_substr_109; return 1;
        }
        til_I64 _tmp_get_substr_116 = 1;
        _arr_status__tmp_get_substr_109 = til_Array_set(&_err_idx__tmp_get_substr_109, &_tmp_get_substr_108, &_tmp_get_substr_116, (til_Dynamic*)&_tmp_get_substr_111);
        if (_arr_status__tmp_get_substr_109 != 0) {
            *_err1 = _err_idx__tmp_get_substr_109; return 1;
        }
        til_I64 _tmp_get_substr_117 = 2;
        _arr_status__tmp_get_substr_109 = til_Array_set(&_err_idx__tmp_get_substr_109, &_tmp_get_substr_108, &_tmp_get_substr_117, (til_Dynamic*)&_tmp_get_substr_112);
        if (_arr_status__tmp_get_substr_109 != 0) {
            *_err1 = _err_idx__tmp_get_substr_109; return 1;
        }
        int _status__tmp_get_substr_107 = til_format(&_tmp_get_substr_106, &_err0__tmp_get_substr_107, &_err1__tmp_get_substr_107, &_err2__tmp_get_substr_107, &((til_Str){(til_I64)"src/core/str.til:425:37:", 24}), &_tmp_get_substr_108);
        ...
        til_Array_delete(&_tmp_get_substr_108);
        til_Str _tmp_get_substr_118;
        til_I64_OverflowError _err0__tmp_get_substr_119;
        til_IndexOutOfBoundsError _err1__tmp_get_substr_119;
        til_AllocError _err2__tmp_get_substr_119;
        til_Array _tmp_get_substr_120;
        til_AllocError _err_alloc__tmp_get_substr_121;
        til_IndexOutOfBoundsError _err_idx__tmp_get_substr_121;
        til_Str _tmp_get_substr_122 = ((til_Str){(til_I64)"Str.get_substr: failed to allocate ", 35});
        til_Str _tmp_get_substr_123 = til_I64_to_str(&(til_I64){til_add(&til_substr.cap, &(til_I64){1})});
        til_Str _tmp_get_substr_124 = ((til_Str){(til_I64)" bytes", 6});
        til_Type _tmp_get_substr_125 = "Str";
        til_I64 _tmp_get_substr_126 = 3;
        int _arr_status__tmp_get_substr_121 = til_Array_new(&_tmp_get_substr_120, &_err_alloc__tmp_get_substr_121, _tmp_get_substr_125, &_tmp_get_substr_126);
        if (_arr_status__tmp_get_substr_121 != 0) {
            *_err2 = _err_alloc__tmp_get_substr_121; return 2;
        }
        til_I64 _tmp_get_substr_127 = 0;
        _arr_status__tmp_get_substr_121 = til_Array_set(&_err_idx__tmp_get_substr_121, &_tmp_get_substr_120, &_tmp_get_substr_127, (til_Dynamic*)&_tmp_get_substr_122);
        if (_arr_status__tmp_get_substr_121 != 0) {
            *_err1 = _err_idx__tmp_get_substr_121; return 1;
        }
        til_I64 _tmp_get_substr_128 = 1;
        _arr_status__tmp_get_substr_121 = til_Array_set(&_err_idx__tmp_get_substr_121, &_tmp_get_substr_120, &_tmp_get_substr_128, (til_Dynamic*)&_tmp_get_substr_123);
        if (_arr_status__tmp_get_substr_121 != 0) {
            *_err1 = _err_idx__tmp_get_substr_121; return 1;
        }
        til_I64 _tmp_get_substr_129 = 2;
        _arr_status__tmp_get_substr_121 = til_Array_set(&_err_idx__tmp_get_substr_121, &_tmp_get_substr_120, &_tmp_get_substr_129, (til_Dynamic*)&_tmp_get_substr_124);
        if (_arr_status__tmp_get_substr_121 != 0) {
            *_err1 = _err_idx__tmp_get_substr_121; return 1;
        }
        int _status__tmp_get_substr_119 = til_format(&_tmp_get_substr_118, &_err0__tmp_get_substr_119, &_err1__tmp_get_substr_119, &_err2__tmp_get_substr_119, &((til_Str){(til_I64)"src/core/str.til:425:37:", 24}), &_tmp_get_substr_120);
        ...
        til_Array_delete(&_tmp_get_substr_120);
        *_err2 = (til_AllocError){.msg = _tmp_get_substr_118};
        return 2;
    }
    til_I64 _tmp_get_substr_130 = til_add(&til_s->c_string, til_start);
    til_memcpy(&til_substr.c_string, &_tmp_get_substr_130, &til_substr.cap);
    const til_U8 til_zero = 0;
    til_I64 _tmp_get_substr_131 = til_add(&til_substr.c_string, &til_substr.cap);
    til_I64 _tmp_get_substr_132 = 1;
    til_memset(&_tmp_get_substr_131, &til_zero, &_tmp_get_substr_132);
    *_ret = til_substr;
    return 0;
}
...
int til_format(til_Str* _ret, til_I64_OverflowError* _err1, til_IndexOutOfBoundsError* _err2, til_AllocError* _err3, const til_Str* til_prefix, til_Array* til_args) {
    ...
    if (til_lt(&(til_I64){0}, &(til_I64){til_Array_len(til_args)}).data) {
        while (til_lt(&til_i, &(til_I64){til_Array_len(til_args)}).data) {
            ...
            if (til_lt(&til_result.cap, &til_arg.cap).data) {
                ...
                int _status__tmp_format_2 = til_format(&_tmp_format_1, &_err0__tmp_format_2, &_err1__tmp_format_2, &_err2__tmp_format_2, &((til_Str){(til_I64)"src/core/str.til:519:48:", 24}), &_tmp_format_3);
                ...
                int _status__tmp_format_12 = til_format(&_tmp_format_11, &_err0__tmp_format_12, &_err1__tmp_format_12, &_err2__tmp_format_12, &((til_Str){(til_I64)"src/core/str.til:519:48:", 24}), &_tmp_format_13);
        ...
        while (til_gt(&til_i, &(til_I64){til_Array_len(til_args)}).data) {
            ...
            if (til_lt(&til_result.cap, &til_arg.cap).data) {
                ...
                int _status__tmp_format_23 = til_format(&_tmp_format_22, &_err0__tmp_format_23, &_err1__tmp_format_23, &_err2__tmp_format_23, &((til_Str){(til_I64)"src/core/str.til:519:48:", 24}), &_tmp_format_24);
                ...
                int _status__tmp_format_33 = til_format(&_tmp_format_32, &_err0__tmp_format_33, &_err1__tmp_format_33, &_err2__tmp_format_33, &((til_Str){(til_I64)"src/core/str.til:519:48:", 24}), &_tmp_format_34);
    ...
    if (til_I64_eq(&til_NULL, &til_result.c_string).data) {
        ...
        int _status__tmp_format_45 = til_format(&_tmp_format_44, &_err0__tmp_format_45, &_err1__tmp_format_45, &_err2__tmp_format_45, &((til_Str){(til_I64)"src/core/str.til:525:37:", 24}), &_tmp_format_46);
        ...
        int _status__tmp_format_55 = til_format(&_tmp_format_54, &_err0__tmp_format_55, &_err1__tmp_format_55, &_err2__tmp_format_55, &((til_Str){(til_I64)"src/core/str.til:525:37:", 24}), &_tmp_format_56);
    ...
    while (til_lt(&_for_i_format_0, &(til_I64){til_Array_len(til_args)}).data) {
        ...
        if (0) { _catch_IndexOutOfBoundsError__tmp_format_64:
            ...
            til_panic(&((til_Str){(til_I64)"src/core/str.til:532:5:", 23}), &til_err.msg, &_tmp_format_66);
...
int til_Vec_push(til_AllocError* _err1, til_Vec* til_self, const til_Dynamic* til_value) {
    ...
    if (til_I64_eq(&til_self->_len, &til_self->cap).data) {
        ...
        if (til_gt(&til_new_cap, &til_Vec_MAX_CAP).data) {
            ...
            til_panic(&((til_Str){(til_I64)"src/core/vec.til:92:23:", 23}), &((til_Str){(til_I64)"Vec.push: capacity exceeded Vec.MAX_CAP", 39}), &_tmp_til_Vec_push_1);
...
int til_Vec_get(til_IndexOutOfBoundsError* _err1, const til_Vec* til_self, const til_I64* til_index, til_Dynamic* til_T) {
    if (til_I64_gteq(til_index, &til_self->_len).data) {
        ...
        int _status__tmp_til_Vec_get_1 = til_format(&_tmp_til_Vec_get_0, &_err0__tmp_til_Vec_get_1, &_err1__tmp_til_Vec_get_1, &_err2__tmp_til_Vec_get_1, &((til_Str){(til_I64)"src/core/vec.til:114:52:", 24}), &_tmp_til_Vec_get_2);
        ...
        int _status__tmp_til_Vec_get_9 = til_format(&_tmp_til_Vec_get_8, &_err0__tmp_til_Vec_get_9, &_err1__tmp_til_Vec_get_9, &_err2__tmp_til_Vec_get_9, &((til_Str){(til_I64)"src/core/vec.til:114:52:", 24}), &_tmp_til_Vec_get_10);
...
int til_Str_clone(til_Str* _ret, til_AllocError* _err1, const til_Str* til_self) {
    ...
    if (til_I64_eq(&til_NULL, &til_cloned.c_string).data) {
        ...
        int _status__tmp_til_Str_clone_3 = til_format(&_tmp_til_Str_clone_2, &_err0__tmp_til_Str_clone_3, &_err1__tmp_til_Str_clone_3, &_err2__tmp_til_Str_clone_3, &((til_Str){(til_I64)"src/core/str.til:50:41:", 23}), &_tmp_til_Str_clone_4);
        ...
        int _status__tmp_til_Str_clone_15 = til_format(&_tmp_til_Str_clone_14, &_err0__tmp_til_Str_clone_15, &_err1__tmp_til_Str_clone_15, &_err2__tmp_til_Str_clone_15, &((til_Str){(til_I64)"src/core/str.til:50:41:", 23}), &_tmp_til_Str_clone_16);
...
til_U8 til_Str_char_at(const til_Str* til_self, const til_I64* til_index) {
    til_U8 til_zero;
    if (til_lt(til_index, &(til_I64){0}).data) {
        til_zero = 0;
        return til_zero;
    }
    if (til_I64_gteq(til_index, &(til_I64){til_Str_len(til_self)}).data) {
        til_zero = 0;
        return til_zero;
    }
    til_U8 til_byte_val = 0;
    til_I64 _tmp_til_Str_char_at_0 = (til_I64)&til_byte_val;
    til_I64 _tmp_til_Str_char_at_1 = til_add(&til_self->c_string, til_index);
    til_I64 _tmp_til_Str_char_at_2 = 1;
    til_memcpy(&_tmp_til_Str_char_at_0, &_tmp_til_Str_char_at_1, &_tmp_til_Str_char_at_2);
    return til_byte_val;
}
