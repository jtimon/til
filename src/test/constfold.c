...
void panic(Str * loc_str, Array * parts) {
    (void)loc_str;
    (void)parts;
    Str *_t_Str_2616 = Str_lit("Str", 3ULL);
    (void)_t_Str_2616;
    U32 _t_U32_2617 = 3;
    (void)_t_U32_2617;
    Array *_va_Array_92 = Array_new(_t_Str_2616, &_t_U32_2617);
    (void)_va_Array_92;
    Str_delete(_t_Str_2616, &(Bool){1});
    ;
    U32 _t_U32_2618 = 0;
    (void)_t_U32_2618;
    Str *_t_Str_2619 = Str_clone(loc_str);
    (void)_t_Str_2619;
    Array_set(_va_Array_92, &_t_U32_2618, _t_Str_2619);
    ;
    U32 _t_U32_2620 = 1;
    (void)_t_U32_2620;
    Str *_t_Str_2621 = Str_lit(": panic: ", 9ULL);
    (void)_t_Str_2621;
    Array_set(_va_Array_92, &_t_U32_2620, _t_Str_2621);
    ;
    Array *_t_Array_2622 = Array_clone(parts);
    (void)_t_Array_2622;
    Array_delete(parts, &(Bool){0});
    U32 _t_U32_2623 = 2;
    (void)_t_U32_2623;
    Str *_t_Str_2624 = format(_t_Array_2622);
    (void)_t_Str_2624;
...
Bool * assert(Str * loc_str, Bool * cond) {
    (void)loc_str;
    (void)cond;
    Bool _t_Bool_2641 = not(DEREF(cond));
    (void)_t_Bool_2641;
    if (_t_Bool_2641) {
        Str *_t_Str_2637 = Str_lit("Str", 3ULL);
        (void)_t_Str_2637;
        U32 _t_U32_2638 = 1;
        (void)_t_U32_2638;
        Array *_va_Array_95 = Array_new(_t_Str_2637, &_t_U32_2638);
        (void)_va_Array_95;
        Str_delete(_t_Str_2637, &(Bool){1});
        ;
        U32 _t_U32_2639 = 0;
        (void)_t_U32_2639;
        Str *_t_Str_2640 = Str_lit("assert failed", 13ULL);
        (void)_t_Str_2640;
        Array_set(_va_Array_95, &_t_U32_2639, _t_Str_2640);
        ;
    ...
    Bool _t_Bool_2642 = 1;
    (void)_t_Bool_2642;
    { Bool *_r = malloc(sizeof(Bool)); *_r = _t_Bool_2642; return _r; }
}
...
void assert_eq(Str * loc_str, I64 * a, I64 * b) {
    ...
    (void)a;
    (void)b;
    Bool _t_Bool_2663 = I64_neq(a, b);
    (void)_t_Bool_2663;
    if (_t_Bool_2663) {
        Str *_t_Str_2651 = Str_lit("Str", 3ULL);
        (void)_t_Str_2651;
        U32 _t_U32_2652 = 5;
        (void)_t_U32_2652;
        Array *_va_Array_97 = Array_new(_t_Str_2651, &_t_U32_2652);
        (void)_va_Array_97;
        Str_delete(_t_Str_2651, &(Bool){1});
        ;
        U32 _t_U32_2653 = 0;
        (void)_t_U32_2653;
        Str *_t_Str_2654 = Str_lit("assert_eq failed: expected '", 28ULL);
        (void)_t_Str_2654;
        Array_set(_va_Array_97, &_t_U32_2653, _t_Str_2654);
        ;
        U32 _t_U32_2655 = 1;
        (void)_t_U32_2655;
        Str *_t_Str_2656 = I64_to_str(a);
        (void)_t_Str_2656;
        Array_set(_va_Array_97, &_t_U32_2655, _t_Str_2656);
        ;
        U32 _t_U32_2657 = 2;
        (void)_t_U32_2657;
        Str *_t_Str_2658 = Str_lit("', found '", 10ULL);
        (void)_t_Str_2658;
        Array_set(_va_Array_97, &_t_U32_2657, _t_Str_2658);
        ;
        U32 _t_U32_2659 = 3;
        (void)_t_U32_2659;
        Str *_t_Str_2660 = I64_to_str(b);
        (void)_t_Str_2660;
        Array_set(_va_Array_97, &_t_U32_2659, _t_Str_2660);
        ;
        U32 _t_U32_2661 = 4;
        (void)_t_U32_2661;
        Str *_t_Str_2662 = Str_lit("'", 1ULL);
        (void)_t_Str_2662;
...
void println(Array * parts) {
    (void)parts;
    {
        Array *_fc_Array_2678 = parts;
        (void)_fc_Array_2678;
        U32 _fi_USize_2678 = 0;
        (void)_fi_USize_2678;
        while (1) {
            U32 _t_U32_2680; { U32 *_hp = (U32 *)Array_len(_fc_Array_2678); _t_U32_2680 = *_hp; free(_hp); }
            (void)_t_U32_2680;
            Bool _wcond_Bool_2679 = U32_lt(&_fi_USize_2678, &_t_U32_2680);
            (void)_wcond_Bool_2679;
            ;
            if (_wcond_Bool_2679) {
            } else {
                ;
            ...
            ;
            Str *s = Array_get(_fc_Array_2678, &_fi_USize_2678);
            (void)s;
            U32 _t_U32_2681 = 1;
            (void)_t_U32_2681;
            U32 _t_U32_2682 = U32_add(_fi_USize_2678, _t_U32_2681);
            (void)_t_U32_2682;
            ;
            _fi_USize_2678 = _t_U32_2682;
            ;
            print_single(s);
        }
        ;
...
void test_simple_add(void) {
    ...
    ;
    ;
    Str *_t_Str_2870 = Str_lit("src/test/constfold.til:15:15", 28ULL);
    (void)_t_Str_2870;
    I64 _t_I64_2871 = 3;
    (void)_t_I64_2871;
    assert_eq(_t_Str_2870, &result, &_t_I64_2871);
    ;
    Str_delete(_t_Str_2870, &(Bool){1});
    ;
}
...
void test_nested_arithmetic(void) {
    ...
    ;
    ;
    Str *_t_Str_2878 = Str_lit("src/test/constfold.til:21:15", 28ULL);
    (void)_t_Str_2878;
    I64 _t_I64_2879 = 15;
    (void)_t_I64_2879;
    assert_eq(_t_Str_2878, &result, &_t_I64_2879);
    ;
    Str_delete(_t_Str_2878, &(Bool){1});
    ;
}
...
void test_deeply_nested(void) {
    ...
    ;
    ;
    Str *_t_Str_2886 = Str_lit("src/test/constfold.til:27:15", 28ULL);
    (void)_t_Str_2886;
    I64 _t_I64_2887 = 26;
    (void)_t_I64_2887;
    assert_eq(_t_Str_2886, &result, &_t_I64_2887);
    ;
    Str_delete(_t_Str_2886, &(Bool){1});
    ;
}
...
Str * poem(I64 * depth, Str * current, Str * s1, Str * s2) {
    ...
    I64 _t_I64_2895 = 4;
    (void)_t_I64_2895;
    Bool _t_Bool_2896 = I64_eq(DEREF(depth), _t_I64_2895);
    (void)_t_Bool_2896;
    ;
    if (_t_Bool_2896) {
        Str *_t_Str_2888 = Str_lit("\n", 2ULL);
        (void)_t_Str_2888;
        Str *_t_Str_2889 = Str_concat(current, _t_Str_2888);
        (void)_t_Str_2889;
    ...
    I64 _t_I64_2897 = 1;
    (void)_t_I64_2897;
    I64 _t_I64_2898 = I64_add(DEREF(depth), _t_I64_2897);
    (void)_t_I64_2898;
    ;
    Str *_t_Str_2899 = Str_concat(current, s1);
    (void)_t_Str_2899;
    ...
    (void)_t_I64_2902;
    ;
    Str *_t_Str_2903 = Str_concat(current, s2);
    (void)_t_Str_2903;
    ...
    I64 _t_I64_2905 = 2;
    (void)_t_I64_2905;
    Bool _t_Bool_2906 = I64_eq(DEREF(depth), _t_I64_2905);
    (void)_t_Bool_2906;
    ;
    if (_t_Bool_2906) {
        I64 _t_I64_2890 = 1;
        (void)_t_I64_2890;
        Str *_t_Str_2891 = Str_lit("lei", 3ULL);
        (void)_t_Str_2891;
        I64 _t_I64_2892 = I64_add(DEREF(depth), _t_I64_2890);
        (void)_t_I64_2892;
        ;
        Str *_t_Str_2893 = Str_concat(current, _t_Str_2891);
        (void)_t_Str_2893;
        Str_delete(_t_Str_2891, &(Bool){1});
        Str *_t_Str_2894 = poem(&_t_I64_2892, _t_Str_2893, s1, s2);
        (void)_t_Str_2894;
        ;
        Str_delete(_t_Str_2893, &(Bool){1});
        { Str *_old = result; result = Str_concat(result, _t_Str_2894); Str_delete(_old, &(Bool){1}); }
...
void test_lolalalo(void) {
    Str *_t_Str_2910 = Str_lit("lo", 2ULL);
    (void)_t_Str_2910;
    Str *_t_Str_2911 = Str_lit("la", 2ULL);
    (void)_t_Str_2911;
    Str *lo_la = make_poem(_t_Str_2910, _t_Str_2911);
    (void)lo_la;
    ...
    (void)_t_Str_2913;
    Str *la_lo = make_poem(_t_Str_2912, _t_Str_2913);
    (void)la_lo;
    Str_delete(_t_Str_2912, &(Bool){1});
    Str_delete(_t_Str_2913, &(Bool){1});
    Str *_t_Str_2914 = Str_lit("lolalolo", 8ULL);
    (void)_t_Str_2914;
    Str *_t_Str_2915 = Str_lit("src/test/constfold.til:56:12", 28ULL);
    (void)_t_Str_2915;
    Bool _t_Bool_2916 = Str_contains(lo_la, _t_Str_2914);
    (void)_t_Bool_2916;
    Str_delete(_t_Str_2914, &(Bool){1});
    Bool _t_Bool_2917; { Bool *_hp = (Bool *)assert(_t_Str_2915, &_t_Bool_2916); _t_Bool_2917 = *_hp; free(_hp); }
    (void)_t_Bool_2917;
    ;
    ;
    Str_delete(_t_Str_2915, &(Bool){1});
    Str *_t_Str_2918 = Str_lit("lalalala", 8ULL);
    (void)_t_Str_2918;
    Str *_t_Str_2919 = Str_lit("src/test/constfold.til:57:12", 28ULL);
    (void)_t_Str_2919;
    Bool _t_Bool_2920 = Str_contains(la_lo, _t_Str_2918);
    (void)_t_Bool_2920;
    ...
    Str *_t_Str_2922 = Str_lit("lolei", 5ULL);
    (void)_t_Str_2922;
    Str *_t_Str_2923 = Str_lit("src/test/constfold.til:59:12", 28ULL);
    (void)_t_Str_2923;
    Bool _t_Bool_2924 = Str_contains(lo_la, _t_Str_2922);
    (void)_t_Bool_2924;
    ...
    Str *_t_Str_2926 = Str_lit("lalei", 5ULL);
    (void)_t_Str_2926;
    Str *_t_Str_2927 = Str_lit("src/test/constfold.til:60:12", 28ULL);
    (void)_t_Str_2927;
    Bool _t_Bool_2928 = Str_contains(la_lo, _t_Str_2926);
    (void)_t_Bool_2928;
