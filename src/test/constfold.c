...
void til_panic(const til_Str* til_loc_str, const til_Str* til_msg, til_Array* til_extra_msgs) {
    ...
    while (til_I64_lt(&_for_i_panic_0, &(til_I64){til_Array_len(til_extra_msgs)}).data) {
        ...
        _for_i_panic_0 = til_I64_add(&_for_i_panic_0, &(til_I64){1});
    }
...
void til_println(til_Array* til_args) {
    ...
    while (til_I64_lt(&_for_i_println_0, &(til_I64){til_Array_len(til_args)}).data) {
        ...
        _for_i_println_0 = til_I64_add(&_for_i_println_0, &(til_I64){1});
    }
    til_single_print(&((til_Str){(til_I64)"\n", 1}));
    til_print_flush();
}
...
til_Str til_concat(const til_Str* til_a, const til_Str* til_b) {
    ...
    if (til_I64_lt(&til_result.cap, &til_a->cap).data) {
        ...
        til_panic(&((til_Str){(til_I64)"src/core/str.til:572:15:", 24}), &((til_Str){(til_I64)"concat: integer overflow", 24}), &_tmp_concat_1);
    ...
    if (0) { _catch_BadAlloc__tmp_concat_0:;
        ...
        til_panic(&((til_Str){(til_I64)"src/core/str.til:576:35:", 24}), &((til_Str){(til_I64)"concat: malloc failed", 21}), &_tmp_concat_7);
...
til_Str til_format(const til_Str* til_prefix, til_Array* til_args) {
    ...
    if (til_I64_lt(&(til_I64){0}, &(til_I64){til_Array_len(til_args)}).data) {
        while (til_I64_lt(&til_i, &(til_I64){til_Array_len(til_args)}).data) {
            ...
            if (til_I64_lt(&til_result.cap, &til_arg.cap).data) {
                ...
                til_panic(&((til_Str){(til_I64)"src/core/str.til:597:19:", 24}), &((til_Str){(til_I64)"format: integer overflow while summing cap", 42}), &_tmp_format_3);
        ...
        while (til_I64_gt(&til_i, &(til_I64){til_Array_len(til_args)}).data) {
            ...
            if (til_I64_lt(&til_result.cap, &til_arg.cap).data) {
                ...
                til_panic(&((til_Str){(til_I64)"src/core/str.til:597:19:", 24}), &((til_Str){(til_I64)"format: integer overflow while summing cap", 42}), &_tmp_format_8);
    ...
    if (0) { _catch_BadAlloc__tmp_format_0:;
        ...
        til_panic(&((til_Str){(til_I64)"src/core/str.til:602:35:", 24}), &((til_Str){(til_I64)"format: malloc failed", 21}), &_tmp_format_14);
    ...
    til_Str til_s;
    while (til_I64_lt(&_for_i_format_0, &(til_I64){til_Array_len(til_args)}).data) {
        ...
        if (0) { _catch_IndexOutOfBoundsError__tmp_format_18:;
            ...
            til_panic(&((til_Str){(til_I64)"src/core/str.til:608:5:", 23}), &til_err.msg, &_tmp_format_20);
        ...
        _for_i_format_0 = til_I64_add(&_for_i_format_0, &(til_I64){1});
    }
    const til_U8 til_zero = 0;
    ...
    if (0) { _catch_IndexOutOfBoundsError__tmp_format_1:;
        ...
        til_panic(&((til_Str){(til_I64)"src/core/str.til:618:15:", 24}), &til_err.msg, &_tmp_format_27);
