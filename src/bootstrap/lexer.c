...
void Str_push_str(Str * self, Str * s) {
    ...
    if (_t741) {
        ...
        ;
        Str *_t734 = Str_lit("/home/user/til/src/core/str.til:55:19", 37ULL);
        (void)_t734;
        panic(_t734, _va13);
    ...
    if (_t742) {
        ...
        ;
        Str *_t740 = Str_lit("/home/user/til/src/core/str.til:59:19", 37ULL);
        (void)_t740;
        panic(_t740, _va14);
...
I64 * Str_to_i64(Str * self) {
    ...
    if (_t990) {
        ...
        ;
        Str *_t951 = Str_lit("/home/user/til/src/core/str.til:206:37", 38ULL);
        (void)_t951;
        panic(_t951, _va15);
    ...
    *_t991 = 0;
    ...
    if (_t994) {
        ...
        ;
        Str *_t959 = Str_lit("/home/user/til/src/core/str.til:215:41", 38ULL);
        (void)_t959;
        panic(_t959, _va16);
    ...
    ;
    {
        ...
        while (1) {
            ...
            if (_t983) {
                ...
                ;
                Str *_t971 = Str_lit("/home/user/til/src/core/str.til:220:23", 38ULL);
                (void)_t971;
                panic(_t971, _va17);
...
void * Vec_get(Vec * self, U64 * i) {
    ...
    if (_t1041) {
        ...
        ;
        Str *_t1040 = Str_lit("/home/user/til/src/core/vec.til:31:19", 37ULL);
        (void)_t1040;
        panic(_t1040, _va18);
...
void * Tuple_get(Tuple * self, U64 * i) {
    ...
    if (_t1166) {
        ...
        ;
        Str *_t1154 = Str_lit("/home/user/til/src/core/tuple.til:36:19", 39ULL);
        (void)_t1154;
        panic(_t1154, _va19);
