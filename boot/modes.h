...
void infer_set_lit_expr(TypeScope * scope, Expr * expr, I32 in_func);
...
void infer_func_def_expr(TypeScope * scope, Expr * expr);
...
Bool desugar_for_in_range_stmt(TypeScope * scope, Expr * body, U32 stmt_idx, I32 in_func);
Bool desugar_for_in_collection_stmt(TypeScope * scope, Expr * body, U32 stmt_idx, I32 in_func);
void infer_body_stmt(TypeScope * scope, Expr * body, U32 * i, I32 in_func, I32 in_loop, I32 returns_ref, I32 in_type_body);
