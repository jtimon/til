...
void priv___src_self_garbager_til__collect_scope_locals(Expr * body, TypeScope * scope, Bool is_program_scope, priv___src_self_garbager_til__BodyFacts * facts, FactIndex * fi, Vec__LocalInfo * locals_vec);
...
Bool priv___src_self_builder_til__is_own_param(Str * name, Context * ctx);
