...
void __doc_init__(Str * kinds_data, Str * docs_data);
...
void fold_subtree(Scope * scope, Expr * e);
...
Expr * make_register_call(Str * callee_name, Str * name, Str * payload, Str * path, U32 line, U32 col);
