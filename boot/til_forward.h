...
Str * Array__Str_get(Array__Str * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
void Array__Str_unsafe_set(Array__Str * self, USize i, Str * val);
void Array__Str_set(Array__Str * self, USize i, Str * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
Str * Vec__Str_get(Vec__Str * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
void Vec__Str_truncate(Vec__Str * self, USize n);
void Vec__Str_unsafe_set(Vec__Str * self, USize i, Str * val);
void Vec__Str_set(Vec__Str * self, USize i, Str * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
Bool * Array__Bool_get(Array__Bool * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
void Array__Bool_unsafe_set(Array__Bool * self, USize i, Bool * val);
void Array__Bool_set(Array__Bool * self, USize i, Bool * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
Bool * Vec__Bool_get(Vec__Bool * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
I64 * Vec__I64_get(Vec__I64 * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
FieldLayout * Vec__FieldLayout_get(Vec__FieldLayout * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
Declaration * Vec__Declaration_get(Vec__Declaration * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
Expr * Vec__Expr_get(Vec__Expr * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
Expr * Vec__Expr_pop(Vec__Expr * self);
void Vec__Expr_unsafe_set(Vec__Expr * self, USize i, Expr * val);
void Vec__Expr_set(Vec__Expr * self, USize i, Expr * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
U32 * Vec__U32_get(Vec__U32 * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
Token * Vec__Token_get(Vec__Token * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
void * Vec__Dynamic_get(Vec__Dynamic * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
priv___src_self_typer_til__CtorArg * Vec__CtorArg_get(Vec__CtorArg * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
void Vec__CtorArg_unsafe_set(Vec__CtorArg * self, USize i, priv___src_self_typer_til__CtorArg * val);
void Vec__CtorArg_set(Vec__CtorArg * self, USize i, priv___src_self_typer_til__CtorArg * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
priv___src_self_typer_til__CoverageNode * Vec__CoverageNode_get(Vec__CoverageNode * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
ProgramUnit * Vec__ProgramUnit_get(Vec__ProgramUnit * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
DocEntry * Vec__DocEntry_get(Vec__DocEntry * self, USize * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
