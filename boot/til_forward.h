...
void lower_throw_catch_in_block(Expr * body, Expr * root_body, Vec * type_to_tag_names);
...
void validate_throws_in_expr(Expr * e, Vec * pending, Vec * seen, Str * path);
void validate_throws_in_body(Expr * body, Vec * pending, Vec * seen, Str * path);
void validate_throws_in_func_body(Expr * body, Vec * fdef_throws, Str * path);
void lower_throw_catch_in_func_body(Expr * body, Vec * fdef_throws);
