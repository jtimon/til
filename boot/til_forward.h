...
File * emit_expr(File * f, Expr * e, I32 depth);
...
File * priv___src_self_builder_til__emit_deref(File * f, Expr * e, I32 depth);
File * emit_as_ptr(File * f, Expr * e, I32 depth, Bool is_own);
...
void priv___src_self_builder_til__emit_struct_field_branches(File * f, I32 kind);
void emit_struct_introspection_bodies(File * f);
