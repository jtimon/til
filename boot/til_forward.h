...
Str * decl_kind(Expr * stmt);
void append_packed_entry(Str * packed, Str * name, Str * value);
void collect_decl_packed(Expr * body, Str * kinds, Str * docs);
U32 * packed_capacity(Expr * body);
Str * doc_init_src_line(Expr * core_ast, Expr * user_ast);
...
Expr * find_size_method(Expr * stmt);
void emit_dyn_size_of_branch(File * f, Expr * stmt);
