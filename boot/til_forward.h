...
void priv___src_self_scavenger_til__children_filter_expr(Vec__Expr * v, void * marks, USize n);
void priv___src_self_scavenger_til__children_filter_decl(Vec__Declaration * v, void * marks, USize n);
