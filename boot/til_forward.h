...
Expr * priv___src_self_context_til__func_defs_lookup_one(Map * m, Str * name);
...
Expr * priv___src_self_initer_til__init_macro_pick_return(Expr * body, Map * subs);
Bool priv___src_self_initer_til__init_is_macro_inst_call(Expr * e, Map * macros);
Bool priv___src_self_initer_til__init_is_direct_macro_inst_decl(Expr * stmt, Map * macros);
...
void priv___src_self_typer_til__rewrite_variadic_fcall_args(Expr * fcall, Str * va_name, I32 vi, U32 vc);
...
Bool priv___src_self_typer_til__desugar_pure_splat_variadic_call(Expr * fcall, I32 vi, U32 vc);
