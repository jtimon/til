...
void generate_unity_derived_methods(Expr * program, TypeScope * _scope);
void generate_size_methods(Expr * program, TypeScope * _scope);
void generate_cmp_derived_methods(Expr * program, TypeScope * _scope);
...
I32 init_declarations(Expr * program, TypeScope * scope, Context * _ctx);
void * Vec_take(Vec * v);
...
void emit_fcall_funcptr_cast(File * f, Expr * e, Expr * sig, I32 _depth);
...
void emit_struct_funcs(File * f, Str * name, Expr * struct_def, Bool _is_lib);
...
I32 build_forward_header(Expr * core_program, Expr * program, Str * fwd_path, Context * _ctx);
I32 build_header(Expr * core_program, Expr * program, Str * h_path, Context * _ctx);
void emit_binding_ns_methods(File * f, Expr * body);
I32 build_til_binding(Expr * _core_program, Expr * program, Str * til_path, Str * lib_name, Context * _ctx);
...
I32 build_python_binding(Expr * _core_program, Expr * program, Str * py_path, Str * lib_name, Context * _ctx);
...
I32 build(Expr * core_program, Expr * program, Mode * mode, Bool run_tests, Str * _path, Str * c_output_path, Context * _ctx);
