...
U64 Array__Dynamic_size(void);
Str * format(Array__Str * parts);
Str * concat3(Str * a, Str * b, Str * c);
U64 Str_len(Str * self);
I8 * Str_get(Str * self, U64 * i);
I8 * Str_unsafe_get(Str * self, U64 * i);
...
U64 KeyNotFound_size(void);
Array__Str * Array__Str_new(U64 cap);
U64 Array__Str_len(Array__Str * self);
Str * Array__Str_unsafe_get(Array__Str * self, U64 * i);
Str * Array__Str_get(Array__Str * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
...
U64 Vec__Str_len(Vec__Str * self);
void Vec__Str_clear(Vec__Str * self);
void Vec__Str_push(Vec__Str * self, Str * val);
void Vec__Str_move_from(Vec__Str * self, Vec__Str * other);
Str * Vec__Str_unsafe_get(Vec__Str * self, U64 * i);
Str * Vec__Str_get(Vec__Str * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
Str * Vec__Str_pop(Vec__Str * self);
void Vec__Str_unsafe_set(Vec__Str * self, U64 i, Str * val);
void Vec__Str_set(Vec__Str * self, U64 i, Str * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
...
I8 * IdentData_unsafe_get(IdentData * self, U64 * i);
I8 * IdentData_get(IdentData * self, U64 * i);
...
void set_own_arg(Expr * fcall, U64 arg_index);
Bool get_own_arg(Expr * fcall, U64 arg_index);
...
Bool priv___src_core_ast_til__lazy_stmts_inlinable(Expr * body, U64 start);
...
U64 fcall_kwargs_count(Expr * fcall);
U64 fcall_variadic_count(Expr * fcall, U64 nparam, Bool callee_has_kwargs);
Map__I64_Str * Map__I64_Str_new(void);
U64 Map__I64_Str_len(Map__I64_Str * self);
...
U64 Vec__Bool_len(Vec__Bool * self);
void Vec__Bool_clear(Vec__Bool * self);
void Vec__Bool_push(Vec__Bool * self, Bool * val);
Bool * Vec__Bool_unsafe_get(Vec__Bool * self, U64 * i);
Bool * Vec__Bool_get(Vec__Bool * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
void Vec__Bool_delete(Vec__Bool * self, Bool call_free);
Vec__Bool * Vec__Bool_clone(Vec__Bool * self);
U64 Vec__Bool_size(void);
Vec__I64 * Vec__I64_new(void);
U64 Vec__I64_len(Vec__I64 * self);
void Vec__I64_clear(Vec__I64 * self);
void Vec__I64_push(Vec__I64 * self, I64 * val);
I64 * Vec__I64_unsafe_get(Vec__I64 * self, U64 * i);
I64 * Vec__I64_get(Vec__I64 * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
void Vec__I64_unsafe_set(Vec__I64 * self, U64 i, I64 * val);
void Vec__I64_delete(Vec__I64 * self, Bool call_free);
Vec__I64 * Vec__I64_clone(Vec__I64 * self);
U64 Vec__I64_size(void);
Vec__FieldLayout * Vec__FieldLayout_new(void);
U64 Vec__FieldLayout_len(Vec__FieldLayout * self);
void Vec__FieldLayout_clear(Vec__FieldLayout * self);
void Vec__FieldLayout_push(Vec__FieldLayout * self, FieldLayout * val);
FieldLayout * Vec__FieldLayout_unsafe_get(Vec__FieldLayout * self, U64 * i);
FieldLayout * Vec__FieldLayout_get(Vec__FieldLayout * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
...
U64 Vec__FieldLayout_size(void);
Vec__Declaration * Vec__Declaration_new(void);
U64 Vec__Declaration_len(Vec__Declaration * self);
...
Declaration * Vec__Declaration_unsafe_get(Vec__Declaration * self, U64 * i);
Declaration * Vec__Declaration_get(Vec__Declaration * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
Declaration * Vec__Declaration_pop(Vec__Declaration * self);
void Vec__Declaration_delete(Vec__Declaration * self, Bool call_free);
Vec__Declaration * Vec__Declaration_clone(Vec__Declaration * self);
U64 Vec__Declaration_size(void);
Vec__Expr * Vec__Expr_new(void);
Vec__Expr * Vec__Expr_with_capacity(U64 n);
U64 Vec__Expr_len(Vec__Expr * self);
...
Expr * Vec__Expr_unsafe_get(Vec__Expr * self, U64 * i);
Expr * Vec__Expr_get(Vec__Expr * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
Expr * Vec__Expr_pop(Vec__Expr * self);
void Vec__Expr_unsafe_set(Vec__Expr * self, U64 i, Expr * val);
void Vec__Expr_set(Vec__Expr * self, U64 i, Expr * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
void Vec__Expr_push_take(Vec__Expr * self, Vec__Expr * src, U64 i);
...
U64 Vec__U64_len(Vec__U64 * self);
void Vec__U64_clear(Vec__U64 * self);
void Vec__U64_push(Vec__U64 * self, U64 * val);
U64 * Vec__U64_unsafe_get(Vec__U64 * self, U64 * i);
U64 * Vec__U64_get(Vec__U64 * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
void Vec__U64_delete(Vec__U64 * self, Bool call_free);
Vec__U64 * Vec__U64_clone(Vec__U64 * self);
U64 Vec__U64_size(void);
...
U64 priv___src_self_lexer_til__scan_to_eol(Str * src, U64 from, U64 src_len);
void priv___src_self_lexer_til__push_tok(Vec__Token * tokens, TokenType * type, U64 start, U64 len, U32 line, U32 col);
void priv___src_self_lexer_til__emit_doc_block_lines(Vec__Token * tokens, Str * src, U64 from, U64 to, U32 doc_line, U32 col);
...
U64 priv___src_self_parser_til__Parser_size(void);
...
void builtin_primitive_size_align(Primitive * prim, U64 * sz, U64 * al);
...
U64 Set__Str_len(Set__Str * self);
...
U64 Set__Str_size(void);
Map__Str_Str * Map__Str_Str_new(void);
U64 Map__Str_Str_len(Map__Str_Str * self);
...
U64 Map__Str_Str_size(void);
EvalHeap EvalHeap_new(void);
void * EvalHeap_heap_alloc(U64 size);
...
U64 BuilderFuncScratch_size(void);
...
Expr * make_is_tag_check_fcall(Str * arg_name, Str * ename, Str * vname, U64 tag_size, U32 line, U32 col);
...
U64 enum_tag_size(Expr * enum_def);
...
U64 Map__Str_TypeBinding_size(void);
...
U64 Map__Str_FuncType_size(void);
...
U64 Map__Str_Value_size(void);
Vec__Dynamic * Vec__Dynamic_new(void);
U64 Vec__Dynamic_len(Vec__Dynamic * self);
void Vec__Dynamic_clear(Vec__Dynamic * self);
void Vec__Dynamic_push(Vec__Dynamic * self, void * val);
void * Vec__Dynamic_unsafe_get(Vec__Dynamic * self, U64 * i);
void * Vec__Dynamic_get(Vec__Dynamic * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
void Vec__Dynamic_unsafe_set(Vec__Dynamic * self, U64 i, void * val);
...
U64 Map__Str_call_Vec_Str_size(void);
...
U64 Map__Str_Dynamic_size(void);
...
U64 Map__Str_FFIEntry_size(void);
...
U64 Map__Str_ExprPtrBox_size(void);
Vec__FFITypePtrBox * Vec__FFITypePtrBox_new(void);
U64 Vec__FFITypePtrBox_len(Vec__FFITypePtrBox * self);
...
FFITypePtrBox * Vec__FFITypePtrBox_unsafe_get(Vec__FFITypePtrBox * self, U64 * i);
...
U64 Vec__FFITypePtrBox_size(void);
Vec__TypeBinding * Vec__TypeBinding_new(void);
U64 Vec__TypeBinding_len(Vec__TypeBinding * self);
void Vec__TypeBinding_clear(Vec__TypeBinding * self);
TypeBinding * Vec__TypeBinding_unsafe_get(Vec__TypeBinding * self, U64 * i);
void Vec__TypeBinding_unsafe_set(Vec__TypeBinding * self, U64 i, TypeBinding * val);
...
U64 Vec__TypeBinding_size(void);
Vec__Mode * Vec__Mode_new(void);
void Vec__Mode_clear(Vec__Mode * self);
Mode * Vec__Mode_unsafe_get(Vec__Mode * self, U64 * i);
void Vec__Mode_unsafe_set(Vec__Mode * self, U64 i, Mode * val);
...
void Vec__FuncType_unsafe_set(Vec__FuncType * self, U64 i, FuncType * val);
void Vec__FuncType_delete(Vec__FuncType * self, Bool call_free);
Vec__FuncType * Vec__FuncType_clone(Vec__FuncType * self);
U64 Vec__FuncType_size(void);
Vec__Value * Vec__Value_new(void);
U64 Vec__Value_len(Vec__Value * self);
void Vec__Value_clear(Vec__Value * self);
void Vec__Value_push(Vec__Value * self, Value * val);
Value * Vec__Value_unsafe_get(Vec__Value * self, U64 * i);
void Vec__Value_unsafe_set(Vec__Value * self, U64 i, Value * val);
...
void Vec__call_Vec_Str_unsafe_set(Vec__call_Vec_Str * self, U64 i, Vec__Str * val);
...
U64 Vec__call_Vec_Str_size(void);
Vec__FFIEntry * Vec__FFIEntry_new(void);
U64 Vec__FFIEntry_len(Vec__FFIEntry * self);
void Vec__FFIEntry_clear(Vec__FFIEntry * self);
FFIEntry * Vec__FFIEntry_unsafe_get(Vec__FFIEntry * self, U64 * i);
void Vec__FFIEntry_unsafe_set(Vec__FFIEntry * self, U64 i, FFIEntry * val);
void Vec__FFIEntry_delete(Vec__FFIEntry * self, Bool call_free);
Vec__FFIEntry * Vec__FFIEntry_clone(Vec__FFIEntry * self);
U64 Vec__FFIEntry_size(void);
Vec__ExprPtrBox * Vec__ExprPtrBox_new(void);
void Vec__ExprPtrBox_clear(Vec__ExprPtrBox * self);
ExprPtrBox * Vec__ExprPtrBox_unsafe_get(Vec__ExprPtrBox * self, U64 * i);
void Vec__ExprPtrBox_unsafe_set(Vec__ExprPtrBox * self, U64 i, ExprPtrBox * val);
...
U64 Vec__ExprPtrBox_size(void);
Bool priv___src_self_initer_til__is_dynamic_type(Str * name);
Bool priv___src_self_initer_til__primitive_type_info(Str * name, TypeScope * scope, Primitive * prim, U64 * sz, U64 * al, Bool * is_builtin);
...
void priv___src_self_initer_til__type_size_align(Str * ftype, TypeScope * scope, Context * ctx, U64 * sz, U64 * al);
U64 compute_enum_layout(Str * name, Expr * enum_def, TypeScope * scope, Context * ctx);
U64 ctx_total_size(Str * name, Context * ctx);
...
void priv___src_self_initer_til__init_generic_expand_call(Expr * parent, U64 call_idx, Str * gname, Expr * gfd_expr, Map__Str_Expr * generics, Map__Str_Str * seen, Vec__Expr * synthesized, Context * ctx);
...
U64 count_ast_imports(Expr * body);
...
void priv___src_self_typer_til__rewrite_til_type_arg(TypeScope * scope, Expr * parent, U64 arg_idx, Type * ptype, I32 in_func, Context * ctx);
...
U64 priv___src_self_typer_til__CtorArg_size(void);
...
void infer_body_stmt(TypeScope * scope, Expr * body, U64 * i, I32 in_func, I32 in_loop, I32 returns_ref, I32 in_type_body, Context * ctx);
...
I32 priv___src_self_typer_til__type_repl_delta_decls_from(Expr * program, U64 start_idx, Context * ctx);
...
U64 priv___src_self_typer_til__CoverageNode_size(void);
...
U64 priv___src_self_typer_til__lower_matches_in_stmt(TypeScope * scope, Expr * body, U64 stmt_idx, I32 in_func, I32 in_loop, I32 returns_ref, Context * ctx);
...
Bool priv___src_self_typer_til__infer_switch_stmt(TypeScope * scope, Expr * body, U64 stmt_idx, I32 in_func, I32 in_loop, I32 returns_ref, Context * ctx);
Bool priv___src_self_typer_til__desugar_for_in_range_stmt(TypeScope * scope, Expr * body, U64 stmt_idx, I32 in_func, Context * ctx);
Bool priv___src_self_typer_til__desugar_for_in_collection_stmt(TypeScope * scope, Expr * body, U64 stmt_idx, I32 in_func, Context * ctx);
...
Bool priv___src_self_typer_til__desugar_for_in_kv_stmt(TypeScope * scope, Expr * body, U64 stmt_idx, I32 in_func, Context * ctx);
Vec__CtorArg * Vec__CtorArg_new(void);
U64 Vec__CtorArg_len(Vec__CtorArg * self);
void Vec__CtorArg_clear(Vec__CtorArg * self);
void Vec__CtorArg_push(Vec__CtorArg * self, priv___src_self_typer_til__CtorArg * val);
priv___src_self_typer_til__CtorArg * Vec__CtorArg_unsafe_get(Vec__CtorArg * self, U64 * i);
priv___src_self_typer_til__CtorArg * Vec__CtorArg_get(Vec__CtorArg * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
void Vec__CtorArg_unsafe_set(Vec__CtorArg * self, U64 i, priv___src_self_typer_til__CtorArg * val);
void Vec__CtorArg_set(Vec__CtorArg * self, U64 i, priv___src_self_typer_til__CtorArg * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
void Vec__CtorArg_delete(Vec__CtorArg * self, Bool call_free);
Vec__CtorArg * Vec__CtorArg_clone(Vec__CtorArg * self);
U64 Vec__CtorArg_size(void);
...
priv___src_self_typer_til__CoverageNode * Vec__CoverageNode_unsafe_get(Vec__CoverageNode * self, U64 * i);
priv___src_self_typer_til__CoverageNode * Vec__CoverageNode_get(Vec__CoverageNode * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
...
Str * priv___src_self_desugarer_til__guess_prior_local_type_in_vec(Vec__Expr * stmts, U64 upto, Str * var_name);
void priv___src_self_desugarer_til__seed_prior_local_types(Context * ctx, Vec__Expr * stmts, U64 upto);
...
Bool priv___src_self_desugarer_til__has_prior_throw_type_in_vec(Vec__Expr * stmts, Expr * root_body, U64 upto, Str * type_name);
...
void priv___src_self_desugarer_til__hoist_walk_consolidated(Context * ctx, Expr * parent, U64 child_idx, Expr * body, Vec__Expr * pre_stmts, Vec__Str * types_to_declare, Vec__Str * seen);
...
void splice_stmts_before(Expr * body, U64 idx, Vec__Expr * pre);
...
void replace_switch_stmt_with_block(Expr * body, U64 stmt_idx, Expr * block);
...
void replace_body_stmt_with_block(Expr * body, U64 stmt_idx, Expr * block);
...
Expr * priv___src_self_desugarer_til__build_variadic_array_decl(Expr * fcall, TypeScope * scope, Str * elem_type, Str * va_name, U64 vc, Context * ctx);
...
Expr * priv___src_self_desugarer_til__build_variadic_array_set(Expr * fcall, TypeScope * scope, Str * elem_type, Str * va_name, I32 vi, U64 j, Context * ctx);
Expr * priv___src_self_desugarer_til__build_builtin_vec_decl(Expr * fcall, Str * elem_type, Str * vec_name);
Expr * priv___src_self_desugarer_til__build_builtin_vec_push(Expr * fcall, TypeScope * scope, Str * elem_type, Str * vec_name, U64 j, Context * ctx);
...
Bool priv___src_self_desugarer_til__fcall_variant_ctor_arg_is_own(Expr * expr, U64 i, TypeScope * scope);
...
void priv___src_self_desugarer_til__rewrite_variadic_fcall_args(Expr * fcall, Str * va_name, Str * array_type, I32 vi, U64 vc);
U64 priv___src_self_desugarer_til__fcall_variadic_count_via_scope(Expr * fcall, TypeScope * scope);
...
Bool priv___src_self_desugarer_til__desugar_pure_splat_variadic_call(Expr * fcall, Str * array_type, I32 vi, U64 vc);
...
U64 Vec__LocalInfo_len(Vec__LocalInfo * self);
...
priv___src_self_garbager_til__LocalInfo * Vec__LocalInfo_unsafe_get(Vec__LocalInfo * self, U64 * i);
void Vec__LocalInfo_delete(Vec__LocalInfo * self, Bool call_free);
Vec__LocalInfo * Vec__LocalInfo_clone(Vec__LocalInfo * self);
U64 Vec__LocalInfo_size(void);
...
Bool priv___src_self_constfolder_til__va_elements_known(Expr * body, U64 decl_idx, Str * va, Context * ctx);
...
Bool priv___src_self_constfolder_til__materialize_va(Scope * scope, Expr * body, U64 decl_idx, Str * va, Context * ctx);
...
void priv___src_self_scavenger_til__children_filter_expr(Vec__Expr * v, void * marks, U64 n);
void priv___src_self_scavenger_til__children_filter_decl(Vec__Declaration * v, void * marks, U64 n);
...
U64 priv___src_self_scavenger_til__dyn_call_real_arg_count(Expr * e);
...
U64 priv___src_self_loader_til__DeclRef_size(void);
...
U64 ReplCoreDocCache_size(void);
...
Expr * priv___src_self_loader_til__lazy_build_guard_chain(Expr * body, U64 i, U64 n);
Expr * priv___src_self_loader_til__lazy_body_as_expr(Expr * body);
Bool priv___src_self_loader_til__inline_lazy_call(Expr * parent, U64 call_idx, Expr * fdef);
Expr * priv___src_self_loader_til__lazy_eff_arg_clone(Expr * call, Bool is_method, U64 k);
Expr * priv___src_self_loader_til__lazy_build_fold(Expr * call, Bool is_method, U64 lo, U64 hi, Str * name, U32 line, U32 col);
void priv___src_self_loader_til__lazy_try_fold_nary(Expr * parent, U64 idx, Expr * fdef, Str * name);
...
Bool priv___src_self_loader_til__lazy_param_shadowed(Expr * e, Set__Str * pnames, I32 depth);
void priv___src_self_loader_til__lazy_autoforce(Expr * e, Set__Str * pnames, I32 depth);
...
U64 Map__Str_DeclRef_size(void);
Vec__ProgramUnit * Vec__ProgramUnit_new(void);
U64 Vec__ProgramUnit_len(Vec__ProgramUnit * self);
void Vec__ProgramUnit_clear(Vec__ProgramUnit * self);
void Vec__ProgramUnit_push(Vec__ProgramUnit * self, ProgramUnit * val);
ProgramUnit * Vec__ProgramUnit_unsafe_get(Vec__ProgramUnit * self, U64 * i);
ProgramUnit * Vec__ProgramUnit_get(Vec__ProgramUnit * self, U64 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds, Str * loc);
...
void Vec__DeclRef_unsafe_set(Vec__DeclRef * self, U64 i, priv___src_self_loader_til__DeclRef * val);
void Vec__DeclRef_delete(Vec__DeclRef * self, Bool call_free);
Vec__DeclRef * Vec__DeclRef_clone(Vec__DeclRef * self);
U64 Vec__DeclRef_size(void);
...
U64 priv___src_self_builder_til__CollectionInfo_size(void);
...
U64 priv___src_self_builder_til__DynCallInfo_size(void);
...
U64 priv___src_self_builder_til__count_ident_uses(Expr * e, Str * name);
...
Bool priv___src_self_builder_til__callee_param_is_shallow(Str * callee_name, U64 arg_index, Context * ctx);
...
Bool priv___src_self_builder_til__templated_container_method_arg_is_own(Str * sname, Str * method, U64 arg_index);
Bool priv___src_self_builder_til__templated_container_fcall_arg_is_own(Str * callee_name, U64 arg_index);
File * priv___src_self_builder_til__emit_usize(File * f, U64 v);
File * priv___src_self_builder_til__emit_i32(File * f, I32 v);
File * priv___src_self_builder_til__emit_indent(File * f, I32 depth);
U64 priv___src_self_builder_til__c_lit_byte_count(Str * s);
...
Str * priv___src_self_builder_til__param_ctype(FunctionDef * fd, U64 i, Context * ctx);
...
U64 priv___src_self_builder_til__BuildPaths_size(void);
...
U64 priv___src_self_builder_til__doc_find_link_end(Str * body, U64 start, Str * loc);
U64 priv___src_self_builder_til__doc_line_end(Str * body, U64 pos);
U64 priv___src_self_builder_til__doc_next_line_pos(Str * body, U64 line_end);
...
U64 priv___src_self_builder_til__doc_unit_entry_capacity(DocEntry * e);
...
U64 priv___src_self_builder_til__doc_index_entry_capacity(DocEntry * e);
...
U64 priv___src_self_builder_til__doc_html_entry_capacity(DocEntry * e);
...
U64 priv___src_self_builder_til__doc_search_entry_capacity(DocEntry * e);
...
priv___src_self_builder_til__DynCallInfo * Vec__DynCallInfo_unsafe_get(Vec__DynCallInfo * self, U64 * i);
...
U64 Vec__DynCallInfo_size(void);
Vec__CollectionInfo * Vec__CollectionInfo_new(void);
U64 Vec__CollectionInfo_len(Vec__CollectionInfo * self);
...
priv___src_self_builder_til__CollectionInfo * Vec__CollectionInfo_unsafe_get(Vec__CollectionInfo * self, U64 * i);
...
U64 ffi_java_raw_closure_size(void);
...
U64 InterpCallableBox_size(void);
...
U64 priv___src_self_interpreter_til__elem_size_for_type(Str * type_name, Context * ctx);
...
U64 priv___src_self_interpreter_til__DynPtrBox_size(void);
...
U64 priv___src_self_interpreter_til__container_elem_size(Str * elem_type, Context * ctx);
Bool priv___src_self_interpreter_til__type_name_is_funcsig(Str * type_name, Context * ctx);
U64 priv___src_self_interpreter_til__container_live_count(Str * struct_name, void * data, Context * ctx);
U64 priv___src_self_interpreter_til__container_capacity(Str * struct_name, void * data, Context * ctx);
...
U64 priv___src_self_interpreter_til__dyn_vec_count(void * data, Context * ctx);
U64 priv___src_self_interpreter_til__dyn_vec_cap(void * data, Context * ctx);
U64 priv___src_self_interpreter_til__dyn_vec_elem_size(void * data, Context * ctx);
U64 priv___src_self_interpreter_til__dyn_vec_elem_kind(void * data, Context * ctx);
...
Value priv___src_self_interpreter_til__build_argv_array(Vec__Str * argv, U64 offset, U64 count, Str * elem_type, Context * ctx);
...
void priv___src_self_interpreter_til__interp_body_slice(Expr * program, U64 start_idx, U64 count, Expr * out);
void priv___src_self_interpreter_til__interp_body_slice_clear(Expr * body);
void priv___src_self_interpreter_til__interp_eval_program_slice(InterpSession * session, LoadedProgram * lp, Expr * program, U64 start_idx, U64 count);
U64 priv___src_self_interpreter_til__interp_first_stmt_at_line(Expr * program, U32 min_line);
...
void interp_session_eval_current_tail(InterpSession * session, LoadedProgram * lp, U64 start_idx, U64 count);
...
U64 priv___src_self_interpreter_til__eval_index_arg(Scope * s, Expr * e, Context * ctx);
...
U64 priv___src_self_interpreter_til__get_elem_size(Scope * s, Str * type_name, Expr * src, Context * ctx);
...
Bool priv___src_self_interpreter_til__ffi_shallow_type_info(void * atype, Str * type_name, U64 * size);
...
U64 Map__Str_Binding_size(void);
...
U64 Map__Str_HeapBinding_size(void);
Vec__DynPtrBox * Vec__DynPtrBox_new(void);
U64 Vec__DynPtrBox_len(Vec__DynPtrBox * self);
...
priv___src_self_interpreter_til__DynPtrBox * Vec__DynPtrBox_unsafe_get(Vec__DynPtrBox * self, U64 * i);
void Vec__DynPtrBox_delete(Vec__DynPtrBox * self, Bool call_free);
Vec__DynPtrBox * Vec__DynPtrBox_clone(Vec__DynPtrBox * self);
U64 Vec__DynPtrBox_size(void);
Vec__Binding * Vec__Binding_new(void);
U64 Vec__Binding_len(Vec__Binding * self);
void Vec__Binding_clear(Vec__Binding * self);
Binding * Vec__Binding_unsafe_get(Vec__Binding * self, U64 * i);
void Vec__Binding_unsafe_set(Vec__Binding * self, U64 i, Binding * val);
void Vec__Binding_delete(Vec__Binding * self, Bool call_free);
Vec__Binding * Vec__Binding_clone(Vec__Binding * self);
U64 Vec__Binding_size(void);
...
U64 Vec__HeapBinding_size(void);
Bool priv___src_self_binder_til__bind_is_ws(I8 c);
U64 priv___src_self_binder_til__skip_ws(Str * s, U64 from);
U64 priv___src_self_binder_til__skip_word(Str * s, U64 from);
U64 priv___src_self_binder_til__trim_right(Str * s, U64 from, U64 to);
Bool priv___src_self_binder_til__range_eq_lit(Str * s, U64 start, U64 end, Str * lit);
I64 priv___src_self_binder_til__parse_c_int_literal(Str * s, U64 from, U64 to, Bool * success);
...
U64 priv___src_self_binder_til__BinderState_size(void);
...
Bool priv___src_self_binder_til__emit_struct_body(priv___src_self_binder_til__BinderState * bs, Str * out, Vec__Str * lines, U64 open, U64 close);
U64 priv___src_self_binder_til__emit_typedef_struct(priv___src_self_binder_til__BinderState * bs, Str * out, Vec__Str * lines, U64 start, U64 open, U64 close);
U64 priv___src_self_binder_til__emit_typedef_enum(priv___src_self_binder_til__BinderState * bs, Str * out, Vec__Str * lines, U64 start, U64 open, U64 close);
...
Bool priv___src_self_binder_til__emit_function(priv___src_self_binder_til__BinderState * bs, Str * out, Vec__Str * lines, U64 start, U64 end);
...
U64 AutomationEventList_size(void);
...
U64 nng_sockaddr_inproc_size(void);
...
U64 nng_sockaddr_path_size(void);
...
U64 nng_sockaddr_ipc_size(void);
...
U64 nng_sockaddr_in6_size(void);
...
U64 nng_sockaddr_abstract_size(void);
...
U64 nng_stream_dialer_size(void);
...
U64 nng_stream_listener_size(void);
...
Str * repl_capture_eval_tail(InterpSession * session, LoadedProgram * lp, Str * out_path, U64 start_idx, U64 count);
...
U64 CliArgs_size(void);
CliArgs * parse_args(Array__Str * args);
Vec__Str * collect_user_argv(LoadedProgram * lp, Array__Str * args, U64 start_idx);
