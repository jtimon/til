...
void priv___src_self_typer_til__steal_own_param_payload_returns(TypeScope * scope, Expr * sw_expr, Expr * case_node, Str * sw_sname, Context * ctx);
...
U64 priv___src_self_garbager_til__StmtFacts_hash(priv___src_self_garbager_til__StmtFacts * self, HashFn hasher);
USize priv___src_self_garbager_til__StmtFacts_size(void);
...
Vec__StmtFacts * Vec__StmtFacts_clone(Vec__StmtFacts * self);
USize Vec__StmtFacts_size(void);
...
extern Array__Str priv___src_self_builder_til__PRIM_NAMES;
extern I64 _priv___src_self_builder_til__PRIM_NAMES_ek;
extern Array__Str priv___src_self_builder_til__WIDTH_ALIAS_NAMES;
extern I64 _priv___src_self_builder_til__WIDTH_ALIAS_NAMES_ek;
