...
void Vec__Str_set(Vec__Str * self, U32 i, Str * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
void Vec__Expr_set(Vec__Expr * self, U32 i, Expr * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
...
void Vec__CtorArg_set(Vec__CtorArg * self, U32 i, priv___src_self_typer_til__CtorArg * val, I64 * _err_kind, OutOfBounds * _err_OutOfBounds);
