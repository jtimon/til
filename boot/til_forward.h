...
void precomp(Expr * core_program, Expr * program);
void scavenge(Expr * program, Mode * mode, Bool run_tests);
I32 interpret(Expr * core_ast, Expr * ast, Mode * mode, Bool run_tests, Str * path, Str * user_c, Str * ext_c, Str * link_flags, Vec * user_argv, Str * fwd_path);
I32 build(Expr * core_ast, Expr * ast, Mode * mode, Bool run_tests, Str * path, Str * c_path);
I32 build_forward_header(Expr * core_ast, Expr * ast, Str * fwd_path);
I32 build_header(Expr * core_ast, Expr * ast, Str * h_path);
I32 build_til_binding(Expr * core_ast, Expr * ast, Str * til_path, Str * lib_name);
...
NodeType *NodeType_LiteralStr(Str *);
NodeType *NodeType_LiteralNum(Str *);
NodeType *NodeType_LiteralBool(Bool *);
NodeType *NodeType_LiteralNull();
NodeType *NodeType_Ident(Str *);
NodeType *NodeType_Decl(Declaration *);
NodeType *NodeType_Assign(Str *);
NodeType *NodeType_FCall(FCallData *);
NodeType *NodeType_FuncDef(FunctionDef *);
NodeType *NodeType_StructDef(StructDefData *);
NodeType *NodeType_EnumDef();
NodeType *NodeType_FieldAccess(Str *);
NodeType *NodeType_FieldAssign(Str *);
NodeType *NodeType_Return();
NodeType *NodeType_If();
NodeType *NodeType_While();
NodeType *NodeType_ForIn(Str *);
