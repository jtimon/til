...
I64 * priv___src_self_typer_til__tag_for_type(Str * type_name, Vec * _type_to_tag_names);
void priv___src_self_typer_til__register_throw_type(Str * name);
...
Expr * priv___src_self_typer_til__lower_catch_node(Expr * catch_node, Vec * type_to_tag_names);
void priv___src_self_typer_til__register_func_throws(Str * name, Vec * throws_list);
...
I64 * priv___src_self_typer_til__find_callee_throws_idx(Expr * fcall);
...
void priv___src_self_typer_til__validate_one_fcall_consolidated(Expr * e, Vec * pending, Vec * seen, Vec * types_to_declare, Str * path);
void priv___src_self_typer_til__inject_err_args_on_one_fcall_consolidated(Expr * e);
void priv___src_self_typer_til__validate_and_inject_expr_consolidated(Expr * e, Vec * pending, Vec * seen, Vec * types_to_declare, Str * path);
Expr * priv___src_self_typer_til__build_bang_lowered(Str * error_type, U32 line, U32 col);
void priv___src_self_typer_til__hoist_walk_consolidated(Expr * parent, U32 * child_idx, Vec * pre_stmts, Vec * types_to_declare, Vec * seen);
void priv___src_self_typer_til__hoist_nested_bangs_consolidated(Expr * stmt, Vec * pre_stmts, Vec * types_to_declare, Vec * seen);
void priv___src_self_typer_til__process_throw_catch_in_body(Expr * body, Vec * fdef_throws, Vec * pending, Vec * seen, Vec * types_to_declare, Str * path);
void process_throw_catch_in_func_body(Expr * body, Vec * fdef_throws, Str * return_type);
...
Bool priv___src_self_typer_til__body_pre_passes(Expr * body, TypeScope * scope, I32 owns_scope);
void apply_hoist_to_stmt(Expr * stmt, Vec * new_ch, TypeScope * scope);
void apply_call_hoist_delete(Expr * stmt, Vec * new_ch, TypeScope * scope, Bool has_array_vec, Bool has_variadic, Bool has_kwargs, Bool do_hoist, Bool needs_delete);
...
Expr * priv___src_self_builder_til__resolve_local_fn_sig(Str * name);
Expr * resolve_decl_fn_sig(Expr * rhs, Declaration * dd, TypeScope * scope);
Expr * fcall_fn_sig(Expr * fcall);
Bool priv___src_self_builder_til__is_stack_local(Str * name);
Bool priv___src_self_builder_til__is_current_func_param(Str * name);
Bool priv___src_self_builder_til__is_value_global(Str * name);
...
Bool priv___src_self_builder_til__variant_is_payload_less(Str * enum_name, Str * variant_name);
Bool priv___src_self_builder_til__is_pod_enum_clone_call(Expr * e);
...
Expr * priv___src_self_builder_til__find_struct_def(Str * name);
Expr * priv___src_self_builder_til__find_callee_fdef(Str * name);
Str * fa_struct_name(Expr * e);
Bool priv___src_self_builder_til__builder_fa_is_ptr_with_fname(Str * sname, Str * fname);
Bool builder_fa_is_ptr(Expr * e);
Bool priv___src_self_builder_til__builder_fa_is_ns_with_fname(Expr * e, Str * sname, Str * fname);
...
Bool priv___src_self_builder_til__fcall_is_shallow_return(Expr * fcall);
...
void priv___src_self_builder_til__emit_indent(File * f, I32 depth);
...
Bool priv___src_self_builder_til__pod_ctor_args_are_safe(Expr * ctor);
void emit_pod_compound_literal(File * f, Expr * ctor, I32 depth);
...
Bool priv___src_self_builder_til__is_noop_delete_stmt(Expr * e);
void priv___src_self_builder_til__emit_stmt(File * f, Expr * e, I32 depth);
...
void priv___src_self_builder_til__emit_body(File * f, Expr * body, I32 depth);
...
void priv___src_self_builder_til__emit_deref(File * f, Expr * e, I32 depth);
...
void priv___src_self_builder_til__emit_func_forward_decl(File * f, Str * name, Expr * fdef, Bool top_level);
...
Bool priv___src_self_builder_til__find_loaded_enum_variants(Str * ename, Vec * variant_names, Vec * variant_types);
...
void priv___src_self_binder_til__register_alias(Str * name);
void priv___src_self_binder_til__register_dynamic_alias(Str * name);
Bool priv___src_self_binder_til__is_alias_to_primitive(Str * name);
Bool priv___src_self_binder_til__is_alias_to_dynamic(Str * name);
void priv___src_self_binder_til__push_til_default(Str * out, Str * c);
Bool * priv___src_self_binder_til__bind_emit_field(Str * out, Str * line, Str * comment);
void priv___src_self_binder_til__emit_comment_line(Str * out, Str * line);
Bool * priv___src_self_binder_til__emit_struct_body(Str * out, Vec * lines, U32 open, U32 close);
U32 * priv___src_self_binder_til__emit_typedef_struct(Str * out, Vec * lines, U32 start, U32 open, U32 close);
U32 * priv___src_self_binder_til__emit_typedef_enum(Str * out, Vec * lines, U32 start, U32 open, U32 close);
Bool * priv___src_self_binder_til__emit_typedef_alias(Str * out, Str * line);
Bool * priv___src_self_binder_til__emit_typedef_fnptr(Str * out, Str * line);
Bool * priv___src_self_binder_til__emit_define(Str * out, Str * line);
Bool * priv___src_self_binder_til__emit_function(Str * out, Vec * lines, U32 start, U32 end);
void priv___src_self_binder_til__walk_header(Str * out, Vec * lines);
...
extern Vec throw_type_registry;
extern Vec throws_names_global;
...
extern I64 priv___src_self_typer_til__bang_counter;
extern Set macros;
extern Set funcs;
extern Map known;
...
extern Str alias_to_primitive;
extern Str alias_to_dynamic;
