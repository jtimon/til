...
void priv___src_self_loader_til__lazy_wrap_thunk_call(Expr * call, Expr * fdef, TypeScope * scope);
...
void priv___src_self_builder_til__append_doc_html_head(Str * out, Str * title);
