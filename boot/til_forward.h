...
void priv___src_self_typer_til__check_user_delete_frees_own_fields(Str * struct_name, Expr * sdef);
...
void priv___src_self_typer_til__validate_struct_pattern_rest(TypeScope * scope, Expr * pattern);
...
void priv___src_self_typer_til__typer_register_lifted_lambda(TypeScope * scope, Expr * lifted);
void priv___src_self_typer_til__typer_lift_lambdas(TypeScope * scope, Expr * prog);
...
Expr * priv___src_self_builder_til__resolve_local_fn_sig(LoadedProgram * lp, Str * name);
Expr * resolve_decl_fn_sig(Expr * rhs, Declaration * dd, TypeScope * scope, LoadedProgram * lp);
Expr * fcall_fn_sig(Expr * fcall, LoadedProgram * lp);
Bool priv___src_self_builder_til__is_stack_local(Str * name, LoadedProgram * lp);
Bool priv___src_self_builder_til__is_current_func_param(Str * name, LoadedProgram * lp);
Bool priv___src_self_builder_til__is_value_global(Str * name, LoadedProgram * lp);
Bool is_ref_global(Str * name, LoadedProgram * lp);
Bool is_ref_local(Str * name, LoadedProgram * lp);
Bool use_dot_access(Expr * obj, LoadedProgram * lp);
Bool is_primitive_type(Str * name);
Bool is_pod_enum(Str * enum_name, LoadedProgram * lp);
Bool priv___src_self_builder_til__variant_is_payload_less(Str * enum_name, Str * variant_name, LoadedProgram * lp);
Bool priv___src_self_builder_til__is_pod_enum_clone_call(Expr * e, LoadedProgram * lp);
Bool is_pod_struct(Str * struct_name, LoadedProgram * lp);
Bool is_funcsig_type(Str * name, LoadedProgram * lp);
Bool is_ext_h_type(Str * name);
Bool is_skip_ext_decl(Str * name);
Bool is_exported_top_level_global(Expr * stmt);
Expr * priv___src_self_builder_til__find_struct_def(Str * name, LoadedProgram * lp);
Expr * priv___src_self_builder_til__find_callee_fdef(Str * name, LoadedProgram * lp);
Str * fa_struct_name(Expr * e);
Bool priv___src_self_builder_til__builder_fa_is_ptr_with_fname(Str * sname, Str * fname, LoadedProgram * lp);
Bool builder_fa_is_ptr(Expr * e, LoadedProgram * lp);
Bool priv___src_self_builder_til__builder_fa_is_ns_with_fname(Expr * e, Str * sname, Str * fname, LoadedProgram * lp);
Bool builder_fa_is_ns(Expr * e, LoadedProgram * lp);
Bool is_shallow_param(Str * name, LoadedProgram * lp);
Bool callee_returns_shallow(Str * callee_name, LoadedProgram * lp);
Bool callee_returns_dynamic(Str * callee_name, LoadedProgram * lp);
Bool callee_param_is_shallow(Str * callee_name, U32 arg_index, LoadedProgram * lp);
Bool callee_param_is_usize(Str * callee_name, U32 arg_index, LoadedProgram * lp);
Bool callee_param_is_uptr(Str * callee_name, U32 arg_index, LoadedProgram * lp);
Bool callee_param_is_own(Str * callee_name, U32 arg_index, LoadedProgram * lp);
Bool priv___src_self_builder_til__fcall_is_shallow_return(Expr * fcall, LoadedProgram * lp);
Bool fcall_returns_dynamic(Expr * fcall, LoadedProgram * lp);
Str * priv___src_self_builder_til__til_type_to_c(Type t);
Str * extern_decl_ctype(Type t, Type rhs_t, LoadedProgram * lp);
Str * resolve_decl_ctype(Type t, Type rhs_t, Str * explicit, LoadedProgram * lp);
Str * c_type_name(Type t, Str * struct_name, LoadedProgram * lp);
Str * func_to_c(Str * name);
Str * type_name_to_c(Str * name, LoadedProgram * lp);
Str * type_name_to_c_value(Str * name, LoadedProgram * lp);
...
Str * param_ctype(FunctionDef * fd, U32 i, LoadedProgram * lp);
void emit_param_list(File * f, Expr * fdef, Bool with_names, Bool for_ext_decl, LoadedProgram * lp);
...
void emit_field(File * f, Str * var, Str * field, LoadedProgram * lp);
Str * get_stack_local_ctype(Str * name, LoadedProgram * lp);
Str * resolve_ident_ctype(Str * ident, Type * ttype, Str * sname, LoadedProgram * lp);
Str * resolve_callee_name(Expr * fcall);
Str * callee_return_ctype(Str * callee_name, LoadedProgram * lp);
Str * fcall_return_ctype(Expr * fcall, LoadedProgram * lp);
void check_fcall_mut_args(LoadedProgram * lp, Expr * e);
void collect_unsafe_to_hoist(LoadedProgram * lp, Expr * body);
void collect_dyn_has_methods(Expr * e, Vec * methods);
Bool priv___src_self_builder_til__fcall_is_struct_ctor(Expr * e);
Bool priv___src_self_builder_til__pod_ctor_args_are_safe(Expr * ctor, LoadedProgram * lp);
void emit_pod_compound_literal(File * f, Expr * ctor, I32 depth, LoadedProgram * lp);
void emit_stmt_decl(File * f, Expr * e, I32 depth, LoadedProgram * lp);
Str * emit_return_ctype(Expr * rv, LoadedProgram * lp);
void emit_return_box(File * f, Expr * rv, I32 depth, LoadedProgram * lp);
void emit_stmt_return(File * f, Expr * e, I32 depth, LoadedProgram * lp);
Bool priv___src_self_builder_til__is_noop_delete_stmt(Expr * e, LoadedProgram * lp);
void priv___src_self_builder_til__emit_stmt(File * f, Expr * e, I32 depth, LoadedProgram * lp);
void emit_fcall_funcptr_cast(File * f, Expr * e, Expr * sig);
void emit_fcall_funcptr_args(File * f, Expr * e, Expr * sig, I32 depth, LoadedProgram * lp);
void emit_str_lit_expr(File * f, Str * s);
File * emit_expr(File * f, Expr * e, I32 depth, LoadedProgram * lp);
void priv___src_self_builder_til__emit_body(File * f, Expr * body, I32 depth, LoadedProgram * lp);
void emit_ctor_fields(File * f, Str * var, Expr * ctor, I32 depth, LoadedProgram * lp);
void emit_ns_inits(File * f, I32 depth, LoadedProgram * lp);
void emit_body_scoped(File * f, Expr * body, I32 depth, LoadedProgram * lp);
File * priv___src_self_builder_til__emit_deref(File * f, Expr * e, I32 depth, LoadedProgram * lp);
File * emit_as_ptr(File * f, Expr * e, I32 depth, Bool is_own, LoadedProgram * lp);
void emit_usize_ref(File * f, Expr * e, I32 depth, LoadedProgram * lp);
void emit_uptr_ref(File * f, Expr * e, I32 depth, LoadedProgram * lp);
...
void emit_enum_struct_body(File * f, Str * ename, Expr * enum_def, LoadedProgram * lp);
void topo_emit_struct_enum_defs_lp(File * f, Set * emitted, LoadedProgram * lp);
Str * func_return_ctype(FunctionDef * fd, LoadedProgram * lp);
void priv___src_self_builder_til__emit_func_forward_decl(File * f, Str * name, Expr * fdef, Bool top_level, LoadedProgram * lp);
void emit_funcsig_typedef(File * f, Str * name, Expr * fdef, LoadedProgram * lp);
...
void register_funcsig_prog(Expr * prog, LoadedProgram * lp);
void emit_global_inits_prog(File * f, Expr * prog, LoadedProgram * lp);
void emit_global_inits(File * f, LoadedProgram * lp);
void build_register_funcsig_names_lp(LoadedProgram * lp);
void register_lookups_prog(Expr * prog, LoadedProgram * lp);
...
void emit_dyn_fn_wrapper(File * f, Str * type_name, Str * method_name, FunctionDef * fd, LoadedProgram * lp);
...
void emit_ext_func_declarations(File * f, Expr * program, LoadedProgram * lp);
...
Bool * priv___src_self_dispatch_til__narrow_bool_arg(Scope * s, Expr * e);
...
Bool priv___src_self_dispatch_til__h_print_single(Scope * s, Expr * e, Value * r);
...
Value priv___src_self_dispatch_til__str_to_owned_value(Str * src);
Expr * interp_lookup_struct(Scope * s, Expr * e, Str * type_name, Str * who);
Bool h_struct_field_count(Scope * s, Expr * e, Value * r);
Bool h_struct_field_name(Scope * s, Expr * e, Value * r);
Bool h_struct_field_is_mut(Scope * s, Expr * e, Value * r);
Bool h_struct_field_type(Scope * s, Expr * e, Value * r);
...
Bool priv___src_self_dispatch_til__ffi_write_shallow_arg(Scope * scope, Value * v, void * atype, void * dst);
