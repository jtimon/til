...
Expr * interp_lookup_enum(Scope * s, Expr * e, Str * type_name, Str * who);
Bool h_enum_variant_count(Scope * s, Expr * e, Value * r);
Bool h_enum_variant_name(Scope * s, Expr * e, Value * r);
Bool h_enum_variant_has_payload(Scope * s, Expr * e, Value * r);
Bool h_enum_variant_payload_type(Scope * s, Expr * e, Value * r);
