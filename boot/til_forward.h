...
void register_body_scope(Context * ctx, Expr * body, void * scope);
TypeScope * priv___src_self_asaper_til__resolve_body_scope(Context * ctx, Expr * body);
void priv___src_self_asaper_til__asap_destroy_one_subbody(Context * ctx, Expr * body);
void priv___src_self_asaper_til__asap_walk_children(Context * ctx, Expr * e, Str * parent_decl_name);
void priv___src_self_asaper_til__asap_walk_expr(Context * ctx, Expr * e, Str * parent_decl_name);
void priv___src_self_asaper_til__free_cached_subbody_scopes(Context * ctx);
void asap_destroy_subbodies(Context * ctx);
