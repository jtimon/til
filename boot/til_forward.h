...
Expr * make_switch_case_condition(TypeScope * scope, Expr * case_body, Expr * match_expr, Str * sw_name, U32 sw_line, U32 sw_col);
...
void process_body(Scope * scope, Expr * body, Context * ctx);
