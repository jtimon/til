...
I32 build_forward_header(Expr * core_program, Expr * program, Str * fwd_path, Context * ctx);
I32 build_header(Expr * core_program, Expr * program, Str * h_path, Context * ctx);
void emit_binding_ns_methods(File * f, Expr * body);
I32 build_til_binding(Expr * core_program, Expr * program, Str * til_path, Str * lib_name, Context * ctx);
...
I32 build(Expr * core_program, Expr * program, Mode * mode, Bool run_tests, Str * path, Str * c_output_path, Context * ctx);
...
I32 type_check(Expr * program, TypeScope * scope, Context * ctx);
void scavenge(Expr * core_program, Expr * program, Mode * mode, Bool run_tests);
I32 build(Expr * core_ast, Expr * ast, Mode * mode, Bool run_tests, Str * path, Str * c_path, Context * ctx);
