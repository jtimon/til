...
Bool priv___src_self_typer_til__subtree_has_propagating_throw(Expr * e);
Bool priv___src_self_typer_til__subtree_has_bang(Expr * e);
Bool priv___src_self_typer_til__subtree_has_throwing_call(Context * ctx, Expr * e);
...
void priv___src_self_typer_til__register_func_throws(Context * ctx, Str * name, Vec * throws_list, Bool returns_ref);
Bool priv___src_self_typer_til__name_returns_ref(Context * ctx, Str * name);
void extend_throwing_func_sigs(Context * ctx, Expr * e);
void priv___src_self_typer_til__append_err_params_to_funcdef(Expr * fdef_expr, Vec * throws_list);
Vec * priv___src_self_typer_til__throws_for_name(Context * ctx, Str * name);
void priv___src_self_typer_til__extend_name_matched_func_sigs(Context * ctx, Expr * e);
void priv___src_self_typer_til__maybe_append_name_matched(Context * ctx, Expr * fdef_expr, Str * name);
...
Expr * priv___src_self_typer_til__build_bang_lowered_named(Context * ctx, Str * error_type, Str * kind_name, Str * slot_name, U32 line, U32 col);
...
void process_throw_catch_in_func_body(Context * ctx, Expr * body, Vec * fdef_throws, Str * return_type, Bool * returns_ref, Vec * err_param_types);
