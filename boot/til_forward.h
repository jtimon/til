...
Bool priv___src_self_context_til__lazy_stmts_inlinable(Expr * body, U64 start);
...
void priv___src_self_loader_til__ns_alias_rewrite_child(Expr * e, U64 i, Set__Str * alias_names, Set__Str * alias_members, Map__Str_Str * alias_paths, Str * path, Set__Str * shadowed);
...
Bool priv___src_self_loader_til__lazy_case_binds_param(Expr * pat, Set__Str * pnames);
...
void priv___src_self_loader_til__lazy_autoforce_node(Expr * parent, U64 idx, Set__Str * pnames, Set__Str * shadowed, I32 depth);
...
I32 priv___src_self_builder_til__compile_lib(Str * c_path, Str * lib_name, Str * ext_c_path, Str * user_c_path, Str * link_flags, Str * include_flags, Target * target, Str * cc_override, Bool asan, Bool usize32);
Bool priv___src_self_builder_til__is_gui_auto_import(Str * auto_import);
I32 priv___src_self_builder_til__compile_c(Str * c_path, Str * bin_path, Str * ext_c_path, Str * user_c_path, Str * link_flags, Str * include_flags, Target * target, Str * cc_override, Str * mode_auto_import, Bool asan, Bool prof, Bool usize32);
