...
void precomp(Expr * program);
void scavenge(Expr * program, Mode * mode, Bool run_tests);
I32 interpret(Expr * ast, Mode * mode, Bool run_tests, Str * path, Str * user_c, Str * ext_c, Str * link_flags, Vec * user_argv, Str * fwd_path);
I32 build(Expr * ast, Mode * mode, Bool run_tests, Str * path, Str * c_path);
