...
U32 priv___src_self_builder_til__doc_html_entry_capacity(DocEntry * e);
...
U32 priv___src_self_builder_til__doc_search_entry_capacity(DocEntry * e);
...
U32 priv___src_self_interpreter_til__container_elem_size(Str * elem_type, Context * ctx);
Bool priv___src_self_interpreter_til__type_name_is_funcsig(Str * type_name, Context * ctx);
U32 priv___src_self_interpreter_til__container_live_count(Str * struct_name, void * data, Context * ctx);
U32 priv___src_self_interpreter_til__container_capacity(Str * struct_name, void * data, Context * ctx);
...
U32 priv___src_self_interpreter_til__dyn_vec_elem_size(void * data, Context * ctx);
U32 priv___src_self_interpreter_til__dyn_vec_elem_kind(void * data, Context * ctx);
...
Bool priv___src_self_interpreter_til__struct_has_custom_teardown(Str * struct_name, Context * ctx);
void priv___src_self_interpreter_til__scope_peel_owned_aggregate(Scope * s, Str name, void * valaddr);
void priv___src_self_interpreter_til__scope_reclaim_peeled(Scope * s, Str name, void * valaddr);
void priv___src_self_interpreter_til__scope_reclaim_peeled_at_binding(Scope * s, Str name);
...
Bool Map__Str_HeapBinding_has(Map__Str_HeapBinding * self, Str * key);
HeapBinding * Map__Str_HeapBinding_get(Map__Str_HeapBinding * self, Str * key, I64 * _err_kind, KeyNotFound * _err_KeyNotFound, Str * loc);
...
HeapBinding * Vec__HeapBinding_unsafe_get(Vec__HeapBinding * self, U32 * i);
void Vec__HeapBinding_unsafe_set(Vec__HeapBinding * self, U32 i, HeapBinding * val);
