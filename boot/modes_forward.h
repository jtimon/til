...
Bool infer_func_ptr_field_call(TypeScope * scope, Expr * e, Expr * fa, Expr * obj, Expr * sdef, Str * method, I32 in_func, Mode * m);
void validate_fcall_own_args(TypeScope * scope, Expr * e, TypeBinding * callee_bind);
Bool infer_struct_constructor_fcall(TypeScope * scope, Expr * e, Str * name, I32 in_func, Mode * m);
void desugar_user_func_fcall_args(Expr * e, Str * name, TypeBinding * callee_bind);
void infer_and_validate_fcall_args(TypeScope * scope, Expr * e, TypeBinding * callee_bind, I32 in_func, Mode * m);
void resolve_fcall_return_type(TypeScope * scope, Expr * e, Str * name, TypeBinding * callee_bind, I32 in_func, Mode * m);
Bool infer_field_access_fcall(TypeScope * scope, Expr * e, I32 in_func, Mode * m);
void infer_fcall_expr(TypeScope * scope, Expr * e, I32 in_func, Mode * m);
void infer_expr(TypeScope * scope, Expr * expr, I32 in_func, Mode * m);
void infer_ident_expr(TypeScope * scope, Expr * expr);
void infer_named_arg_expr(TypeScope * scope, Expr * expr, I32 in_func, Mode * m);
void infer_map_lit_expr(TypeScope * scope, Expr * expr, I32 in_func, Mode * m);
void infer_set_lit_expr(TypeScope * scope, Expr * expr, I32 in_func, Mode * m);
void infer_type_def_expr(TypeScope * scope, Expr * expr, Mode * m);
void infer_func_sig_expr(TypeScope * scope, Expr * expr);
void check_ref_function_returns(TypeScope * func_scope, Expr * expr);
void infer_func_def_expr(TypeScope * scope, Expr * expr, Mode * m);
void infer_return_stmt(TypeScope * scope, Expr * stmt, I32 in_func, I32 returns_ref, Mode * m);
void infer_if_stmt(TypeScope * scope, Expr * stmt, I32 in_func, I32 in_loop, I32 returns_ref, Mode * m);
void infer_field_access_expr(TypeScope * scope, Expr * expr, I32 in_func, Mode * m);
void infer_field_assign_stmt(TypeScope * scope, Expr * stmt, I32 in_func, Mode * m);
void infer_while_stmt(TypeScope * scope, Expr * stmt, I32 in_func, I32 returns_ref, Mode * m);
...
void infer_decl_stmt(TypeScope * scope, Expr * stmt, I32 in_func, I32 in_type_body, Mode * m);
...
void infer_switch_stmt(TypeScope * scope, Expr * body, U32 stmt_idx, I32 in_func, Mode * m);
...
Bool desugar_for_in_range_stmt(TypeScope * scope, Expr * body, U32 stmt_idx, I32 in_func, Mode * m);
Bool desugar_for_in_collection_stmt(TypeScope * scope, Expr * body, U32 stmt_idx, I32 in_func, Mode * m);
void infer_body_stmt(TypeScope * scope, Expr * body, U32 * i, I32 in_func, I32 in_loop, I32 returns_ref, I32 in_type_body, Mode * m);
void infer_body(TypeScope * scope, Expr * body, I32 in_func, I32 owns_scope, I32 in_loop, I32 returns_ref, I32 in_type_body, Mode * m);
void infer_assign_stmt(TypeScope * scope, Expr * stmt, I32 in_func, Mode * m);
