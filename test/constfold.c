...
static void test_struct_fold_f32(void) {
    ...
    Str_delete(&hoisted__Str_test_struct_fold_f32_3, 0);
    ...
    Str_delete(&hoisted__Str_test_struct_fold_f32_6, 0);
    ...
    while (1) {
        ...
        if (hoisted__Bool_12) {
            ...
            if (hoisted__Bool_6) {
                ...
                I64 *hoisted__I64_4 = ((I64 *)((void *)((U8 *)(self->values.data) + (((U64)(((U64)(mid)) * 8ULL))))));
