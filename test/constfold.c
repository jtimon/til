...
__attribute__((noreturn)) void panic(Array__Str * parts, Str * loc) {
    U32 hoisted__U32_6096 = 3;
    Array__Str *_va_Array_166 = Array__Str_new(hoisted__U32_6096);
    I64 _va_Array_166_ek = 0;
    U32 hoisted__U32_6097 = 0;
    Str *hoisted__Str_6098 = Str_clone(loc);
    Array__Str_set(_va_Array_166, hoisted__U32_6097, hoisted__Str_6098, &_va_Array_166_ek);
    U32 hoisted__U32_6099 = 1;
    Array__Str_set(_va_Array_166, hoisted__U32_6099, &_til_str_lits[0], &_va_Array_166_ek);
    Array__Str *hoisted__Array__Str_6101 = Array__Str_clone(parts);
    U32 hoisted__U32_6102 = 2;
    Str *hoisted__Str_6103 = format(hoisted__Array__Str_6101);
    Array__Str_set(_va_Array_166, hoisted__U32_6102, hoisted__Str_6103, &_va_Array_166_ek);
    Array__Str_delete(parts, 1);
    println(_va_Array_166);
    I64 hoisted__I64_6104 = 1;
    exit(hoisted__I64_6104);
}

__attribute__((noreturn)) void UNREACHABLE(Array__Str * parts, Str * loc) {
    USize hoisted__U32_6126 = (parts->cap);
    U32 hoisted__U32_6127 = 0;
    Bool hoisted__Bool_6128 = ((Bool)(hoisted__U32_6126 == hoisted__U32_6127));
    if (hoisted__Bool_6128) {
        U32 hoisted__U32_6117 = 1;
        Array__Str *_va_Array_169 = Array__Str_new(hoisted__U32_6117);
        I64 _va_Array_169_ek = 0;
        U32 hoisted__U32_6118 = 0;
        Array__Str_set(_va_Array_169, hoisted__U32_6118, &_til_str_lits[1], &_va_Array_169_ek);
        panic(_va_Array_169, loc);
    } else {
        U32 hoisted__U32_6120 = 2;
        Array__Str *_va_Array_170 = Array__Str_new(hoisted__U32_6120);
        I64 _va_Array_170_ek = 0;
        U32 hoisted__U32_6121 = 0;
        Array__Str_set(_va_Array_170, hoisted__U32_6121, &_til_str_lits[2], &_va_Array_170_ek);
        Array__Str *hoisted__Array__Str_6123 = Array__Str_clone(parts);
        U32 hoisted__U32_6124 = 1;
        Str *hoisted__Str_6125 = format(hoisted__Array__Str_6123);
        Array__Str_set(_va_Array_170, hoisted__U32_6124, hoisted__Str_6125, &_va_Array_170_ek);
...
void assert(Bool cond, Str * loc) {
    Bool hoisted__Bool_6132 = ((Bool)(!(cond)));
    if (hoisted__Bool_6132) {
        U32 hoisted__U32_6129 = 1;
        Array__Str *_va_Array_171 = Array__Str_new(hoisted__U32_6129);
        I64 _va_Array_171_ek = 0;
        U32 hoisted__U32_6130 = 0;
        Array__Str_set(_va_Array_171, hoisted__U32_6130, &_til_str_lits[3], &_va_Array_171_ek);
        panic(_va_Array_171, loc);
    }
}

void expect(Bool cond, Array__Str * parts, Str * loc) {
    Bool hoisted__Bool_6139 = ((Bool)(!(cond)));
    if (hoisted__Bool_6139) {
        U32 hoisted__U32_6133 = 2;
        Array__Str *_va_Array_172 = Array__Str_new(hoisted__U32_6133);
        I64 _va_Array_172_ek = 0;
        U32 hoisted__U32_6134 = 0;
        Array__Str_set(_va_Array_172, hoisted__U32_6134, &_til_str_lits[4], &_va_Array_172_ek);
        Array__Str *hoisted__Array__Str_6136 = Array__Str_clone(parts);
        U32 hoisted__U32_6137 = 1;
        Str *hoisted__Str_6138 = format(hoisted__Array__Str_6136);
        Array__Str_set(_va_Array_172, hoisted__U32_6137, hoisted__Str_6138, &_va_Array_172_ek);
...
void println(Array__Str * parts) {
    {
        Array__Str *_fc_Array__Str_6140 = parts;
        U32 _fi_USize_6140 = 0;
        while (1) {
            USize hoisted__U32_6142 = (_fc_Array__Str_6140->cap);
            Bool _wcond_Bool_6141 = ((Bool)(_fi_USize_6140 < hoisted__U32_6142));
            if (_wcond_Bool_6141) {
            } else {
                break;
            }
            Str *s = ((Str *)((void *)((U8 *)(_fc_Array__Str_6140->data) + (((U32)(_fi_USize_6140 * 16))))));
            U32 hoisted__U32_6143 = 1;
            U32 hoisted__U32_6144 = ((U32)(_fi_USize_6140 + hoisted__U32_6143));
            _fi_USize_6140 = hoisted__U32_6144;
            print_single(s);
        }
    }
    Array__Str_delete(parts, 1);
...
void Token_delete(Token * self, Bool call_free) {
    Bool hoisted__Bool_7055 = ((Bool)((((Token *)(self))->tag) == (((Token *)(&(Token){.tag = Token_TAG_Num}))->tag)));
    if (hoisted__Bool_7055) {
        I64 *hoisted__I64_7051 = ((void *)((U8 *)(self) + offsetof(Token, data)));
        Bool hoisted__Bool_7052 = 0;
        I64_delete(hoisted__I64_7051, hoisted__Bool_7052);
    }
    Bool hoisted__Bool_7056 = ((Bool)((((Token *)(self))->tag) == (((Token *)(&(Token){.tag = Token_TAG_Name}))->tag)));
    if (hoisted__Bool_7056) {
        Str *hoisted__Str_7053 = ((void *)((U8 *)(self) + offsetof(Token, data)));
        Bool hoisted__Bool_7054 = 0;
        Str_delete(hoisted__Str_7053, hoisted__Bool_7054);
    }
    if (call_free) {
        free(self);
    }
...
void test_enum_payload_fold(void) {
    ...
    Bool hoisted__Bool_7118 = ((Bool)((((Token *)(t))->tag) == (((Token *)(&(Token){.tag = Token_TAG_Num}))->tag)));
    assert(hoisted__Bool_7118, &_til_str_lits[43]);
    Str_delete(&_til_str_lits[43], (Bool){0});
    Bool hoisted__Bool_7120 = ((Bool)((((Token *)(t))->tag) == (((Token *)(&(Token){.tag = Token_TAG_Eof}))->tag)));
    Bool hoisted__Bool_7121 = ((Bool)(!(hoisted__Bool_7120)));
    assert(hoisted__Bool_7121, &_til_str_lits[44]);
...
void test_enum_return_fold(void) {
    ...
    Bool hoisted__Bool_7123 = Color_eq(&c, &(Color){.tag = Color_TAG_Green});
    assert(hoisted__Bool_7123, &_til_str_lits[45]);
    Str_delete(&_til_str_lits[45], (Bool){0});
    Bool hoisted__Bool_7125 = Color_eq(&c, &(Color){.tag = Color_TAG_Red});
    Bool hoisted__Bool_7126 = ((Bool)(!(hoisted__Bool_7125)));
    assert(hoisted__Bool_7126, &_til_str_lits[46]);
    Str_delete(&_til_str_lits[46], (Bool){0});
}

void test_enum_payload_return_fold(void) {
    Token *t = Token_Num(&(I64){7});
    Bool hoisted__Bool_7130 = ((Bool)((((Token *)(t))->tag) == (((Token *)(&(Token){.tag = Token_TAG_Num}))->tag)));
    assert(hoisted__Bool_7130, &_til_str_lits[47]);
    Str_delete(&_til_str_lits[47], (Bool){0});
    Bool hoisted__Bool_7132 = ((Bool)((((Token *)(t))->tag) == (((Token *)(&(Token){.tag = Token_TAG_Eof}))->tag)));
    Bool hoisted__Bool_7133 = ((Bool)(!(hoisted__Bool_7132)));
    assert(hoisted__Bool_7133, &_til_str_lits[48]);
...
void test_const_and_or_fold(void) {
    ...
    Array__Str_set(_va_Array_209, hoisted__U32_7142, &_til_str_lits[49], &_va_Array_209_ek);
    Bool hoisted__Bool_7144 = 1;
    expect(hoisted__Bool_7144, _va_Array_209, &_til_str_lits[50]);
    Str_delete(&_til_str_lits[50], (Bool){0});
    U32 hoisted__U32_7146 = 1;
    Array__Str *_va_Array_210 = Array__Str_new(hoisted__U32_7146);
    I64 _va_Array_210_ek = 0;
    U32 hoisted__U32_7147 = 0;
    Array__Str_set(_va_Array_210, hoisted__U32_7147, &_til_str_lits[51], &_va_Array_210_ek);
    Bool hoisted__Bool_7150 = 1;
    expect(hoisted__Bool_7150, _va_Array_210, &_til_str_lits[52]);
    ...
    Array__Str_set(_va_Array_211, hoisted__U32_7153, &_til_str_lits[53], &_va_Array_211_ek);
    Bool hoisted__Bool_7155 = 1;
    expect(hoisted__Bool_7155, _va_Array_211, &_til_str_lits[54]);
    Str_delete(&_til_str_lits[54], (Bool){0});
    U32 hoisted__U32_7157 = 1;
    Array__Str *_va_Array_212 = Array__Str_new(hoisted__U32_7157);
    I64 _va_Array_212_ek = 0;
    U32 hoisted__U32_7158 = 0;
    Array__Str_set(_va_Array_212, hoisted__U32_7158, &_til_str_lits[55], &_va_Array_212_ek);
    Bool hoisted__Bool_7161 = 1;
    expect(hoisted__Bool_7161, _va_Array_212, &_til_str_lits[56]);
    ...
    Array__Str_set(_va_Array_213, hoisted__U32_7164, &_til_str_lits[57], &_va_Array_213_ek);
    Bool hoisted__Bool_7166 = 1;
    expect(hoisted__Bool_7166, _va_Array_213, &_til_str_lits[58]);
    Str_delete(&_til_str_lits[58], (Bool){0});
    U32 hoisted__U32_7168 = 1;
    Array__Str *_va_Array_214 = Array__Str_new(hoisted__U32_7168);
    I64 _va_Array_214_ek = 0;
    U32 hoisted__U32_7169 = 0;
    Array__Str_set(_va_Array_214, hoisted__U32_7169, &_til_str_lits[59], &_va_Array_214_ek);
    Bool hoisted__Bool_7172 = 1;
    expect(hoisted__Bool_7172, _va_Array_214, &_til_str_lits[60]);
    ...
    Array__Str_set(_va_Array_215, hoisted__U32_7175, &_til_str_lits[61], &_va_Array_215_ek);
    Bool hoisted__Bool_7177 = 1;
    expect(hoisted__Bool_7177, _va_Array_215, &_til_str_lits[62]);
    Str_delete(&_til_str_lits[62], (Bool){0});
    U32 hoisted__U32_7179 = 1;
    Array__Str *_va_Array_216 = Array__Str_new(hoisted__U32_7179);
    I64 _va_Array_216_ek = 0;
    U32 hoisted__U32_7180 = 0;
    Array__Str_set(_va_Array_216, hoisted__U32_7180, &_til_str_lits[63], &_va_Array_216_ek);
    Bool hoisted__Bool_7183 = 1;
    expect(hoisted__Bool_7183, _va_Array_216, &_til_str_lits[64]);
    ...
    Array__Str_set(_va_Array_217, hoisted__U32_7186, &_til_str_lits[65], &_va_Array_217_ek);
    Bool hoisted__Bool_7188 = 1;
    expect(hoisted__Bool_7188, _va_Array_217, &_til_str_lits[66]);
    Str_delete(&_til_str_lits[66], (Bool){0});
    Bool _m_Bool_7135 = 0;
    {
        Bool hoisted__Bool_7140 = 0;
        if (hoisted__Bool_7140) {
            Bool hoisted__Bool_7137 = 1;
            _m_Bool_7135 = hoisted__Bool_7137;
        } else {
            Bool hoisted__Bool_7138 = 1;
            _m_Bool_7135 = hoisted__Bool_7138;
        }
    }
    U32 hoisted__U32_7190 = 1;
    Array__Str *_va_Array_218 = Array__Str_new(hoisted__U32_7190);
    I64 _va_Array_218_ek = 0;
    U32 hoisted__U32_7191 = 0;
    Array__Str_set(_va_Array_218, hoisted__U32_7191, &_til_str_lits[67], &_va_Array_218_ek);
    expect(_m_Bool_7135, _va_Array_218, &_til_str_lits[68]);
    Str_delete(&_til_str_lits[68], (Bool){0});
}

void assert_eq__I64(I64 a, I64 b, Str * loc) {
    Bool hoisted__Bool_7251 = ((Bool)(a != b));
    if (hoisted__Bool_7251) {
        U32 hoisted__U32_7240 = 5;
        Array__Str *_va_Array_219 = Array__Str_new(hoisted__U32_7240);
        I64 _va_Array_219_ek = 0;
        U32 hoisted__U32_7241 = 0;
        Array__Str_set(_va_Array_219, hoisted__U32_7241, &_til_str_lits[69], &_va_Array_219_ek);
        U32 hoisted__U32_7243 = 1;
        Str *hoisted__Str_7244 = I64_to_str(a);
        Array__Str_set(_va_Array_219, hoisted__U32_7243, hoisted__Str_7244, &_va_Array_219_ek);
        U32 hoisted__U32_7245 = 2;
        Array__Str_set(_va_Array_219, hoisted__U32_7245, &_til_str_lits[70], &_va_Array_219_ek);
        U32 hoisted__U32_7247 = 3;
        Str *hoisted__Str_7248 = I64_to_str(b);
        Array__Str_set(_va_Array_219, hoisted__U32_7247, hoisted__Str_7248, &_va_Array_219_ek);
        U32 hoisted__U32_7249 = 4;
        Array__Str_set(_va_Array_219, hoisted__U32_7249, &_til_str_lits[71], &_va_Array_219_ek);
        panic(_va_Array_219, loc);
    }
}

void assert_eq__Str(Str * a, Str * b, Str * loc) {
    Bool hoisted__Bool_7263 = Str_neq(a, b);
    if (hoisted__Bool_7263) {
        U32 hoisted__U32_7252 = 5;
        Array__Str *_va_Array_220 = Array__Str_new(hoisted__U32_7252);
        I64 _va_Array_220_ek = 0;
        U32 hoisted__U32_7253 = 0;
        Array__Str_set(_va_Array_220, hoisted__U32_7253, &_til_str_lits[69], &_va_Array_220_ek);
        U32 hoisted__U32_7255 = 1;
        Str *hoisted__Str_7256 = Str_to_str(a);
        Array__Str_set(_va_Array_220, hoisted__U32_7255, hoisted__Str_7256, &_va_Array_220_ek);
        U32 hoisted__U32_7257 = 2;
        Array__Str_set(_va_Array_220, hoisted__U32_7257, &_til_str_lits[70], &_va_Array_220_ek);
        U32 hoisted__U32_7259 = 3;
        Str *hoisted__Str_7260 = Str_to_str(b);
        Array__Str_set(_va_Array_220, hoisted__U32_7259, hoisted__Str_7260, &_va_Array_220_ek);
        U32 hoisted__U32_7261 = 4;
        Array__Str_set(_va_Array_220, hoisted__U32_7261, &_til_str_lits[71], &_va_Array_220_ek);
