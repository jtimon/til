...
void test_simple_add(void) {
    I64 result = 3;
    Str hoisted__Str_3160 = (Str){.c_str = (void *)"test/constfold.til:15:15", .count = 24ULL, .cap = TIL_CAP_LIT};
    I64 hoisted__I64_3161 = 3;
...
void test_nested_arithmetic(void) {
    I64 result = 15;
    Str hoisted__Str_3168 = (Str){.c_str = (void *)"test/constfold.til:21:15", .count = 24ULL, .cap = TIL_CAP_LIT};
    I64 hoisted__I64_3169 = 15;
...
void test_deeply_nested(void) {
    I64 result = 26;
    Str hoisted__Str_3176 = (Str){.c_str = (void *)"test/constfold.til:27:15", .count = 24ULL, .cap = TIL_CAP_LIT};
    I64 hoisted__I64_3177 = 26;
    assert_eq(&hoisted__Str_3176, &result, &hoisted__I64_3177);
    Str_delete(&hoisted__Str_3176, &(Bool){0});
}

void test_string_concat(void) {
    Str result = (Str){.c_str = (void *)"hello world", .count = 11ULL, .cap = TIL_CAP_LIT};
    Str hoisted__Str_3180 = (Str){.c_str = (void *)"test/constfold.til:33:19", .count = 24ULL, .cap = TIL_CAP_LIT};
    Str hoisted__Str_3181 = (Str){.c_str = (void *)"hello world", .count = 11ULL, .cap = TIL_CAP_LIT};
    assert_eq_str(&hoisted__Str_3180, &result, &hoisted__Str_3181);
    Str_delete(&hoisted__Str_3180, &(Bool){0});
...
void test_lolalalo(void) {
    ...
    Str hoisted__Str_3512 = (Str){.c_str = (void *)"test/constfold.til:86:19", .count = 24ULL, .cap = TIL_CAP_LIT};
    assert_eq_str(&hoisted__Str_3512, &lola_rec, &lola_it);
    Str_delete(&hoisted__Str_3512, &(Bool){0});
    Str_delete(&lola_it, &(Bool){0});
    Str_delete(&lola_rec, &(Bool){0});
    Str hoisted__Str_3513 = (Str){.c_str = (void *)"test/constfold.til:87:19", .count = 24ULL, .cap = TIL_CAP_LIT};
    assert_eq_str(&hoisted__Str_3513, &lalo_rec, &lalo_it);
...
void test_fold_variable(void) {
    I64 result = 8;
    Str hoisted__Str_3515 = (Str){.c_str = (void *)"test/constfold.til:94:15", .count = 24ULL, .cap = TIL_CAP_LIT};
    I64 hoisted__I64_3516 = 8;
    assert_eq(&hoisted__Str_3515, &result, &hoisted__I64_3516);
    Str_delete(&hoisted__Str_3515, &(Bool){0});
}

void test_loc_folded(void) {
    Str hoisted__Str_3519 = (Str){.c_str = (void *)"test/constfold.til:99:12", .count = 24ULL, .cap = TIL_CAP_LIT};
    Bool hoisted__Bool_3520 = 1;
    Bool_delete(assert(&hoisted__Str_3519, &hoisted__Bool_3520), &(Bool){1});
    Str_delete(&hoisted__Str_3519, &(Bool){0});
    Str hoisted__Str_3524 = (Str){.c_str = (void *)"test/constfold.til:100:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    Bool hoisted__Bool_3525 = 1;
    Bool_delete(assert(&hoisted__Str_3524, &hoisted__Bool_3525), &(Bool){1});
    Str_delete(&hoisted__Str_3524, &(Bool){0});
}

CfVec2 * CfVec2_magic(void) {
    I64 hoisted__I64_3527 = 42;
    I64 hoisted__I64_3528 = 99;
    CfVec2 hoisted__CfVec2_3529 = (CfVec2){.x = hoisted__I64_3527, .y = hoisted__I64_3528};
    { CfVec2 *_r = malloc(sizeof(CfVec2)); *_r = hoisted__CfVec2_3529; return _r; }
}

CfVec2 * CfVec2_at(I64 * x, I64 * y) {
    CfVec2 hoisted__CfVec2_3530 = (CfVec2){.x = DEREF(x), .y = DEREF(y)};
    { CfVec2 *_r = malloc(sizeof(CfVec2)); *_r = hoisted__CfVec2_3530; return _r; }
}

CfVec2 * CfVec2_clone(CfVec2 * self) {
    CfVec2 hoisted__CfVec2_3531 = (CfVec2){.x = self->x, .y = self->y};
...
U32 CfRect_size(void) {
    I64 hoisted__I64_3549 = 32;
    return hoisted__I64_3549;
}

void test_struct_fold_nested(void) {
    CfRect *r = CfRect_sample();
    Str hoisted__Str_3550 = (Str){.c_str = (void *)"test/constfold.til:146:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    I64 hoisted__I64_3551 = 5;
    assert_eq(&hoisted__Str_3550, &r->top_left.x, &hoisted__I64_3551);
    Str_delete(&hoisted__Str_3550, &(Bool){0});
    Str hoisted__Str_3552 = (Str){.c_str = (void *)"test/constfold.til:147:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    I64 hoisted__I64_3553 = 10;
    assert_eq(&hoisted__Str_3552, &r->top_left.y, &hoisted__I64_3553);
    Str_delete(&hoisted__Str_3552, &(Bool){0});
    Str hoisted__Str_3554 = (Str){.c_str = (void *)"test/constfold.til:148:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    I64 hoisted__I64_3555 = 100;
    assert_eq(&hoisted__Str_3554, &r->bottom_right.x, &hoisted__I64_3555);
    Str_delete(&hoisted__Str_3554, &(Bool){0});
    Str hoisted__Str_3556 = (Str){.c_str = (void *)"test/constfold.til:149:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    I64 hoisted__I64_3557 = 200;
    assert_eq(&hoisted__Str_3556, &r->bottom_right.y, &hoisted__I64_3557);
...
Bool Color_eq(Color * self, Color * other) {
    Bool hoisted__Bool_3562 = is(self, &(Color){.tag = Color_TAG_Red});
    if (hoisted__Bool_3562) {
        Bool hoisted__Bool_3559 = is(other, &(Color){.tag = Color_TAG_Red});
        return hoisted__Bool_3559;
    }
    Bool hoisted__Bool_3563 = is(self, &(Color){.tag = Color_TAG_Green});
    if (hoisted__Bool_3563) {
        Bool hoisted__Bool_3560 = is(other, &(Color){.tag = Color_TAG_Green});
        return hoisted__Bool_3560;
    }
    Bool hoisted__Bool_3564 = is(self, &(Color){.tag = Color_TAG_Blue});
    if (hoisted__Bool_3564) {
        Bool hoisted__Bool_3561 = is(other, &(Color){.tag = Color_TAG_Blue});
...
Color * Color_clone(Color * self) {
    Bool hoisted__Bool_3573 = Color_eq(self, &(Color){.tag = Color_TAG_Red});
    if (hoisted__Bool_3573) {
        { Color *_r = malloc(sizeof(Color)); _r->tag = Color_TAG_Red; return _r; }
    }
    Bool hoisted__Bool_3574 = Color_eq(self, &(Color){.tag = Color_TAG_Green});
    if (hoisted__Bool_3574) {
        { Color *_r = malloc(sizeof(Color)); _r->tag = Color_TAG_Green; return _r; }
    }
    Bool hoisted__Bool_3575 = Color_eq(self, &(Color){.tag = Color_TAG_Blue});
    if (hoisted__Bool_3575) {
        { Color *_r = malloc(sizeof(Color)); _r->tag = Color_TAG_Blue; return _r; }
    }
    Str hoisted__Str_3576 = (Str){.c_str = (void *)"Color.clone:154:1", .count = 17ULL, .cap = TIL_CAP_LIT};
    UNREACHABLE(&hoisted__Str_3576);
    Str_delete(&hoisted__Str_3576, &(Bool){0});
    { Color *_r = malloc(sizeof(Color)); _r->tag = Color_TAG_Red; return _r; }
}

U32 Color_size(void) {
    I64 hoisted__I64_3577 = 4;
    return hoisted__I64_3577;
}


void test_enum_fold(void) {
    Color *c = Color_clone(&(Color){.tag = Color_TAG_Red});
    Str hoisted__Str_3578 = (Str){.c_str = (void *)"test/constfold.til:159:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    Bool hoisted__Bool_3579 = Color_eq(c, &(Color){.tag = Color_TAG_Red});
    Bool_delete(assert(&hoisted__Str_3578, &hoisted__Bool_3579), &(Bool){1});
    Str_delete(&hoisted__Str_3578, &(Bool){0});
    Bool hoisted__Bool_3581 = Color_eq(c, &(Color){.tag = Color_TAG_Green});
    Color_delete(c, &(Bool){1});
    Str hoisted__Str_3582 = (Str){.c_str = (void *)"test/constfold.til:160:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    Bool hoisted__Bool_3583 = not(hoisted__Bool_3581);
    Bool_delete(assert(&hoisted__Str_3582, &hoisted__Bool_3583), &(Bool){1});
...
Bool Token_is(Token * self, Token * other) {
    Bool hoisted__Bool_3585 = is(self, other);
    return hoisted__Bool_3585;
}

void Token_delete(Token * self, Bool * call_free) {
    Bool hoisted__Bool_3603 = is(self, &(Token){.tag = Token_TAG_Num});
    if (hoisted__Bool_3603) {
        I64 *hoisted__I64_3599 = get_payload(self);
        Bool hoisted__Bool_3600 = 0;
        I64_delete(hoisted__I64_3599, &hoisted__Bool_3600);
    }
    Bool hoisted__Bool_3604 = is(self, &(Token){.tag = Token_TAG_Name});
    if (hoisted__Bool_3604) {
        Str *hoisted__Str_3601 = get_payload(self);
        Bool hoisted__Bool_3602 = 0;
        Str_delete(hoisted__Str_3601, &hoisted__Bool_3602);
    }
    if (DEREF(call_free)) {
        free(self);
    }
...
Token * Token_clone(Token * self) {
    Bool hoisted__Bool_3632 = is(self, &(Token){.tag = Token_TAG_Num});
    if (hoisted__Bool_3632) {
        I64 *_clone_payload_Num_0 = get_payload(self);
        (void)_clone_payload_Num_0;
        (void)_clone_payload_Num_0;
        Token *hoisted__Token_3630 = Token_Num(_clone_payload_Num_0);
        return hoisted__Token_3630;
    }
    Bool hoisted__Bool_3633 = is(self, &(Token){.tag = Token_TAG_Name});
    if (hoisted__Bool_3633) {
        Str *_clone_payload_Name_1 = get_payload(self);
        (void)_clone_payload_Name_1;
        (void)_clone_payload_Name_1;
        Token *hoisted__Token_3631 = Token_Name(_clone_payload_Name_1);
        return hoisted__Token_3631;
    }
    { Token *_r = malloc(sizeof(Token)); _r->tag = Token_TAG_Eof; return _r; }
}

U32 Token_size(void) {
    I64 hoisted__I64_3634 = 24;
    return hoisted__I64_3634;
}


void test_enum_payload_fold(void) {
    I64 hoisted__I64_3635 = 42;
    Token *t = Token_Num(&hoisted__I64_3635);
    Str hoisted__Str_3636 = (Str){.c_str = (void *)"test/constfold.til:168:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    Bool hoisted__Bool_3637 = Token_is(t, &(Token){.tag = Token_TAG_Num});
    Bool_delete(assert(&hoisted__Str_3636, &hoisted__Bool_3637), &(Bool){1});
    Str_delete(&hoisted__Str_3636, &(Bool){0});
    Bool hoisted__Bool_3639 = Token_is(t, &(Token){.tag = Token_TAG_Eof});
    Token_delete(t, &(Bool){1});
    Str hoisted__Str_3640 = (Str){.c_str = (void *)"test/constfold.til:169:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    Bool hoisted__Bool_3641 = not(hoisted__Bool_3639);
    Bool_delete(assert(&hoisted__Str_3640, &hoisted__Bool_3641), &(Bool){1});
    Str_delete(&hoisted__Str_3640, &(Bool){0});
}
