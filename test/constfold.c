...
void Str_push_str(Str * self, Str * s) {
    ...
    if (hoisted__Bool_178) {
        ...
        static Str hoisted__Str_169 = (Str){.c_str = (void *)"./src/core/str.til:114:13", .count = 25ULL, .cap = TIL_CAP_LIT};
        ...
        static Str hoisted__Str_170 = (Str){.c_str = (void *)"./src/core/str.til:114:13", .count = 25ULL, .cap = TIL_CAP_LIT};
    ...
    if (hoisted__Bool_179) {
        ...
        static Str hoisted__Str_174 = (Str){.c_str = (void *)"./src/core/str.til:118:13", .count = 25ULL, .cap = TIL_CAP_LIT};
        ...
        static Str hoisted__Str_175 = (Str){.c_str = (void *)"./src/core/str.til:118:13", .count = 25ULL, .cap = TIL_CAP_LIT};
...
StructDef * StructDef_clone(StructDef * self) {
    StructDef *hoisted__StructDef_2868 = malloc(sizeof(StructDef));
    { Vec__Declaration *_ca = Vec__Declaration_clone(&self->fields); hoisted__StructDef_2868->fields = *_ca; free(_ca); }
    { Vec__Declaration *_ca = Vec__Declaration_clone(&self->ns_decls); hoisted__StructDef_2868->ns_decls = *_ca; free(_ca); }
    { Str *_ca = Str_clone(&self->c_tag); hoisted__StructDef_2868->c_tag = *_ca; free(_ca); }
    hoisted__StructDef_2868->is_interface = self->is_interface;
    hoisted__StructDef_2868->interface_ns_marker = self->interface_ns_marker;
    { Str *_ca = Str_clone(&self->implements_name); hoisted__StructDef_2868->implements_name = *_ca; free(_ca); }
    (void)hoisted__StructDef_2868;
    return hoisted__StructDef_2868;
}

void StructDef_delete(StructDef * self, Bool call_free) {
    Bool hoisted__Bool_2869 = 0;
    (void)hoisted__Bool_2869;
    Vec__Declaration_delete(&self->fields, hoisted__Bool_2869);
    Bool hoisted__Bool_2870 = 0;
    (void)hoisted__Bool_2870;
    Vec__Declaration_delete(&self->ns_decls, hoisted__Bool_2870);
    Bool hoisted__Bool_2871 = 0;
    (void)hoisted__Bool_2871;
    Str_delete(&self->c_tag, hoisted__Bool_2871);
    Bool hoisted__Bool_2872 = 0;
    (void)hoisted__Bool_2872;
    Bool_delete(&self->is_interface, hoisted__Bool_2872);
    Bool hoisted__Bool_2873 = 0;
    (void)hoisted__Bool_2873;
    Bool_delete(&self->interface_ns_marker, hoisted__Bool_2873);
    Bool hoisted__Bool_2874 = 0;
    (void)hoisted__Bool_2874;
    Str_delete(&self->implements_name, hoisted__Bool_2874);
    if (call_free) {
        free(self);
    }
}
...
U64 StructDef_hash(StructDef * self, HashFn hasher) {
    ...
    U64 hoisted__U64_2876 = ({ TilClosure *til_closure = (TilClosure *)(hasher); ((U64 (*)(void *, StructDef *, U32))til_closure->call)(til_closure->env, self, hoisted__U32_2875); });
...
EnumDef * EnumDef_clone(EnumDef * self) {
    EnumDef *hoisted__EnumDef_2882 = malloc(sizeof(EnumDef));
    { Vec__Declaration *_ca = Vec__Declaration_clone(&self->ns_decls); hoisted__EnumDef_2882->ns_decls = *_ca; free(_ca); }
    { Vec__Str *_ca = Vec__Str_clone(&self->variants); hoisted__EnumDef_2882->variants = *_ca; free(_ca); }
    { Map__I64_Str *_ca = Map__I64_Str_clone(&self->payload_types); hoisted__EnumDef_2882->payload_types = *_ca; free(_ca); }
    { Vec__Bool *_ca = Vec__Bool_clone(&self->payload_consts); hoisted__EnumDef_2882->payload_consts = *_ca; free(_ca); }
    { Str *_ca = Str_clone(&self->implements_name); hoisted__EnumDef_2882->implements_name = *_ca; free(_ca); }
    { Str *_ca = Str_clone(&self->tag_type); hoisted__EnumDef_2882->tag_type = *_ca; free(_ca); }
    { Vec__I64 *_ca = Vec__I64_clone(&self->tag_values); hoisted__EnumDef_2882->tag_values = *_ca; free(_ca); }
    (void)hoisted__EnumDef_2882;
    return hoisted__EnumDef_2882;
}
...
void EnumDef_delete(EnumDef * self, Bool call_free) {
    ...
    Vec__Str_delete(&self->variants, hoisted__Bool_2884);
    Bool hoisted__Bool_2885 = 0;
    (void)hoisted__Bool_2885;
    Map__I64_Str_delete(&self->payload_types, hoisted__Bool_2885);
    Bool hoisted__Bool_2886 = 0;
    (void)hoisted__Bool_2886;
    Vec__Bool_delete(&self->payload_consts, hoisted__Bool_2886);
    ...
    Str_delete(&self->tag_type, hoisted__Bool_2888);
    Bool hoisted__Bool_2889 = 0;
    (void)hoisted__Bool_2889;
    Vec__I64_delete(&self->tag_values, hoisted__Bool_2889);
    if (call_free) {
        free(self);
    }
}
...
U64 EnumDef_hash(EnumDef * self, HashFn hasher) {
    ...
    U64 hoisted__U64_2891 = ({ TilClosure *til_closure = (TilClosure *)(hasher); ((U64 (*)(void *, EnumDef *, U32))til_closure->call)(til_closure->env, self, hoisted__U32_2890); });
    (void)hoisted__U64_2891;
    return hoisted__U64_2891;
}

U32 EnumDef_size(void) {
    U32 hoisted__U32_2892 = 128;
    (void)hoisted__U32_2892;
    return hoisted__U32_2892;
}
...
void Literal_delete(Literal * self, Bool call_free) {
    ...
    Bool hoisted__Bool_3061 = ((Bool)(((Literal *)(self))->tag == ((Literal *)(&(Literal){.tag = Literal_TAG_Str}))->tag));
    ...
    Bool hoisted__Bool_3063 = ((Bool)(((Literal *)(self))->tag == ((Literal *)(&(Literal){.tag = Literal_TAG_Num}))->tag));
    ...
    Bool hoisted__Bool_3065 = ((Bool)(((Literal *)(self))->tag == ((Literal *)(&(Literal){.tag = Literal_TAG_Bool}))->tag));
...
Literal * Literal_clone(Literal * self) {
    ...
    Bool hoisted__Bool_3121 = ((Bool)(((Literal *)(self))->tag == ((Literal *)(&(Literal){.tag = Literal_TAG_Str}))->tag));
    ...
    Bool hoisted__Bool_3123 = ((Bool)(((Literal *)(self))->tag == ((Literal *)(&(Literal){.tag = Literal_TAG_Num}))->tag));
    ...
    Bool hoisted__Bool_3125 = ((Bool)(((Literal *)(self))->tag == ((Literal *)(&(Literal){.tag = Literal_TAG_Bool}))->tag));
    ...
    Bool hoisted__Bool_3127 = ((Bool)(((Literal *)(self))->tag == ((Literal *)(&(Literal){.tag = Literal_TAG_Null}))->tag));
    ...
    Bool hoisted__Bool_3129 = ((Bool)(((Literal *)(self))->tag == ((Literal *)(&(Literal){.tag = Literal_TAG_MapLit}))->tag));
...
void NodeType_delete(NodeType * self, Bool call_free) {
    ...
    Bool hoisted__Bool_3410 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Literal}))->tag));
    ...
    Bool hoisted__Bool_3412 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Ident}))->tag));
    ...
    Bool hoisted__Bool_3414 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Decl}))->tag));
    ...
    Bool hoisted__Bool_3416 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Assign}))->tag));
    ...
    Bool hoisted__Bool_3418 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_FCall}))->tag));
    ...
    Bool hoisted__Bool_3420 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_FuncDef}))->tag));
    ...
    Bool hoisted__Bool_3422 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_StructDef}))->tag));
    ...
    Bool hoisted__Bool_3424 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_EnumDef}))->tag));
    ...
    Bool hoisted__Bool_3426 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_FieldAccess}))->tag));
    ...
    Bool hoisted__Bool_3428 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_FieldAssign}))->tag));
    ...
    Bool hoisted__Bool_3430 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_ForIn}))->tag));
    ...
    Bool hoisted__Bool_3432 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_NamedArg}))->tag));
    ...
    Bool hoisted__Bool_3434 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Match}))->tag));
    ...
    Bool hoisted__Bool_3436 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_CaptureBlock}))->tag));
    ...
    Bool hoisted__Bool_3438 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_BodyValue}))->tag));
...
NodeType * NodeType_clone(NodeType * self) {
    ...
    Bool hoisted__Bool_3703 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Body}))->tag));
    ...
    Bool hoisted__Bool_3705 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Literal}))->tag));
    ...
    Bool hoisted__Bool_3707 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Ident}))->tag));
    ...
    Bool hoisted__Bool_3709 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Decl}))->tag));
    ...
    Bool hoisted__Bool_3711 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Assign}))->tag));
    ...
    Bool hoisted__Bool_3713 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_FCall}))->tag));
    ...
    Bool hoisted__Bool_3715 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_FuncDef}))->tag));
    ...
    Bool hoisted__Bool_3717 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_StructDef}))->tag));
    ...
    Bool hoisted__Bool_3719 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_EnumDef}))->tag));
    ...
    Bool hoisted__Bool_3721 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_FieldAccess}))->tag));
    ...
    Bool hoisted__Bool_3723 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_FieldAssign}))->tag));
    ...
    Bool hoisted__Bool_3725 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Return}))->tag));
    ...
    Bool hoisted__Bool_3727 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_If}))->tag));
    ...
    Bool hoisted__Bool_3729 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_While}))->tag));
    ...
    Bool hoisted__Bool_3731 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_ForIn}))->tag));
    ...
    Bool hoisted__Bool_3733 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_NamedArg}))->tag));
    ...
    Bool hoisted__Bool_3735 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Break}))->tag));
    ...
    Bool hoisted__Bool_3737 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Continue}))->tag));
    ...
    Bool hoisted__Bool_3739 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Switch}))->tag));
    ...
    Bool hoisted__Bool_3741 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Match}))->tag));
    ...
    Bool hoisted__Bool_3743 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Case}))->tag));
    ...
    Bool hoisted__Bool_3745 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_NoDefaultArg}))->tag));
    ...
    Bool hoisted__Bool_3747 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Throw}))->tag));
    ...
    Bool hoisted__Bool_3749 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Catch}))->tag));
    ...
    Bool hoisted__Bool_3751 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_RestPattern}))->tag));
    ...
    Bool hoisted__Bool_3753 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_CaptureBlock}))->tag));
    ...
    Bool hoisted__Bool_3755 = ((Bool)(((NodeType *)(self))->tag == ((NodeType *)(&(NodeType){.tag = NodeType_TAG_Loc}))->tag));
...
void Expr_delete(Expr * self, Bool call_free) {
    Bool hoisted__Bool_3759 = ((Bool)((UPtr)(self) == 0));
...
Bool is_null(void * p) {
    Bool hoisted__Bool_7708 = ptr_eq(p, NULL);
    (void)hoisted__Bool_7708;
    return hoisted__Bool_7708;
}
...
Range * Range_clone(Range * val) {
    Range hoisted__Range_7717 = (Range){.start = val->start, .end = val->end};
    (void)hoisted__Range_7717;
    { Range *_r = malloc(sizeof(Range)); *_r = hoisted__Range_7717;
    return _r; }
}
...
U64 Range_hash(Range * self, HashFn hasher) {
    U32 hoisted__U32_7718 = 0;
    (void)hoisted__U32_7718;
    U64 hoisted__U64_7719 = ({ TilClosure *til_closure = (TilClosure *)(hasher); ((U64 (*)(void *, Range *, U32))til_closure->call)(til_closure->env, self, hoisted__U32_7718); });
    (void)hoisted__U64_7719;
    return hoisted__U64_7719;
}

U32 Range_size(void) {
    U32 hoisted__U32_7750 = 16;
    (void)hoisted__U32_7750;
    return hoisted__U32_7750;
}

void test_simple_add(void) {
    I64 result = 3;
    I64 hoisted__I64_7766 = 3;
    (void)hoisted__I64_7766;
    (void)_til_str_lit_152;
    (void)_til_str_lit_152;
    assert_eq__I64(result, hoisted__I64_7766, &_til_str_lit_152);
    Str_delete(&_til_str_lit_152, (Bool){0});
}

void test_nested_arithmetic(void) {
    I64 result = 15;
    I64 hoisted__I64_7774 = 15;
    (void)hoisted__I64_7774;
    (void)_til_str_lit_153;
    (void)_til_str_lit_153;
    assert_eq__I64(result, hoisted__I64_7774, &_til_str_lit_153);
    Str_delete(&_til_str_lit_153, (Bool){0});
}

void test_deeply_nested(void) {
    I64 result = 26;
    I64 hoisted__I64_7782 = 26;
    (void)hoisted__I64_7782;
    (void)_til_str_lit_154;
    (void)_til_str_lit_154;
    assert_eq__I64(result, hoisted__I64_7782, &_til_str_lit_154);
...
void test_variadic_direct_fold(void) {
    ...
    (void)_til_str_lit_164;
    assert_eq__I64(d3, hoisted__I64_7869, &_til_str_lit_164);
...
void test_fold_variable(void) {
    ...
    (void)_til_str_lit_169;
    assert_eq__I64(result, hoisted__I64_8472, &_til_str_lit_169);
...
void test_struct_fold_simple(void) {
    ...
    (void)_til_str_lit_178;
    assert_eq__I64(v.x, hoisted__I64_8532, &_til_str_lit_178);
    Str_delete(&_til_str_lit_178, (Bool){0});
    I64 hoisted__I64_8534 = 99;
    (void)hoisted__I64_8534;
    (void)_til_str_lit_179;
    (void)_til_str_lit_179;
    assert_eq__I64(v.y, hoisted__I64_8534, &_til_str_lit_179);
...
void test_struct_fold_values(void) {
    ...
    (void)_til_str_lit_180;
    assert_eq__I64(p.x, hoisted__I64_8538, &_til_str_lit_180);
    Str_delete(&_til_str_lit_180, (Bool){0});
    I64 hoisted__I64_8540 = 20;
    (void)hoisted__I64_8540;
    (void)_til_str_lit_181;
    (void)_til_str_lit_181;
    assert_eq__I64(p.y, hoisted__I64_8540, &_til_str_lit_181);
...
void test_struct_fold_f32(void) {
    ...
    (void)_til_str_lit_191;
    assert_eq__Str(hoisted__Str_8639, &_til_str_lit_190, &_til_str_lit_191);
    ...
    (void)_til_str_lit_193;
    assert_eq__Str(hoisted__Str_8642, &_til_str_lit_192, &_til_str_lit_193);
    ...
    (void)_til_str_lit_195;
    assert_eq__Str(hoisted__Str_8645, &_til_str_lit_194, &_til_str_lit_195);
...
Bool Color_eq(Color * self, Color * other) {
    ...
    Bool hoisted__Bool_8657 = ((Bool)(((Color *)(self))->tag == ((Color *)(&(Color){.tag = Color_TAG_Red}))->tag));
    (void)hoisted__Bool_8657;
    if (hoisted__Bool_8657) {
        U32 hoisted__U32_8650 = 1;
        (void)hoisted__U32_8650;
        Bool hoisted__Bool_8651 = ((Bool)(((Color *)(other))->tag == ((Color *)(&(Color){.tag = Color_TAG_Red}))->tag));
    ...
    Bool hoisted__Bool_8659 = ((Bool)(((Color *)(self))->tag == ((Color *)(&(Color){.tag = Color_TAG_Green}))->tag));
    (void)hoisted__Bool_8659;
    if (hoisted__Bool_8659) {
        U32 hoisted__U32_8652 = 1;
        (void)hoisted__U32_8652;
        Bool hoisted__Bool_8653 = ((Bool)(((Color *)(other))->tag == ((Color *)(&(Color){.tag = Color_TAG_Green}))->tag));
        (void)hoisted__Bool_8653;
        { Bool _ret_val = hoisted__Bool_8653;
                return _ret_val; }
    }
    U32 hoisted__U32_8660 = 1;
    (void)hoisted__U32_8660;
    Bool hoisted__Bool_8661 = ((Bool)(((Color *)(self))->tag == ((Color *)(&(Color){.tag = Color_TAG_Blue}))->tag));
    (void)hoisted__Bool_8661;
    if (hoisted__Bool_8661) {
        U32 hoisted__U32_8654 = 1;
        (void)hoisted__U32_8654;
        Bool hoisted__Bool_8655 = ((Bool)(((Color *)(other))->tag == ((Color *)(&(Color){.tag = Color_TAG_Blue}))->tag));
        (void)hoisted__Bool_8655;
        { Bool _ret_val = hoisted__Bool_8655;
                return _ret_val; }
    }
    Bool hoisted__Bool_8662 = 0;
    (void)hoisted__Bool_8662;
    return hoisted__Bool_8662;
}
...
Color * Color_clone(Color * self) {
    Bool hoisted__Bool_8670 = Color_eq(self, &(Color){.tag = Color_TAG_Red});
    (void)hoisted__Bool_8670;
    if (hoisted__Bool_8670) {
        { Color *_r = malloc(sizeof(Color)); _r->tag = Color_TAG_Red;
                return _r; }
    }
    Bool hoisted__Bool_8671 = Color_eq(self, &(Color){.tag = Color_TAG_Green});
    (void)hoisted__Bool_8671;
    if (hoisted__Bool_8671) {
        { Color *_r = malloc(sizeof(Color)); _r->tag = Color_TAG_Green;
                return _r; }
    }
    Bool hoisted__Bool_8672 = Color_eq(self, &(Color){.tag = Color_TAG_Blue});
    (void)hoisted__Bool_8672;
    if (hoisted__Bool_8672) {
        { Color *_r = malloc(sizeof(Color)); _r->tag = Color_TAG_Blue;
                return _r; }
    }
    static Str hoisted__Str_8673 = (Str){.c_str = (void *)"Color.clone:235:1", .count = 17ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_8673;
    UNREACHABLE(&hoisted__Str_8673);
...
U32 Color_size(void) {
    U32 hoisted__U32_8674 = 1;
    (void)hoisted__U32_8674;
    return hoisted__U32_8674;
}


void test_enum_fold(void) {
    Color c = (Color){.tag = Color_TAG_Red};
    Bool hoisted__Bool_8675 = Color_eq(&c, &(Color){.tag = Color_TAG_Red});
    (void)hoisted__Bool_8675;
    (void)_til_str_lit_199;
    (void)_til_str_lit_199;
    assert(hoisted__Bool_8675, &_til_str_lit_199);
    Str_delete(&_til_str_lit_199, (Bool){0});
    Bool hoisted__Bool_8677 = Color_eq(&c, &(Color){.tag = Color_TAG_Green});
    (void)hoisted__Bool_8677;
    Bool hoisted__Bool_8678 = not(hoisted__Bool_8677);
...
Bool Token_is(Token * self, Token * other) {
    ...
    Bool hoisted__Bool_8681 = ((Bool)(((Token *)(self))->tag == ((Token *)(other))->tag));
    (void)hoisted__Bool_8681;
    return hoisted__Bool_8681;
}

void Token_delete(Token * self, Bool call_free) {
    U32 hoisted__U32_8705 = 1;
    (void)hoisted__U32_8705;
    Bool hoisted__Bool_8706 = ((Bool)(((Token *)(self))->tag == ((Token *)(&(Token){.tag = Token_TAG_Num}))->tag));
    (void)hoisted__Bool_8706;
    if (hoisted__Bool_8706) {
        I64 *hoisted__I64_8701 = get_payload(self);
        (void)hoisted__I64_8701;
        (void)hoisted__I64_8701;
        Bool hoisted__Bool_8702 = 0;
        (void)hoisted__Bool_8702;
        I64_delete(hoisted__I64_8701, hoisted__Bool_8702);
    }
    U32 hoisted__U32_8707 = 1;
    (void)hoisted__U32_8707;
    Bool hoisted__Bool_8708 = ((Bool)(((Token *)(self))->tag == ((Token *)(&(Token){.tag = Token_TAG_Name}))->tag));
    (void)hoisted__Bool_8708;
    if (hoisted__Bool_8708) {
        Str *hoisted__Str_8703 = get_payload(self);
        (void)hoisted__Str_8703;
        (void)hoisted__Str_8703;
        Bool hoisted__Bool_8704 = 0;
        (void)hoisted__Bool_8704;
        Str_delete(hoisted__Str_8703, hoisted__Bool_8704);
    }
    if (call_free) {
        free(self);
    }
...
Token * Token_clone(Token * self) {
    U32 hoisted__U32_8742 = 1;
    (void)hoisted__U32_8742;
    Bool hoisted__Bool_8743 = ((Bool)(((Token *)(self))->tag == ((Token *)(&(Token){.tag = Token_TAG_Num}))->tag));
    (void)hoisted__Bool_8743;
    if (hoisted__Bool_8743) {
        I64 *_clone_payload_Num_0 = get_payload(self);
        (void)_clone_payload_Num_0;
        (void)_clone_payload_Num_0;
        Token *hoisted__Token_8739 = Token_Num(_clone_payload_Num_0);
        (void)hoisted__Token_8739;
        { Token * _ret_val = hoisted__Token_8739;
                return _ret_val; }
    }
    U32 hoisted__U32_8744 = 1;
    (void)hoisted__U32_8744;
    Bool hoisted__Bool_8745 = ((Bool)(((Token *)(self))->tag == ((Token *)(&(Token){.tag = Token_TAG_Name}))->tag));
    (void)hoisted__Bool_8745;
    if (hoisted__Bool_8745) {
        Str *_clone_payload_Name_1 = get_payload(self);
        (void)_clone_payload_Name_1;
        (void)_clone_payload_Name_1;
        Str *hoisted__Str_8740 = Str_clone(_clone_payload_Name_1);
        (void)hoisted__Str_8740;
        Token *hoisted__Token_8741 = Token_Name(hoisted__Str_8740);
        (void)hoisted__Token_8741;
        { Token * _ret_val = hoisted__Token_8741;
                return _ret_val; }
    }
...
U32 Token_size(void) {
    U32 hoisted__U32_8746 = 24;
    (void)hoisted__U32_8746;
    return hoisted__U32_8746;
}


void test_enum_payload_fold(void) {
    Token *t = Token_Num(&(I64){42});
    Bool hoisted__Bool_8748 = Token_is(t, &(Token){.tag = Token_TAG_Num});
    (void)hoisted__Bool_8748;
    (void)_til_str_lit_203;
    (void)_til_str_lit_203;
    assert(hoisted__Bool_8748, &_til_str_lit_203);
    Str_delete(&_til_str_lit_203, (Bool){0});
    Bool hoisted__Bool_8750 = Token_is(t, &(Token){.tag = Token_TAG_Eof});
    (void)hoisted__Bool_8750;
    Bool hoisted__Bool_8751 = not(hoisted__Bool_8750);
...
void test_enum_return_fold(void) {
    ...
    Bool hoisted__Bool_8753 = Color_eq(&c, &(Color){.tag = Color_TAG_Green});
    (void)hoisted__Bool_8753;
    (void)_til_str_lit_205;
    (void)_til_str_lit_205;
    assert(hoisted__Bool_8753, &_til_str_lit_205);
    Str_delete(&_til_str_lit_205, (Bool){0});
    Bool hoisted__Bool_8755 = Color_eq(&c, &(Color){.tag = Color_TAG_Red});
    (void)hoisted__Bool_8755;
    Bool hoisted__Bool_8756 = not(hoisted__Bool_8755);
...
void test_enum_payload_return_fold(void) {
    ...
    Bool hoisted__Bool_8760 = Token_is(t, &(Token){.tag = Token_TAG_Num});
    (void)hoisted__Bool_8760;
    (void)_til_str_lit_207;
    (void)_til_str_lit_207;
    assert(hoisted__Bool_8760, &_til_str_lit_207);
    Str_delete(&_til_str_lit_207, (Bool){0});
    Bool hoisted__Bool_8762 = Token_is(t, &(Token){.tag = Token_TAG_Eof});
    (void)hoisted__Bool_8762;
    Bool hoisted__Bool_8763 = not(hoisted__Bool_8762);
...
void assert_eq__I64(I64 a, I64 b, Str * loc) {
    Bool hoisted__Bool_8896 = ((Bool)(a != b));
    (void)hoisted__Bool_8896;
    if (hoisted__Bool_8896) {
        U32 hoisted__U32_8880 = 5;
        (void)hoisted__U32_8880;
        Array__Str *_va_Array_253 = Array__Str_new(hoisted__U32_8880);
        (void)_va_Array_253;
        ...
        U32 hoisted__U32_8881 = 0;
        (void)hoisted__U32_8881;
        (void)_til_str_lit_209;
        (void)_til_str_lit_209;
        (void)_til_str_lit_210;
        (void)_til_str_lit_210;
        Array__Str_set(_va_Array_253, hoisted__U32_8881, &_til_str_lit_209, &_va_Array_253_ek, _va_Array_253_eo, &_til_str_lit_210);
        Str_delete(&_til_str_lit_210, (Bool){0});
        U32 hoisted__U32_8884 = 1;
        (void)hoisted__U32_8884;
        Str *hoisted__Str_8885 = I64_to_str(a);
        (void)hoisted__Str_8885;
        (void)_til_str_lit_210;
        (void)_til_str_lit_210;
        Array__Str_set(_va_Array_253, hoisted__U32_8884, hoisted__Str_8885, &_va_Array_253_ek, _va_Array_253_eo, &_til_str_lit_210);
        Str_delete(&_til_str_lit_210, (Bool){0});
        U32 hoisted__U32_8887 = 2;
        (void)hoisted__U32_8887;
        (void)_til_str_lit_211;
        (void)_til_str_lit_211;
        (void)_til_str_lit_210;
        (void)_til_str_lit_210;
        Array__Str_set(_va_Array_253, hoisted__U32_8887, &_til_str_lit_211, &_va_Array_253_ek, _va_Array_253_eo, &_til_str_lit_210);
        Str_delete(&_til_str_lit_210, (Bool){0});
        U32 hoisted__U32_8890 = 3;
        (void)hoisted__U32_8890;
        Str *hoisted__Str_8891 = I64_to_str(b);
        ...
        Str_delete(&_til_str_lit_210, (Bool){0});
        U32 hoisted__U32_8893 = 4;
        (void)hoisted__U32_8893;
        (void)_til_str_lit_212;
        (void)_til_str_lit_212;
        (void)_til_str_lit_210;
        (void)_til_str_lit_210;
        Array__Str_set(_va_Array_253, hoisted__U32_8893, &_til_str_lit_212, &_va_Array_253_ek, _va_Array_253_eo, &_til_str_lit_210);
...
void assert_eq__Str(Str * a, Str * b, Str * loc) {
    Bool hoisted__Bool_8913 = Str_neq(a, b);
    (void)hoisted__Bool_8913;
    if (hoisted__Bool_8913) {
        U32 hoisted__U32_8897 = 5;
        (void)hoisted__U32_8897;
        Array__Str *_va_Array_254 = Array__Str_new(hoisted__U32_8897);
        (void)_va_Array_254;
        ...
        U32 hoisted__U32_8898 = 0;
        (void)hoisted__U32_8898;
        (void)_til_str_lit_209;
        (void)_til_str_lit_209;
        (void)_til_str_lit_210;
        (void)_til_str_lit_210;
        Array__Str_set(_va_Array_254, hoisted__U32_8898, &_til_str_lit_209, &_va_Array_254_ek, _va_Array_254_eo, &_til_str_lit_210);
        Str_delete(&_til_str_lit_210, (Bool){0});
        U32 hoisted__U32_8901 = 1;
        (void)hoisted__U32_8901;
        Str *hoisted__Str_8902 = Str_to_str(a);
        (void)hoisted__Str_8902;
        (void)_til_str_lit_210;
        (void)_til_str_lit_210;
        Array__Str_set(_va_Array_254, hoisted__U32_8901, hoisted__Str_8902, &_va_Array_254_ek, _va_Array_254_eo, &_til_str_lit_210);
        Str_delete(&_til_str_lit_210, (Bool){0});
        U32 hoisted__U32_8904 = 2;
        (void)hoisted__U32_8904;
        (void)_til_str_lit_211;
        (void)_til_str_lit_211;
        (void)_til_str_lit_210;
        (void)_til_str_lit_210;
        Array__Str_set(_va_Array_254, hoisted__U32_8904, &_til_str_lit_211, &_va_Array_254_ek, _va_Array_254_eo, &_til_str_lit_210);
        Str_delete(&_til_str_lit_210, (Bool){0});
        U32 hoisted__U32_8907 = 3;
        (void)hoisted__U32_8907;
        Str *hoisted__Str_8908 = Str_to_str(b);
        ...
        Str_delete(&_til_str_lit_210, (Bool){0});
        U32 hoisted__U32_8910 = 4;
        (void)hoisted__U32_8910;
        (void)_til_str_lit_212;
        (void)_til_str_lit_212;
        (void)_til_str_lit_210;
        (void)_til_str_lit_210;
        Array__Str_set(_va_Array_254, hoisted__U32_8910, &_til_str_lit_212, &_va_Array_254_ek, _va_Array_254_eo, &_til_str_lit_210);
