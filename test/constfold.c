...
Array * Array_new_type_name(Str * elem_type, U32 cap) {
    Bool hoisted__Bool_3701 = Str_is_empty(elem_type);
    (void)hoisted__Bool_3701;
    if (hoisted__Bool_3701) {
        Type *hoisted__Type_3696 = Type_Struct(({ Str *_lit = malloc(sizeof(Str)); *_lit = (Str){.c_str = (void *)"Str", .count = 3ULL, .cap = TIL_CAP_LIT}; _lit; }));
        (void)hoisted__Type_3696;
        U32 hoisted__U32_3697 = 1;
        (void)hoisted__U32_3697;
        Array *_va_Array_113 = Array_new(hoisted__Type_3696, hoisted__U32_3697);
        (void)_va_Array_113;
        Type_delete(hoisted__Type_3696, 1);
        U32 hoisted__U32_3698 = 0;
        (void)hoisted__U32_3698;
        Str hoisted__Str_3699 = (Str){.c_str = (void *)"Array.new: elem_type required", .count = 29ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_3699;
        Array_set(_va_Array_113, hoisted__U32_3698, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_3699; _oa; }));
        Str hoisted__Str_3700 = (Str){.c_str = (void *)"./src/core/array.til:22:41", .count = 26ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_3700;
        panic(&hoisted__Str_3700, _va_Array_113);
        Str_delete(&hoisted__Str_3700, (Bool){0});
    }
    U32 elem_size = dyn_size_of(elem_type);
    void * hoisted__v_3702 = calloc(cap, elem_size);
    (void)hoisted__v_3702;
    void * hoisted__v_3703 = dyn_fn(elem_type, &(Str){.c_str=(void*)"clone", .count=5ULL, .cap=TIL_CAP_LIT});
    (void)hoisted__v_3703;
    void * hoisted__v_3704 = dyn_fn(elem_type, &(Str){.c_str=(void*)"delete", .count=6ULL, .cap=TIL_CAP_LIT});
    (void)hoisted__v_3704;
    Array *hoisted__Array_3705 = malloc(sizeof(Array));
    hoisted__Array_3705->data = hoisted__v_3702;
    hoisted__Array_3705->cap = cap;
    hoisted__Array_3705->elem_size = elem_size;
    hoisted__Array_3705->elem_clone = hoisted__v_3703;
    hoisted__Array_3705->elem_delete = hoisted__v_3704;
    (void)hoisted__Array_3705;
    return hoisted__Array_3705;
}

Array * Array_new(Type * T, U32 cap) {
    Str *elem_type = dyn_type_to_str(T);
    Array *hoisted__Array_3706 = Array_new_type_name(elem_type, cap);
    (void)hoisted__Array_3706;
    Str_delete(elem_type, 1);
    return hoisted__Array_3706;
}
...
void * Array_get(Array * self, U32 * i, I64 * _err_kind, OutOfBounds * _err_OutOfBounds) {
    Bool hoisted__Bool_3727 = U32_gte(DEREF(i), self->cap);
    (void)hoisted__Bool_3727;
    if (hoisted__Bool_3727) {
        Type *hoisted__Type_3708 = Type_Struct(({ Str *_lit = malloc(sizeof(Str)); *_lit = (Str){.c_str = (void *)"Str", .count = 3ULL, .cap = TIL_CAP_LIT}; _lit; }));
        (void)hoisted__Type_3708;
        U32 hoisted__U32_3709 = 6;
        (void)hoisted__U32_3709;
        Array *_va_Array_114 = Array_new(hoisted__Type_3708, hoisted__U32_3709);
        (void)_va_Array_114;
        Type_delete(hoisted__Type_3708, 1);
        U32 hoisted__U32_3710 = 0;
        (void)hoisted__U32_3710;
        Str hoisted__Str_3711 = (Str){.c_str = (void *)"./src/core/array.til:41:44", .count = 26ULL, .cap = TIL_CAP_LIT};
        ...
        Str hoisted__Str_3713 = (Str){.c_str = (void *)":Array.get: index ", .count = 18ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_3713;
        Array_set(_va_Array_114, hoisted__U32_3712, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_3713; _oa; }));
        U32 hoisted__U32_3714 = 2;
        (void)hoisted__U32_3714;
        Str *hoisted__Str_3715 = U32_to_str(DEREF(i));
        (void)hoisted__Str_3715;
        Array_set(_va_Array_114, hoisted__U32_3714, hoisted__Str_3715);
        U32 hoisted__U32_3716 = 3;
        (void)hoisted__U32_3716;
        Str hoisted__Str_3717 = (Str){.c_str = (void *)" out of bounds (len ", .count = 20ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_3717;
        Array_set(_va_Array_114, hoisted__U32_3716, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_3717; _oa; }));
        U32 hoisted__U32_3718 = 4;
        (void)hoisted__U32_3718;
        Str *hoisted__Str_3719 = U32_to_str(self->cap);
        (void)hoisted__Str_3719;
        Array_set(_va_Array_114, hoisted__U32_3718, hoisted__Str_3719);
        U32 hoisted__U32_3720 = 5;
        (void)hoisted__U32_3720;
        Str hoisted__Str_3721 = (Str){.c_str = (void *)")", .count = 1ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_3721;
        Array_set(_va_Array_114, hoisted__U32_3720, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_3721; _oa; }));
        OutOfBounds *hoisted__OutOfBounds_3722 = malloc(sizeof(OutOfBounds));
        { Str *_ca = format(_va_Array_114); hoisted__OutOfBounds_3722->msg = *_ca; free(_ca); }
        (void)hoisted__OutOfBounds_3722;
        U32 hoisted__U32_3723 = 16;
        (void)hoisted__U32_3723;
        swap(_err_OutOfBounds, hoisted__OutOfBounds_3722, hoisted__U32_3723);
        OutOfBounds_delete(hoisted__OutOfBounds_3722, 1);
        I64 hoisted__I64_3724 = 3;
        (void)hoisted__I64_3724;
        *_err_kind = hoisted__I64_3724;
    }
    I64 hoisted__I64_3728 = 0;
    (void)hoisted__I64_3728;
    Bool hoisted__Bool_3729 = I64_eq(DEREF(_err_kind), hoisted__I64_3728);
    (void)hoisted__Bool_3729;
    if (hoisted__Bool_3729) {
        U32 hoisted__U64_3725 = U32_mul(DEREF(i), self->elem_size);
        (void)hoisted__U64_3725;
        void *hoisted__v_3726 = ptr_add(self->data, hoisted__U64_3725);
        (void)hoisted__v_3726;
        (void)hoisted__v_3726;
        { void * _ret_val = hoisted__v_3726;
                return _ret_val; }
    }
    return NULL;
}
...
void Array_set(Array * self, U32 i, void * val) {
    Bool hoisted__Bool_3744 = U32_gte(i, self->cap);
    (void)hoisted__Bool_3744;
    if (hoisted__Bool_3744) {
        Type *hoisted__Type_3731 = Type_Struct(({ Str *_lit = malloc(sizeof(Str)); *_lit = (Str){.c_str = (void *)"Str", .count = 3ULL, .cap = TIL_CAP_LIT}; _lit; }));
        (void)hoisted__Type_3731;
        U32 hoisted__U32_3732 = 5;
        (void)hoisted__U32_3732;
        Array *_va_Array_115 = Array_new(hoisted__Type_3731, hoisted__U32_3732);
        (void)_va_Array_115;
        Type_delete(hoisted__Type_3731, 1);
        U32 hoisted__U32_3733 = 0;
        (void)hoisted__U32_3733;
        Str hoisted__Str_3734 = (Str){.c_str = (void *)"Array.set: index ", .count = 17ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_3734;
        Array_set(_va_Array_115, hoisted__U32_3733, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_3734; _oa; }));
        U32 hoisted__U32_3735 = 1;
        (void)hoisted__U32_3735;
        Str *hoisted__Str_3736 = U32_to_str(i);
        (void)hoisted__Str_3736;
        Array_set(_va_Array_115, hoisted__U32_3735, hoisted__Str_3736);
        U32 hoisted__U32_3737 = 2;
        (void)hoisted__U32_3737;
        Str hoisted__Str_3738 = (Str){.c_str = (void *)" out of bounds (len ", .count = 20ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_3738;
        Array_set(_va_Array_115, hoisted__U32_3737, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_3738; _oa; }));
        U32 hoisted__U32_3739 = 3;
        (void)hoisted__U32_3739;
        Str *hoisted__Str_3740 = U32_to_str(self->cap);
        (void)hoisted__Str_3740;
        Array_set(_va_Array_115, hoisted__U32_3739, hoisted__Str_3740);
        U32 hoisted__U32_3741 = 4;
        (void)hoisted__U32_3741;
        Str hoisted__Str_3742 = (Str){.c_str = (void *)")", .count = 1ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_3742;
        Array_set(_va_Array_115, hoisted__U32_3741, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_3742; _oa; }));
        Str hoisted__Str_3743 = (Str){.c_str = (void *)"./src/core/array.til:50:19", .count = 26ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_3743;
        panic(&hoisted__Str_3743, _va_Array_115);
    ...
    ((void (*)(void *, Bool))(void *)(self->elem_delete))(hoisted__v_3746, hoisted__Bool_3747);
    U32 hoisted__U64_3748 = U32_mul(i, self->elem_size);
    (void)hoisted__U64_3748;
    void *hoisted__v_3749 = ptr_add(self->data, hoisted__U64_3748);
    (void)hoisted__v_3749;
    (void)hoisted__v_3749;
    memcpy(hoisted__v_3749, val, self->elem_size);
    free(val);
}

void Array_delete(Array * self, Bool call_free) {
    {
        U32 _re_U32_3750 = self->cap;
        (void)_re_U32_3750;
        U32 _rc_U32_3750 = 0;
        (void)_rc_U32_3750;
        Bool hoisted__Bool_3759 = U32_lte(_rc_U32_3750, _re_U32_3750);
        (void)hoisted__Bool_3759;
        if (hoisted__Bool_3759) {
            while (1) {
                Bool _wcond_Bool_3751 = U32_lt(_rc_U32_3750, _re_U32_3750);
                (void)_wcond_Bool_3751;
                if (_wcond_Bool_3751) {
                } else {
                    break;
                }
                U32 i = U32_clone(&_rc_U32_3750);
                U32_inc(&_rc_U32_3750);
            ...
            while (1) {
                Bool _wcond_Bool_3755 = U32_gt(_rc_U32_3750, _re_U32_3750);
                ...
                U32 i = U32_clone(&_rc_U32_3750);
                U32_dec(&_rc_U32_3750);
                U32 hoisted__U64_3756 = U32_mul(i, self->elem_size);
                (void)hoisted__U64_3756;
                void *hoisted__v_3757 = ptr_add(self->data, hoisted__U64_3756);
                (void)hoisted__v_3757;
                (void)hoisted__v_3757;
                Bool hoisted__Bool_3758 = 0;
                (void)hoisted__Bool_3758;
                ((void (*)(void *, Bool))(void *)(self->elem_delete))(hoisted__v_3757, hoisted__Bool_3758);
            }
        }
    }
    free(self->data);
...
Array * Array_clone(Array * self) {
    U32 hoisted__U64_3772 = U32_mul(self->cap, self->elem_size);
    (void)hoisted__U64_3772;
    void * new_data = malloc(hoisted__U64_3772);
    {
        U32 _re_U32_3760 = self->cap;
        (void)_re_U32_3760;
        U32 _rc_U32_3760 = 0;
        (void)_rc_U32_3760;
        Bool hoisted__Bool_3771 = U32_lte(_rc_U32_3760, _re_U32_3760);
        (void)hoisted__Bool_3771;
        if (hoisted__Bool_3771) {
            while (1) {
                Bool _wcond_Bool_3761 = U32_lt(_rc_U32_3760, _re_U32_3760);
                (void)_wcond_Bool_3761;
                if (_wcond_Bool_3761) {
                } else {
                    break;
                }
                U32 i = U32_clone(&_rc_U32_3760);
                U32_inc(&_rc_U32_3760);
                U32 hoisted__U64_3762 = U32_mul(i, self->elem_size);
                (void)hoisted__U64_3762;
                void *hoisted__v_3763 = ptr_add(self->data, hoisted__U64_3762);
                (void)hoisted__v_3763;
                (void)hoisted__v_3763;
                void * cloned = ((void * (*)(void *))(void *)(self->elem_clone))(hoisted__v_3763);
                U32 hoisted__U64_3764 = U32_mul(i, self->elem_size);
                (void)hoisted__U64_3764;
                void *hoisted__v_3765 = ptr_add(new_data, hoisted__U64_3764);
                (void)hoisted__v_3765;
                (void)hoisted__v_3765;
                memcpy(hoisted__v_3765, cloned, self->elem_size);
                free(cloned);
            }
        } else {
            while (1) {
                Bool _wcond_Bool_3766 = U32_gt(_rc_U32_3760, _re_U32_3760);
                (void)_wcond_Bool_3766;
                if (_wcond_Bool_3766) {
                } else {
                    break;
                }
                U32 i = U32_clone(&_rc_U32_3760);
                U32_dec(&_rc_U32_3760);
                ...
                (void)hoisted__v_3768;
                void * cloned = ((void * (*)(void *))(void *)(self->elem_clone))(hoisted__v_3768);
                U32 hoisted__U64_3769 = U32_mul(i, self->elem_size);
                (void)hoisted__U64_3769;
                void *hoisted__v_3770 = ptr_add(new_data, hoisted__U64_3769);
                (void)hoisted__v_3770;
                (void)hoisted__v_3770;
                memcpy(hoisted__v_3770, cloned, self->elem_size);
                free(cloned);
            }
        }
    }
    Array *hoisted__Array_3773 = malloc(sizeof(Array));
    hoisted__Array_3773->data = new_data;
    hoisted__Array_3773->cap = self->cap;
    hoisted__Array_3773->elem_size = self->elem_size;
    hoisted__Array_3773->elem_clone = (void *)self->elem_clone;
    hoisted__Array_3773->elem_delete = (void *)self->elem_delete;
    (void)hoisted__Array_3773;
    return hoisted__Array_3773;
}

U32 Array_size(void) {
    U32 hoisted__U32_3774 = 32;
    (void)hoisted__U32_3774;
    return hoisted__U32_3774;
}

void panic(Str * loc_str, Array * parts) {
    Type *hoisted__Type_4147 = Type_Struct(({ Str *_lit = malloc(sizeof(Str)); *_lit = (Str){.c_str = (void *)"Str", .count = 3ULL, .cap = TIL_CAP_LIT}; _lit; }));
    (void)hoisted__Type_4147;
    U32 hoisted__U32_4148 = 3;
    (void)hoisted__U32_4148;
    Array *_va_Array_147 = Array_new(hoisted__Type_4147, hoisted__U32_4148);
    (void)_va_Array_147;
    Type_delete(hoisted__Type_4147, 1);
    U32 hoisted__U32_4149 = 0;
    (void)hoisted__U32_4149;
    Str *hoisted__Str_4150 = Str_clone(loc_str);
    (void)hoisted__Str_4150;
    Array_set(_va_Array_147, hoisted__U32_4149, hoisted__Str_4150);
    U32 hoisted__U32_4151 = 1;
    (void)hoisted__U32_4151;
    Str hoisted__Str_4152 = (Str){.c_str = (void *)": panic: ", .count = 9ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4152;
    Array_set(_va_Array_147, hoisted__U32_4151, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_4152; _oa; }));
    Array *hoisted__Array_4153 = Array_clone(parts);
    (void)hoisted__Array_4153;
    Array_delete(parts, 1);
    U32 hoisted__U32_4154 = 2;
    (void)hoisted__U32_4154;
    Str *hoisted__Str_4155 = format(hoisted__Array_4153);
    (void)hoisted__Str_4155;
    Array_set(_va_Array_147, hoisted__U32_4154, hoisted__Str_4155);
    println(_va_Array_147);
    I64 hoisted__I64_4156 = 1;
    (void)hoisted__I64_4156;
    exit(hoisted__I64_4156);
}
...
void UNREACHABLE(Str * loc_str) {
    ...
    Array *_va_Array_149 = Array_new(hoisted__Type_4166, hoisted__U32_4167);
    (void)_va_Array_149;
    Type_delete(hoisted__Type_4166, 1);
    U32 hoisted__U32_4168 = 0;
    (void)hoisted__U32_4168;
    Str hoisted__Str_4169 = (Str){.c_str = (void *)"unreachable", .count = 11ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4169;
    Array_set(_va_Array_149, hoisted__U32_4168, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_4169; _oa; }));
    panic(loc_str, _va_Array_149);
}

Bool assert(Str * loc_str, Bool cond) {
    Bool hoisted__Bool_4175 = not(cond);
    (void)hoisted__Bool_4175;
    if (hoisted__Bool_4175) {
        ...
        Array *_va_Array_150 = Array_new(hoisted__Type_4171, hoisted__U32_4172);
        (void)_va_Array_150;
        Type_delete(hoisted__Type_4171, 1);
        U32 hoisted__U32_4173 = 0;
        (void)hoisted__U32_4173;
        Str hoisted__Str_4174 = (Str){.c_str = (void *)"assert failed", .count = 13ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_4174;
        Array_set(_va_Array_150, hoisted__U32_4173, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_4174; _oa; }));
        panic(loc_str, _va_Array_150);
    }
    Bool hoisted__Bool_4176 = 1;
    (void)hoisted__Bool_4176;
    return hoisted__Bool_4176;
}

void assert_eq(Str * loc_str, I64 a, I64 b) {
    Bool hoisted__Bool_4199 = I64_neq(a, b);
    (void)hoisted__Bool_4199;
    if (hoisted__Bool_4199) {
        ...
        Str hoisted__Str_4190 = (Str){.c_str = (void *)"assert_eq failed: expected '", .count = 28ULL, .cap = TIL_CAP_LIT};
        ...
        Str *hoisted__Str_4192 = I64_to_str(a);
        (void)hoisted__Str_4192;
        Array_set(_va_Array_152, hoisted__U32_4191, hoisted__Str_4192);
        U32 hoisted__U32_4193 = 2;
        (void)hoisted__U32_4193;
        Str hoisted__Str_4194 = (Str){.c_str = (void *)"', found '", .count = 10ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_4194;
        Array_set(_va_Array_152, hoisted__U32_4193, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_4194; _oa; }));
        U32 hoisted__U32_4195 = 3;
        (void)hoisted__U32_4195;
        Str *hoisted__Str_4196 = I64_to_str(b);
        (void)hoisted__Str_4196;
        Array_set(_va_Array_152, hoisted__U32_4195, hoisted__Str_4196);
        U32 hoisted__U32_4197 = 4;
        (void)hoisted__U32_4197;
        Str hoisted__Str_4198 = (Str){.c_str = (void *)"'", .count = 1ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_4198;
        Array_set(_va_Array_152, hoisted__U32_4197, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_4198; _oa; }));
        panic(loc_str, _va_Array_152);
    }
}

void assert_eq_str(Str * loc_str, Str * a, Str * b) {
    Bool hoisted__Bool_4213 = Str_eq(a, b);
    (void)hoisted__Bool_4213;
    Bool hoisted__Bool_4214 = not(hoisted__Bool_4213);
    ...
    if (hoisted__Bool_4214) {
        ...
        U32 hoisted__U32_4202 = 5;
        (void)hoisted__U32_4202;
        Array *_va_Array_153 = Array_new(hoisted__Type_4201, hoisted__U32_4202);
        (void)_va_Array_153;
        Type_delete(hoisted__Type_4201, 1);
        U32 hoisted__U32_4203 = 0;
        (void)hoisted__U32_4203;
        Str hoisted__Str_4204 = (Str){.c_str = (void *)"assert_eq_str failed: expected '", .count = 32ULL, .cap = TIL_CAP_LIT};
        ...
        Str *hoisted__Str_4206 = Str_clone(a);
        ...
        Str hoisted__Str_4208 = (Str){.c_str = (void *)"', found '", .count = 10ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_4208;
        Array_set(_va_Array_153, hoisted__U32_4207, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_4208; _oa; }));
        U32 hoisted__U32_4209 = 3;
        (void)hoisted__U32_4209;
        Str *hoisted__Str_4210 = Str_clone(b);
        (void)hoisted__Str_4210;
        Array_set(_va_Array_153, hoisted__U32_4209, hoisted__Str_4210);
        U32 hoisted__U32_4211 = 4;
        (void)hoisted__U32_4211;
        Str hoisted__Str_4212 = (Str){.c_str = (void *)"'", .count = 1ULL, .cap = TIL_CAP_LIT};
        (void)hoisted__Str_4212;
        Array_set(_va_Array_153, hoisted__U32_4211, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_4212; _oa; }));
...
void println(Array * parts) {
    {
        Array *_fc_Array_4215 = parts;
        (void)_fc_Array_4215;
        (void)_fc_Array_4215;
        U32 _fi_USize_4215 = 0;
        (void)_fi_USize_4215;
        I64 _forin_err_kind_4215 = 0;
        (void)_forin_err_kind_4215;
        OutOfBounds *_forin_OutOfBounds_4215 = malloc(sizeof(OutOfBounds));
        _forin_OutOfBounds_4215->msg = (Str){.c_str=(void*)"", .count=0ULL, .cap=TIL_CAP_LIT};
        (void)_forin_OutOfBounds_4215;
        while (1) {
            U32 hoisted__U32_4223 = Array_len(_fc_Array_4215);
            (void)hoisted__U32_4223;
            Bool _wcond_Bool_4216 = U32_lt(_fi_USize_4215, hoisted__U32_4223);
            (void)_wcond_Bool_4216;
            if (_wcond_Bool_4216) {
            } else {
                break;
            }
            Str *s = Array_get(_fc_Array_4215, &_fi_USize_4215, &_forin_err_kind_4215, _forin_OutOfBounds_4215);
            I64 hoisted__I64_4224 = 0;
            (void)hoisted__I64_4224;
            Bool hoisted__Bool_4225 = I64_eq(_forin_err_kind_4215, hoisted__I64_4224);
            (void)hoisted__Bool_4225;
            Bool hoisted__Bool_4226 = not(hoisted__Bool_4225);
            ...
            if (hoisted__Bool_4226) {
                ...
                Array *_va_Array_154 = Array_new(hoisted__Type_4218, hoisted__U32_4219);
                (void)_va_Array_154;
                Type_delete(hoisted__Type_4218, 1);
                U32 hoisted__U32_4220 = 0;
                (void)hoisted__U32_4220;
                Str hoisted__Str_4221 = (Str){.c_str = (void *)"OutOfBounds", .count = 11ULL, .cap = TIL_CAP_LIT};
                (void)hoisted__Str_4221;
                Array_set(_va_Array_154, hoisted__U32_4220, ({ Str *_oa = malloc(sizeof(Str)); *_oa = hoisted__Str_4221; _oa; }));
                Str hoisted__Str_4222 = (Str){.c_str = (void *)"./src/core/io.til:15:9", .count = 22ULL, .cap = TIL_CAP_LIT};
                (void)hoisted__Str_4222;
                panic(&hoisted__Str_4222, _va_Array_154);
                Str_delete(&hoisted__Str_4222, (Bool){0});
            }
            U32 hoisted__U32_4227 = 1;
            (void)hoisted__U32_4227;
            U32 hoisted__U32_4228 = U32_add(_fi_USize_4215, hoisted__U32_4227);
            (void)hoisted__U32_4228;
            _fi_USize_4215 = hoisted__U32_4228;
            print_single(s);
        }
        OutOfBounds_delete(_forin_OutOfBounds_4215, 1);
    }
    Array_delete(parts, 1);
    print_flush();
}
...
void test_simple_add(void) {
    I64 result = 3;
    Str hoisted__Str_4483 = (Str){.c_str = (void *)"test/constfold.til:15:15", .count = 24ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4483;
    I64 hoisted__I64_4484 = 3;
...
void test_nested_arithmetic(void) {
    I64 result = 15;
    Str hoisted__Str_4491 = (Str){.c_str = (void *)"test/constfold.til:21:15", .count = 24ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4491;
    I64 hoisted__I64_4492 = 15;
    (void)hoisted__I64_4492;
    assert_eq(&hoisted__Str_4491, result, hoisted__I64_4492);
    Str_delete(&hoisted__Str_4491, (Bool){0});
}

void test_deeply_nested(void) {
    I64 result = 26;
    Str hoisted__Str_4499 = (Str){.c_str = (void *)"test/constfold.til:27:15", .count = 24ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4499;
    I64 hoisted__I64_4500 = 26;
    (void)hoisted__I64_4500;
    assert_eq(&hoisted__Str_4499, result, hoisted__I64_4500);
    Str_delete(&hoisted__Str_4499, (Bool){0});
}

void test_string_concat(void) {
    Str result = (Str){.c_str = (void *)"hello world", .count = 11ULL, .cap = TIL_CAP_LIT};
    Str hoisted__Str_4503 = (Str){.c_str = (void *)"test/constfold.til:33:19", .count = 24ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4503;
    Str hoisted__Str_4504 = (Str){.c_str = (void *)"hello world", .count = 11ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4504;
    assert_eq_str(&hoisted__Str_4503, &result, &hoisted__Str_4504);
...
void test_lolalalo(void) {
    ...
    Str hoisted__Str_4835 = (Str){.c_str = (void *)"test/constfold.til:86:19", .count = 24ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4835;
    assert_eq_str(&hoisted__Str_4835, &lola_rec, &lola_it);
    Str_delete(&hoisted__Str_4835, (Bool){0});
    Str_delete(&lola_it, (Bool){0});
    Str_delete(&lola_rec, (Bool){0});
    Str hoisted__Str_4836 = (Str){.c_str = (void *)"test/constfold.til:87:19", .count = 24ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4836;
    assert_eq_str(&hoisted__Str_4836, &lalo_rec, &lalo_it);
...
void test_fold_variable(void) {
    I64 result = 8;
    Str hoisted__Str_4838 = (Str){.c_str = (void *)"test/constfold.til:94:15", .count = 24ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4838;
    I64 hoisted__I64_4839 = 8;
    (void)hoisted__I64_4839;
    assert_eq(&hoisted__Str_4838, result, hoisted__I64_4839);
    Str_delete(&hoisted__Str_4838, (Bool){0});
}

void test_loc_folded(void) {
    Str hoisted__Str_4842 = (Str){.c_str = (void *)"test/constfold.til:99:12", .count = 24ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4842;
    Bool hoisted__Bool_4843 = 1;
    (void)hoisted__Bool_4843;
    assert(&hoisted__Str_4842, hoisted__Bool_4843);
    Str_delete(&hoisted__Str_4842, (Bool){0});
    Str hoisted__Str_4846 = (Str){.c_str = (void *)"test/constfold.til:100:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4846;
    Bool hoisted__Bool_4847 = 1;
    (void)hoisted__Bool_4847;
    assert(&hoisted__Str_4846, hoisted__Bool_4847);
    Str_delete(&hoisted__Str_4846, (Bool){0});
}

void test_fold_f32(void) {
    Str hoisted__Str_4852 = (Str){.c_str = (void *)"test/constfold.til:111:19", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4852;
    Str hoisted__Str_4853 = (Str){.c_str = (void *)"6.25", .count = 4ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4853;
    Str hoisted__Str_4854 = (Str){.c_str = (void *)"6.25", .count = 4ULL, .cap = TIL_CAP_LIT};
    ...
    Str hoisted__Str_4857 = (Str){.c_str = (void *)"test/constfold.til:113:19", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4857;
    Str hoisted__Str_4858 = (Str){.c_str = (void *)"3.5", .count = 3ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4858;
    Str hoisted__Str_4859 = (Str){.c_str = (void *)"3.5", .count = 3ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4859;
    assert_eq_str(&hoisted__Str_4857, &hoisted__Str_4858, &hoisted__Str_4859);
...
CfVec2 * CfVec2_clone(CfVec2 * self) {
    CfVec2 hoisted__CfVec2_4864 = (CfVec2){.x = self->x, .y = self->y};
    (void)hoisted__CfVec2_4864;
    { CfVec2 *_r = malloc(sizeof(CfVec2)); *_r = hoisted__CfVec2_4864;
    return _r; }
}
...
U64 CfVec2_hash(CfVec2 * self, HashFn hasher) {
    ...
    U64 hoisted__U64_4866 = ((U64 (*)(CfVec2 *, U32))(void *)hasher)(self, hoisted__U32_4865);
    (void)hoisted__U64_4866;
    return hoisted__U64_4866;
}

U32 CfVec2_size(void) {
    U32 hoisted__U32_4867 = 16;
    (void)hoisted__U32_4867;
    return hoisted__U32_4867;
}

void test_struct_fold_simple(void) {
    CfVec2 v = (CfVec2){.x = 42, .y = 99};
    Str hoisted__Str_4868 = (Str){.c_str = (void *)"test/constfold.til:135:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4868;
    I64 hoisted__I64_4869 = 42;
    (void)hoisted__I64_4869;
    assert_eq(&hoisted__Str_4868, v.x, hoisted__I64_4869);
    Str_delete(&hoisted__Str_4868, (Bool){0});
    Str hoisted__Str_4870 = (Str){.c_str = (void *)"test/constfold.til:136:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4870;
    I64 hoisted__I64_4871 = 99;
    (void)hoisted__I64_4871;
    assert_eq(&hoisted__Str_4870, v.y, hoisted__I64_4871);
...
void test_struct_fold_values(void) {
    ...
    Str hoisted__Str_4874 = (Str){.c_str = (void *)"test/constfold.til:142:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4874;
    I64 hoisted__I64_4875 = 10;
    (void)hoisted__I64_4875;
    assert_eq(&hoisted__Str_4874, p.x, hoisted__I64_4875);
    Str_delete(&hoisted__Str_4874, (Bool){0});
    Str hoisted__Str_4876 = (Str){.c_str = (void *)"test/constfold.til:143:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4876;
    I64 hoisted__I64_4877 = 20;
    (void)hoisted__I64_4877;
    assert_eq(&hoisted__Str_4876, p.y, hoisted__I64_4877);
    Str_delete(&hoisted__Str_4876, (Bool){0});
    CfVec2_delete(&p, (Bool){0});
}

CfRect * CfRect_clone(CfRect * self) {
    CfRect hoisted__CfRect_4883 = (CfRect){.top_left = self->top_left, .bottom_right = self->bottom_right};
    (void)hoisted__CfRect_4883;
    { CfRect *_r = malloc(sizeof(CfRect)); *_r = hoisted__CfRect_4883;
    return _r; }
}
...
U64 CfRect_hash(CfRect * self, HashFn hasher) {
    ...
    U64 hoisted__U64_4885 = ((U64 (*)(CfRect *, U32))(void *)hasher)(self, hoisted__U32_4884);
    (void)hoisted__U64_4885;
    return hoisted__U64_4885;
}

U32 CfRect_size(void) {
    U32 hoisted__U32_4886 = 32;
...
void test_struct_fold_nested(void) {
    ...
    Str hoisted__Str_4887 = (Str){.c_str = (void *)"test/constfold.til:159:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4887;
    I64 hoisted__I64_4888 = 5;
    (void)hoisted__I64_4888;
    assert_eq(&hoisted__Str_4887, r.top_left.x, hoisted__I64_4888);
    Str_delete(&hoisted__Str_4887, (Bool){0});
    Str hoisted__Str_4889 = (Str){.c_str = (void *)"test/constfold.til:160:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4889;
    I64 hoisted__I64_4890 = 10;
    (void)hoisted__I64_4890;
    assert_eq(&hoisted__Str_4889, r.top_left.y, hoisted__I64_4890);
    Str_delete(&hoisted__Str_4889, (Bool){0});
    Str hoisted__Str_4891 = (Str){.c_str = (void *)"test/constfold.til:161:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4891;
    I64 hoisted__I64_4892 = 100;
    (void)hoisted__I64_4892;
    assert_eq(&hoisted__Str_4891, r.bottom_right.x, hoisted__I64_4892);
    Str_delete(&hoisted__Str_4891, (Bool){0});
    Str hoisted__Str_4893 = (Str){.c_str = (void *)"test/constfold.til:162:15", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4893;
    I64 hoisted__I64_4894 = 200;
    (void)hoisted__I64_4894;
    assert_eq(&hoisted__Str_4893, r.bottom_right.y, hoisted__I64_4894);
...
Bool Color_eq(Color * self, Color * other) {
    Bool hoisted__Bool_4899 = is(self, &(Color){.tag = Color_TAG_Red});
    (void)hoisted__Bool_4899;
    if (hoisted__Bool_4899) {
        Bool hoisted__Bool_4896 = is(other, &(Color){.tag = Color_TAG_Red});
        (void)hoisted__Bool_4896;
        { Bool _ret_val = hoisted__Bool_4896;
                return _ret_val; }
    }
    Bool hoisted__Bool_4900 = is(self, &(Color){.tag = Color_TAG_Green});
    (void)hoisted__Bool_4900;
    if (hoisted__Bool_4900) {
        Bool hoisted__Bool_4897 = is(other, &(Color){.tag = Color_TAG_Green});
        (void)hoisted__Bool_4897;
        { Bool _ret_val = hoisted__Bool_4897;
                return _ret_val; }
    }
    Bool hoisted__Bool_4901 = is(self, &(Color){.tag = Color_TAG_Blue});
    (void)hoisted__Bool_4901;
    if (hoisted__Bool_4901) {
        Bool hoisted__Bool_4898 = is(other, &(Color){.tag = Color_TAG_Blue});
        (void)hoisted__Bool_4898;
        { Bool _ret_val = hoisted__Bool_4898;
                return _ret_val; }
    }
    Bool hoisted__Bool_4902 = 0;
    (void)hoisted__Bool_4902;
    return hoisted__Bool_4902;
}
...
Color * Color_clone(Color * self) {
    Bool hoisted__Bool_4910 = Color_eq(self, &(Color){.tag = Color_TAG_Red});
    (void)hoisted__Bool_4910;
    if (hoisted__Bool_4910) {
        { Color *_r = malloc(sizeof(Color)); _r->tag = Color_TAG_Red;
                return _r; }
    }
    Bool hoisted__Bool_4911 = Color_eq(self, &(Color){.tag = Color_TAG_Green});
    (void)hoisted__Bool_4911;
    if (hoisted__Bool_4911) {
        { Color *_r = malloc(sizeof(Color)); _r->tag = Color_TAG_Green;
                return _r; }
    }
    Bool hoisted__Bool_4912 = Color_eq(self, &(Color){.tag = Color_TAG_Blue});
    (void)hoisted__Bool_4912;
    if (hoisted__Bool_4912) {
        { Color *_r = malloc(sizeof(Color)); _r->tag = Color_TAG_Blue;
                return _r; }
    }
    Str hoisted__Str_4913 = (Str){.c_str = (void *)"Color.clone:167:1", .count = 17ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4913;
    UNREACHABLE(&hoisted__Str_4913);
...
void test_enum_fold(void) {
    ...
    Str hoisted__Str_4915 = (Str){.c_str = (void *)"test/constfold.til:172:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4915;
    Bool hoisted__Bool_4916 = Color_eq(&c, &(Color){.tag = Color_TAG_Red});
    (void)hoisted__Bool_4916;
    assert(&hoisted__Str_4915, hoisted__Bool_4916);
    Str_delete(&hoisted__Str_4915, (Bool){0});
    Bool hoisted__Bool_4917 = Color_eq(&c, &(Color){.tag = Color_TAG_Green});
    (void)hoisted__Bool_4917;
    Str hoisted__Str_4918 = (Str){.c_str = (void *)"test/constfold.til:173:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4918;
    Bool hoisted__Bool_4919 = not(hoisted__Bool_4917);
...
Bool Token_is(Token * self, Token * other) {
    Bool hoisted__Bool_4920 = is(self, other);
    (void)hoisted__Bool_4920;
    return hoisted__Bool_4920;
}

void Token_delete(Token * self, Bool call_free) {
    Bool hoisted__Bool_4938 = is(self, &(Token){.tag = Token_TAG_Num});
    (void)hoisted__Bool_4938;
    if (hoisted__Bool_4938) {
        I64 *hoisted__I64_4934 = get_payload(self);
        (void)hoisted__I64_4934;
        (void)hoisted__I64_4934;
        Bool hoisted__Bool_4935 = 0;
        (void)hoisted__Bool_4935;
        I64_delete(hoisted__I64_4934, hoisted__Bool_4935);
    }
    Bool hoisted__Bool_4939 = is(self, &(Token){.tag = Token_TAG_Name});
    (void)hoisted__Bool_4939;
    if (hoisted__Bool_4939) {
        Str *hoisted__Str_4936 = get_payload(self);
        (void)hoisted__Str_4936;
        (void)hoisted__Str_4936;
        Bool hoisted__Bool_4937 = 0;
        (void)hoisted__Bool_4937;
        Str_delete(hoisted__Str_4936, hoisted__Bool_4937);
    }
    if (call_free) {
        free(self);
    }
...
Token * Token_clone(Token * self) {
    ...
    if (hoisted__Bool_4968) {
        ...
        (void)_clone_payload_Num_0;
        Token *hoisted__Token_4965 = Token_Num(_clone_payload_Num_0);
        (void)hoisted__Token_4965;
        { Token * _ret_val = hoisted__Token_4965;
                return _ret_val; }
    }
    ...
    if (hoisted__Bool_4969) {
        ...
        (void)_clone_payload_Name_1;
        Str *hoisted__Str_4966 = Str_clone(_clone_payload_Name_1);
        (void)hoisted__Str_4966;
        Token *hoisted__Token_4967 = Token_Name(hoisted__Str_4966);
        (void)hoisted__Token_4967;
        { Token * _ret_val = hoisted__Token_4967;
                return _ret_val; }
    }
...
void test_enum_payload_fold(void) {
    ...
    Str hoisted__Str_4972 = (Str){.c_str = (void *)"test/constfold.til:181:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    ...
    Token_delete(t, 1);
    Str hoisted__Str_4975 = (Str){.c_str = (void *)"test/constfold.til:182:12", .count = 25ULL, .cap = TIL_CAP_LIT};
...
void test_enum_return_fold(void) {
    ...
    Str hoisted__Str_4977 = (Str){.c_str = (void *)"test/constfold.til:191:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4977;
    Bool hoisted__Bool_4978 = Color_eq(&c, &(Color){.tag = Color_TAG_Green});
    (void)hoisted__Bool_4978;
    assert(&hoisted__Str_4977, hoisted__Bool_4978);
    Str_delete(&hoisted__Str_4977, (Bool){0});
    Bool hoisted__Bool_4979 = Color_eq(&c, &(Color){.tag = Color_TAG_Red});
    (void)hoisted__Bool_4979;
    Str hoisted__Str_4980 = (Str){.c_str = (void *)"test/constfold.til:192:12", .count = 25ULL, .cap = TIL_CAP_LIT};
...
void test_enum_payload_return_fold(void) {
    ...
    Str hoisted__Str_4984 = (Str){.c_str = (void *)"test/constfold.til:203:12", .count = 25ULL, .cap = TIL_CAP_LIT};
    (void)hoisted__Str_4984;
    Bool hoisted__Bool_4985 = Token_is(t, &(Token){.tag = Token_TAG_Num});
    (void)hoisted__Bool_4985;
    assert(&hoisted__Str_4984, hoisted__Bool_4985);
    Str_delete(&hoisted__Str_4984, (Bool){0});
    Bool hoisted__Bool_4986 = Token_is(t, &(Token){.tag = Token_TAG_Eof});
    (void)hoisted__Bool_4986;
    Token_delete(t, 1);
    Str hoisted__Str_4987 = (Str){.c_str = (void *)"test/constfold.til:204:12", .count = 25ULL, .cap = TIL_CAP_LIT};
